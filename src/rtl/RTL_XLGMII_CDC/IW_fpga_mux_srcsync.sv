...
//------------------------------------------------------------------------------
// Parallel mux with source sync clock version
...
module IW_fpga_mux_srcsync #(
  ...
  , parameter INSTANCE_NAME        = "u_mux_srcsync"  //Can hold upto 16 ASCII characters
 ) (
    input                                            rst_mux_n
...
assign local_clk_mux_int = pos_divby2 ^ neg_divby2;
...
IW_fpga_avst2csr #(
  ...
  assign params0_reg = {NUMBER_OF_OUTPUTS[7:0],SRC_SYNC_DELAY[3:0],SYNC_DELAY[3:0],OUTPUT_BUDGET[7:0],INPUT_BUDGET[7:0]};
