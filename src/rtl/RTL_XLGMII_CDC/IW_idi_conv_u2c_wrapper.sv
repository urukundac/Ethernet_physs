module IW_idi_conv_u2c_wrapper (
...
parameter DEMUX_DATA_WIDTH 		= 490;
...
//}; 
   ...
   input   [(IDI_C2U_DATA_WIDTH/8)-1:0]  	idi_data_if_C2U_DATA_BYTE_ENABLE;
   input           				idi_data_if_C2U_DATA_BYTE_ENABLE_PARITY;
   input   [IDI_C2U_DATA_WIDTH-1:0] 		idi_data_if_C2U_DATA_DATA;
   input   [IDI_C2U_ECC_WIDTH-1:0]   		idi_data_if_C2U_DATA_ECC;
   input           				idi_data_if_C2U_DATA_ECC_VALID;
   input   [(IDI_C2U_DATA_WIDTH/64)-1:0]   	idi_data_if_C2U_DATA_PARITY;
   input           				idi_data_if_C2U_DATA_POISON;
   output  [IDI_U2C_DATA_WIDTH-1:0] 		idi_data_if_U2C_DATA_DATA;
   output  [IDI_U2C_ECC_WIDTH-1:0]   		idi_data_if_U2C_DATA_ECC;
   output          				idi_data_if_U2C_DATA_ECC_VALID;
   output  [(IDI_U2C_DATA_WIDTH/64)-1:0]   	idi_data_if_U2C_DATA_PARITY;
   output          				idi_data_if_U2C_DATA_POISON;
   // Ports for Interface idi_pld_if
   input           				idi_pld_if_C2U_DATA_BOGUS;
   input   [3:0]   				idi_pld_if_C2U_DATA_CHUNKVALID;
   input   [1:0]   				idi_pld_if_C2U_DATA_SPARE;
   input   [IDI_UQID_WIDTH-1:0]  		idi_pld_if_C2U_DATA_UQID;
   input           				idi_pld_if_C2U_DATA_VALID;
   input   [IDI_ADDRESS_WIDTH-1:0]  		idi_pld_if_C2U_REQ_ADDRESS;
   input           				idi_pld_if_C2U_REQ_ADDRPARITY;
   input           				idi_pld_if_C2U_REQ_CACHELOCALLY;
   input           				idi_pld_if_C2U_REQ_CACHEREMOTELY;
   input   [IDI_CLOS_WIDTH-1:0]  		idi_pld_if_C2U_REQ_CLOS;
   input   [IDI_CQID_WIDTH-1:0]  		idi_pld_if_C2U_REQ_CQID;
   input   [5:0]   				idi_pld_if_C2U_REQ_HASH;
   input   [5:0]   				idi_pld_if_C2U_REQ_LENGTH;
   input   [IDI_LPID_WIDTH-1:0]   		idi_pld_if_C2U_REQ_LPID;
   input   [IDI_NONTEMPORAL_WIDTH-1:0]   	idi_pld_if_C2U_REQ_NONTEMPORAL;
   input   [5:0]   				idi_pld_if_C2U_REQ_OPCODE;
   input   [1:0]   				idi_pld_if_C2U_REQ_OPGROUP;
   input   [7:0]   				idi_pld_if_C2U_REQ_SAI;
   input           				idi_pld_if_C2U_REQ_SLFSNP;
   input   [9:0]   				idi_pld_if_C2U_REQ_SPARE;
   input   [3:0]   				idi_pld_if_C2U_REQ_TOPOLOGY;
   input           				idi_pld_if_C2U_REQ_VALID;
   input           				idi_pld_if_C2U_RSP_HLEABORT;
   input           				idi_pld_if_C2U_RSP_MONEXIST;
   input   [4:0]   				idi_pld_if_C2U_RSP_OPCODE;
   input   [1:0]   				idi_pld_if_C2U_RSP_SPARE;
   input   [IDI_UQID_WIDTH-1:0]  		idi_pld_if_C2U_RSP_UQID;
   input           				idi_pld_if_C2U_RSP_VALID;
   input           				idi_pld_if_U2C_DATA_CREDIT_RETURN;
   input           				idi_pld_if_U2C_REQ_CREDIT_RETURN;
   input           				idi_pld_if_U2C_RSP_CREDIT_RETURN;
   output          				idi_pld_if_C2U_DATA_CREDIT_RETURN;
   output          				idi_pld_if_C2U_REQ_CREDIT_RETURN;
   output          				idi_pld_if_C2U_RSP_CREDIT_RETURN;
   output  [3:0]   				idi_pld_if_U2C_DATA_CHUNKVALID;
   output  [IDI_CQID_WIDTH-1:0]  		idi_pld_if_U2C_DATA_CQID;
   output  [6:0]   				idi_pld_if_U2C_DATA_PRE;
   output          				idi_pld_if_U2C_DATA_SPARE;
   output          				idi_pld_if_U2C_DATA_VALID;
   output  [(IDI_ADDRESS_WIDTH-3)-1:0]  	idi_pld_if_U2C_REQ_ADDRESS;
   output          				idi_pld_if_U2C_REQ_ADDRPARITY;
   output  [4:0]   				idi_pld_if_U2C_REQ_OPCODE;
   output  [15:0]  				idi_pld_if_U2C_REQ_REQDATA;
   output  [1:0]   				idi_pld_if_U2C_REQ_SPARE;
   output          				idi_pld_if_U2C_REQ_VALID;
   output  [IDI_CQID_WIDTH-1:0]  		idi_pld_if_U2C_RSP_CQID;
   output  [3:0]   				idi_pld_if_U2C_RSP_OPCODE;
   output  [1:0]   				idi_pld_if_U2C_RSP_PRE;
   output  [12:0]  				idi_pld_if_U2C_RSP_RSPDATA;
   output  [1:0]   				idi_pld_if_U2C_RSP_SPARE;
   output          				idi_pld_if_U2C_RSP_VALID;
   // Ports for Interface idi_ras_if
   input           				idi_ras_if_C2U_StickyFatalErr;
   // Ports for Interface idi_strap_if
   input   [C2U_STRAP_STRAP_WIDTH-1:0]  	idi_strap_if_C2U_STRAP_STRAP;
   input   [C2U_STRAP_VERSION_WIDTH-1:0]   	idi_strap_if_C2U_STRAP_VERSION;
   output  [U2C_STRAP_STRAP_WIDTH-1:0]  	idi_strap_if_U2C_STRAP_STRAP;
   output  [U2C_STRAP_VERSION_WIDTH-1:0]   	idi_strap_if_U2C_STRAP_VERSION;
