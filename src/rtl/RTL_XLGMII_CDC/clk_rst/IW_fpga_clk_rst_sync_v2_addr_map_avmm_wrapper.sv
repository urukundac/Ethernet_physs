...
/*
 --------------------------------------------------------------------------
 -- Project Code      : IMPrES
 -- Module Name       : IW_fpga_clk_rst_sync_v2_addr_map_avmm_wrapper 
...
module IW_fpga_clk_rst_sync_v2_addr_map_avmm_wrapper #(
    parameter INSTANCE_NAME           = "u_clk_rst_syncv2"     //Can hold upto 16 ASCII characters
  ...
  , input logic [9:0]                                   i_master_calibrate_fsm
	, input logic [4:0]                                   i_tx_calibrate_fsm
	...
	, input logic                                         i_cal_success
  , input logic [PARAM_WIDTH-1:0]                       i_failure_det_cnt  
  , input logic [PARAM_WIDTH-1:0]                       i_valid_window

);

import IW_fpga_clk_rst_sync_v2_addr_map_pkg::*;
import rtlgen_pkg_IW_fpga_clk_rst_sync_v2_addr_map::*;
...
new_clk_status_0_reg_cr_t                  new_clk_status_0_reg_cr;
new_clk_status_1_reg_cr_t                  new_clk_status_1_reg_cr;
new_clk_status_2_reg_cr_t                  new_clk_status_2_reg_cr;
new_clk_status_3_reg_cr_t                  new_clk_status_3_reg_cr;
new_clk_status_4_reg_cr_t                  new_clk_status_4_reg_cr;
new_clk_status_5_reg_cr_t                  new_clk_status_5_reg_cr;

IW_fpga_clk_rst_sync_v2_addr_map_cr_req_t     reg_mod_req;
IW_fpga_clk_rst_sync_v2_addr_map_cr_ack_t     reg_mod_ack;
...
begin
  ...
  new_clk_status_0_reg_cr                     = 'h0;
  new_clk_status_1_reg_cr                     = 'h0;
  new_clk_status_2_reg_cr                     = 'h0;
  new_clk_status_3_reg_cr                     = 'h0;
  new_clk_status_4_reg_cr                     = 'h0;
  new_clk_status_5_reg_cr                     = 'h0;

  new_clk_param_0_reg_cr.PLL_NUM_CLKS                              = NUM_PLL_CLOCKS;
  new_clk_param_0_reg_cr.NUM_DERIVATIVE_CLOCKS                     = NUM_DERIVATIVE_CLOCKS;
  new_clk_param_0_reg_cr.ENABLE_CLK_SYNC                           = ENABLE_CLK_SYNC;
  new_clk_param_0_reg_cr.CLK_SYN_MASTER                            = CLK_SYN_MASTER;
  new_clk_param_0_reg_cr.UPSTREAM_WIDTH                            = UPSTREAM_WIDTH;

  new_clk_param_1_reg_cr.PARAM_WIDTH                               = PARAM_WIDTH;
  new_clk_param_1_reg_cr.NUM_ITERATIONS                            = NUM_ITERATIONS;
  new_clk_param_1_reg_cr.MIN_PULSE_WIDTH                           = MIN_PULSE_WIDTH;
  new_clk_param_1_reg_cr.MAX_PULSE_WIDTH                           = MAX_PULSE_WIDTH;

  new_clk_param_2_reg_cr.START_OFFSET_POSITION                     = START_OFFSET_POSITION;
  new_clk_param_2_reg_cr.END_OFFSET_POSITION                       = END_OFFSET_POSITION;

  new_clk_param_3_reg_cr.VCO_SHIFT_PER_PULSE                       = VCO_SHIFT_PER_PULSE;
  new_clk_param_3_reg_cr.CLOCK_RATIO                               = CLOCK_RATIO;

  new_clk_status_0_reg_cr.master_calib_fsm                          = {6'b0, i_master_calibrate_fsm};
  new_clk_status_0_reg_cr.tx_calib_fsm                              = {11'b0, i_tx_calibrate_fsm};
  new_clk_status_1_reg_cr.Tx_offset                                 = i_hit_tx_offset[15:0];
  new_clk_status_1_reg_cr.Rx_offset                                 = i_hit_rx_offset[15:0];
  new_clk_status_2_reg_cr.hit_iterations                            = i_hit_iterations[15:0];
  new_clk_status_2_reg_cr.hit_pulsewidth                            = i_hit_pulse_width[15:0];
  new_clk_status_3_reg_cr.calib_success                             = i_cal_success;
  new_clk_status_3_reg_cr.reserved                                  = '0;
  new_clk_status_4_reg_cr.valid_window                              = i_valid_window;
  new_clk_status_5_reg_cr.failuer_det_cntr                          = i_failure_det_cnt;
end
 
// clock and reset sync register module instantiation
   IW_fpga_clk_rst_sync_v2_addr_map IW_fpga_clk_rst_sync_v2_addr_map_inst (
    // Clocks
    // Resets
    . rst_n                                 ( rsi_reset_n                      )
    // Register Inputs
    ...
    ,. new_clk_status_0_reg_cr              ( new_clk_status_0_reg_cr          )
    ,. new_clk_status_1_reg_cr              ( new_clk_status_1_reg_cr          )
    ,. new_clk_status_2_reg_cr              ( new_clk_status_2_reg_cr          )
    ,. new_clk_status_3_reg_cr              ( new_clk_status_3_reg_cr          )
    ,. new_clk_status_4_reg_cr              ( new_clk_status_4_reg_cr          )
    ,. new_clk_status_5_reg_cr              ( new_clk_status_5_reg_cr          )
