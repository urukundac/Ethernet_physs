...
// ctech_lib_doublesync_set  flop with metastability modeling active high set
        ...
        if (meta_disable) begin
            ...
            if (MIN_PERIOD!=0) begin
                ...
                fork
                    ...
                    forever begin
                        @(posedge clk or posedge set) begin
                            past_delay<=dly;
                        end
                    end
...
endmodule // ctech_lib_doublesync_set
