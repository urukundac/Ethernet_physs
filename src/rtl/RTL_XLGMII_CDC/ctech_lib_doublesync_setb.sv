...
// ctech_lib_doublesync_setb  flop with metastability modeling active low set
// Date Generated:  08:38:28 05-Oct-2017//
                ...
                fork
                    case({SINGLE_BUS_META, three2one_disable,plus1_only_mode, minus1_only_mode})
                        ...
                        4'b1011: begin // Single and only +1 (3->1 is NOP)
                                     if( minus1_only_mode ) $display("ERROR: %0m CTECH DOUBLESYNC - Both PLUS and MINUS modes are selected. Defaulting to plus only.") ;
                                     forever begin
...
endmodule // ctech_lib_doublesync_setb
