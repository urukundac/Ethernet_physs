...
//
// File Name:     $RCSfile: AW_fpga_idi_mon_csr.sv.rca $
...
module  IW_fpga_idi_mon_addr_map_avmm_wrapper#(
    parameter MON_TYPE            = "idi"              //Type of monitor
  ...
  //import idi_jem_pkg::*;
  import IW_fpga_idi_mon_av_addr_map_pkg::*;
  //import rtlgen_pkg_v12::*;
  import rtlgen_pkg_IW_fpga_idi_mon_av_addr_map::*;
...
new_type_reg_cr_t  new_type_reg_cr;
...
type_reg_cr_t  type_reg_cr;
IW_fpga_idi_mon_av_addr_map_cr_req_t  req;
IW_fpga_idi_mon_av_addr_map_cr_ack_t  ack;
...
IW_fpga_idi_mon_av_addr_map u_csr (
.gated_clk                                         (clk_logic),
.rst_n                                             (rst_logic_n),
...
.new_type_reg_cr                                   (new_type_reg_cr),
...
.ack                                               (ack)
  ...
  begin
    for (n=0;n<4;n++)
    begin
      new_type_reg_cr.inst_name[(n*8) +:  8] =  type_str[3-n];
    end
