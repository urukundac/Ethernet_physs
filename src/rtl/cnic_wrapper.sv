module cnic_wrapper #( parameter int NUM_PORTS = 8
)
(	input clk_tcam_fast,
	input xtalclk,
	input infra_clk,
...
//        output tx_serial_data,
     input    [NUM_PORTS-1:0]  clk_125mhz,
    input                     i_reset,         // active-low global reset
    input                     reference_clk,     // not used here, keep if needed

    // 16 serial lanes
    input   [NUM_PORTS-1:0]   rx_serial_data,
    output  [NUM_PORTS-1:0]   tx_serial_data,

    // per-port loopback controls
    //input   [NUM_PORTS-1:0]   i_cfg_pcs_loopback,
    //input   [NUM_PORTS-1:0]   i_cfg_serdes_loopback,
	inout  tri   [NUM_PORTS-1:0]   I2C_SCL,
    inout  tri   [NUM_PORTS-1:0]   I2C_SDA,
    output  [NUM_PORTS-1:0]   I2C_MODSELL,
    input   [NUM_PORTS-1:0]   I2C_MODPRSL,
    input   [NUM_PORTS-1:0]   I2C_INTL,
    output  [NUM_PORTS-1:0]   I2C_RESETL,
    output  [NUM_PORTS-1:0]   I2C_LPMODE,
	  input [NUM_PORTS-1:0]   i2c_apb_clk,
       //  input i2c_apb_clk,
...
.nss_cosq_clk     (nss_cosq_clk), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.nss_cosq_fnic_clk (nss_cosq_fnic_clk), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.nlf_scpd_clk     (nlf_scpd_clk), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.imc_core_clk     (imc_core_clk), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.mt_clk           (mt_clk), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.nss_core_clk     (nss_core_clk), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.nss_fxp_clk      (nss_fxp_clk), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.nss_hif_clk      (nss_hif_clk), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.nss_lan_clk      (nss_lan_clk), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.physs_intf0_clk  (physs_intf0_clk), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.soc_nlf_clk      (soc_nlf_clk), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.soc_per_clk      (soc_per_clk), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.soc_tsgen_clk    (soc_tsgen_clk), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.ecm_clk          (ecm_clk), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.pgcb_clk         (pgcb_clk), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.aclk_s           (aclk_s), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.ports_clk       (ports_clk), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.switch_clk      (switch_clk), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.rclk_diff_p     (rclk_diff_p), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.rclk_diff_n     (rclk_diff_n), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.physs_funcx2_clk (physs_funcx2_clk), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.tsu_clk         (tsu_clk), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.nss_cosq_clk0   (nss_cosq_clk0), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.nss_cosq_clk1   (nss_cosq_clk1), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.clk_1588_freq   (clk_1588_freq), //900MHz 10MHz imc_core_clk, nss_fxp_clk, nss_lan_clk(750MHz), sn2sfi(1000MHz)
.gclk1_div4       (div_2_clk), //450MHz 5MHz  imc_sys_clk ,imc_dfd_clk, nac_dap_clk, nss_psm_clk(529.41)
.imc_sys_clk      (imc_sys_clk), //450MHz 5MHz  imc_sys_clk ,imc_dfd_clk, nac_dap_clk, nss_psm_clk(529.41)
.mt_dist_clk      (mt_dist_clk), //450MHz 5MHz  imc_sys_clk ,imc_dfd_clk, nac_dap_clk, nss_psm_clk(529.41)
.nss_psm_clk      (nss_psm_clk), //450MHz 5MHz  imc_sys_clk ,imc_dfd_clk, nac_dap_clk, nss_psm_clk(529.41)
.nss_sep_clk      (nss_sep_clk), //450MHz 5MHz  imc_sys_clk ,imc_dfd_clk, nac_dap_clk, nss_psm_clk(529.41)
.ssn_clk          (ssn_clk), //450MHz 5MHz  imc_sys_clk ,imc_dfd_clk, nac_dap_clk, nss_psm_clk(529.41)
.utmi_clk         (utmi_clk), //450MHz 5MHz  imc_sys_clk ,imc_dfd_clk, nac_dap_clk, nss_psm_clk(529.41)
...
force nac_ss.nss.nss_cosq_clk = nss_cosq_clk;
force nac_ss.nss.nss_cosq_fnic_clk = nss_cosq_fnic_clk;
force nac_ss.nss.nlf_scpd_clk = nlf_scpd_clk;

// =======================================

force nac_ss.nss.imc_core_clk = imc_core_clk; 
force nac_ss.nss.imc_sys_clk = imc_sys_clk; //this is spi_clk. SPI soft modules need to be more than 2x spi DUT Clock. Connecting 
force nac_ss.nss.mt_clk = mt_clk; //apeksha check mt_clk_800
force nac_ss.nss.mt_dist_clk = mt_dist_clk;
force nac_ss.nss.ncsi_clk = div_4_clk;
force nac_ss.nss.nss_core_clk = nss_core_clk;
force nac_ss.nss.nss_fxp_clk = nss_fxp_clk;
force nac_ss.nss.nss_hif_clk = nss_hif_clk;
// apeksha force nac_ss.nss.nss_hlp_clk = core_clk;
force nac_ss.nss.nss_lan_clk = nss_lan_clk;
force nac_ss.nss.nss_psm_clk = nss_psm_clk;
force nac_ss.nss.nss_sep_clk = nss_sep_clk;
// apeksha force nac_ss.nss.physs_func_clk = core_clk;
force nac_ss.nss.physs_intf0_clk = physs_intf0_clk;
force nac_ss.nss.s3m_cnt_clk = div_8_clk;
force nac_ss.nss.soc_nlf_clk = soc_nlf_clk;
force nac_ss.nss.soc_per_clk = soc_per_clk;
force nac_ss.nss.soc_tsgen_clk = soc_tsgen_clk;
//force nac_ss.nss.ssn_clk = ssn_clk; //Not there in R18
force nac_ss.nss.utmi_clk = utmi_clk;
//DFX clock
...
force nac_ss.nss.ecm_clk = ecm_clk;
...
force nac_ss.hlp.pgcb_clk = pgcb_clk; //apeksha check
force nac_ss.hlp.aclk_s = aclk_s;//xtalclk ;
//force nac_ss.hlp.dtf_clk = core_clk;//xtalclk ;
force nac_ss.hlp.ports_clk = ports_clk;//xtalclk ;
force nac_ss.hlp.switch_clk = switch_clk;//xtalclk ;
...
//physs clks from par_nac_miscclk
// removed in r15 force nac_ss.physs.physs_func_clk = core_clk;//CLK_EREF0_P;
force nac_ss.physs.rclk_diff_p = rclk_diff_p;//xtalclk ; 
force nac_ss.physs.rclk_diff_n = rclk_diff_n;//xtalclk ;
force nac_ss.physs.soc_per_clk = soc_per_clk;//CLK_EREF0_P  ;
force nac_ss.physs.physs_intf0_clk = physs_intf0_clk;//CLK_EREF0_P  ;
force nac_ss.physs.physs_funcx2_clk = physs_funcx2_clk;//CLK_EREF0_P  ; 
//removed in r15 force nac_ss.physs.physs_func_clk = core_clk;//CLK_EREF0_P  ;
//removed in r15 fforce nac_ss.physs.timeref_clk = core_clk;//CLK_EREF0_P   ;
//newly added in r15
force nac_ss.physs.tsu_clk = tsu_clk ;
force nac_ss.physs.nss_cosq_clk0 = nss_cosq_clk0;
force nac_ss.physs.nss_cosq_clk1 = nss_cosq_clk1;
force nac_ss.physs.clk_1588_freq = clk_1588_freq;//1588_freq_out generated from NSS.MTS module from CPK. Muxed with recovered serdes clks to output on synce_rxclk[1:0]
...
//Physs I2C registers interface
    ...
    wire  [NUM_PORTS-1:0] xcvr_tx_serial_clk0;
    wire  [NUM_PORTS-1:0] fpll_locked_SGMII;
    wire  [NUM_PORTS-1:0] pcs_ref_clk_125mhz_lock;
    wire  [NUM_PORTS-1:0] pcs_ref_clk_125mhz;
    wire  [NUM_PORTS-1:0] onpi_3_125mhz_clk;   // if you use it per-port
    wire  [NUM_PORTS-1:0] sync_i_reset; 
    wire  [NUM_PORTS-1:0]        rx_clk_out;
    wire  [NUM_PORTS-1:0][9:0]   tbi_rx_phy;
    wire  [NUM_PORTS-1:0][9:0]   tbi_tx_phy;
    wire  [NUM_PORTS-1:0][31:0]   usr_cntrl_0;
    wire  [NUM_PORTS-1:0][3:0]	pcs_loopback_en;
    wire  [NUM_PORTS-1:0][3:0]    serdes_loopback_en;
	
    wire [NUM_PORTS-1:0]   rx_serial_data;
    wire [NUM_PORTS-1:0]   tx_serial_data;
    wire [NUM_PORTS-1:0] i_cfg_pcs_loopback;

	   //I2C Interface Signals
    wire  [NUM_PORTS-1:0]           i2c_psel            ;   //  APB Peripheral Select Signal
    wire  [NUM_PORTS-1:0]           i2c_penable         ;   //  Strobe Signal
    wire  [NUM_PORTS-1:0]           i2c_pwrite          ;   //  Write Signal
    wire  [NUM_PORTS-1:0]   [2:0]   i2c_pprot           ;   //  Protection Signal
    wire  [NUM_PORTS-1:0]   [3:0]   i2c_pstrb           ;   //  Write Strobes
    wire  [NUM_PORTS-1:0]   [7:0]   i2c_paddr           ;   //  Address Bus
    wire  [NUM_PORTS-1:0]   [31:0]  i2c_pwdata          ;   //  Write Data Bus 
    wire  [NUM_PORTS-1:0]   [31:0]  i2c_prdata          ;   //  APB read data bus.
    wire  [NUM_PORTS-1:0]           i2c_pready          ;   //  Slave ready
    wire  [NUM_PORTS-1:0]           i2c_pslverr         ;   //  Slave error
    wire  [NUM_PORTS-1:0]           i2c_clk_in          ;   //  Incoming I2C clock
    wire  [NUM_PORTS-1:0]           i2c_data_in         ;   //  Incoming I2C Data
    wire  [NUM_PORTS-1:0]           i2c_clk_oe_n        ;   //# Outgoing I2C clock: Open drain synchronous with i2c_clk
    wire  [NUM_PORTS-1:0]           i2c_data_oe_n       ;   //# Outgoing I2C Data: Open Drain. Synchronous to i2c_clk
    wire  [NUM_PORTS-1:0]           i2c_clk_oe          ;
    wire  [NUM_PORTS-1:0]           i2c_data_oe         ;
wire  [NUM_PORTS-1:0]           apb_psel      ;      
wire  [NUM_PORTS-1:0]           apb_penable   ;
wire  [NUM_PORTS-1:0]           apb_pwrite    ;
wire  [NUM_PORTS-1:0]           apb_paddr     ; 
wire  [NUM_PORTS-1:0]           apb_pwdata    ; 
wire  [NUM_PORTS-1:0]           apb_prdata    ; 
wire  [NUM_PORTS-1:0]           apb_pready    ;
wire  [NUM_PORTS-1:0]           apb_pslverr   ;
...
//assign cnic_wrapper.nac_ss.physs.physs0.parmquad0.pcs100_wrap_0.quadpcs100_0.sg0_sgpcs_ena = 1'b1;
//assign cnic_wrapper.nac_ss.physs.physs0.parmquad1.pcs100_wrap_1.quadpcs100_1.sg0_sgpcs_ena = 1'b1;
//assign cnic_wrapper.nac_ss.physs.physs1.parpquad0.pcs100_wrap_2.quadpcs100_0.sg0_sgpcs_ena = 1'b1;
//assign cnic_wrapper.nac_ss.physs.physs1.parpquad0.pcs100_wrap_3.quadpcs100_0.sg0_sgpcs_ena = 1'b1;
//
//assign cnic_wrapper.nac_ss.physs.physs0.parmquad0.pcs100_wrap_0.quadpcs100_0.sg0_speed[1:0] = 2'b10;
//assign cnic_wrapper.nac_ss.physs.physs0.parmquad1.pcs100_wrap_1.quadpcs100_1.sg0_speed[1:0] = 2'b10;
//assign cnic_wrapper.nac_ss.physs.physs1.parpquad0.pcs100_wrap_2.quadpcs100_0.sg0_speed[1:0] = 2'b10;
//assign cnic_wrapper.nac_ss.physs.physs1.parpquad0.pcs100_wrap_3.quadpcs100_0.sg0_speed[1:0] = 2'b10;
...
//wire i_cfg_pcs_loopback;
	...
	// -------------------------
    // 16× PLL + 16× reset sync + 16× PHY
    // -------------------------
	generate
      for (k=0; k<NUM_PORTS; k++) begin : GEN_PORT

        // 1) Per-port FPLL (TX serial clock)
        s10_fpll_ref125Mhz_625Mhz u_s10_fpll_ref125Mhz_625Mhz (
            .pll_refclk0    (clk_125mhz[k]),
            .pll_cal_busy   (),
            .pll_locked     (fpll_locked_SGMII[k]),
            .tx_serial_clk  (xcvr_tx_serial_clk0[k])
        );
        ...
        io_pll_125mhz_eth_clks io_pll_125mhz_eth_clks (
            .rst      (1'b0), //TBD 
            .refclk   (clk_125mhz[k]),
            .locked   (pcs_ref_clk_125mhz_lock[k]),
            .outclk_0 (pcs_ref_clk_125mhz[k]),
            .outclk_1 (onpi_3_125mhz_clk[k])
        );

        // 3) Per-port reset sync (sync deassert to each PCS clock)
        IW_sync_reset  IW_sync_reset (
            .clk    (pcs_ref_clk_125mhz[k]),
            .rst_n (i_reset),
            .rst_n_sync (sync_i_reset[k])
        );
  assign usr_cntrl_0[k] [3:0]     = i_cfg_pcs_loopback[k] ? 4'b0010 : 4'b0000;

        // 4) Per-port Ethernet PHY
        ethernet_altera_phy u0_ethernet_altera_phy (
            .pcs_ref_clk_125mhz         (pcs_ref_clk_125mhz[k]),
            .xcvr_125mhz_refclk         (clk_125mhz[k]),
            .xcvr_reset                 (sync_i_reset[k]),          // per-port synced reset
            .xcvr_tx_serial_clk0        (xcvr_tx_serial_clk0[k]),
            .fpll_locked_SGMII          (fpll_locked_SGMII[k]),

            .xcvr_rx_clk                (rx_clk_out[k]),
            .xcvr_tbi_rx_gmii           (tbi_rx_phy[k]),
            .xcvr_tbi_tx_gmii           (tbi_tx_phy[k]),

            .usr_cntrl_0                (usr_cntrl_0[k][3:0]),
            .fpga_pcs_loopback_ena      (pcs_loopback_en[k][0]),
            .fpga_serdes_loopback_ena   (serdes_loopback_en[k][0]),

            .xcvr_rx_serial_data        (rx_serial_data[k]),
            .xcvr_tx_serial_data        (tx_serial_data[k])
        );
...
tristate_buf tristate_inst_scl1(.in (1'b0),.oe (i2c_clk_oe[k]),.out(i2c_clk_in[k]),.pad(I2C_SCL[k]));
tristate_buf tristate_inst_scl2(.in (1'b0),.oe (i2c_data_oe[k]),.out(i2c_data_in[k]),.pad(I2C_SDA[k]));
...
RED_VAPB #(
      ...
      .DUT_CLK_PROVIDED    ( 1            )
       ...
       // APB interface
      .u_apb_pclk          (  i2c_apb_clk[k]  ), 
      .u_apb_presetn       (   sys_rst_n ), 
      .u_apb_psel          (  i2c_psel[k]     ), 
      .u_apb_penable       (  i2c_penable[k]  ), 
      .u_apb_pwrite        (  i2c_pwrite[k]   ), 
      .u_apb_paddr         (  i2c_paddr [k]   ), 
      .u_apb_pwdata        (  i2c_pwdata [k]  ), 
      .u_apb_prdata        (  i2c_prdata[k]   ), 
      .u_apb_pready        (  i2c_pready [k]  ), 
      .u_apb_pslverr       (  i2c_pslverr [k] ), 
                                               
      .dut_apb_pclk        ( i2c_apb_clk[k] ),
      .dut_apb_presetn     ( sys_rst_n )
  );

   Imc_DW_apb_i2c
        A00_i2c (
        .pclk               (   i2c_apb_clk [k]            ),  //  APB Clock Signal
        .presetn            (   sys_rst_n  ),  //  APB Reset Signal (active low)
        .psel               (   i2c_psel  [k]          ),  //  APB Peripheral Select Signal
        .penable            (   i2c_penable [k]        ),  //  Strobe Signal
        .pprot              (   i2c_pprot  [k]         ),  //  Protection Signal
        //.pstrb              (   i2c_pstrb [k]          ),  //  Write Strobes
        .pstrb              (   4'b1111           ),  //  Write Strobes
        .pwrite             (   i2c_pwrite [k]         ),  //  Write Signal
        .paddr              (   i2c_paddr [k]        ),  //  Address Bus
        .pwdata             (   i2c_pwdata [k]       ),  //  Write Data Bus
        .prdata             (   i2c_prdata [k]       ),  //  APB read data bus.
        .pready             (   i2c_pready [k]       ),  //  Slave ready
        .pslverr            (   i2c_pslverr [k]        ),  //  Slave error
        .ic_rst_n           (   sys_rst_n  ),
        .ic_clk             (   i2c_apb_clk [k]          ),  //  I2C clock 50Kz
        .ic_clk_in_a        (   i2c_clk_in   [k]       ),  //  Incoming I2C clock
        .ic_data_in_a       (   i2c_data_in  [k]       ),  //  Incoming I2C Data
        .ic_clk_oe          (   i2c_clk_oe [k]         ),
        .ic_data_oe         (   i2c_data_oe [k]        ),
...
RED_VAPB #(
      ...
      .u_apb_pclk          (  i2c_apb_clk [k]    ), 
      .u_apb_presetn       (  sys_rst_n  ), 
      .u_apb_psel          (  apb_psel [k]    ), 
      .u_apb_penable       (  apb_penable [k] ), 
      .u_apb_pwrite        (  apb_pwrite [k]  ), 
      .u_apb_paddr         (  apb_paddr [k]   ), 
      .u_apb_pwdata        (  apb_pwdata [k]  ), 
      .u_apb_prdata        (  apb_prdata [k]  ), 
      .u_apb_pready        (  apb_pready [k]  ), 
      .u_apb_pslverr       (  apb_pslverr [k] ), 
 ...
 (   
      // Connect to APB 1
      .apb_prdata           (apb_prdata[k]),    
      .apb_pready           (apb_pready[k]),    
      .apb_pslverr          (apb_pslverr[k]),   
      .apb_clk              (i2c_apb_clk[k]),     
      .apb_reset            (~sys_rst_n),   
      .apb_psel             (apb_psel[k]),     
      .apb_penable          (apb_penable[k]),   
      .apb_pwrite           (apb_pwrite[k]),    
      .apb_pwdata           (apb_pwdata[k]),    
      .apb_paddr            (apb_paddr[k]),     
