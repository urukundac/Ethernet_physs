...
// UFI_FABRIC   connection #0
			...
			`define 	UFI_AGENT_1 					fpga_transactors_top_inst       // example:  fpga_tcss_top.tcss_val_rtl.tcss.par_iom
...
// A2F Request connections
   assign   `TRANSACTORS_PATH.ufi_a2f_req_is_valid[1]          	= `UFI_AGENT_1.a2f_req_is_valid_1;    /*ufi_a2f_idi1_req_is_valid*/  
   assign   `TRANSACTORS_PATH.ufi_a2f_req_protocol_id[1]       	= `UFI_AGENT_1.a2f_req_protocol_id_1; /*ufi_a2f_idi1_req_protocol_id*/
   assign   `TRANSACTORS_PATH.ufi_a2f_req_header[1]            	= `UFI_AGENT_1.a2f_req_header_1;      /*ufi_a2f_idi1_req_header*/
...
// F2A Response connections 
   assign   `TRANSACTORS_PATH.ufi_f2a_rsp_rxcrd[1]             	= `UFI_AGENT_1.f2a_rsp_rxcrd_1;    /*ufi_f2a_idi1_rsp_rxcrd*/         
   assign   `TRANSACTORS_PATH.ufi_f2a_rsp_rxcrd_protocol_id[1] 	= `UFI_AGENT_1.f2a_rsp_rxcrd_protocol_id_1; /*ufi_f2a_idi1_rsp_rxcrd_protocol_id*/
...
// A2F Request connections
   assign   `UFI_AGENT_1.a2f_req_rxcrd_1 /*ufi_a2f_idi1_req_rxcrd*/	  = `TRANSACTORS_PATH.ufi_a2f_req_rxcrd[1]; 
...
// F2A Response connections 
   assign   `UFI_AGENT_1.f2a_rsp_is_valid_1 /*ufi_f2a_idi1_rsp_is_valid*/      				= `TRANSACTORS_PATH.ufi_f2a_rsp_is_valid[1];
   assign   `UFI_AGENT_1.f2a_rsp_protocol_id_1 /*ufi_f2a_idi1_rsp_protocol_id_1*/    	= `TRANSACTORS_PATH.ufi_f2a_rsp_protocol_id[1];
   assign   `UFI_AGENT_1.f2a_rsp_header_1 /*ufi_f2a_f2a_idi1_rsp_header*/         = `TRANSACTORS_PATH.ufi_f2a_rsp_header[1]; 
