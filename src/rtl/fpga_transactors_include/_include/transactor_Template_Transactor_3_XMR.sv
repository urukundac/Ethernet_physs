...
// Template Transactor   connection #3
							...
							`define 	TEMPLATE_TRANSACOR_3 					fpga_transactors_top_inst   // example:  fpga_tcss_top.tcss_val_rtl.tcss.par_iom    //HERE USER SHOULD SET THE PATH TO HIS SIDE OF THE TEAMPLATE TRANSACTOR
