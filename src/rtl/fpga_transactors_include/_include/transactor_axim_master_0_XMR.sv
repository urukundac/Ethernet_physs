...
// AXIM  Write port 
   ...
   assign   `AXIM_SLAVE_0.m_wdata_0      =   `TRANSACTORS_PATH.m_wdata[511:0];	
   assign   `AXIM_SLAVE_0.m_wstrb_0      =   `TRANSACTORS_PATH.m_wstrb[63:0];	
...
// AXIM Read port    
   ...
   assign   `TRANSACTORS_PATH.m_rdata[511:0]      =   `AXIM_SLAVE_0.m_rdata_0; 		    
