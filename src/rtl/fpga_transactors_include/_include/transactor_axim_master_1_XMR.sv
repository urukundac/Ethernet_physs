...
// AXIM  Write port 
   ...
   assign   `AXIM_MASTER_1.m_wdata_1      =   `TRANSACTORS_PATH.m_wdata[1023:512];	
   assign   `AXIM_MASTER_1.m_wstrb_1      =   `TRANSACTORS_PATH.m_wstrb[127:64];	
...
// AXIM Read port    
   ...
   assign   `TRANSACTORS_PATH.m_rdata[1023:512]      =   `AXIM_MASTER_1.m_rdata_1; 		    
