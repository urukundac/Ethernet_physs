...
// AXIM Addreaa Write port 
   ...
   assign   `TRANSACTORS_PATH.s_wdata[1023:512] = `AXIM_SLAVE_1.s_wdata_1; 
   assign   `TRANSACTORS_PATH.s_wstrb[127:64]	  = `AXIM_SLAVE_1.s_wstrb_1;
...
// AXIM Read port    
   ...
   assign   `AXIM_SLAVE_1.s_rdata_1 		     	= `TRANSACTORS_PATH.s_rdata[1023:512];
