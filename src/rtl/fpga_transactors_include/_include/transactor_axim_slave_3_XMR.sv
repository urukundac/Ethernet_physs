...
// UFI_FABRIC   connection #0
	  ...
	  `define 	AXIM_SLAVE_3 					fpga_transactors_top_inst       // example:  fpga_tcss_top.tcss_val_rtl.tcss.par_iom
...
// AXIM Addreaa Write port 
   ...
   assign   `TRANSACTORS_PATH.s_wdata[2047:1536] = `AXIM_SLAVE_3.s_wdata_3; 
   assign   `TRANSACTORS_PATH.s_wstrb[255:192]	  = `AXIM_SLAVE_3.s_wstrb_3;
...
// AXIM Read port    
   ...
   assign   `AXIM_SLAVE_3.s_rdata_3 		     	= `TRANSACTORS_PATH.s_rdata[2047:1536];
