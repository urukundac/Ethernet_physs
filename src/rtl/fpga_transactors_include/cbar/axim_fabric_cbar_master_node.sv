...
/*
 ...
 -- Module Name       : axim_fabric_cbar_master_node
...
module axim_fabric_cbar_master_node #(
...
//----------------------- Start of Code -----------------------------------
  ...
  /*  AW Node */
  axim_fabric_cbar_master_aw_egr_node #(
    ...
    ,.aw2w_node_valid (aw2w_node_valid )
    ,.aw2w_node_ready (aw2w_node_ready )
    ,.aw2w_node_data  (aw2w_node_data  )

  );

  /*  W Node  */
  axim_fabric_cbar_master_w_egr_node #(
  ...
  /*  AR Node */
  axim_fabric_cbar_master_ar_egr_node #(
  ...
  /*  B Node  */
  axim_fabric_cbar_master_b_ingr_node #(
  ...
  /*  R Node  */
  axim_fabric_cbar_master_r_ingr_node #(
...
endmodule // axim_fabric_cbar_master_node
