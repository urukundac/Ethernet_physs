...
// Additional COMM Block   connection #4
			...
			`define 	ADDITIONAL_COMM_BLOCK_4 					`FPGA_TRANSACTORS_TOP   // example:  fpga_tcss_top.tcss_val_rtl.tcss.par_iom    //HERE USER SHOULD SET THE PATH TO HIS SIDE OF THE ADDITIONAL COMM BLOCK FIFO INTERFACE
