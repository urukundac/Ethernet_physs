...
// CFI_AGENT    connection #1
	 ...
	 // `define 	TRANSACTORS_PATH 					`FPGA_TRANSACTORS_TOP       // example:  fpga_tcss_top.tcss_val_rtl.tcss.par_iom
...
// RX Data connections 
   ...
   assign   rx_data_header_parity_0    = tx_data_header_parity_1; 
...
// TX Data connections 
   ...
   assign   rx_data_header_parity_1      = tx_data_header_parity_0;
