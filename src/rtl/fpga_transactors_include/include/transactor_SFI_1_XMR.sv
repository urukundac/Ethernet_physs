...
// SFI   connection #0
							...
							`define 	SFI_1 					`FPGA_TRANSACTORS_TOP   // example:  fpga_tcss_top.tcss_val_rtl.tcss.par_iom    //HERE USER SHOULD SET THE PATH TO HIS SIDE OF THE SFI INTEFACE
...
assign                  	`TRANSACTORS_PATH.sfi_rx_data[1][SFI_D_SRC_1*8-1:0]     			= `SFI_1.sfi_rx_data_1;
assign                  	`TRANSACTORS_PATH.sfi_rx_data_parity[1][SFI_D_SRC_1/8-1:0]   		= `SFI_1.sfi_rx_data_parity_1;
...
assign                  	`TRANSACTORS_PATH.sfi_rx_data_end[1][SFI_D_SRC_1/4-1:0]     		= `SFI_1.sfi_rx_data_end_1;
assign                  	`TRANSACTORS_PATH.sfi_rx_data_poison[1][SFI_D_SRC_1/4-1:0]     	= `SFI_1.sfi_rx_data_poison_1;
assign                  	`TRANSACTORS_PATH.sfi_rx_data_edb[1][SFI_D_SRC_1/4-1:0]     		= `SFI_1.sfi_rx_data_edb_1;
...
assign  				 	`SFI_1.sfi_tx_data_1											=	`TRANSACTORS_PATH.sfi_tx_data[1][SFI_D_SRC_1*8-1:0]     				;
assign  				 	`SFI_1.sfi_tx_data_parity_1										=	`TRANSACTORS_PATH.sfi_tx_data_parity[1][SFI_D_SRC_1/8-1:0]   		 	 	;
...
assign  				 	`SFI_1.sfi_tx_data_end_1										=	`TRANSACTORS_PATH.sfi_tx_data_end[1][SFI_D_SRC_1/4-1:0]     	;
assign  				 	`SFI_1.sfi_tx_data_poison_1										=	`TRANSACTORS_PATH.sfi_tx_data_poison[1][SFI_D_SRC_1/4-1:0]     	;
assign  				 	`SFI_1.sfi_tx_data_edb_1										=	`TRANSACTORS_PATH.sfi_tx_data_edb[1][SFI_D_SRC_1/4-1:0]     	;
