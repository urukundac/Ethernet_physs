...
// AXI MEMORY MASTER   connection #0
	  ...
	  `define 	AXIM_MASTER_2 				`FPGA_TRANSACTORS_TOP          // example:  fpga_tcss_top.tcss_val_rtl.tcss.par_iom
...
// AXIM  Write port 
   ...
   assign   `AXIM_MASTER_2.m_wdata_2      =   `TRANSACTORS_PATH.m_wdata[3071:2048];	
   assign   `AXIM_MASTER_2.m_wstrb_2      =   `TRANSACTORS_PATH.m_wstrb[383:256];	
...
// AXIM Read port    
   ...
   assign   `TRANSACTORS_PATH.m_rdata[3071:2048]      =   `AXIM_MASTER_2.m_rdata_2; 		    
