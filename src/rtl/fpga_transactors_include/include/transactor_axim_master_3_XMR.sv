...
// AXIM  Write port 
   ...
   assign   `AXIM_MASTER_3.m_wdata_3      =   `TRANSACTORS_PATH.m_wdata[4095:3072];	
   assign   `AXIM_MASTER_3.m_wstrb_3      =   `TRANSACTORS_PATH.m_wstrb[511:384];	
...
// AXIM Read port    
   ...
   assign   `TRANSACTORS_PATH.m_rdata[4095:3072]      =   `AXIM_MASTER_3.m_rdata_3; 		    
