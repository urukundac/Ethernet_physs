...
// AXIM Addreaa Write port 
   ...
   assign   `TRANSACTORS_PATH.s_wdata[1023:0] = `AXIM_SLAVE_0.s_wdata_0; 
   assign   `TRANSACTORS_PATH.s_wstrb[127:0]	  = `AXIM_SLAVE_0.s_wstrb_0;
...
// AXIM Read port    
   ...
   assign   `AXIM_SLAVE_0.s_rdata_0 		     	= `TRANSACTORS_PATH.s_rdata[1023:0];
