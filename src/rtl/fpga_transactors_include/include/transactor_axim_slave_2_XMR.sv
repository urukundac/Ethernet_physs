...
// UFI_FABRIC   connection #0
	  ...
	  `define 	AXIM_SLAVE_2 					`FPGA_TRANSACTORS_TOP       // example:  fpga_tcss_top.tcss_val_rtl.tcss.par_iom
...
// AXIM Addreaa Write port 
   ...
   assign   `TRANSACTORS_PATH.s_wdata[3071:2048] = `AXIM_SLAVE_2.s_wdata_2; 
   assign   `TRANSACTORS_PATH.s_wstrb[383:256]	  = `AXIM_SLAVE_2.s_wstrb_2;
...
// AXIM Read port    
   ...
   assign   `AXIM_SLAVE_2.s_rdata_2 		     	= `TRANSACTORS_PATH.s_rdata[3071:2048];
