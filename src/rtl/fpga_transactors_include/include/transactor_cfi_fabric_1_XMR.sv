...
// CFI_FABRIC   connection #0
			...
			`define 	CFI_AGENT_1 					`FPGA_TRANSACTORS_TOP       // example:  fpga_tcss_top.tcss_val_rtl.tcss.par_iom
...
// RX Data connections 
   ...
   assign   `TRANSACTORS_PATH.rx_data_header_parity[1]    = `CFI_AGENT_1.rx_data_header_parity_1; 
...
// TX Data connections 
   ...
   assign   `CFI_AGENT_1.tx_data_header_parity_1          = `TRANSACTORS_PATH.tx_data_header_parity[1];   
