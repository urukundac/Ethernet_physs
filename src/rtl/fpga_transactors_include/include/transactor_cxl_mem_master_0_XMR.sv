...
// CXL_MEM_MASTER   connection #0
			...
			`define 	CXL_MEM_SLAVE_0 					`FPGA_TRANSACTORS_TOP   // example:  fpga_tcss_top.tcss_val_rtl.tcss.par_iom   //HERE USER SHOULD SET THE PATH TO HIS SIDE OF THE CXL.MEM INTEFACE, THE SLAVE SIDE
