...
// A2F Request connections
   ...
   assign   `TRANSACTORS_PATH.ufi_2_a2f_req_shared_credit[0]      = `UFI_2_AGENT_0.a2f_2_req_shared_credit_0;   
...
// A2F Response connections
   ...
   assign   `TRANSACTORS_PATH.ufi_2_a2f_rsp_shared_credit[0]      = `UFI_2_AGENT_0.a2f_2_rsp_shared_credit_0;    
...
// A2F Data connections 
   ...
   assign   `TRANSACTORS_PATH.ufi_2_a2f_data_shared_credit[0]   = `UFI_2_AGENT_0.a2f_2_data_shared_credit_0; 
...
// F2A Request connections 
   ...
   assign   `TRANSACTORS_PATH.ufi_2_f2a_req_rxcrd_shared[0]       = `UFI_2_AGENT_0.f2a_2_req_rxcrd_shared_0;  
...
// F2A Response connections 
   ...
   assign   `TRANSACTORS_PATH.ufi_2_f2a_rsp_rxcrd_shared[0]       = `UFI_2_AGENT_0.f2a_2_rsp_rxcrd_shared_0;
...
// F2A Data connections 
   ...
   assign   `TRANSACTORS_PATH.ufi_2_f2a_data_rxcrd_shared[0]      = `UFI_2_AGENT_0.f2a_2_data_rxcrd_shared_0;
...
// A2F Request connections
   ...
   assign   `UFI_2_AGENT_0.a2f_2_req_rxcrd_shared_0             = `TRANSACTORS_PATH.ufi_2_a2f_req_rxcrd_shared[0];
...
// A2F Response connections
   ...
   assign   `UFI_2_AGENT_0.a2f_2_rsp_rxcrd_shared_0             = `TRANSACTORS_PATH.ufi_2_a2f_rsp_rxcrd_shared[0];
...
// A2F Data connections 
   ...
   assign   `UFI_2_AGENT_0.a2f_2_data_rxcrd_shared_0            = `TRANSACTORS_PATH.ufi_2_a2f_data_rxcrd_shared[0];
...
// F2A Request connections 
   ...
   assign   `UFI_2_AGENT_0.f2a_2_req_shared_credit_0          = `TRANSACTORS_PATH.ufi_2_f2a_req_shared_credit[0];  
...
// F2A Response connections 
   ...
   assign   `UFI_2_AGENT_0.f2a_2_rsp_shared_credit_0          = `TRANSACTORS_PATH.ufi_2_f2a_rsp_shared_credit[0];
...
// F2A Data connections 
   ...
   assign   `UFI_2_AGENT_0.f2a_2_data_shared_credit_0       = `TRANSACTORS_PATH.ufi_2_f2a_data_shared_credit[0]; 
