...
logic [7:0] physs_0_WSTRB; //Write strobe
...
logic [7:0] physs_1_WSTRB; //Write strobe
...
logic [39:0] physs_mse_port_1_rx_ts; //Receive Timestamp Value. Time when the MAC detected the SFD of the frame and latched the mac00N_frc_in_rx value. Only meaningful when sop is valid. On ingress contains the 1588 ingress timestamp: Bits [39:8] - 32b timestamp in nano seconds. Bits [7:1] - 7b timestamp in sub-nano seconds. Bit 0 - 1b of valid for TIMESTAMP
...
logic [39:0] physs_mse_port_2_rx_ts; //Receive Timestamp Value. Time when the MAC detected the SFD of the frame and latched the mac00N_frc_in_rx value. Only meaningful when sop is valid. On ingress contains the 1588 ingress timestamp: Bits [39:8] - 32b timestamp in nano seconds. Bits [7:1] - 7b timestamp in sub-nano seconds. Bit 0 - 1b of valid for TIMESTAMP
...
logic [39:0] physs_mse_port_4_rx_ts; //Receive Timestamp Value. Time when the MAC detected the SFD of the frame and latched the mac00N_frc_in_rx value. Only meaningful when sop is valid. On ingress contains the 1588 ingress timestamp: Bits [39:8] - 32b timestamp in nano seconds. Bits [7:1] - 7b timestamp in sub-nano seconds. Bit 0 - 1b of valid for TIMESTAMP
...
logic [39:0] physs_mse_port_5_rx_ts; //Receive Timestamp Value. Time when the MAC detected the SFD of the frame and latched the mac00N_frc_in_rx value. Only meaningful when sop is valid. On ingress contains the 1588 ingress timestamp: Bits [39:8] - 32b timestamp in nano seconds. Bits [7:1] - 7b timestamp in sub-nano seconds. Bit 0 - 1b of valid for TIMESTAMP
...
logic [39:0] physs_mse_port_6_rx_ts; //Receive Timestamp Value. Time when the MAC detected the SFD of the frame and latched the mac00N_frc_in_rx value. Only meaningful when sop is valid. On ingress contains the 1588 ingress timestamp: Bits [39:8] - 32b timestamp in nano seconds. Bits [7:1] - 7b timestamp in sub-nano seconds. Bit 0 - 1b of valid for TIMESTAMP
...
logic [39:0] physs_mse_port_7_rx_ts; //Receive Timestamp Value. Time when the MAC detected the SFD of the frame and latched the mac00N_frc_in_rx value. Only meaningful when sop is valid. On ingress contains the 1588 ingress timestamp: Bits [39:8] - 32b timestamp in nano seconds. Bits [7:1] - 7b timestamp in sub-nano seconds. Bit 0 - 1b of valid for TIMESTAMP
...
physs_bbl physs_bbl(
				.physs_reset_prep_req (loopback_req_ack),
				.physs_reset_prep_ack (loopback_req_ack),
				.physs_synce_rxclk (physs_synce_rxclk),
				.physs_o_ref_clk_out (physs_o_ref_clk_out),
				.eref0_pad_clk_p (eref0_pad_clk_p),
				.eref0_pad_clk_m (eref0_pad_clk_m),
				.syncE_pad_clk_p (syncE_pad_clk_p),
				.syncE_pad_clk_m (syncE_pad_clk_m),
				.physs_clkobs_out_clk (physs_clkobs_out_clk),
				...
				.physs_0_AWQOS (physs_0_AWQOS),
				.physs_0_AWUSER (physs_0_AWUSER),
				.physs_0_AWVALID (physs_0_AWVALID),
				.physs_0_AWREADY (physs_0_AWREADY),
				.physs_0_WDATA (physs_0_WDATA),
				.physs_0_WSTRB (physs_0_WSTRB),
				.physs_0_WLAST (physs_0_WLAST),
				.physs_0_WUSER (physs_0_WUSER),
				.physs_0_WVALID (physs_0_WVALID),
				.physs_0_WREADY (physs_0_WREADY),
				.physs_0_BID (physs_0_BID),
				.physs_0_BRESP (physs_0_BRESP),
				.physs_0_BVALID (physs_0_BVALID),
				...
				.physs_0_ARREADY (physs_0_ARREADY),
				.physs_0_RID (physs_0_RID),
				.physs_0_RDATA (physs_0_RDATA),
				.physs_0_RRESP (physs_0_RRESP),
				.physs_0_RLAST (physs_0_RLAST),
				.physs_0_RVALID (physs_0_RVALID),
				...
				.physs_1_AWQOS (physs_1_AWQOS),
				.physs_1_AWUSER (physs_1_AWUSER),
				.physs_1_AWVALID (physs_1_AWVALID),
				.physs_1_AWREADY (physs_1_AWREADY),
				.physs_1_WDATA (physs_1_WDATA),
				.physs_1_WSTRB (physs_1_WSTRB),
				.physs_1_WLAST (physs_1_WLAST),
				.physs_1_WUSER (physs_1_WUSER),
				.physs_1_WVALID (physs_1_WVALID),
				.physs_1_WREADY (physs_1_WREADY),
				.physs_1_BID (physs_1_BID),
				.physs_1_BRESP (physs_1_BRESP),
				.physs_1_BVALID (physs_1_BVALID),
				...
				.physs_1_ARREADY (physs_1_ARREADY),
				.physs_1_RID (physs_1_RID),
				.physs_1_RDATA (physs_1_RDATA),
				.physs_1_RRESP (physs_1_RRESP),
				.physs_1_RLAST (physs_1_RLAST),
				.physs_1_RVALID (physs_1_RVALID),
				.physs_1_RREADY (physs_1_RREADY),
				.physs_icq_port_0_link_stat (physs_icq_port_0_link_stat),
				.physs_mse_port_0_rx_dval (physs_mse_port_0_rx_dval),
				.physs_mse_port_0_rx_data (physs_mse_port_0_rx_data),
				.physs_mse_port_0_rx_sop (physs_mse_port_0_rx_sop),
				.physs_mse_port_0_rx_eop (physs_mse_port_0_rx_eop),
				.physs_mse_port_0_rx_mod (physs_mse_port_0_rx_mod),
				.physs_mse_port_0_rx_err (physs_mse_port_0_rx_err),
				.physs_mse_port_0_rx_ecc_err (physs_mse_port_0_rx_ecc_err),
				.mse_physs_port_0_rx_rdy (mse_physs_port_0_rx_rdy),
				.physs_mse_port_0_rx_ts (physs_mse_port_0_rx_ts),
				...
				.physs_mse_port_0_tx_rdy (physs_mse_port_0_tx_rdy),
				.physs_icq_port_1_link_stat (physs_icq_port_1_link_stat),
				.physs_mse_port_1_link_speed (physs_mse_port_1_link_speed),
				.physs_mse_port_1_rx_dval (physs_mse_port_1_rx_dval),
				.physs_mse_port_1_rx_data (physs_mse_port_1_rx_data),
				.physs_mse_port_1_rx_sop (physs_mse_port_1_rx_sop),
				.physs_mse_port_1_rx_eop (physs_mse_port_1_rx_eop),
				.physs_mse_port_1_rx_mod (physs_mse_port_1_rx_mod),
				.physs_mse_port_1_rx_err (physs_mse_port_1_rx_err),
				.physs_mse_port_1_rx_ecc_err (physs_mse_port_1_rx_ecc_err),
				.mse_physs_port_1_rx_rdy (mse_physs_port_1_rx_rdy),
				.physs_mse_port_1_rx_ts (physs_mse_port_1_rx_ts),
				...
				.physs_mse_port_1_tx_rdy (physs_mse_port_1_tx_rdy),
				.physs_icq_port_2_link_stat (physs_icq_port_2_link_stat),
				.physs_mse_port_2_link_speed (physs_mse_port_2_link_speed),
				.physs_mse_port_2_rx_dval (physs_mse_port_2_rx_dval),
				.physs_mse_port_2_rx_data (physs_mse_port_2_rx_data),
				.physs_mse_port_2_rx_sop (physs_mse_port_2_rx_sop),
				.physs_mse_port_2_rx_eop (physs_mse_port_2_rx_eop),
				.physs_mse_port_2_rx_mod (physs_mse_port_2_rx_mod),
				.physs_mse_port_2_rx_err (physs_mse_port_2_rx_err),
				.physs_mse_port_2_rx_ecc_err (physs_mse_port_2_rx_ecc_err),
				.mse_physs_port_2_rx_rdy (mse_physs_port_2_rx_rdy),
				.physs_mse_port_2_rx_ts (physs_mse_port_2_rx_ts),
				...
				.physs_mse_port_2_tx_rdy (physs_mse_port_2_tx_rdy),
				.physs_icq_port_3_link_stat (physs_icq_port_3_link_stat),
				.physs_mse_port_3_link_speed (physs_mse_port_3_link_speed),
				.physs_mse_port_3_rx_dval (physs_mse_port_3_rx_dval),
				.physs_mse_port_3_rx_data (physs_mse_port_3_rx_data),
				.physs_mse_port_3_rx_sop (physs_mse_port_3_rx_sop),
				.physs_mse_port_3_rx_eop (physs_mse_port_3_rx_eop),
				.physs_mse_port_3_rx_mod (physs_mse_port_3_rx_mod),
				.physs_mse_port_3_rx_err (physs_mse_port_3_rx_err),
				.physs_mse_port_3_rx_ecc_err (physs_mse_port_3_rx_ecc_err),
				.mse_physs_port_3_rx_rdy (mse_physs_port_3_rx_rdy),
				.physs_mse_port_3_rx_ts (physs_mse_port_3_rx_ts),
				...
				.mse_physs_port_3_tx_eop (mse_physs_port_1_tx_eop),
				.mse_physs_port_3_tx_mod (mse_physs_port_1_tx_mod),
				.mse_physs_port_3_tx_err (mse_physs_port_1_tx_err),
				.mse_physs_port_3_tx_crc (mse_physs_port_2_tx_crc),
				.physs_mse_port_3_tx_rdy (physs_mse_port_2_tx_rdy),
				.physs_icq_port_4_link_stat (physs_icq_port_4_link_stat),
				.physs_mse_port_4_link_speed (physs_mse_port_4_link_speed),
				.physs_mse_port_4_rx_dval (physs_mse_port_4_rx_dval),
				.physs_mse_port_4_rx_data (physs_mse_port_4_rx_data),
				.physs_mse_port_4_rx_sop (physs_mse_port_4_rx_sop),
				.physs_mse_port_4_rx_eop (physs_mse_port_4_rx_eop),
				.physs_mse_port_4_rx_mod (physs_mse_port_4_rx_mod),
				.physs_mse_port_4_rx_err (physs_mse_port_4_rx_err),
				.physs_mse_port_4_rx_ecc_err (physs_mse_port_4_rx_ecc_err),
				.mse_physs_port_4_rx_rdy (mse_physs_port_4_rx_rdy),
				.physs_mse_port_4_rx_ts (physs_mse_port_4_rx_ts),
				...
				.mse_physs_port_4_tx_eop (mse_physs_port_1_tx_eop),
				.mse_physs_port_4_tx_mod (mse_physs_port_1_tx_mod),
				.mse_physs_port_4_tx_err (mse_physs_port_1_tx_err),
				.mse_physs_port_4_tx_crc (mse_physs_port_2_tx_crc),
				.physs_mse_port_4_tx_rdy (physs_mse_port_2_tx_rdy),
				.physs_icq_port_5_link_stat (physs_icq_port_5_link_stat),
				.physs_mse_port_5_link_speed (physs_mse_port_5_link_speed),
				.physs_mse_port_5_rx_dval (physs_mse_port_5_rx_dval),
				.physs_mse_port_5_rx_data (physs_mse_port_5_rx_data),
				.physs_mse_port_5_rx_sop (physs_mse_port_5_rx_sop),
				.physs_mse_port_5_rx_eop (physs_mse_port_5_rx_eop),
				.physs_mse_port_5_rx_mod (physs_mse_port_5_rx_mod),
				.physs_mse_port_5_rx_err (physs_mse_port_5_rx_err),
				.physs_mse_port_5_rx_ecc_err (physs_mse_port_5_rx_ecc_err),
				.mse_physs_port_5_rx_rdy (mse_physs_port_5_rx_rdy),
				.physs_mse_port_5_rx_ts (physs_mse_port_5_rx_ts),
				...
				.mse_physs_port_5_tx_eop (mse_physs_port_1_tx_eop),
				.mse_physs_port_5_tx_mod (mse_physs_port_1_tx_mod),
				.mse_physs_port_5_tx_err (mse_physs_port_1_tx_err),
				.mse_physs_port_5_tx_crc (mse_physs_port_2_tx_crc),
				.physs_mse_port_5_tx_rdy (physs_mse_port_2_tx_rdy),
				.physs_icq_port_6_link_stat (physs_icq_port_6_link_stat),
				.physs_mse_port_6_link_speed (physs_mse_port_6_link_speed),
				.physs_mse_port_6_rx_dval (physs_mse_port_6_rx_dval),
				.physs_mse_port_6_rx_data (physs_mse_port_6_rx_data),
				.physs_mse_port_6_rx_sop (physs_mse_port_6_rx_sop),
				.physs_mse_port_6_rx_eop (physs_mse_port_6_rx_eop),
				.physs_mse_port_6_rx_mod (physs_mse_port_6_rx_mod),
				.physs_mse_port_6_rx_err (physs_mse_port_6_rx_err),
				.physs_mse_port_6_rx_ecc_err (physs_mse_port_6_rx_ecc_err),
				.mse_physs_port_6_rx_rdy (mse_physs_port_6_rx_rdy),
				.physs_mse_port_6_rx_ts (physs_mse_port_6_rx_ts),
				...
				.mse_physs_port_6_tx_eop (mse_physs_port_1_tx_eop),
				.mse_physs_port_6_tx_mod (mse_physs_port_1_tx_mod),
				.mse_physs_port_6_tx_err (mse_physs_port_1_tx_err),
				.mse_physs_port_6_tx_crc (mse_physs_port_2_tx_crc),
				.physs_mse_port_6_tx_rdy (physs_mse_port_2_tx_rdy),
				.physs_icq_port_7_link_stat (physs_icq_port_7_link_stat),
				.physs_mse_port_7_link_speed (physs_mse_port_7_link_speed),
				.physs_mse_port_7_rx_dval (physs_mse_port_7_rx_dval),
				.physs_mse_port_7_rx_data (physs_mse_port_7_rx_data),
				.physs_mse_port_7_rx_sop (physs_mse_port_7_rx_sop),
				.physs_mse_port_7_rx_eop (physs_mse_port_7_rx_eop),
				.physs_mse_port_7_rx_mod (physs_mse_port_7_rx_mod),
				.physs_mse_port_7_rx_err (physs_mse_port_7_rx_err),
				.physs_mse_port_7_rx_ecc_err (physs_mse_port_7_rx_ecc_err),
				.mse_physs_port_7_rx_rdy (mse_physs_port_7_rx_rdy),
				.physs_mse_port_7_rx_ts (physs_mse_port_7_rx_ts),
				...
				.mse_physs_port_7_tx_eop (mse_physs_port_1_tx_eop),
				.mse_physs_port_7_tx_mod (mse_physs_port_1_tx_mod),
				.mse_physs_port_7_tx_err (mse_physs_port_1_tx_err),
				.mse_physs_port_7_tx_crc (mse_physs_port_2_tx_crc),
				.physs_mse_port_7_tx_rdy (physs_mse_port_2_tx_rdy),
...
.hlp_xlgmii1_txclk_ena_0 (hlp_xlgmii1_txclk_ena_0),
.hlp_xlgmii1_rxclk_ena_0 (hlp_xlgmii1_rxclk_ena_0),
.hlp_xlgmii1_rxc_0 (hlp_xlgmii1_rxc_0),
.hlp_xlgmii1_rxd_0 (hlp_xlgmii1_rxd_0),
.hlp_xlgmii1_rxt0_next_0 (hlp_xlgmii1_rxt0_next_0),
.hlp_xlgmii1_txc_0 (hlp_xlgmii1_txc_0),
.hlp_xlgmii1_txd_0 (hlp_xlgmii1_txd_0),
.hlp_xlgmii2_txclk_ena_0 (hlp_xlgmii2_txclk_ena_0),
.hlp_xlgmii2_rxclk_ena_0 (hlp_xlgmii2_rxclk_ena_0),
.hlp_xlgmii2_rxc_0 (hlp_xlgmii2_rxc_0),
.hlp_xlgmii2_rxd_0 (hlp_xlgmii2_rxd_0),
.hlp_xlgmii2_rxt0_next_0 (hlp_xlgmii2_rxt0_next_0),
.hlp_xlgmii2_txc_0 (hlp_xlgmii2_txc_0),
.hlp_xlgmii2_txd_0 (hlp_xlgmii2_txd_0),
.hlp_xlgmii3_txclk_ena_0 (hlp_xlgmii3_txclk_ena_0),
.hlp_xlgmii3_rxclk_ena_0 (hlp_xlgmii3_rxclk_ena_0),
.hlp_xlgmii3_rxc_0 (hlp_xlgmii3_rxc_0),
.hlp_xlgmii3_rxd_0 (hlp_xlgmii3_rxd_0),
.hlp_xlgmii3_rxt0_next_0 (hlp_xlgmii3_rxt0_next_0),
.hlp_xlgmii3_txc_0 (hlp_xlgmii3_txc_0),
.hlp_xlgmii3_txd_0 (hlp_xlgmii3_txd_0),
.hlp_cgmii0_rxd_0 (hlp_cgmii0_rxd_0),
.hlp_cgmii0_rxc_0 (hlp_cgmii0_rxc_0),
.hlp_cgmii0_rxclk_ena_0 (hlp_cgmii0_rxclk_ena_0),
.hlp_cgmii0_txd_0 (hlp_cgmii0_txd_0),
.hlp_cgmii0_txc_0 (hlp_cgmii0_txc_0),
.hlp_cgmii0_txclk_ena_0 (hlp_cgmii0_txclk_ena_0),
.hlp_cgmii1_rxd_0 (hlp_cgmii1_rxd_0),
.hlp_cgmii1_rxc_0 (hlp_cgmii1_rxc_0),
.hlp_cgmii1_rxclk_ena_0 (hlp_cgmii1_rxclk_ena_0),
.hlp_cgmii1_txd_0 (hlp_cgmii1_txd_0),
.hlp_cgmii1_txc_0 (hlp_cgmii1_txc_0),
.hlp_cgmii1_txclk_ena_0 (hlp_cgmii1_txclk_ena_0),
.hlp_cgmii2_rxd_0 (hlp_cgmii2_rxd_0),
.hlp_cgmii2_rxc_0 (hlp_cgmii2_rxc_0),
.hlp_cgmii2_rxclk_ena_0 (hlp_cgmii2_rxclk_ena_0),
.hlp_cgmii2_txd_0 (hlp_cgmii2_txd_0),
.hlp_cgmii2_txc_0 (hlp_cgmii2_txc_0),
.hlp_cgmii2_txclk_ena_0 (hlp_cgmii2_txclk_ena_0),
.hlp_cgmii3_rxd_0 (hlp_cgmii3_rxd_0),
.hlp_cgmii3_rxc_0 (hlp_cgmii3_rxc_0),
.hlp_cgmii3_rxclk_ena_0 (hlp_cgmii3_rxclk_ena_0),
.hlp_cgmii3_txd_0 (hlp_cgmii3_txd_0),
.hlp_cgmii3_txc_0 (hlp_cgmii3_txc_0),
.hlp_cgmii3_txclk_ena_0 (hlp_cgmii3_txclk_ena_0),
...
.hlp_xlgmii0_txc_nss_0 (hlp_xlgmii0_txc_nss_0),
.hlp_xlgmii0_txd_nss_0 (hlp_xlgmii0_txd_nss_0),
...
.hlp_xlgmii1_txc_nss_0 (hlp_xlgmii1_txc_nss_0),
.hlp_xlgmii1_txd_nss_0 (hlp_xlgmii1_txd_nss_0),
...
.hlp_xlgmii2_txc_nss_0 (hlp_xlgmii2_txc_nss_0),
.hlp_xlgmii2_txd_nss_0 (hlp_xlgmii2_txd_nss_0),
...
.hlp_xlgmii3_txc_nss_0 (hlp_xlgmii3_txc_nss_0),
.hlp_xlgmii3_txd_nss_0 (hlp_xlgmii3_txd_nss_0),
...
.hlp_cgmii0_txd_nss_0 (hlp_cgmii0_txd_nss_0),
.hlp_cgmii0_txc_nss_0 (hlp_cgmii0_txc_nss_0),
...
.hlp_cgmii1_txd_nss_0 (hlp_cgmii1_txd_nss_0),
.hlp_cgmii1_txc_nss_0 (hlp_cgmii1_txc_nss_0),
...
.hlp_cgmii2_txd_nss_0 (hlp_cgmii2_txd_nss_0),
.hlp_cgmii2_txc_nss_0 (hlp_cgmii2_txc_nss_0),
...
.hlp_cgmii3_txd_nss_0 (hlp_cgmii3_txd_nss_0),
.hlp_cgmii3_txc_nss_0 (hlp_cgmii3_txc_nss_0),
.hlp_cgmii3_txclk_ena_nss_0 (hlp_cgmii3_txclk_ena_nss_0),
.hlp_xlgmii0_txclk_ena_1 (hlp_xlgmii0_txclk_ena_1),
.hlp_xlgmii0_rxclk_ena_1 (hlp_xlgmii0_rxclk_ena_1),
.hlp_xlgmii0_rxc_1 (hlp_xlgmii0_rxc_1),
.hlp_xlgmii0_rxd_1 (hlp_xlgmii0_rxd_1),
.hlp_xlgmii0_rxt0_next_1 (hlp_xlgmii0_rxt0_next_1),
.hlp_xlgmii0_txc_1 (hlp_xlgmii0_txc_1),
.hlp_xlgmii0_txd_1 (hlp_xlgmii0_txd_1),
.hlp_xlgmii1_txclk_ena_1 (hlp_xlgmii1_txclk_ena_1),
.hlp_xlgmii1_rxclk_ena_1 (hlp_xlgmii1_rxclk_ena_1),
.hlp_xlgmii1_rxc_1 (hlp_xlgmii1_rxc_1),
.hlp_xlgmii1_rxd_1 (hlp_xlgmii1_rxd_1),
.hlp_xlgmii1_rxt0_next_1 (hlp_xlgmii1_rxt0_next_1),
.hlp_xlgmii1_txc_1 (hlp_xlgmii1_txc_1),
.hlp_xlgmii1_txd_1 (hlp_xlgmii1_txd_1),
.hlp_xlgmii2_txclk_ena_1 (hlp_xlgmii2_txclk_ena_1),
.hlp_xlgmii2_rxclk_ena_1 (hlp_xlgmii2_rxclk_ena_1),
.hlp_xlgmii2_rxc_1 (hlp_xlgmii2_rxc_1),
.hlp_xlgmii2_rxd_1 (hlp_xlgmii2_rxd_1),
.hlp_xlgmii2_rxt0_next_1 (hlp_xlgmii2_rxt0_next_1),
.hlp_xlgmii2_txc_1 (hlp_xlgmii2_txc_1),
.hlp_xlgmii2_txd_1 (hlp_xlgmii2_txd_1),
.hlp_xlgmii3_txclk_ena_1 (hlp_xlgmii3_txclk_ena_1),
.hlp_xlgmii3_rxclk_ena_1 (hlp_xlgmii3_rxclk_ena_1),
.hlp_xlgmii3_rxc_1 (hlp_xlgmii3_rxc_1),
.hlp_xlgmii3_rxd_1 (hlp_xlgmii3_rxd_1),
.hlp_xlgmii3_rxt0_next_1 (hlp_xlgmii3_rxt0_next_1),
.hlp_xlgmii3_txc_1 (hlp_xlgmii3_txc_1),
.hlp_xlgmii3_txd_1 (hlp_xlgmii3_txd_1),
.hlp_cgmii0_rxd_1 (hlp_cgmii0_rxd_1),
.hlp_cgmii0_rxc_1 (hlp_cgmii0_rxc_1),
.hlp_cgmii0_rxclk_ena_1 (hlp_cgmii0_rxclk_ena_1),
.hlp_cgmii0_txd_1 (hlp_cgmii0_txd_1),
.hlp_cgmii0_txc_1 (hlp_cgmii0_txc_1),
.hlp_cgmii0_txclk_ena_1 (hlp_cgmii0_txclk_ena_1),
.hlp_cgmii1_rxd_1 (hlp_cgmii1_rxd_1),
.hlp_cgmii1_rxc_1 (hlp_cgmii1_rxc_1),
.hlp_cgmii1_rxclk_ena_1 (hlp_cgmii1_rxclk_ena_1),
.hlp_cgmii1_txd_1 (hlp_cgmii1_txd_1),
.hlp_cgmii1_txc_1 (hlp_cgmii1_txc_1),
.hlp_cgmii1_txclk_ena_1 (hlp_cgmii1_txclk_ena_1),
.hlp_cgmii2_rxd_1 (hlp_cgmii2_rxd_1),
.hlp_cgmii2_rxc_1 (hlp_cgmii2_rxc_1),
.hlp_cgmii2_rxclk_ena_1 (hlp_cgmii2_rxclk_ena_1),
.hlp_cgmii2_txd_1 (hlp_cgmii2_txd_1),
.hlp_cgmii2_txc_1 (hlp_cgmii2_txc_1),
.hlp_cgmii2_txclk_ena_1 (hlp_cgmii2_txclk_ena_1),
.hlp_cgmii3_rxd_1 (hlp_cgmii3_rxd_1),
.hlp_cgmii3_rxc_1 (hlp_cgmii3_rxc_1),
.hlp_cgmii3_rxclk_ena_1 (hlp_cgmii3_rxclk_ena_1),
.hlp_cgmii3_txd_1 (hlp_cgmii3_txd_1),
.hlp_cgmii3_txc_1 (hlp_cgmii3_txc_1),
.hlp_cgmii3_txclk_ena_1 (hlp_cgmii3_txclk_ena_1),
.hlp_xlgmii0_txclk_ena_2 (hlp_xlgmii0_txclk_ena_2),
.hlp_xlgmii0_rxclk_ena_2 (hlp_xlgmii0_rxclk_ena_2),
.hlp_xlgmii0_rxc_2 (hlp_xlgmii0_rxc_2),
.hlp_xlgmii0_rxd_2 (hlp_xlgmii0_rxd_2),
.hlp_xlgmii0_rxt0_next_2 (hlp_xlgmii0_rxt0_next_2),
.hlp_xlgmii0_txc_2 (hlp_xlgmii0_txc_2),
.hlp_xlgmii0_txd_2 (hlp_xlgmii0_txd_2),
.hlp_xlgmii1_txclk_ena_2 (hlp_xlgmii1_txclk_ena_2),
.hlp_xlgmii1_rxclk_ena_2 (hlp_xlgmii1_rxclk_ena_2),
.hlp_xlgmii1_rxc_2 (hlp_xlgmii1_rxc_2),
.hlp_xlgmii1_rxd_2 (hlp_xlgmii1_rxd_2),
.hlp_xlgmii1_rxt0_next_2 (hlp_xlgmii1_rxt0_next_2),
.hlp_xlgmii1_txc_2 (hlp_xlgmii1_txc_2),
.hlp_xlgmii1_txd_2 (hlp_xlgmii1_txd_2),
.hlp_xlgmii2_txclk_ena_2 (hlp_xlgmii2_txclk_ena_2),
.hlp_xlgmii2_rxclk_ena_2 (hlp_xlgmii2_rxclk_ena_2),
.hlp_xlgmii2_rxc_2 (hlp_xlgmii2_rxc_2),
.hlp_xlgmii2_rxd_2 (hlp_xlgmii2_rxd_2),
.hlp_xlgmii2_rxt0_next_2 (hlp_xlgmii2_rxt0_next_2),
.hlp_xlgmii2_txc_2 (hlp_xlgmii2_txc_2),
.hlp_xlgmii2_txd_2 (hlp_xlgmii2_txd_2),
.hlp_xlgmii3_txclk_ena_2 (hlp_xlgmii3_txclk_ena_2),
.hlp_xlgmii3_rxclk_ena_2 (hlp_xlgmii3_rxclk_ena_2),
.hlp_xlgmii3_rxc_2 (hlp_xlgmii3_rxc_2),
.hlp_xlgmii3_rxd_2 (hlp_xlgmii3_rxd_2),
.hlp_xlgmii3_rxt0_next_2 (hlp_xlgmii3_rxt0_next_2),
.hlp_xlgmii3_txc_2 (hlp_xlgmii3_txc_2),
.hlp_xlgmii3_txd_2 (hlp_xlgmii3_txd_2),
.hlp_cgmii0_rxd_2 (hlp_cgmii0_rxd_2),
.hlp_cgmii0_rxc_2 (hlp_cgmii0_rxc_2),
.hlp_cgmii0_rxclk_ena_2 (hlp_cgmii0_rxclk_ena_2),
.hlp_cgmii0_txd_2 (hlp_cgmii0_txd_2),
.hlp_cgmii0_txc_2 (hlp_cgmii0_txc_2),
.hlp_cgmii0_txclk_ena_2 (hlp_cgmii0_txclk_ena_2),
.hlp_cgmii1_rxd_2 (hlp_cgmii1_rxd_2),
.hlp_cgmii1_rxc_2 (hlp_cgmii1_rxc_2),
.hlp_cgmii1_rxclk_ena_2 (hlp_cgmii1_rxclk_ena_2),
.hlp_cgmii1_txd_2 (hlp_cgmii1_txd_2),
.hlp_cgmii1_txc_2 (hlp_cgmii1_txc_2),
.hlp_cgmii1_txclk_ena_2 (hlp_cgmii1_txclk_ena_2),
.hlp_cgmii2_rxd_2 (hlp_cgmii2_rxd_2),
.hlp_cgmii2_rxc_2 (hlp_cgmii2_rxc_2),
.hlp_cgmii2_rxclk_ena_2 (hlp_cgmii2_rxclk_ena_2),
.hlp_cgmii2_txd_2 (hlp_cgmii2_txd_2),
.hlp_cgmii2_txc_2 (hlp_cgmii2_txc_2),
.hlp_cgmii2_txclk_ena_2 (hlp_cgmii2_txclk_ena_2),
.hlp_cgmii3_rxd_2 (hlp_cgmii3_rxd_2),
.hlp_cgmii3_rxc_2 (hlp_cgmii3_rxc_2),
.hlp_cgmii3_rxclk_ena_2 (hlp_cgmii3_rxclk_ena_2),
.hlp_cgmii3_txd_2 (hlp_cgmii3_txd_2),
.hlp_cgmii3_txc_2 (hlp_cgmii3_txc_2),
.hlp_cgmii3_txclk_ena_2 (hlp_cgmii3_txclk_ena_2),
.hlp_xlgmii0_txclk_ena_3 (hlp_xlgmii0_txclk_ena_3),
.hlp_xlgmii0_rxclk_ena_3 (hlp_xlgmii0_rxclk_ena_3),
.hlp_xlgmii0_rxc_3 (hlp_xlgmii0_rxc_3),
.hlp_xlgmii0_rxd_3 (hlp_xlgmii0_rxd_3),
.hlp_xlgmii0_rxt0_next_3 (hlp_xlgmii0_rxt0_next_3),
.hlp_xlgmii0_txc_3 (hlp_xlgmii0_txc_3),
.hlp_xlgmii0_txd_3 (hlp_xlgmii0_txd_3),
.hlp_xlgmii1_txclk_ena_3 (hlp_xlgmii1_txclk_ena_3),
.hlp_xlgmii1_rxclk_ena_3 (hlp_xlgmii1_rxclk_ena_3),
.hlp_xlgmii1_rxc_3 (hlp_xlgmii1_rxc_3),
.hlp_xlgmii1_rxd_3 (hlp_xlgmii1_rxd_3),
.hlp_xlgmii1_rxt0_next_3 (hlp_xlgmii1_rxt0_next_3),
.hlp_xlgmii1_txc_3 (hlp_xlgmii1_txc_3),
.hlp_xlgmii1_txd_3 (hlp_xlgmii1_txd_3),
.hlp_xlgmii2_txclk_ena_3 (hlp_xlgmii2_txclk_ena_3),
.hlp_xlgmii2_rxclk_ena_3 (hlp_xlgmii2_rxclk_ena_3),
.hlp_xlgmii2_rxc_3 (hlp_xlgmii2_rxc_3),
.hlp_xlgmii2_rxd_3 (hlp_xlgmii2_rxd_3),
.hlp_xlgmii2_rxt0_next_3 (hlp_xlgmii2_rxt0_next_3),
.hlp_xlgmii2_txc_3 (hlp_xlgmii2_txc_3),
.hlp_xlgmii2_txd_3 (hlp_xlgmii2_txd_3),
.hlp_xlgmii3_txclk_ena_3 (hlp_xlgmii3_txclk_ena_3),
.hlp_xlgmii3_rxclk_ena_3 (hlp_xlgmii3_rxclk_ena_3),
.hlp_xlgmii3_rxc_3 (hlp_xlgmii3_rxc_3),
.hlp_xlgmii3_rxd_3 (hlp_xlgmii3_rxd_3),
.hlp_xlgmii3_rxt0_next_3 (hlp_xlgmii3_rxt0_next_3),
.hlp_xlgmii3_txc_3 (hlp_xlgmii3_txc_3),
.hlp_xlgmii3_txd_3 (hlp_xlgmii3_txd_3),
.hlp_cgmii0_rxd_3 (hlp_cgmii0_rxd_3),
.hlp_cgmii0_rxc_3 (hlp_cgmii0_rxc_3),
.hlp_cgmii0_rxclk_ena_3 (hlp_cgmii0_rxclk_ena_3),
.hlp_cgmii0_txd_3 (hlp_cgmii0_txd_3),
.hlp_cgmii0_txc_3 (hlp_cgmii0_txc_3),
.hlp_cgmii0_txclk_ena_3 (hlp_cgmii0_txclk_ena_3),
.hlp_cgmii1_rxd_3 (hlp_cgmii1_rxd_3),
.hlp_cgmii1_rxc_3 (hlp_cgmii1_rxc_3),
.hlp_cgmii1_rxclk_ena_3 (hlp_cgmii1_rxclk_ena_3),
.hlp_cgmii1_txd_3 (hlp_cgmii1_txd_3),
.hlp_cgmii1_txc_3 (hlp_cgmii1_txc_3),
.hlp_cgmii1_txclk_ena_3 (hlp_cgmii1_txclk_ena_3),
.hlp_cgmii2_rxd_3 (hlp_cgmii2_rxd_3),
.hlp_cgmii2_rxc_3 (hlp_cgmii2_rxc_3),
.hlp_cgmii2_rxclk_ena_3 (hlp_cgmii2_rxclk_ena_3),
.hlp_cgmii2_txd_3 (hlp_cgmii2_txd_3),
.hlp_cgmii2_txc_3 (hlp_cgmii2_txc_3),
.hlp_cgmii2_txclk_ena_3 (hlp_cgmii2_txclk_ena_3),
.hlp_cgmii3_rxd_3 (hlp_cgmii3_rxd_3),
.hlp_cgmii3_rxc_3 (hlp_cgmii3_rxc_3),
.hlp_cgmii3_rxclk_ena_3 (hlp_cgmii3_rxclk_ena_3),
.hlp_cgmii3_txd_3 (hlp_cgmii3_txd_3),
.hlp_cgmii3_txc_3 (hlp_cgmii3_txc_3),
.hlp_cgmii3_txclk_ena_3 (hlp_cgmii3_txclk_ena_3),
...
.mii_rx_tsu_mux (mii_rx_tsu_mux),
.mii_tx_tsu (mii_tx_tsu),
.pcs_sd_bit_slip (pcs_sd_bit_slip),
.pcs_desk_buf_rlevel (pcs_desk_buf_rlevel),
.pcs_link_status_tsu (pcs_link_status_tsu),
.physs_icq_port_0_pfc_mode (physs_icq_port_0_pfc_mode),
.physs_icq_port_1_pfc_mode (physs_icq_port_1_pfc_mode),
.physs_icq_port_2_pfc_mode (physs_icq_port_2_pfc_mode),
.physs_icq_port_3_pfc_mode (physs_icq_port_3_pfc_mode),
.physs_icq_port_4_pfc_mode (physs_icq_port_4_pfc_mode),
.physs_icq_port_5_pfc_mode (physs_icq_port_5_pfc_mode),
.physs_icq_port_6_pfc_mode (physs_icq_port_6_pfc_mode),
.physs_icq_port_7_pfc_mode (physs_icq_port_7_pfc_mode),
.icq_physs_net_xoff (icq_physs_net_xoff),
.physs_icq_net_xoff (physs_icq_net_xoff),
.physs_hif_port_0_magic_pkt_ind_tgl (physs_hif_port_0_magic_pkt_ind_tgl),
.physs_hif_port_1_magic_pkt_ind_tgl (physs_hif_port_1_magic_pkt_ind_tgl),
.physs_hif_port_2_magic_pkt_ind_tgl (physs_hif_port_2_magic_pkt_ind_tgl),
.physs_hif_port_3_magic_pkt_ind_tgl (physs_hif_port_3_magic_pkt_ind_tgl),
.physs_hif_port_4_magic_pkt_ind_tgl (physs_hif_port_4_magic_pkt_ind_tgl),
.physs_hif_port_5_magic_pkt_ind_tgl (physs_hif_port_5_magic_pkt_ind_tgl),
.physs_hif_port_6_magic_pkt_ind_tgl (physs_hif_port_6_magic_pkt_ind_tgl),
.physs_hif_port_7_magic_pkt_ind_tgl (physs_hif_port_7_magic_pkt_ind_tgl),
.physs_timesync_sync_val (physs_timesync_sync_val),
.physs_fatal_int_0 (physs_fatal_int_0),
.physs_fatal_int_1 (physs_fatal_int_1),
.physs_ares_int_0 (physs_ares_int_0),
.physs_ares_int_1 (physs_ares_int_1),
.physs_imc_int_0 (physs_imc_int_0),
.physs_imc_int_1 (physs_imc_int_1),
.physs_0_ts_int (physs_0_ts_int),
.physs_1_ts_int (physs_1_ts_int),
.physs_0_noc_int (physs_0_noc_int),
.physs_1_noc_int (physs_1_noc_int),
.mdio_in (mdio_in),
.mdio_out (mdio_out),
.mdio_oen (mdio_oen),
.mdc (mdc),
...
.o_abscan_pma0_tdo_0 (o_abscan_pma0_tdo_0),
.o_abscan_pma0_tdo_f_0 (o_abscan_pma0_tdo_f_0),
.o_abscan_pma1_tdo_0 (o_abscan_pma1_tdo_0),
.o_abscan_pma1_tdo_f_0 (o_abscan_pma1_tdo_f_0),
.o_abscan_pma2_tdo_0 (o_abscan_pma2_tdo_0),
.o_abscan_pma2_tdo_f_0 (o_abscan_pma2_tdo_f_0),
.o_abscan_pma3_tdo_0 (o_abscan_pma3_tdo_0),
.o_abscan_pma3_tdo_f_0 (o_abscan_pma3_tdo_f_0),
...
.o_abscan_pma0_tdo_1 (o_abscan_pma0_tdo_1),
.o_abscan_pma0_tdo_f_1 (o_abscan_pma0_tdo_f_1),
.o_abscan_pma1_tdo_1 (o_abscan_pma1_tdo_1),
.o_abscan_pma1_tdo_f_1 (o_abscan_pma1_tdo_f_1),
.o_abscan_pma2_tdo_1 (o_abscan_pma2_tdo_1),
.o_abscan_pma2_tdo_f_1 (o_abscan_pma2_tdo_f_1),
.o_abscan_pma3_tdo_1 (o_abscan_pma3_tdo_1),
.o_abscan_pma3_tdo_f_1 (o_abscan_pma3_tdo_f_1),
...
.o_abscan_pma0_tdo_2 (o_abscan_pma0_tdo_2),
.o_abscan_pma0_tdo_f_2 (o_abscan_pma0_tdo_f_2),
.o_abscan_pma1_tdo_2 (o_abscan_pma1_tdo_2),
.o_abscan_pma1_tdo_f_2 (o_abscan_pma1_tdo_f_2),
.o_abscan_pma2_tdo_2 (o_abscan_pma2_tdo_2),
.o_abscan_pma2_tdo_f_2 (o_abscan_pma2_tdo_f_2),
.o_abscan_pma3_tdo_2 (o_abscan_pma3_tdo_2),
.o_abscan_pma3_tdo_f_2 (o_abscan_pma3_tdo_f_2),
...
.o_abscan_pma0_tdo_3 (o_abscan_pma0_tdo_3),
.o_abscan_pma0_tdo_f_3 (o_abscan_pma0_tdo_f_3),
.o_abscan_pma1_tdo_3 (o_abscan_pma1_tdo_3),
.o_abscan_pma1_tdo_f_3 (o_abscan_pma1_tdo_f_3),
.o_abscan_pma2_tdo_3 (o_abscan_pma2_tdo_3),
.o_abscan_pma2_tdo_f_3 (o_abscan_pma2_tdo_f_3),
.o_abscan_pma3_tdo_3 (o_abscan_pma3_tdo_3),
.o_abscan_pma3_tdo_f_3 (o_abscan_pma3_tdo_f_3),
...
.o_pma0_jtag_tdo_en (o_pma0_jtag_tdo_en),
.o_pma0_jtag_tdo (o_pma0_jtag_tdo),
...
.o_pma1_jtag_tdo_en (o_pma1_jtag_tdo_en),
.o_pma1_jtag_tdo (o_pma1_jtag_tdo),
...
.o_pma2_jtag_tdo_en (o_pma2_jtag_tdo_en),
.o_pma2_jtag_tdo (o_pma2_jtag_tdo),
...
.o_pma3_jtag_tdo_en (o_pma3_jtag_tdo_en),
.o_pma3_jtag_tdo (o_pma3_jtag_tdo),
...
.o_pma4_jtag_tdo_en (o_pma4_jtag_tdo_en),
.o_pma4_jtag_tdo (o_pma4_jtag_tdo),
...
.o_pma5_jtag_tdo_en (o_pma5_jtag_tdo_en),
.o_pma5_jtag_tdo (o_pma5_jtag_tdo),
...
.o_pma6_jtag_tdo_en (o_pma6_jtag_tdo_en),
.o_pma6_jtag_tdo (o_pma6_jtag_tdo),
...
.o_pma7_jtag_tdo_en (o_pma7_jtag_tdo_en),
.o_pma7_jtag_tdo (o_pma7_jtag_tdo),
...
.o_pma8_jtag_tdo_en (o_pma8_jtag_tdo_en),
.o_pma8_jtag_tdo (o_pma8_jtag_tdo),
...
.o_pma9_jtag_tdo_en (o_pma9_jtag_tdo_en),
.o_pma9_jtag_tdo (o_pma9_jtag_tdo),
...
.o_pma10_jtag_tdo_en (o_pma10_jtag_tdo_en),
.o_pma10_jtag_tdo (o_pma10_jtag_tdo),
...
.o_pma11_jtag_tdo_en (o_pma11_jtag_tdo_en),
.o_pma11_jtag_tdo (o_pma11_jtag_tdo),
...
.o_pma12_jtag_tdo_en (o_pma12_jtag_tdo_en),
.o_pma12_jtag_tdo (o_pma12_jtag_tdo),
...
.o_pma13_jtag_tdo_en (o_pma13_jtag_tdo_en),
.o_pma13_jtag_tdo (o_pma13_jtag_tdo),
...
.o_pma14_jtag_tdo_en (o_pma14_jtag_tdo_en),
.o_pma14_jtag_tdo (o_pma14_jtag_tdo),
...
.o_pma15_jtag_tdo_en (o_pma15_jtag_tdo_en),
.o_pma15_jtag_tdo (o_pma15_jtag_tdo),
...
.o_ucss_jtag_tdo_en_0 (o_ucss_jtag_tdo_en_0),
.o_ucss_jtag_tdo_0 (o_ucss_jtag_tdo_0),
...
.o_cpu_debug_tdo_0 (o_cpu_debug_tdo_0),
.o_cpu_debug_tdo_en_0 (o_cpu_debug_tdo_en_0),
...
.o_ucss_jtag_tdo_en_1 (o_ucss_jtag_tdo_en_1),
.o_ucss_jtag_tdo_1 (o_ucss_jtag_tdo_1),
...
.o_cpu_debug_tdo_1 (o_cpu_debug_tdo_1),
.o_cpu_debug_tdo_en_1 (o_cpu_debug_tdo_en_1),
...
.o_ucss_jtag_tdo_en_2 (o_ucss_jtag_tdo_en_2),
.o_ucss_jtag_tdo_2 (o_ucss_jtag_tdo_2),
...
.o_cpu_debug_tdo_2 (o_cpu_debug_tdo_2),
.o_cpu_debug_tdo_en_2 (o_cpu_debug_tdo_en_2),
...
.o_ucss_jtag_tdo_en_3 (o_ucss_jtag_tdo_en_3),
.o_ucss_jtag_tdo_3 (o_ucss_jtag_tdo_3),
...
.o_cpu_debug_tdo_3 (o_cpu_debug_tdo_3),
.o_cpu_debug_tdo_en_3 (o_cpu_debug_tdo_en_3),
...
.o_ascan_pma0_sdo_ref_cmn_0 (o_ascan_pma0_sdo_ref_cmn_0),
.o_ascan_pma0_sdo_apb_cmn_0 (o_ascan_pma0_sdo_apb_cmn_0),
.o_ascan_pma0_sdo_ref_channelcmn_0 (o_ascan_pma0_sdo_ref_channelcmn_0),
.o_ascan_pma0_sdo_cmnplla_0 (o_ascan_pma0_sdo_cmnplla_0),
.o_ascan_pma0_sdo_cmnpllb_0 (o_ascan_pma0_sdo_cmnpllb_0),
...
.o_ascan_pma0_sdo_ctrl_l0_0 (o_ascan_pma0_sdo_ctrl_l0_0),
.o_ascan_pma0_sdo_memarray_word_l0_0 (o_ascan_pma0_sdo_memarray_word_l0_0),
.o_ascan_pma0_sdo_ref_l0_0 (o_ascan_pma0_sdo_ref_l0_0),
.o_ascan_pma0_sdo_word_l0_0 (o_ascan_pma0_sdo_word_l0_0),
.o_ascan_pma0_sdo_ref_channelleft_l0_0 (o_ascan_pma0_sdo_ref_channelleft_l0_0),
.o_ascan_pma0_sdo_ref_channelright_l0_0 (o_ascan_pma0_sdo_ref_channelright_l0_0),
.o_ascan_pma0_sdo_ref_txffe_l0_0 (o_ascan_pma0_sdo_ref_txffe_l0_0),
.o_ascan_pma0_sdo_word_txffe_l0_0 (o_ascan_pma0_sdo_word_txffe_l0_0),
.o_ascan_pma0_sdo_txpll_l0_0 (o_ascan_pma0_sdo_txpll_l0_0),
...
.o_ascan_pma1_sdo_ref_cmn_0 (o_ascan_pma1_sdo_ref_cmn_0),
.o_ascan_pma1_sdo_apb_cmn_0 (o_ascan_pma1_sdo_apb_cmn_0),
.o_ascan_pma1_sdo_ref_channelcmn_0 (o_ascan_pma1_sdo_ref_channelcmn_0),
.o_ascan_pma1_sdo_cmnplla_0 (o_ascan_pma1_sdo_cmnplla_0),
.o_ascan_pma1_sdo_cmnpllb_0 (o_ascan_pma1_sdo_cmnpllb_0),
...
.o_ascan_pma1_sdo_ctrl_l0_0 (o_ascan_pma1_sdo_ctrl_l0_0),
.o_ascan_pma1_sdo_memarray_word_l0_0 (o_ascan_pma1_sdo_memarray_word_l0_0),
.o_ascan_pma1_sdo_ref_l0_0 (o_ascan_pma1_sdo_ref_l0_0),
.o_ascan_pma1_sdo_word_l0_0 (o_ascan_pma1_sdo_word_l0_0),
.o_ascan_pma1_sdo_ref_channelleft_l0_0 (o_ascan_pma1_sdo_ref_channelleft_l0_0),
.o_ascan_pma1_sdo_ref_channelright_l0_0 (o_ascan_pma1_sdo_ref_channelright_l0_0),
.o_ascan_pma1_sdo_ref_txffe_l0_0 (o_ascan_pma1_sdo_ref_txffe_l0_0),
.o_ascan_pma1_sdo_word_txffe_l0_0 (o_ascan_pma1_sdo_word_txffe_l0_0),
.o_ascan_pma1_sdo_txpll_l0_0 (o_ascan_pma1_sdo_txpll_l0_0),
...
.o_ascan_pma2_sdo_ref_cmn_0 (o_ascan_pma2_sdo_ref_cmn_0),
.o_ascan_pma2_sdo_apb_cmn_0 (o_ascan_pma2_sdo_apb_cmn_0),
.o_ascan_pma2_sdo_ref_channelcmn_0 (o_ascan_pma2_sdo_ref_channelcmn_0),
.o_ascan_pma2_sdo_cmnplla_0 (o_ascan_pma2_sdo_cmnplla_0),
.o_ascan_pma2_sdo_cmnpllb_0 (o_ascan_pma2_sdo_cmnpllb_0),
...
.o_ascan_pma2_sdo_ctrl_l0_0 (o_ascan_pma2_sdo_ctrl_l0_0),
.o_ascan_pma2_sdo_memarray_word_l0_0 (o_ascan_pma2_sdo_memarray_word_l0_0),
.o_ascan_pma2_sdo_ref_l0_0 (o_ascan_pma2_sdo_ref_l0_0),
.o_ascan_pma2_sdo_word_l0_0 (o_ascan_pma2_sdo_word_l0_0),
.o_ascan_pma2_sdo_ref_channelleft_l0_0 (o_ascan_pma2_sdo_ref_channelleft_l0_0),
.o_ascan_pma2_sdo_ref_channelright_l0_0 (o_ascan_pma2_sdo_ref_channelright_l0_0),
.o_ascan_pma2_sdo_ref_txffe_l0_0 (o_ascan_pma2_sdo_ref_txffe_l0_0),
.o_ascan_pma2_sdo_word_txffe_l0_0 (o_ascan_pma2_sdo_word_txffe_l0_0),
.o_ascan_pma2_sdo_txpll_l0_0 (o_ascan_pma2_sdo_txpll_l0_0),
...
.o_ascan_pma3_sdo_ref_cmn_0 (o_ascan_pma3_sdo_ref_cmn_0),
.o_ascan_pma3_sdo_apb_cmn_0 (o_ascan_pma3_sdo_apb_cmn_0),
.o_ascan_pma3_sdo_ref_channelcmn_0 (o_ascan_pma3_sdo_ref_channelcmn_0),
.o_ascan_pma3_sdo_cmnplla_0 (o_ascan_pma3_sdo_cmnplla_0),
.o_ascan_pma3_sdo_cmnpllb_0 (o_ascan_pma3_sdo_cmnpllb_0),
...
.o_ascan_pma3_sdo_ctrl_l0_0 (o_ascan_pma3_sdo_ctrl_l0_0),
.o_ascan_pma3_sdo_memarray_word_l0_0 (o_ascan_pma3_sdo_memarray_word_l0_0),
.o_ascan_pma3_sdo_ref_l0_0 (o_ascan_pma3_sdo_ref_l0_0),
.o_ascan_pma3_sdo_word_l0_0 (o_ascan_pma3_sdo_word_l0_0),
.o_ascan_pma3_sdo_ref_channelleft_l0_0 (o_ascan_pma3_sdo_ref_channelleft_l0_0),
.o_ascan_pma3_sdo_ref_channelright_l0_0 (o_ascan_pma3_sdo_ref_channelright_l0_0),
.o_ascan_pma3_sdo_ref_txffe_l0_0 (o_ascan_pma3_sdo_ref_txffe_l0_0),
.o_ascan_pma3_sdo_word_txffe_l0_0 (o_ascan_pma3_sdo_word_txffe_l0_0),
.o_ascan_pma3_sdo_txpll_l0_0 (o_ascan_pma3_sdo_txpll_l0_0),
...
.o_ascan_pma0_sdo_ref_cmn_1 (o_ascan_pma0_sdo_ref_cmn_1),
.o_ascan_pma0_sdo_apb_cmn_1 (o_ascan_pma0_sdo_apb_cmn_1),
.o_ascan_pma0_sdo_ref_channelcmn_1 (o_ascan_pma0_sdo_ref_channelcmn_1),
.o_ascan_pma0_sdo_cmnplla_1 (o_ascan_pma0_sdo_cmnplla_1),
.o_ascan_pma0_sdo_cmnpllb_1 (o_ascan_pma0_sdo_cmnpllb_1),
...
.o_ascan_pma0_sdo_ctrl_l0_1 (o_ascan_pma0_sdo_ctrl_l0_1),
.o_ascan_pma0_sdo_memarray_word_l0_1 (o_ascan_pma0_sdo_memarray_word_l0_1),
.o_ascan_pma0_sdo_ref_l0_1 (o_ascan_pma0_sdo_ref_l0_1),
.o_ascan_pma0_sdo_word_l0_1 (o_ascan_pma0_sdo_word_l0_1),
.o_ascan_pma0_sdo_ref_channelleft_l0_1 (o_ascan_pma0_sdo_ref_channelleft_l0_1),
.o_ascan_pma0_sdo_ref_channelright_l0_1 (o_ascan_pma0_sdo_ref_channelright_l0_1),
.o_ascan_pma0_sdo_ref_txffe_l0_1 (o_ascan_pma0_sdo_ref_txffe_l0_1),
.o_ascan_pma0_sdo_word_txffe_l0_1 (o_ascan_pma0_sdo_word_txffe_l0_1),
.o_ascan_pma0_sdo_txpll_l0_1 (o_ascan_pma0_sdo_txpll_l0_1),
...
.o_ascan_pma1_sdo_ref_cmn_1 (o_ascan_pma1_sdo_ref_cmn_1),
.o_ascan_pma1_sdo_apb_cmn_1 (o_ascan_pma1_sdo_apb_cmn_1),
.o_ascan_pma1_sdo_ref_channelcmn_1 (o_ascan_pma1_sdo_ref_channelcmn_1),
.o_ascan_pma1_sdo_cmnplla_1 (o_ascan_pma1_sdo_cmnplla_1),
.o_ascan_pma1_sdo_cmnpllb_1 (o_ascan_pma1_sdo_cmnpllb_1),
...
.o_ascan_pma1_sdo_ctrl_l0_1 (o_ascan_pma1_sdo_ctrl_l0_1),
.o_ascan_pma1_sdo_memarray_word_l0_1 (o_ascan_pma1_sdo_memarray_word_l0_1),
.o_ascan_pma1_sdo_ref_l0_1 (o_ascan_pma1_sdo_ref_l0_1),
.o_ascan_pma1_sdo_word_l0_1 (o_ascan_pma1_sdo_word_l0_1),
.o_ascan_pma1_sdo_ref_channelleft_l0_1 (o_ascan_pma1_sdo_ref_channelleft_l0_1),
.o_ascan_pma1_sdo_ref_channelright_l0_1 (o_ascan_pma1_sdo_ref_channelright_l0_1),
.o_ascan_pma1_sdo_ref_txffe_l0_1 (o_ascan_pma1_sdo_ref_txffe_l0_1),
.o_ascan_pma1_sdo_word_txffe_l0_1 (o_ascan_pma1_sdo_word_txffe_l0_1),
.o_ascan_pma1_sdo_txpll_l0_1 (o_ascan_pma1_sdo_txpll_l0_1),
...
.o_ascan_pma2_sdo_ref_cmn_1 (o_ascan_pma2_sdo_ref_cmn_1),
.o_ascan_pma2_sdo_apb_cmn_1 (o_ascan_pma2_sdo_apb_cmn_1),
.o_ascan_pma2_sdo_ref_channelcmn_1 (o_ascan_pma2_sdo_ref_channelcmn_1),
.o_ascan_pma2_sdo_cmnplla_1 (o_ascan_pma2_sdo_cmnplla_1),
.o_ascan_pma2_sdo_cmnpllb_1 (o_ascan_pma2_sdo_cmnpllb_1),
...
.o_ascan_pma2_sdo_ctrl_l0_1 (o_ascan_pma2_sdo_ctrl_l0_1),
.o_ascan_pma2_sdo_memarray_word_l0_1 (o_ascan_pma2_sdo_memarray_word_l0_1),
.o_ascan_pma2_sdo_ref_l0_1 (o_ascan_pma2_sdo_ref_l0_1),
.o_ascan_pma2_sdo_word_l0_1 (o_ascan_pma2_sdo_word_l0_1),
.o_ascan_pma2_sdo_ref_channelleft_l0_1 (o_ascan_pma2_sdo_ref_channelleft_l0_1),
.o_ascan_pma2_sdo_ref_channelright_l0_1 (o_ascan_pma2_sdo_ref_channelright_l0_1),
.o_ascan_pma2_sdo_ref_txffe_l0_1 (o_ascan_pma2_sdo_ref_txffe_l0_1),
.o_ascan_pma2_sdo_word_txffe_l0_1 (o_ascan_pma2_sdo_word_txffe_l0_1),
.o_ascan_pma2_sdo_txpll_l0_1 (o_ascan_pma2_sdo_txpll_l0_1),
...
.o_ascan_pma3_sdo_ref_cmn_1 (o_ascan_pma3_sdo_ref_cmn_1),
.o_ascan_pma3_sdo_apb_cmn_1 (o_ascan_pma3_sdo_apb_cmn_1),
.o_ascan_pma3_sdo_ref_channelcmn_1 (o_ascan_pma3_sdo_ref_channelcmn_1),
.o_ascan_pma3_sdo_cmnplla_1 (o_ascan_pma3_sdo_cmnplla_1),
.o_ascan_pma3_sdo_cmnpllb_1 (o_ascan_pma3_sdo_cmnpllb_1),
...
.o_ascan_pma3_sdo_ctrl_l0_1 (o_ascan_pma3_sdo_ctrl_l0_1),
.o_ascan_pma3_sdo_memarray_word_l0_1 (o_ascan_pma3_sdo_memarray_word_l0_1),
.o_ascan_pma3_sdo_ref_l0_1 (o_ascan_pma3_sdo_ref_l0_1),
.o_ascan_pma3_sdo_word_l0_1 (o_ascan_pma3_sdo_word_l0_1),
.o_ascan_pma3_sdo_ref_channelleft_l0_1 (o_ascan_pma3_sdo_ref_channelleft_l0_1),
.o_ascan_pma3_sdo_ref_channelright_l0_1 (o_ascan_pma3_sdo_ref_channelright_l0_1),
.o_ascan_pma3_sdo_ref_txffe_l0_1 (o_ascan_pma3_sdo_ref_txffe_l0_1),
.o_ascan_pma3_sdo_word_txffe_l0_1 (o_ascan_pma3_sdo_word_txffe_l0_1),
.o_ascan_pma3_sdo_txpll_l0_1 (o_ascan_pma3_sdo_txpll_l0_1),				
...
.o_ascan_pma0_sdo_ref_cmn_2 (o_ascan_pma0_sdo_ref_cmn_2),
.o_ascan_pma0_sdo_apb_cmn_2 (o_ascan_pma0_sdo_apb_cmn_2),
.o_ascan_pma0_sdo_ref_channelcmn_2 (o_ascan_pma0_sdo_ref_channelcmn_2),
.o_ascan_pma0_sdo_cmnplla_2 (o_ascan_pma0_sdo_cmnplla_2),
.o_ascan_pma0_sdo_cmnpllb_2 (o_ascan_pma0_sdo_cmnpllb_2),
...
.o_ascan_pma0_sdo_ctrl_l0_2 (o_ascan_pma0_sdo_ctrl_l0_2),
.o_ascan_pma0_sdo_memarray_word_l0_2 (o_ascan_pma0_sdo_memarray_word_l0_2),
.o_ascan_pma0_sdo_ref_l0_2 (o_ascan_pma0_sdo_ref_l0_2),
.o_ascan_pma0_sdo_word_l0_2 (o_ascan_pma0_sdo_word_l0_2),
.o_ascan_pma0_sdo_ref_channelleft_l0_2 (o_ascan_pma0_sdo_ref_channelleft_l0_2),
.o_ascan_pma0_sdo_ref_channelright_l0_2 (o_ascan_pma0_sdo_ref_channelright_l0_2),
.o_ascan_pma0_sdo_ref_txffe_l0_2 (o_ascan_pma0_sdo_ref_txffe_l0_2),
.o_ascan_pma0_sdo_word_txffe_l0_2 (o_ascan_pma0_sdo_word_txffe_l0_2),
.o_ascan_pma0_sdo_txpll_l0_2 (o_ascan_pma0_sdo_txpll_l0_2),
...
.o_ascan_pma1_sdo_ref_cmn_2 (o_ascan_pma1_sdo_ref_cmn_2),
.o_ascan_pma1_sdo_apb_cmn_2 (o_ascan_pma1_sdo_apb_cmn_2),
.o_ascan_pma1_sdo_ref_channelcmn_2 (o_ascan_pma1_sdo_ref_channelcmn_2),
.o_ascan_pma1_sdo_cmnplla_2 (o_ascan_pma1_sdo_cmnplla_2),
.o_ascan_pma1_sdo_cmnpllb_2 (o_ascan_pma1_sdo_cmnpllb_2),
...
.o_ascan_pma1_sdo_ctrl_l0_2 (o_ascan_pma1_sdo_ctrl_l0_2),
.o_ascan_pma1_sdo_memarray_word_l0_2 (o_ascan_pma1_sdo_memarray_word_l0_2),
.o_ascan_pma1_sdo_ref_l0_2 (o_ascan_pma1_sdo_ref_l0_2),
.o_ascan_pma1_sdo_word_l0_2 (o_ascan_pma1_sdo_word_l0_2),
.o_ascan_pma1_sdo_ref_channelleft_l0_2 (o_ascan_pma1_sdo_ref_channelleft_l0_2),
.o_ascan_pma1_sdo_ref_channelright_l0_2 (o_ascan_pma1_sdo_ref_channelright_l0_2),
.o_ascan_pma1_sdo_ref_txffe_l0_2 (o_ascan_pma1_sdo_ref_txffe_l0_2),
.o_ascan_pma1_sdo_word_txffe_l0_2 (o_ascan_pma1_sdo_word_txffe_l0_2),
.o_ascan_pma1_sdo_txpll_l0_2 (o_ascan_pma1_sdo_txpll_l0_2),
...
.o_ascan_pma2_sdo_ref_cmn_2 (o_ascan_pma2_sdo_ref_cmn_2),
.o_ascan_pma2_sdo_apb_cmn_2 (o_ascan_pma2_sdo_apb_cmn_2),
.o_ascan_pma2_sdo_ref_channelcmn_2 (o_ascan_pma2_sdo_ref_channelcmn_2),
.o_ascan_pma2_sdo_cmnplla_2 (o_ascan_pma2_sdo_cmnplla_2),
.o_ascan_pma2_sdo_cmnpllb_2 (o_ascan_pma2_sdo_cmnpllb_2),
...
.o_ascan_pma2_sdo_ctrl_l0_2 (o_ascan_pma2_sdo_ctrl_l0_2),
.o_ascan_pma2_sdo_memarray_word_l0_2 (o_ascan_pma2_sdo_memarray_word_l0_2),
.o_ascan_pma2_sdo_ref_l0_2 (o_ascan_pma2_sdo_ref_l0_2),
.o_ascan_pma2_sdo_word_l0_2 (o_ascan_pma2_sdo_word_l0_2),
.o_ascan_pma2_sdo_ref_channelleft_l0_2 (o_ascan_pma2_sdo_ref_channelleft_l0_2),
.o_ascan_pma2_sdo_ref_channelright_l0_2 (o_ascan_pma2_sdo_ref_channelright_l0_2),
.o_ascan_pma2_sdo_ref_txffe_l0_2 (o_ascan_pma2_sdo_ref_txffe_l0_2),
.o_ascan_pma2_sdo_word_txffe_l0_2 (o_ascan_pma2_sdo_word_txffe_l0_2),
.o_ascan_pma2_sdo_txpll_l0_2 (o_ascan_pma2_sdo_txpll_l0_2),
...
.o_ascan_pma3_sdo_ref_cmn_2 (o_ascan_pma3_sdo_ref_cmn_2),
.o_ascan_pma3_sdo_apb_cmn_2 (o_ascan_pma3_sdo_apb_cmn_2),
.o_ascan_pma3_sdo_ref_channelcmn_2 (o_ascan_pma3_sdo_ref_channelcmn_2),
.o_ascan_pma3_sdo_cmnplla_2 (o_ascan_pma3_sdo_cmnplla_2),
.o_ascan_pma3_sdo_cmnpllb_2 (o_ascan_pma3_sdo_cmnpllb_2),
...
.o_ascan_pma3_sdo_ctrl_l0_2 (o_ascan_pma3_sdo_ctrl_l0_2),
.o_ascan_pma3_sdo_memarray_word_l0_2 (o_ascan_pma3_sdo_memarray_word_l0_2),
.o_ascan_pma3_sdo_ref_l0_2 (o_ascan_pma3_sdo_ref_l0_2),
.o_ascan_pma3_sdo_word_l0_2 (o_ascan_pma3_sdo_word_l0_2),
.o_ascan_pma3_sdo_ref_channelleft_l0_2 (o_ascan_pma3_sdo_ref_channelleft_l0_2),
.o_ascan_pma3_sdo_ref_channelright_l0_2 (o_ascan_pma3_sdo_ref_channelright_l0_2),
.o_ascan_pma3_sdo_ref_txffe_l0_2 (o_ascan_pma3_sdo_ref_txffe_l0_2),
.o_ascan_pma3_sdo_word_txffe_l0_2 (o_ascan_pma3_sdo_word_txffe_l0_2),
.o_ascan_pma3_sdo_txpll_l0_2 (o_ascan_pma3_sdo_txpll_l0_2),
...
.o_ascan_pma0_sdo_ref_cmn_3 (o_ascan_pma0_sdo_ref_cmn_3),
.o_ascan_pma0_sdo_apb_cmn_3 (o_ascan_pma0_sdo_apb_cmn_3),
.o_ascan_pma0_sdo_ref_channelcmn_3 (o_ascan_pma0_sdo_ref_channelcmn_3),
.o_ascan_pma0_sdo_cmnplla_3 (o_ascan_pma0_sdo_cmnplla_3),
.o_ascan_pma0_sdo_cmnpllb_3 (o_ascan_pma0_sdo_cmnpllb_3),
...
.o_ascan_pma0_sdo_ctrl_l0_3 (o_ascan_pma0_sdo_ctrl_l0_3),
.o_ascan_pma0_sdo_memarray_word_l0_3 (o_ascan_pma0_sdo_memarray_word_l0_3),
.o_ascan_pma0_sdo_ref_l0_3 (o_ascan_pma0_sdo_ref_l0_3),
.o_ascan_pma0_sdo_word_l0_3 (o_ascan_pma0_sdo_word_l0_3),
.o_ascan_pma0_sdo_ref_channelleft_l0_3 (o_ascan_pma0_sdo_ref_channelleft_l0_3),
.o_ascan_pma0_sdo_ref_channelright_l0_3 (o_ascan_pma0_sdo_ref_channelright_l0_3),
.o_ascan_pma0_sdo_ref_txffe_l0_3 (o_ascan_pma0_sdo_ref_txffe_l0_3),
.o_ascan_pma0_sdo_word_txffe_l0_3 (o_ascan_pma0_sdo_word_txffe_l0_3),
.o_ascan_pma0_sdo_txpll_l0_3 (o_ascan_pma0_sdo_txpll_l0_3),
...
.o_ascan_pma1_sdo_ref_cmn_3 (o_ascan_pma1_sdo_ref_cmn_3),
.o_ascan_pma1_sdo_apb_cmn_3 (o_ascan_pma1_sdo_apb_cmn_3),
.o_ascan_pma1_sdo_ref_channelcmn_3 (o_ascan_pma1_sdo_ref_channelcmn_3),
.o_ascan_pma1_sdo_cmnplla_3 (o_ascan_pma1_sdo_cmnplla_3),
.o_ascan_pma1_sdo_cmnpllb_3 (o_ascan_pma1_sdo_cmnpllb_3),
...
.o_ascan_pma1_sdo_ctrl_l0_3 (o_ascan_pma1_sdo_ctrl_l0_3),
.o_ascan_pma1_sdo_memarray_word_l0_3 (o_ascan_pma1_sdo_memarray_word_l0_3),
.o_ascan_pma1_sdo_ref_l0_3 (o_ascan_pma1_sdo_ref_l0_3),
.o_ascan_pma1_sdo_word_l0_3 (o_ascan_pma1_sdo_word_l0_3),
.o_ascan_pma1_sdo_ref_channelleft_l0_3 (o_ascan_pma1_sdo_ref_channelleft_l0_3),
.o_ascan_pma1_sdo_ref_channelright_l0_3 (o_ascan_pma1_sdo_ref_channelright_l0_3),
.o_ascan_pma1_sdo_ref_txffe_l0_3 (o_ascan_pma1_sdo_ref_txffe_l0_3),
.o_ascan_pma1_sdo_word_txffe_l0_3 (o_ascan_pma1_sdo_word_txffe_l0_3),
.o_ascan_pma1_sdo_txpll_l0_3 (o_ascan_pma1_sdo_txpll_l0_3),
...
.o_ascan_pma2_sdo_ref_cmn_3 (o_ascan_pma2_sdo_ref_cmn_3),
.o_ascan_pma2_sdo_apb_cmn_3 (o_ascan_pma2_sdo_apb_cmn_3),
.o_ascan_pma2_sdo_ref_channelcmn_3 (o_ascan_pma2_sdo_ref_channelcmn_3),
.o_ascan_pma2_sdo_cmnplla_3 (o_ascan_pma2_sdo_cmnplla_3),
.o_ascan_pma2_sdo_cmnpllb_3 (o_ascan_pma2_sdo_cmnpllb_3),
...
.o_ascan_pma2_sdo_ctrl_l0_3 (o_ascan_pma2_sdo_ctrl_l0_3),
.o_ascan_pma2_sdo_memarray_word_l0_3 (o_ascan_pma2_sdo_memarray_word_l0_3),
.o_ascan_pma2_sdo_ref_l0_3 (o_ascan_pma2_sdo_ref_l0_3),
.o_ascan_pma2_sdo_word_l0_3 (o_ascan_pma2_sdo_word_l0_3),
.o_ascan_pma2_sdo_ref_channelleft_l0_3 (o_ascan_pma2_sdo_ref_channelleft_l0_3),
.o_ascan_pma2_sdo_ref_channelright_l0_3 (o_ascan_pma2_sdo_ref_channelright_l0_3),
.o_ascan_pma2_sdo_ref_txffe_l0_3 (o_ascan_pma2_sdo_ref_txffe_l0_3),
.o_ascan_pma2_sdo_word_txffe_l0_3 (o_ascan_pma2_sdo_word_txffe_l0_3),
.o_ascan_pma2_sdo_txpll_l0_3 (o_ascan_pma2_sdo_txpll_l0_3),
...
.o_ascan_pma3_sdo_ref_cmn_3 (o_ascan_pma3_sdo_ref_cmn_3),
.o_ascan_pma3_sdo_apb_cmn_3 (o_ascan_pma3_sdo_apb_cmn_3),
.o_ascan_pma3_sdo_ref_channelcmn_3 (o_ascan_pma3_sdo_ref_channelcmn_3),
.o_ascan_pma3_sdo_cmnplla_3 (o_ascan_pma3_sdo_cmnplla_3),
.o_ascan_pma3_sdo_cmnpllb_3 (o_ascan_pma3_sdo_cmnpllb_3),
...
.o_ascan_pma3_sdo_ctrl_l0_3 (o_ascan_pma3_sdo_ctrl_l0_3),
.o_ascan_pma3_sdo_memarray_word_l0_3 (o_ascan_pma3_sdo_memarray_word_l0_3),
.o_ascan_pma3_sdo_ref_l0_3 (o_ascan_pma3_sdo_ref_l0_3),
.o_ascan_pma3_sdo_word_l0_3 (o_ascan_pma3_sdo_word_l0_3),
.o_ascan_pma3_sdo_ref_channelleft_l0_3 (o_ascan_pma3_sdo_ref_channelleft_l0_3),
.o_ascan_pma3_sdo_ref_channelright_l0_3 (o_ascan_pma3_sdo_ref_channelright_l0_3),
.o_ascan_pma3_sdo_ref_txffe_l0_3 (o_ascan_pma3_sdo_ref_txffe_l0_3),
.o_ascan_pma3_sdo_word_txffe_l0_3 (o_ascan_pma3_sdo_word_txffe_l0_3),
.o_ascan_pma3_sdo_txpll_l0_3 (o_ascan_pma3_sdo_txpll_l0_3),
...
.o_scanio_pma0_dat_ref0_n_a_0 (o_scanio_pma0_dat_ref0_n_a_0),
.o_scanio_pma0_dat_ref0_p_a_0 (o_scanio_pma0_dat_ref0_p_a_0),
.o_scanio_pma0_dat_ref1_n_a_0 (o_scanio_pma0_dat_ref1_n_a_0),
.o_scanio_pma0_dat_ref1_p_a_0 (o_scanio_pma0_dat_ref1_p_a_0),
.o_scanio_pma0_dat_rx_n_l0_a_0 (o_scanio_pma0_dat_rx_n_l0_a_0),
.o_scanio_pma0_dat_rx_p_l0_a_0 (o_scanio_pma0_dat_rx_p_l0_a_0),
...
.o_scanio_pma1_dat_ref0_n_a_0 (o_scanio_pma1_dat_ref0_n_a_0),
.o_scanio_pma1_dat_ref0_p_a_0 (o_scanio_pma1_dat_ref0_p_a_0),
.o_scanio_pma1_dat_ref1_n_a_0 (o_scanio_pma1_dat_ref1_n_a_0),
.o_scanio_pma1_dat_ref1_p_a_0 (o_scanio_pma1_dat_ref1_p_a_0),
.o_scanio_pma1_dat_rx_n_l0_a_0 (o_scanio_pma1_dat_rx_n_l0_a_0),
.o_scanio_pma1_dat_rx_p_l0_a_0 (o_scanio_pma1_dat_rx_p_l0_a_0),
...
.o_scanio_pma2_dat_ref0_n_a_0 (o_scanio_pma2_dat_ref0_n_a_0),
.o_scanio_pma2_dat_ref0_p_a_0 (o_scanio_pma2_dat_ref0_p_a_0),
.o_scanio_pma2_dat_ref1_n_a_0 (o_scanio_pma2_dat_ref1_n_a_0),
.o_scanio_pma2_dat_ref1_p_a_0 (o_scanio_pma2_dat_ref1_p_a_0),
.o_scanio_pma2_dat_rx_n_l0_a_0 (o_scanio_pma2_dat_rx_n_l0_a_0),
.o_scanio_pma2_dat_rx_p_l0_a_0 (o_scanio_pma2_dat_rx_p_l0_a_0),
...
.o_scanio_pma3_dat_ref0_n_a_0 (o_scanio_pma3_dat_ref0_n_a_0),
.o_scanio_pma3_dat_ref0_p_a_0 (o_scanio_pma3_dat_ref0_p_a_0),
.o_scanio_pma3_dat_ref1_n_a_0 (o_scanio_pma3_dat_ref1_n_a_0),
.o_scanio_pma3_dat_ref1_p_a_0 (o_scanio_pma3_dat_ref1_p_a_0),
.o_scanio_pma3_dat_rx_n_l0_a_0 (o_scanio_pma3_dat_rx_n_l0_a_0),
.o_scanio_pma3_dat_rx_p_l0_a_0 (o_scanio_pma3_dat_rx_p_l0_a_0),
...
.o_scanio_pma0_dat_ref0_n_a_1 (o_scanio_pma0_dat_ref0_n_a_1),
.o_scanio_pma0_dat_ref0_p_a_1 (o_scanio_pma0_dat_ref0_p_a_1),
.o_scanio_pma0_dat_ref1_n_a_1 (o_scanio_pma0_dat_ref1_n_a_1),
.o_scanio_pma0_dat_ref1_p_a_1 (o_scanio_pma0_dat_ref1_p_a_1),
.o_scanio_pma0_dat_rx_n_l0_a_1 (o_scanio_pma0_dat_rx_n_l0_a_1),
.o_scanio_pma0_dat_rx_p_l0_a_1 (o_scanio_pma0_dat_rx_p_l0_a_1),
...
.o_scanio_pma1_dat_ref0_n_a_1 (o_scanio_pma1_dat_ref0_n_a_1),
.o_scanio_pma1_dat_ref0_p_a_1 (o_scanio_pma1_dat_ref0_p_a_1),
.o_scanio_pma1_dat_ref1_n_a_1 (o_scanio_pma1_dat_ref1_n_a_1),
.o_scanio_pma1_dat_ref1_p_a_1 (o_scanio_pma1_dat_ref1_p_a_1),
.o_scanio_pma1_dat_rx_n_l0_a_1 (o_scanio_pma1_dat_rx_n_l0_a_1),
.o_scanio_pma1_dat_rx_p_l0_a_1 (o_scanio_pma1_dat_rx_p_l0_a_1),
...
.o_scanio_pma2_dat_ref0_n_a_1 (o_scanio_pma2_dat_ref0_n_a_1),
.o_scanio_pma2_dat_ref0_p_a_1 (o_scanio_pma2_dat_ref0_p_a_1),
.o_scanio_pma2_dat_ref1_n_a_1 (o_scanio_pma2_dat_ref1_n_a_1),
.o_scanio_pma2_dat_ref1_p_a_1 (o_scanio_pma2_dat_ref1_p_a_1),
.o_scanio_pma2_dat_rx_n_l0_a_1 (o_scanio_pma2_dat_rx_n_l0_a_1),
.o_scanio_pma2_dat_rx_p_l0_a_1 (o_scanio_pma2_dat_rx_p_l0_a_1),
...
.o_scanio_pma3_dat_ref0_n_a_1 (o_scanio_pma3_dat_ref0_n_a_1),
.o_scanio_pma3_dat_ref0_p_a_1 (o_scanio_pma3_dat_ref0_p_a_1),
.o_scanio_pma3_dat_ref1_n_a_1 (o_scanio_pma3_dat_ref1_n_a_1),
.o_scanio_pma3_dat_ref1_p_a_1 (o_scanio_pma3_dat_ref1_p_a_1),
...
.o_scanio_pma0_dat_ref0_n_a_2          (o_scanio_pma0_dat_ref0_n_a_2),
.o_scanio_pma0_dat_ref0_p_a_2          (o_scanio_pma0_dat_ref0_p_a_2),
.o_scanio_pma0_dat_ref1_n_a_2          (o_scanio_pma0_dat_ref1_n_a_2),
.o_scanio_pma0_dat_ref1_p_a_2          (o_scanio_pma0_dat_ref1_p_a_2),
.o_scanio_pma0_dat_rx_n_l0_a_2         (o_scanio_pma0_dat_rx_n_l0_a_2),
.o_scanio_pma0_dat_rx_p_l0_a_2         (o_scanio_pma0_dat_rx_p_l0_a_2),
...
.o_scanio_pma1_dat_ref0_n_a_2          (o_scanio_pma1_dat_ref0_n_a_2),
.o_scanio_pma1_dat_ref0_p_a_2          (o_scanio_pma1_dat_ref0_p_a_2),
.o_scanio_pma1_dat_ref1_n_a_2          (o_scanio_pma1_dat_ref1_n_a_2),
.o_scanio_pma1_dat_ref1_p_a_2          (o_scanio_pma1_dat_ref1_p_a_2),
.o_scanio_pma1_dat_rx_n_l0_a_2         (o_scanio_pma1_dat_rx_n_l0_a_2),
.o_scanio_pma1_dat_rx_p_l0_a_2         (o_scanio_pma1_dat_rx_p_l0_a_2),
...
.o_scanio_pma2_dat_ref0_n_a_2          (o_scanio_pma2_dat_ref0_n_a_2),
.o_scanio_pma2_dat_ref0_p_a_2          (o_scanio_pma2_dat_ref0_p_a_2),
.o_scanio_pma2_dat_ref1_n_a_2          (o_scanio_pma2_dat_ref1_n_a_2),
.o_scanio_pma2_dat_ref1_p_a_2          (o_scanio_pma2_dat_ref1_p_a_2),
.o_scanio_pma2_dat_rx_n_l0_a_2         (o_scanio_pma2_dat_rx_n_l0_a_2),
.o_scanio_pma2_dat_rx_p_l0_a_2         (o_scanio_pma2_dat_rx_p_l0_a_2),
...
.o_scanio_pma3_dat_ref0_n_a_2          (o_scanio_pma3_dat_ref0_n_a_2),
.o_scanio_pma3_dat_ref0_p_a_2          (o_scanio_pma3_dat_ref0_p_a_2),
.o_scanio_pma3_dat_ref1_n_a_2          (o_scanio_pma3_dat_ref1_n_a_2),
.o_scanio_pma3_dat_ref1_p_a_2          (o_scanio_pma3_dat_ref1_p_a_2),
.o_scanio_pma3_dat_rx_n_l0_a_2         (o_scanio_pma3_dat_rx_n_l0_a_2),
.o_scanio_pma3_dat_rx_p_l0_a_2         (o_scanio_pma3_dat_rx_p_l0_a_2),
...
.o_scanio_pma0_dat_ref0_n_a_3          (o_scanio_pma0_dat_ref0_n_a_3),
.o_scanio_pma0_dat_ref0_p_a_3          (o_scanio_pma0_dat_ref0_p_a_3),
.o_scanio_pma0_dat_ref1_n_a_3          (o_scanio_pma0_dat_ref1_n_a_3),
.o_scanio_pma0_dat_ref1_p_a_3          (o_scanio_pma0_dat_ref1_p_a_3),
.o_scanio_pma0_dat_rx_n_l0_a_3         (o_scanio_pma0_dat_rx_n_l0_a_3),
.o_scanio_pma0_dat_rx_p_l0_a_3         (o_scanio_pma0_dat_rx_p_l0_a_3),
...
.o_scanio_pma1_dat_ref0_n_a_3          (o_scanio_pma1_dat_ref0_n_a_3),
.o_scanio_pma1_dat_ref0_p_a_3          (o_scanio_pma1_dat_ref0_p_a_3),
.o_scanio_pma1_dat_ref1_n_a_3          (o_scanio_pma1_dat_ref1_n_a_3),
.o_scanio_pma1_dat_ref1_p_a_3          (o_scanio_pma1_dat_ref1_p_a_3),
.o_scanio_pma1_dat_rx_n_l0_a_3         (o_scanio_pma1_dat_rx_n_l0_a_3),
.o_scanio_pma1_dat_rx_p_l0_a_3         (o_scanio_pma1_dat_rx_p_l0_a_3),
...
.o_scanio_pma2_dat_ref0_n_a_3          (o_scanio_pma2_dat_ref0_n_a_3),
.o_scanio_pma2_dat_ref0_p_a_3          (o_scanio_pma2_dat_ref0_p_a_3),
.o_scanio_pma2_dat_ref1_n_a_3          (o_scanio_pma2_dat_ref1_n_a_3),
.o_scanio_pma2_dat_ref1_p_a_3          (o_scanio_pma2_dat_ref1_p_a_3),
.o_scanio_pma2_dat_rx_n_l0_a_3         (o_scanio_pma2_dat_rx_n_l0_a_3),
.o_scanio_pma2_dat_rx_p_l0_a_3         (o_scanio_pma2_dat_rx_p_l0_a_3),
...
.o_scanio_pma3_dat_ref0_n_a_3          (o_scanio_pma3_dat_ref0_n_a_3),
.o_scanio_pma3_dat_ref0_p_a_3          (o_scanio_pma3_dat_ref0_p_a_3),
.o_scanio_pma3_dat_ref1_n_a_3          (o_scanio_pma3_dat_ref1_n_a_3),
.o_scanio_pma3_dat_ref1_p_a_3          (o_scanio_pma3_dat_ref1_p_a_3),
.o_scanio_pma3_dat_rx_n_l0_a_3         (o_scanio_pma3_dat_rx_n_l0_a_3),
.o_scanio_pma3_dat_rx_p_l0_a_3         (o_scanio_pma3_dat_rx_p_l0_a_3),
...
.o_dfx_upm_pma0_so_0                  (o_dfx_upm_pma0_so_0),
...
.o_dfx_upm_pma1_so_0                  (o_dfx_upm_pma1_so_0),
...
.o_dfx_upm_pma2_so_0                  (o_dfx_upm_pma2_so_0),
...
.o_dfx_upm_pma3_so_0                  (o_dfx_upm_pma3_so_0),
...
.o_dfx_upm_pma0_so_1                  (o_dfx_upm_pma0_so_1),
...
.o_dfx_upm_pma1_so_1                  (o_dfx_upm_pma1_so_1),
...
.o_dfx_upm_pma2_so_1                  (o_dfx_upm_pma2_so_1),
...
.o_dfx_upm_pma3_so_1                  (o_dfx_upm_pma3_so_1),
...
.o_dfx_upm_pma0_so_2                  (o_dfx_upm_pma0_so_2),
...
.o_dfx_upm_pma1_so_2                  (o_dfx_upm_pma1_so_2),
...
.o_dfx_upm_pma2_so_2                  (o_dfx_upm_pma2_so_2),
...
.o_dfx_upm_pma3_so_2                  (o_dfx_upm_pma3_so_2),
...
.o_dfx_upm_pma0_so_3                  (o_dfx_upm_pma0_so_3),
...
.o_dfx_upm_pma1_so_3                  (o_dfx_upm_pma1_so_3),
...
.o_dfx_upm_pma2_so_3                  (o_dfx_upm_pma2_so_3),
...
.o_dfx_upm_pma3_so_3                  (o_dfx_upm_pma3_so_3),
.i_ck_dfx_upm_pma3_clk_debug_3        (i_ck_dfx_upm_pma3_clk_debug_3),
.i_dfx_upm_pma3_iso_b_3               (i_dfx_upm_pma3_iso_b_3),
.mac100_0_int    (mac100_0_int),
.pcs100_0_int    (pcs100_0_int),
.mac100_1_int    (mac100_1_int),
.pcs100_1_int    (pcs100_1_int),
.mac100_2_int    (mac100_2_int),
.pcs100_2_int    (pcs100_2_int),
.mac100_3_int    (mac100_3_int),
.pcs100_3_int    (pcs100_3_int),
.physs_ts_int    (physs_ts_int) 
);
assign physs_bbl.physs0.mquad0.pcs100_wrap_0.quadpcs100_0.U_PCS_TOP.U_SGMII4x_USXGMII4x_INST.U_SGMII_10B_0.clk_eth_ref_125mhz = clk_125mhz;
assign physs_bbl.physs0.mquad0.pcs100_wrap_0.quadpcs100_0.U_PCS_TOP.U_SGMII4x_USXGMII4x_INST.U_SGMII_10B_0.i_reset = i_reset;
assign physs_bbl.physs0.mquad0.pcs100_wrap_0.quadpcs100_0.U_PCS_TOP.U_SGMII4x_USXGMII4x_INST.U_SGMII_10B_0.rx_serial_data = rx_serial_data;
assign physs_bbl.physs0.mquad0.pcs100_wrap_0.quadpcs100_0.U_PCS_TOP.U_SGMII4x_USXGMII4x_INST.U_SGMII_10B_0.tx_serial_data = tx_serial_data;
assign physs_bbl.physs0.mquad0.pcs100_wrap_0.quadpcs100_0.U_PCS_TOP.U_SGMII4x_USXGMII4x_INST.U_SGMII_10B_0.tx_clk = soc_per_clk;
assign physs_bbl.physs0.mquad0.pcs100_wrap_0.quadpcs100_0.U_PCS_TOP.U_SGMII4x_USXGMII4x_INST.U_SGMII_10B_0.rx_clk = soc_per_clk;
//assign physs_bbl.soc_per_clk = soc_per_clk;
//assign physs_bbl.physs0.physs_func_rst_raw_n = i_reset;
//assign physs_bbl.physs0.soc_per_clk = soc_per_clk;
//assign physs_bbl.physs_func_rst_raw_n = i_reset;
