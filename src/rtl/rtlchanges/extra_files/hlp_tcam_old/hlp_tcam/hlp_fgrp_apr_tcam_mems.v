...
input wire core_rst_b);
  ...
  wire hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_mbist_inst_so, 
       hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sti_inst_so, 
       hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sri_ctrl_inst_so, 
       hlp_fgrp_apr_tcam_mems_rtl_tessent_tdr_sri_ctrl_inst_so, 
       hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sri_inst_to_select, 
       hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sti_inst_so_ts1, 
       hlp_fgrp_apr_tcam_mems_rtl_tessent_tdr_TCAM_c1_algo_select_tdr_inst_so, 
       hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sti_inst_to_select, 
       hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst_so, 
       hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sri_ctrl_inst_to_select, 
       hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst_to_select, 
       ...
       MEM31_BIST_COLLAR_SI, MBISTPG_SO, BIST_SO, BIST_SO_ts1, BIST_SO_ts2, 
       ...
       BIST_SO_ts28, BIST_SO_ts29, BIST_SO_ts30, BIST_SO_ts31, MBISTPG_DONE, 
       MBISTPG_GO, BIST_GO, BIST_GO_ts1, BIST_GO_ts2, BIST_GO_ts3, BIST_GO_ts4, 
       BIST_GO_ts5, BIST_GO_ts6, BIST_GO_ts7, BIST_GO_ts8, BIST_GO_ts9, 
       BIST_GO_ts10, BIST_GO_ts11, BIST_GO_ts12, BIST_GO_ts13, BIST_GO_ts14, 
       BIST_GO_ts15, BIST_GO_ts16, BIST_GO_ts17, BIST_GO_ts18, BIST_GO_ts19, 
       BIST_GO_ts20, BIST_GO_ts21, BIST_GO_ts22, BIST_GO_ts23, BIST_GO_ts24, 
       BIST_GO_ts25, BIST_GO_ts26, BIST_GO_ts27, BIST_GO_ts28, BIST_GO_ts29, 
       BIST_GO_ts30, BIST_GO_ts31, FL_CNT_MODE0, FL_CNT_MODE1, BIST_USER9, 
       ...
       BIST_READENABLE, BIST_SELECT, BIST_CMP, INCLUDE_MEM_RESULTS_REG, 
       BIST_COL_ADD, BIST_COLLAR_EN0, BIST_COLLAR_EN1, BIST_COLLAR_EN2, 
       BIST_COLLAR_EN3, BIST_COLLAR_EN4, BIST_COLLAR_EN5, BIST_COLLAR_EN6, 
       BIST_COLLAR_EN7, BIST_COLLAR_EN8, BIST_COLLAR_EN9, BIST_COLLAR_EN10, 
       BIST_COLLAR_EN11, BIST_COLLAR_EN12, BIST_COLLAR_EN13, BIST_COLLAR_EN14, 
       BIST_COLLAR_EN15, BIST_COLLAR_EN16, BIST_COLLAR_EN17, BIST_COLLAR_EN18, 
       BIST_COLLAR_EN19, BIST_COLLAR_EN20, BIST_COLLAR_EN21, BIST_COLLAR_EN22, 
       BIST_COLLAR_EN23, BIST_COLLAR_EN24, BIST_COLLAR_EN25, BIST_COLLAR_EN26, 
       BIST_COLLAR_EN27, BIST_COLLAR_EN28, BIST_COLLAR_EN29, BIST_COLLAR_EN30, 
       BIST_COLLAR_EN31, BIST_RUN_TO_COLLAR0, BIST_RUN_TO_COLLAR1, 
       BIST_RUN_TO_COLLAR2, BIST_RUN_TO_COLLAR3, BIST_RUN_TO_COLLAR4, 
       ...
       hlp_fgrp_apr_tcam_mems_rtl_tessent_mbist_bap_inst_so, clk_ts1, 
       tck_select, MBISTPG_STABLE, ijtag_so, bisr_so_pd_vinf_ts1, trigger_post, 
...
hlp_fgrp_tcam_mems  fgrp_tcam_mems(
        .DFTMASK(DFTMASK),
        ...
        .fgrp_ffu_tcam_0_to_tcam(fgrp_ffu_tcam_0_to_tcam),
        .fgrp_ffu_tcam_10_to_tcam(fgrp_ffu_tcam_10_to_tcam),
        .fgrp_ffu_tcam_11_to_tcam(fgrp_ffu_tcam_11_to_tcam),
        .fgrp_ffu_tcam_12_to_tcam(fgrp_ffu_tcam_12_to_tcam),
        .fgrp_ffu_tcam_13_to_tcam(fgrp_ffu_tcam_13_to_tcam),
        .fgrp_ffu_tcam_14_to_tcam(fgrp_ffu_tcam_14_to_tcam),
        .fgrp_ffu_tcam_15_to_tcam(fgrp_ffu_tcam_15_to_tcam),
        .fgrp_ffu_tcam_16_to_tcam(fgrp_ffu_tcam_16_to_tcam),
        .fgrp_ffu_tcam_17_to_tcam(fgrp_ffu_tcam_17_to_tcam),
        .fgrp_ffu_tcam_18_to_tcam(fgrp_ffu_tcam_18_to_tcam),
        .fgrp_ffu_tcam_19_to_tcam(fgrp_ffu_tcam_19_to_tcam),
        .fgrp_ffu_tcam_1_to_tcam(fgrp_ffu_tcam_1_to_tcam),
        .fgrp_ffu_tcam_20_to_tcam(fgrp_ffu_tcam_20_to_tcam),
        .fgrp_ffu_tcam_21_to_tcam(fgrp_ffu_tcam_21_to_tcam),
        .fgrp_ffu_tcam_22_to_tcam(fgrp_ffu_tcam_22_to_tcam),
        .fgrp_ffu_tcam_23_to_tcam(fgrp_ffu_tcam_23_to_tcam),
        .fgrp_ffu_tcam_24_to_tcam(fgrp_ffu_tcam_24_to_tcam),
        .fgrp_ffu_tcam_25_to_tcam(fgrp_ffu_tcam_25_to_tcam),
        .fgrp_ffu_tcam_26_to_tcam(fgrp_ffu_tcam_26_to_tcam),
        .fgrp_ffu_tcam_27_to_tcam(fgrp_ffu_tcam_27_to_tcam),
        .fgrp_ffu_tcam_28_to_tcam(fgrp_ffu_tcam_28_to_tcam),
        .fgrp_ffu_tcam_29_to_tcam(fgrp_ffu_tcam_29_to_tcam),
        .fgrp_ffu_tcam_2_to_tcam(fgrp_ffu_tcam_2_to_tcam),
        .fgrp_ffu_tcam_30_to_tcam(fgrp_ffu_tcam_30_to_tcam),
        .fgrp_ffu_tcam_31_to_tcam(fgrp_ffu_tcam_31_to_tcam),
        .fgrp_ffu_tcam_3_to_tcam(fgrp_ffu_tcam_3_to_tcam),
        .fgrp_ffu_tcam_4_to_tcam(fgrp_ffu_tcam_4_to_tcam),
        .fgrp_ffu_tcam_5_to_tcam(fgrp_ffu_tcam_5_to_tcam),
        .fgrp_ffu_tcam_6_to_tcam(fgrp_ffu_tcam_6_to_tcam),
        .fgrp_ffu_tcam_7_to_tcam(fgrp_ffu_tcam_7_to_tcam),
        .fgrp_ffu_tcam_8_to_tcam(fgrp_ffu_tcam_8_to_tcam),
        .fgrp_ffu_tcam_9_to_tcam(fgrp_ffu_tcam_9_to_tcam),
`ifdef HLP_FPGA_TCAM_MEMS
...
`endif
        ...
        .fgrp_ffu_tcam_0_from_tcam(fgrp_ffu_tcam_0_from_tcam),
        .fgrp_ffu_tcam_10_from_tcam(fgrp_ffu_tcam_10_from_tcam),
        .fgrp_ffu_tcam_11_from_tcam(fgrp_ffu_tcam_11_from_tcam),
        .fgrp_ffu_tcam_12_from_tcam(fgrp_ffu_tcam_12_from_tcam),
        .fgrp_ffu_tcam_13_from_tcam(fgrp_ffu_tcam_13_from_tcam),
        .fgrp_ffu_tcam_14_from_tcam(fgrp_ffu_tcam_14_from_tcam),
        .fgrp_ffu_tcam_15_from_tcam(fgrp_ffu_tcam_15_from_tcam),
        .fgrp_ffu_tcam_16_from_tcam(fgrp_ffu_tcam_16_from_tcam),
        .fgrp_ffu_tcam_17_from_tcam(fgrp_ffu_tcam_17_from_tcam),
        .fgrp_ffu_tcam_18_from_tcam(fgrp_ffu_tcam_18_from_tcam),
        .fgrp_ffu_tcam_19_from_tcam(fgrp_ffu_tcam_19_from_tcam),
        .fgrp_ffu_tcam_1_from_tcam(fgrp_ffu_tcam_1_from_tcam),
        .fgrp_ffu_tcam_20_from_tcam(fgrp_ffu_tcam_20_from_tcam),
        .fgrp_ffu_tcam_21_from_tcam(fgrp_ffu_tcam_21_from_tcam),
        .fgrp_ffu_tcam_22_from_tcam(fgrp_ffu_tcam_22_from_tcam),
        .fgrp_ffu_tcam_23_from_tcam(fgrp_ffu_tcam_23_from_tcam),
        .fgrp_ffu_tcam_24_from_tcam(fgrp_ffu_tcam_24_from_tcam),
        .fgrp_ffu_tcam_25_from_tcam(fgrp_ffu_tcam_25_from_tcam),
        .fgrp_ffu_tcam_26_from_tcam(fgrp_ffu_tcam_26_from_tcam),
        .fgrp_ffu_tcam_27_from_tcam(fgrp_ffu_tcam_27_from_tcam),
        .fgrp_ffu_tcam_28_from_tcam(fgrp_ffu_tcam_28_from_tcam),
        .fgrp_ffu_tcam_29_from_tcam(fgrp_ffu_tcam_29_from_tcam),
        .fgrp_ffu_tcam_2_from_tcam(fgrp_ffu_tcam_2_from_tcam),
        .fgrp_ffu_tcam_30_from_tcam(fgrp_ffu_tcam_30_from_tcam),
        .fgrp_ffu_tcam_31_from_tcam(fgrp_ffu_tcam_31_from_tcam),
        .fgrp_ffu_tcam_3_from_tcam(fgrp_ffu_tcam_3_from_tcam),
        .fgrp_ffu_tcam_4_from_tcam(fgrp_ffu_tcam_4_from_tcam),
        .fgrp_ffu_tcam_5_from_tcam(fgrp_ffu_tcam_5_from_tcam),
        .fgrp_ffu_tcam_6_from_tcam(fgrp_ffu_tcam_6_from_tcam),
        .fgrp_ffu_tcam_7_from_tcam(fgrp_ffu_tcam_7_from_tcam),
        .fgrp_ffu_tcam_8_from_tcam(fgrp_ffu_tcam_8_from_tcam),
        .fgrp_ffu_tcam_9_from_tcam(fgrp_ffu_tcam_9_from_tcam), .BIST_SETUP(BIST_SETUP[0]), 
                                   ...
                                   .BIST_SO_ts12(BIST_SO_ts12), .BIST_SO_ts13(BIST_SO_ts13), 
                                   .BIST_SO_ts14(BIST_SO_ts14), .BIST_SO_ts15(BIST_SO_ts15), 
                                   .BIST_SO_ts16(BIST_SO_ts16), .BIST_SO_ts17(BIST_SO_ts17), 
                                   .BIST_SO_ts18(BIST_SO_ts18), .BIST_SO_ts19(BIST_SO_ts19), 
                                   .BIST_SO_ts20(BIST_SO_ts20), .BIST_SO_ts21(BIST_SO_ts21), 
                                   .BIST_SO_ts22(BIST_SO_ts22), .BIST_SO_ts23(BIST_SO_ts23), 
                                   .BIST_SO_ts24(BIST_SO_ts24), .BIST_SO_ts25(BIST_SO_ts25), 
                                   .BIST_SO_ts26(BIST_SO_ts26), .BIST_SO_ts27(BIST_SO_ts27), 
                                   .BIST_SO_ts28(BIST_SO_ts28), .BIST_SO_ts29(BIST_SO_ts29), 
                                   .BIST_SO_ts30(BIST_SO_ts30), .BIST_SO_ts31(BIST_SO_ts31), 
                                   ...
                                   .BIST_GO_ts12(BIST_GO_ts12), .BIST_GO_ts13(BIST_GO_ts13), 
                                   .BIST_GO_ts14(BIST_GO_ts14), .BIST_GO_ts15(BIST_GO_ts15), 
                                   .BIST_GO_ts16(BIST_GO_ts16), .BIST_GO_ts17(BIST_GO_ts17), 
                                   .BIST_GO_ts18(BIST_GO_ts18), .BIST_GO_ts19(BIST_GO_ts19), 
                                   .BIST_GO_ts20(BIST_GO_ts20), .BIST_GO_ts21(BIST_GO_ts21), 
                                   .BIST_GO_ts22(BIST_GO_ts22), .BIST_GO_ts23(BIST_GO_ts23), 
                                   .BIST_GO_ts24(BIST_GO_ts24), .BIST_GO_ts25(BIST_GO_ts25), 
                                   .BIST_GO_ts26(BIST_GO_ts26), .BIST_GO_ts27(BIST_GO_ts27), 
                                   .BIST_GO_ts28(BIST_GO_ts28), .BIST_GO_ts29(BIST_GO_ts29), 
                                   .BIST_GO_ts30(BIST_GO_ts30), .BIST_GO_ts31(BIST_GO_ts31), 
                                   ...
                                   .tcam_row_0_col_0_bisr_inst_SO_ts31(bisr_so_pd_vinf)
);
...
// END_BOTTOM_LOGIC
  ...
  hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_1 hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sti_inst(
      ...
      .ijtag_tck(fary_ijtag_tck), .ijtag_so(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sti_inst_so), 
      .ijtag_from_so(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_mbist_inst_so), .ltest_si(1'b0), 
      ...
      .ijtag_to_tck(ijtag_to_tck), .ijtag_to_reset(ijtag_to_reset), .ijtag_to_si(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sti_inst_so_ts1), 
      ...
      .ijtag_to_sel(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sti_inst_to_select)
  );

  hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_2 hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sri_inst(
      .ijtag_reset(fary_ijtag_rst_b), .ijtag_sel(fary_ijtag_select), .ijtag_si(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sti_inst_so), 
      .ijtag_ce(fary_ijtag_capture), .ijtag_se(fary_ijtag_shift), .ijtag_ue(fary_ijtag_update), 
      .ijtag_tck(fary_ijtag_tck), .ijtag_so(aary_ijtag_so), .ijtag_from_so(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sri_ctrl_inst_so), 
      .ijtag_to_sel(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sri_inst_to_select)
  );

  hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_3 hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sri_ctrl_inst(
      .ijtag_reset(fary_ijtag_rst_b), .ijtag_sel(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sri_inst_to_select), 
      .ijtag_si(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sti_inst_so), .ijtag_ce(fary_ijtag_capture), 
      .ijtag_se(fary_ijtag_shift), .ijtag_ue(fary_ijtag_update), .ijtag_tck(fary_ijtag_tck), 
      .ijtag_so(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sri_ctrl_inst_so), .ijtag_from_so(hlp_fgrp_apr_tcam_mems_rtl_tessent_tdr_sri_ctrl_inst_so), 
      .ijtag_to_sel(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sri_ctrl_inst_to_select)
  );

  hlp_fgrp_apr_tcam_mems_rtl_tessent_tdr_sri_ctrl hlp_fgrp_apr_tcam_mems_rtl_tessent_tdr_sri_ctrl_inst(
      .ijtag_reset(fary_ijtag_rst_b), .ijtag_sel(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sri_ctrl_inst_to_select), 
      .ijtag_si(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sti_inst_so), .ijtag_ce(fary_ijtag_capture), 
      .ijtag_se(fary_ijtag_shift), .ijtag_ue(fary_ijtag_update), .ijtag_tck(fary_ijtag_tck), 
      .tck_select(tck_select), .all_test(), .ijtag_so(hlp_fgrp_apr_tcam_mems_rtl_tessent_tdr_sri_ctrl_inst_so)
  );

  hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_4 hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst(
      .ijtag_reset(ijtag_to_reset), .ijtag_sel(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sti_inst_to_select), 
      .ijtag_si(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sti_inst_so_ts1), .ijtag_ce(ijtag_to_ce), 
      .ijtag_se(ijtag_to_se), .ijtag_ue(ijtag_to_ue), .ijtag_tck(ijtag_to_tck), 
      .ijtag_so(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst_so), 
      .ijtag_from_so(hlp_fgrp_apr_tcam_mems_rtl_tessent_tdr_TCAM_c1_algo_select_tdr_inst_so), 
      .ijtag_to_sel(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst_to_select)
  );

  hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_4 hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_mbist_inst(
      .ijtag_reset(ijtag_to_reset), .ijtag_sel(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sti_inst_to_select), 
      .ijtag_si(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst_so), 
      .ijtag_ce(ijtag_to_ce), .ijtag_se(ijtag_to_se), .ijtag_ue(ijtag_to_ue), .ijtag_tck(ijtag_to_tck), 
      .ijtag_so(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_mbist_inst_so), .ijtag_from_so(ijtag_so), 
      .ijtag_to_sel(ijtag_to_sel)
  );

  hlp_fgrp_apr_tcam_mems_rtl_tessent_tdr_TCAM_c1_algo_select_tdr hlp_fgrp_apr_tcam_mems_rtl_tessent_tdr_TCAM_c1_algo_select_tdr_inst(
      .ijtag_reset(ijtag_to_reset), .ijtag_sel(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst_to_select), 
      .ijtag_si(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_sti_inst_so_ts1), .ijtag_ce(ijtag_to_ce), 
      .ijtag_se(ijtag_to_se), .ijtag_ue(ijtag_to_ue), .ijtag_tck(ijtag_to_tck), 
      .ALGO_SEL_REG(ALGO_SEL_REG), .ijtag_so(hlp_fgrp_apr_tcam_mems_rtl_tessent_tdr_TCAM_c1_algo_select_tdr_inst_so)
  );

  hlp_fgrp_apr_tcam_mems_rtl_tessent_mbist_bap hlp_fgrp_apr_tcam_mems_rtl_tessent_mbist_bap_inst(
      .reset(ijtag_to_reset), .ijtag_select(ijtag_to_sel), .si(hlp_fgrp_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst_so), 
      ...
      .fromBist(MBISTPG_SO), .so(hlp_fgrp_apr_tcam_mems_rtl_tessent_mbist_bap_inst_so), 
      .fscan_clkungate(fscan_clkungate)
  );

  hlp_fgrp_apr_tcam_mems_rtl_tessent_mbist_TCAM_c1_controller hlp_fgrp_apr_tcam_mems_rtl_tessent_mbist_TCAM_c1_controller_inst(
      ...
      .MEM9_BIST_COLLAR_SO(BIST_SO_ts9), .MEM10_BIST_COLLAR_SO(BIST_SO_ts10), .MEM11_BIST_COLLAR_SO(BIST_SO_ts11), 
      .MEM12_BIST_COLLAR_SO(BIST_SO_ts12), .MEM13_BIST_COLLAR_SO(BIST_SO_ts13), 
      .MEM14_BIST_COLLAR_SO(BIST_SO_ts14), .MEM15_BIST_COLLAR_SO(BIST_SO_ts15), 
      .MEM16_BIST_COLLAR_SO(BIST_SO_ts16), .MEM17_BIST_COLLAR_SO(BIST_SO_ts17), 
      .MEM18_BIST_COLLAR_SO(BIST_SO_ts18), .MEM19_BIST_COLLAR_SO(BIST_SO_ts19), 
      .MEM20_BIST_COLLAR_SO(BIST_SO_ts20), .MEM21_BIST_COLLAR_SO(BIST_SO_ts21), 
      .MEM22_BIST_COLLAR_SO(BIST_SO_ts22), .MEM23_BIST_COLLAR_SO(BIST_SO_ts23), 
      .MEM24_BIST_COLLAR_SO(BIST_SO_ts24), .MEM25_BIST_COLLAR_SO(BIST_SO_ts25), 
      .MEM26_BIST_COLLAR_SO(BIST_SO_ts26), .MEM27_BIST_COLLAR_SO(BIST_SO_ts27), 
      .MEM28_BIST_COLLAR_SO(BIST_SO_ts28), .MEM29_BIST_COLLAR_SO(BIST_SO_ts29), 
      .MEM30_BIST_COLLAR_SO(BIST_SO_ts30), .MEM31_BIST_COLLAR_SO(BIST_SO_ts31), 
      ...
      BIST_GO_ts28, BIST_GO_ts27, BIST_GO_ts26, BIST_GO_ts25, BIST_GO_ts24, 
      BIST_GO_ts23, BIST_GO_ts22, BIST_GO_ts21, BIST_GO_ts20, BIST_GO_ts19, 
  ...
  TS_CLK_MUX tessent_persistent_cell_tck_mux_hlp_fgrp_apr_tcam_mems_rtl_clk_inst(
      .ck0(clk), .ck1(ijtag_to_tck), .s(tck_select), .o(clk_ts1)
  );

  hlp_fgrp_apr_tcam_mems_rtl_tessent_mbist_diagnosis_ready hlp_fgrp_apr_tcam_mems_rtl_tessent_mbist_diagnosis_ready_inst(
      .ijtag_reset(ijtag_to_reset), .ijtag_sel(ijtag_to_sel), .ijtag_si(hlp_fgrp_apr_tcam_mems_rtl_tessent_mbist_bap_inst_so), 
      .ijtag_ce(ijtag_to_ce), .ijtag_se(ijtag_to_se), .ijtag_ue(ijtag_to_ue), .ijtag_tck(ijtag_to_tck), 
