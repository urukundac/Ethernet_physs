...
// Module inputs
   ...
   input                                   [11:0] fary_ffuse_tune_tcam                    ,   
...
input wire core_rst_b);
  ...
  wire hlp_fwd_apr_tcam_mems_rtl_tessent_sib_mbist_inst_so, 
       hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sti_inst_so, 
       hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sri_ctrl_inst_so, 
       hlp_fwd_apr_tcam_mems_rtl_tessent_tdr_sri_ctrl_inst_so, 
       hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sri_inst_to_select, 
       hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sti_inst_so_ts1, 
       hlp_fwd_apr_tcam_mems_rtl_tessent_tdr_TCAM_c1_algo_select_tdr_inst_so, 
       hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sti_inst_to_select, 
       hlp_fwd_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst_so, 
       hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sri_ctrl_inst_to_select, 
       hlp_fwd_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst_to_select, 
       ijtag_to_reset, ijtag_to_se, ijtag_to_ce, ijtag_to_tck, ijtag_to_ue, 
       ...
       MEM7_BIST_COLLAR_SI, MBISTPG_SO, BIST_SO, BIST_SO_ts1, BIST_SO_ts2, 
       BIST_SO_ts3, BIST_SO_ts4, BIST_SO_ts5, BIST_SO_ts6, BIST_SO_ts7, 
       MBISTPG_DONE, MBISTPG_GO, BIST_GO, BIST_GO_ts1, BIST_GO_ts2, BIST_GO_ts3, 
       BIST_GO_ts4, BIST_GO_ts5, BIST_GO_ts6, BIST_GO_ts7, FL_CNT_MODE0, 
       FL_CNT_MODE1, BIST_USER9, BIST_USER10, BIST_USER11, BIST_USER0, 
       ...
       BIST_RUN_TO_COLLAR6, BIST_RUN_TO_COLLAR7, BIST_TESTDATA_SELECT_TO_COLLAR, 
       BIST_ON_TO_COLLAR, BIST_SHIFT_COLLAR, BIST_COLLAR_SETUP, 
       BIST_CLEAR_DEFAULT, BIST_CLEAR, BIST_COLLAR_OPSET_SELECT, 
       BIST_COLLAR_HOLD, FREEZE_STOP_ERROR, ERROR_CNT_ZERO, 
       MBISTPG_RESET_REG_SETUP2, 
       hlp_fwd_apr_tcam_mems_rtl_tessent_mbist_bap_inst_so, clk_ts1, tck_select, 
...
`endif
        ...
        .fwd_ma_table_tcam_3_from_tcam(fwd_ma_table_tcam_3_from_tcam), .BIST_SETUP(BIST_SETUP[0]), 
                                 .BIST_SETUP_ts1(BIST_SETUP[1]), 
                                 ...
                                 .tcam_row_1_col_0_bisr_inst_SO_ts3(bisr_so_pd_vinf)
);
...
// END_BOTTOM_LOGIC
  ...
  hlp_fwd_apr_tcam_mems_rtl_tessent_sib_1 hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sti_inst(
      ...
      .ijtag_tck(fary_ijtag_tck), .ijtag_so(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sti_inst_so), 
      .ijtag_from_so(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_mbist_inst_so), .ltest_si(1'b0), 
      ...
      .ijtag_to_tck(ijtag_to_tck), .ijtag_to_reset(ijtag_to_reset), .ijtag_to_si(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sti_inst_so_ts1), 
      ...
      .ijtag_to_sel(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sti_inst_to_select)
  );

  hlp_fwd_apr_tcam_mems_rtl_tessent_sib_2 hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sri_inst(
      .ijtag_reset(fary_ijtag_rst_b), .ijtag_sel(fary_ijtag_select), .ijtag_si(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sti_inst_so), 
      .ijtag_ce(fary_ijtag_capture), .ijtag_se(fary_ijtag_shift), .ijtag_ue(fary_ijtag_update), 
      .ijtag_tck(fary_ijtag_tck), .ijtag_so(aary_ijtag_so), .ijtag_from_so(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sri_ctrl_inst_so), 
      .ijtag_to_sel(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sri_inst_to_select)
  );

  hlp_fwd_apr_tcam_mems_rtl_tessent_sib_3 hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sri_ctrl_inst(
      .ijtag_reset(fary_ijtag_rst_b), .ijtag_sel(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sri_inst_to_select), 
      .ijtag_si(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sti_inst_so), .ijtag_ce(fary_ijtag_capture), 
      .ijtag_se(fary_ijtag_shift), .ijtag_ue(fary_ijtag_update), .ijtag_tck(fary_ijtag_tck), 
      .ijtag_so(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sri_ctrl_inst_so), .ijtag_from_so(hlp_fwd_apr_tcam_mems_rtl_tessent_tdr_sri_ctrl_inst_so), 
      .ijtag_to_sel(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sri_ctrl_inst_to_select)
  );

  hlp_fwd_apr_tcam_mems_rtl_tessent_tdr_sri_ctrl hlp_fwd_apr_tcam_mems_rtl_tessent_tdr_sri_ctrl_inst(
      .ijtag_reset(fary_ijtag_rst_b), .ijtag_sel(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sri_ctrl_inst_to_select), 
      .ijtag_si(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sti_inst_so), .ijtag_ce(fary_ijtag_capture), 
      .ijtag_se(fary_ijtag_shift), .ijtag_ue(fary_ijtag_update), .ijtag_tck(fary_ijtag_tck), 
      .tck_select(tck_select), .all_test(), .ijtag_so(hlp_fwd_apr_tcam_mems_rtl_tessent_tdr_sri_ctrl_inst_so)
  );

  hlp_fwd_apr_tcam_mems_rtl_tessent_sib_4 hlp_fwd_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst(
      .ijtag_reset(ijtag_to_reset), .ijtag_sel(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sti_inst_to_select), 
      .ijtag_si(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sti_inst_so_ts1), .ijtag_ce(ijtag_to_ce), 
      .ijtag_se(ijtag_to_se), .ijtag_ue(ijtag_to_ue), .ijtag_tck(ijtag_to_tck), 
      .ijtag_so(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst_so), 
      .ijtag_from_so(hlp_fwd_apr_tcam_mems_rtl_tessent_tdr_TCAM_c1_algo_select_tdr_inst_so), 
      .ijtag_to_sel(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst_to_select)
  );

  hlp_fwd_apr_tcam_mems_rtl_tessent_sib_4 hlp_fwd_apr_tcam_mems_rtl_tessent_sib_mbist_inst(
      .ijtag_reset(ijtag_to_reset), .ijtag_sel(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sti_inst_to_select), 
      .ijtag_si(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst_so), 
      .ijtag_ce(ijtag_to_ce), .ijtag_se(ijtag_to_se), .ijtag_ue(ijtag_to_ue), .ijtag_tck(ijtag_to_tck), 
      .ijtag_so(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_mbist_inst_so), .ijtag_from_so(ijtag_so), 
      .ijtag_to_sel(ijtag_to_sel)
  );

  hlp_fwd_apr_tcam_mems_rtl_tessent_tdr_TCAM_c1_algo_select_tdr hlp_fwd_apr_tcam_mems_rtl_tessent_tdr_TCAM_c1_algo_select_tdr_inst(
      .ijtag_reset(ijtag_to_reset), .ijtag_sel(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst_to_select), 
      .ijtag_si(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_sti_inst_so_ts1), .ijtag_ce(ijtag_to_ce), 
      .ijtag_se(ijtag_to_se), .ijtag_ue(ijtag_to_ue), .ijtag_tck(ijtag_to_tck), 
      .ALGO_SEL_REG(ALGO_SEL_REG), .ijtag_so(hlp_fwd_apr_tcam_mems_rtl_tessent_tdr_TCAM_c1_algo_select_tdr_inst_so)
  );

  hlp_fwd_apr_tcam_mems_rtl_tessent_mbist_bap hlp_fwd_apr_tcam_mems_rtl_tessent_mbist_bap_inst(
      .reset(ijtag_to_reset), .ijtag_select(ijtag_to_sel), .si(hlp_fwd_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst_so), 
      ...
      .fromBist(MBISTPG_SO), .so(hlp_fwd_apr_tcam_mems_rtl_tessent_mbist_bap_inst_so), 
      .fscan_clkungate(fscan_clkungate)
  );

  hlp_fwd_apr_tcam_mems_rtl_tessent_mbist_TCAM_c1_controller hlp_fwd_apr_tcam_mems_rtl_tessent_mbist_TCAM_c1_controller_inst(
      ...
      .MEM0_BIST_COLLAR_SO(BIST_SO), .MEM1_BIST_COLLAR_SO(BIST_SO_ts1), .MEM2_BIST_COLLAR_SO(BIST_SO_ts2), 
      .MEM3_BIST_COLLAR_SO(BIST_SO_ts3), .MEM4_BIST_COLLAR_SO(BIST_SO_ts4), .MEM5_BIST_COLLAR_SO(BIST_SO_ts5), 
      .MEM6_BIST_COLLAR_SO(BIST_SO_ts6), .MEM7_BIST_COLLAR_SO(BIST_SO_ts7), .FL_CNT_MODE({
      FL_CNT_MODE1, FL_CNT_MODE0}), .MBISTPG_BIRA_EN(BIRA_EN), .CHECK_REPAIR_NEEDED(CHECK_REPAIR_NEEDED), 
      .BIST_COLLAR_GO({BIST_GO_ts7, BIST_GO_ts3, BIST_GO_ts6, BIST_GO_ts2, 
      BIST_GO_ts5, BIST_GO_ts1, BIST_GO_ts4, BIST_GO}), .MBISTPG_DIAG_EN(BIST_DIAG_EN), 
      .BIST_CLK(clk_ts1), .BIST_SI(toBist), .BIST_HOLD(BIST_HOLD), .BIST_SETUP2(BIST_SETUP[2]), 
      .BIST_SETUP(BIST_SETUP[1:0]), .MBISTPG_TESTDATA_SELECT(BIST_SELECT_TEST_DATA), 
      .TCK(to_controllers_tck), .TCK_RETIME(to_controllers_tck_retime), .MBISTPG_EN(bistEn), 
  ...
  TS_CLK_MUX tessent_persistent_cell_tck_mux_hlp_fwd_apr_tcam_mems_rtl_clk_inst(
      .ck0(clk), .ck1(ijtag_to_tck), .s(tck_select), .o(clk_ts1)
  );

  hlp_fwd_apr_tcam_mems_rtl_tessent_mbist_diagnosis_ready hlp_fwd_apr_tcam_mems_rtl_tessent_mbist_diagnosis_ready_inst(
      .ijtag_reset(ijtag_to_reset), .ijtag_sel(ijtag_to_sel), .ijtag_si(hlp_fwd_apr_tcam_mems_rtl_tessent_mbist_bap_inst_so), 
      .ijtag_ce(ijtag_to_ce), .ijtag_se(ijtag_to_se), .ijtag_ue(ijtag_to_ue), .ijtag_tck(ijtag_to_tck), 
