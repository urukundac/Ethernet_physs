...
module  hlp_fwd_wrap_tcam_ma_table_tcam_shell_1024x35 #(
...
//clc        output        [*num_of_inst*-1:0]                      fscan_sout
        ...
        input wire MEM4_BIST_COLLAR_SI, output wire BIST_SO, 
        output wire BIST_SO_ts1, output wire BIST_GO, output wire BIST_GO_ts1, 
        ...
        input wire BIST_COL_ADD, input wire BIST_ROW_ADD, 
        input wire BIST_ROW_ADD_ts1, input wire BIST_ROW_ADD_ts2, 
        input wire BIST_ROW_ADD_ts3, input wire BIST_ROW_ADD_ts4, 
        input wire BIST_ROW_ADD_ts5, input wire BIST_ROW_ADD_ts6, 
        input wire BIST_BANK_ADD, input wire BIST_BANK_ADD_ts1, 
        input wire BIST_COLLAR_EN0, input wire BIST_COLLAR_EN4, 
        input wire BIST_RUN_TO_COLLAR0, input wire BIST_RUN_TO_COLLAR4, 
        input wire BIST_ASYNC_RESET, input wire BIST_TESTDATA_SELECT_TO_COLLAR, 
        input wire BIST_ON_TO_COLLAR, input wire BIST_WRITE_DATA, 
        input wire BIST_WRITE_DATA_ts1, input wire BIST_WRITE_DATA_ts2, 
        input wire BIST_WRITE_DATA_ts3, input wire BIST_WRITE_DATA_ts4, 
        input wire BIST_WRITE_DATA_ts5, input wire BIST_WRITE_DATA_ts6, 
        input wire BIST_WRITE_DATA_ts7, input wire BIST_WRITE_DATA_ts8, 
        input wire BIST_WRITE_DATA_ts9, input wire BIST_WRITE_DATA_ts10, 
        input wire BIST_WRITE_DATA_ts11, input wire BIST_WRITE_DATA_ts12, 
        input wire BIST_WRITE_DATA_ts13, input wire BIST_WRITE_DATA_ts14, 
        input wire BIST_WRITE_DATA_ts15, input wire BIST_WRITE_DATA_ts16, 
        input wire BIST_WRITE_DATA_ts17, input wire BIST_WRITE_DATA_ts18, 
        input wire BIST_WRITE_DATA_ts19, input wire BIST_WRITE_DATA_ts20, 
        input wire BIST_WRITE_DATA_ts21, input wire BIST_WRITE_DATA_ts22, 
        input wire BIST_WRITE_DATA_ts23, input wire BIST_WRITE_DATA_ts24, 
        input wire BIST_WRITE_DATA_ts25, input wire BIST_WRITE_DATA_ts26, 
        input wire BIST_WRITE_DATA_ts27, input wire BIST_WRITE_DATA_ts28, 
        input wire BIST_WRITE_DATA_ts29, input wire BIST_WRITE_DATA_ts30, 
        input wire BIST_WRITE_DATA_ts31, input wire BIST_EXPECT_DATA, 
        input wire BIST_EXPECT_DATA_ts1, input wire BIST_EXPECT_DATA_ts2, 
        input wire BIST_EXPECT_DATA_ts3, input wire BIST_EXPECT_DATA_ts4, 
        input wire BIST_EXPECT_DATA_ts5, input wire BIST_EXPECT_DATA_ts6, 
        input wire BIST_EXPECT_DATA_ts7, input wire BIST_EXPECT_DATA_ts8, 
        input wire BIST_EXPECT_DATA_ts9, input wire BIST_EXPECT_DATA_ts10, 
        input wire BIST_EXPECT_DATA_ts11, input wire BIST_EXPECT_DATA_ts12, 
        input wire BIST_EXPECT_DATA_ts13, input wire BIST_EXPECT_DATA_ts14, 
        input wire BIST_EXPECT_DATA_ts15, input wire BIST_EXPECT_DATA_ts16, 
        input wire BIST_EXPECT_DATA_ts17, input wire BIST_EXPECT_DATA_ts18, 
        input wire BIST_EXPECT_DATA_ts19, input wire BIST_EXPECT_DATA_ts20, 
        input wire BIST_EXPECT_DATA_ts21, input wire BIST_EXPECT_DATA_ts22, 
        input wire BIST_EXPECT_DATA_ts23, input wire BIST_EXPECT_DATA_ts24, 
        input wire BIST_EXPECT_DATA_ts25, input wire BIST_EXPECT_DATA_ts26, 
        input wire BIST_EXPECT_DATA_ts27, input wire BIST_EXPECT_DATA_ts28, 
        input wire BIST_EXPECT_DATA_ts29, input wire BIST_EXPECT_DATA_ts30, 
        input wire BIST_EXPECT_DATA_ts31, input wire BIST_SHIFT_COLLAR, 
        ...
        output wire tcam_row_1_col_0_bisr_inst_SO, input wire DFTSHIFTEN_ts1, 
        input wire DFTSHIFTEN_ts2);
...
// Disassembling the to_tcam bus
  ...
  wire [39:0] TMASK, TMASK_ts1;
  wire [9:0] TADR, TADR_ts1;
  wire [39:0] DIN, DIN_ts1, TDIN, TDIN_ts1;
  wire [6:0] tcam_row_0_col_0_bisr_inst_Q, tcam_row_1_col_0_bisr_inst_Q;
  wire FLS, FLS_ts1, TVBE, TVBE_ts1, TVBI, TVBI_ts1, BISTE, BISTE_ts1, 
       BIST_CM_MODE, BIST_CM_MODE_ts1, BIST_CM_EN_IN, BIST_CM_EN_IN_ts1, 
       BIST_CM_MATCH_SEL0, BIST_CM_MATCH_SEL0_ts1, BIST_CM_MATCH_SEL1, 
       BIST_CM_MATCH_SEL1_ts1, BIST_ROTATE_SR, BIST_ROTATE_SR_ts1, 
       BIST_ALL_MASK, BIST_ALL_MASK_ts1, BIST_EN_SR_DATA_B, 
       BIST_EN_SR_DATA_B_ts1, BIST_EN_SR_MASK_B, BIST_EN_SR_MASK_B_ts1, 
       BIST_MATCHIN_IN, BIST_MATCHIN_IN_ts1, BIST_FLS, BIST_FLS_ts1, 
       tcam_row_0_col_0_interface_inst_WE, tcam_row_1_col_0_interface_inst_WE, 
       TWE, TWE_ts1, tcam_row_0_col_0_interface_inst_RE, 
       tcam_row_1_col_0_interface_inst_RE, TRE, TRE_ts1, 
       tcam_row_0_col_0_interface_inst_ME, tcam_row_1_col_0_interface_inst_ME, 
       TME, TME_ts1, tcam_row_0_col_0_bisr_inst_SO, All_SCOL0_ALLOC_REG, 
       All_SCOL0_ALLOC_REG_ts1;
...
`ifdef DC
        `ifndef HLP_FWD_ASIC_MEMS_EXCLUDE
                `define HLP_FWD_ASIC_MEMS
        `endif
`endif

        // Memories Implementation
`ifdef HLP_FWD_ASIC_MEMS      
...
localparam TCAM_SLICE_EN_MIN = TCAM_SLICE_EN_FACT < TCAM_SLICE_EN_WIDTH ? TCAM_SLICE_EN_FACT : TCAM_SLICE_EN_WIDTH;
    ...
    wire    [2-1:0]                tcam_row_sel;
    assign                    tcam_row_sel[0]        = ((adr>=11'd0) && (adr<11'd1024));
    assign                    tcam_row_sel[1]        = (adr>=11'd1024);


    // TCAM Address Decoder

    wire    [10-1:0]        tcam_row_adr[2-1:0];
    ...
    reg            rd_en_nope_done;
    reg    [2-1:0]    rd_en_delay_inst[TCAM_RD_DELAY:0];
    logic   [TCAM_RD_DELAY:0]               rd_en_delay;
    always_comb
         begin
        rd_en_delay_inst[0][2-1:0]        = tcam_row_rd_en[2-1:0];
    ...
    reg            wr_en_nope_done;
    reg    [2-1:0]    wr_en_delay_inst[TCAM_WR_DELAY:0];
    logic    [TCAM_WR_DELAY:0]               wr_en_delay;
    always_comb
         begin
        wr_en_delay_inst[0][2-1:0]        = tcam_row_wr_en[2-1:0];
    ...
    logic    [512-1:0]    tcam_raw_hit_in[2-1:0];
    always_comb begin
        for (int i = 0; i < 2; i = i + 1) begin
    ...
    logic    [40-1:0]    tcam_rd_data_col[2-1:0][1-1:0];
    logic    [40-1:0]    tcam_rd_data_row;
    always_comb begin
        for (int i = 0; i < 1; i = i + 1) begin
            tcam_rd_data_row[i*(40)+:40]        = tcam_rd_data_col[tcam_row_num_rd_en_delay[1-1:0]][i][40-1:0];
        end
    end
    ...
    logic    [512-1:0]    tcam_col_hit_out[2-1:0][1-1:0];
...
// Match In Array 
        ...
        logic    [512-1:0]      tcam_row_match_in[2-1:0];
        always_comb begin 
                for (int i = 0; i < 2; i = i + 1) begin
    ...
    // EBBs Instantiation
        ...
        wire    [40-1:0]                              tcam_row_0_col_0_mask_in = tcam_chk_mask_col[0][40-1:0]; // must be inverted // inverted back in DFT wrapper
        ...
        logic    [40-1:0]                              tcam_row_0_col_0_data_out_ff; // must delay data_out 1 cycle due to 1 cycle read within intel18A TCAM
        logic                                                    tcam_row_0_col_0_x_ybar_sel;
        
        logic  [40-1:0]                              tcam_row_0_col_0_data_in_inv;
        ...
        tcam_row_0_col_0  (       
                 ...
                 //-------------------------------------------------------------      
                    ...
                    .FAF           (tcam_row_0_col_0_bisr_inst_Q[6:1]), // column repair addres? --- > F means faulty
        ...
        assign          tcam_col_hit_out[0][0]       = tcam_row_0_col_0_hit_out; // DFT_WRP already delays this by one
        

        wire                                            tcam_row_1_col_0_clk         = clk;
        wire    [TCAM_ANALOG_TUNE_CONFG_WIDTH-1:0]       tcam_row_1_col_0_cfg = analog_tune_confg;
        wire    [8-1:0]                                  tcam_row_1_col_0_slice_en = slice_en[1+:8];
        ...
        wire    [40-1:0]                              tcam_row_1_col_0_mask_in = tcam_chk_mask_col[0][40-1:0]; // must be inverted // inverted back in DFT wrapper
        wire    [512-1:0]                               tcam_row_1_col_0_hit_in = tcam_raw_hit_in[1];
        wire    [40-1:0]                              tcam_row_1_col_0_data_out;
        wire    [512-1:0]                               tcam_row_1_col_0_hit_out;
        
        //needed for intel18A TCAM
        logic    [40-1:0]                              tcam_row_1_col_0_data_out_ff; // must delay data_out 1 cycle due to 1 cycle read within intel18A TCAM
        logic                                                    tcam_row_1_col_0_x_ybar_sel;
        
        logic  [40-1:0]                              tcam_row_1_col_0_data_in_inv;
        
        wire tcam_row_1_col_0_memen;
        wire tcam_row_1_col_0_dft_wrp_rst;
        
        assign tcam_row_1_col_0_data_in_inv = ~tcam_row_1_col_0_data_in; // must be inverted
        
        assign tcam_row_1_col_0_x_ybar_sel = ~tcam_row_1_col_0_adr[0:0]; // must be inverted
        
        
        assign tcam_row_1_col_0_memen = tcam_row_1_col_0_wr_en ^ tcam_row_1_col_0_rd_en; // disable mem if ren = 1 and wen = 1 and also wen ren = 0 and wen = 0;
        assign tcam_row_1_col_0_dft_wrp_rst = ~fary_output_reset; // changed in DFT wrp
        ...
        tcam_row_1_col_0  (       
                     ...
                     //------------------------------------------------------------
                       ...
                       .CLK                             (tcam_row_1_col_0_clk),
                       .DIN                             (DIN_ts1),
                       .RE                              (tcam_row_1_col_0_interface_inst_RE),
                       .WE                              (tcam_row_1_col_0_interface_inst_WE),
                       .ME                              (tcam_row_1_col_0_interface_inst_ME),
                       .MASK                            (tcam_row_1_col_0_mask_in),
                       .CMP                             (tcam_row_1_col_0_chk_en), //srchen
                       .ADR                             ({tcam_row_1_col_0_x_ybar_sel,tcam_row_1_col_0_adr[10-1:1]}), //reorder this because that's how they implemented it in dft_wrp
        
                       .VBI                               (1'b0), // dinvalidmask
                       .VBE                               (1'b1), // dinvalid
                       .RST                               (tcam_row_1_col_0_dft_wrp_rst), //output_reset 
                       .RVLD                              ('1), //matchin
                       .QOUT                              (tcam_row_1_col_0_data_out),
                       .QHR                               (tcam_row_1_col_0_hit_out),
                       .DSEL                              (tcam_row_1_col_0_x_ybar_sel), //x_ybar_sel
                       .FLS                               (FLS_ts1), //glbvalidbitrst
                       .QVLD                            (),
                  
                       //.RESET_N                          (tcam_row_1_col_0_reset_n),
                      //.FUNC_CM_SLICE_EN                 (tcam_row_1_col_0_slice_en),
                       //Test inputs
                       .TADR (TADR_ts1),
                       .TVBE(TVBE_ts1),
                       .TVBI (TVBI_ts1),
                       ...
                       .TME(TME_ts1),
                       .TDIN(TDIN_ts1),
                       .BISTE (BISTE_ts1), //TEST enable
        
                 //-------------------------------------------------------------
                 // Power Management Interfaces
                 //-------------------------------------------------------------      
                      //.PWR_MGMT_IN                      (tcam_fary_pwren_b[1]),
                      //.PWR_MGMT_OUT                     (tcam_aary_pwren_b[1]),
                      `ifndef INTEL_NO_PWR_PINS
                                     .vddp                            (1'b1),
                             `ifdef INTC_ADD_VSS
                                     .vss                              (1'b0),
                 ...
                 //-------------------------------------------------------------      
                    ...
                    .FAF           (tcam_row_1_col_0_bisr_inst_Q[6:1]), // column repair addres? --- > F means faulty
                    .FAF_EN         (tcam_row_1_col_0_bisr_inst_Q[0]), //Column repair enable
        ...
        always_ff @(posedge clk) begin
           tcam_row_1_col_0_data_out_ff <= tcam_row_1_col_0_data_out;
        end
        
        assign          tcam_rd_data_col[1][0]      = ~tcam_row_1_col_0_data_out_ff; // invert data_out before sending back to controller // 
        assign          tcam_col_hit_out[1][0]       = tcam_row_1_col_0_hit_out; // DFT_WRP already delays this by one
...
`endif
  ...
  hlp_fwd_apr_tcam_mems_rtl_tessent_mbist_TCAM_c1_interface_MEM1 tcam_row_0_col_0_interface_inst(
      ...
      .ME_IN(tcam_row_0_col_0_memen), .QOUT(tcam_row_0_col_0_data_out), .DIN_IN(tcam_row_0_col_0_data_in_inv[39:0]), 
      ...
      .BIST_COL_ADD(BIST_COL_ADD), .BIST_ROW_ADD({BIST_ROW_ADD_ts6, 
      BIST_ROW_ADD_ts5, BIST_ROW_ADD_ts4, BIST_ROW_ADD_ts3, BIST_ROW_ADD_ts2, 
      BIST_ROW_ADD_ts1, BIST_ROW_ADD}), .BIST_BANK_ADD({BIST_BANK_ADD_ts1, 
      BIST_BANK_ADD}), .BIST_WRITE_DATA({BIST_WRITE_DATA_ts31, 
      BIST_WRITE_DATA_ts30, BIST_WRITE_DATA_ts29, BIST_WRITE_DATA_ts28, 
      BIST_WRITE_DATA_ts27, BIST_WRITE_DATA_ts26, BIST_WRITE_DATA_ts25, 
      BIST_WRITE_DATA_ts24, BIST_WRITE_DATA_ts23, BIST_WRITE_DATA_ts22, 
      BIST_WRITE_DATA_ts21, BIST_WRITE_DATA_ts20, BIST_WRITE_DATA_ts19, 
      BIST_WRITE_DATA_ts18, BIST_WRITE_DATA_ts17, BIST_WRITE_DATA_ts16, 
      ...
      BIST_WRITE_DATA_ts9, BIST_WRITE_DATA_ts8, BIST_WRITE_DATA_ts7, 
      BIST_WRITE_DATA_ts6, BIST_WRITE_DATA_ts5, BIST_WRITE_DATA_ts4, 
      ...
      BIST_EXPECT_DATA_ts31, BIST_EXPECT_DATA_ts30, BIST_EXPECT_DATA_ts29, 
      BIST_EXPECT_DATA_ts28, BIST_EXPECT_DATA_ts27, BIST_EXPECT_DATA_ts26, 
      BIST_EXPECT_DATA_ts25, BIST_EXPECT_DATA_ts24, BIST_EXPECT_DATA_ts23, 
      BIST_EXPECT_DATA_ts22, BIST_EXPECT_DATA_ts21, BIST_EXPECT_DATA_ts20, 
      BIST_EXPECT_DATA_ts19, BIST_EXPECT_DATA_ts18, BIST_EXPECT_DATA_ts17, 
      BIST_EXPECT_DATA_ts16, BIST_EXPECT_DATA_ts15, BIST_EXPECT_DATA_ts14, 
      BIST_EXPECT_DATA_ts13, BIST_EXPECT_DATA_ts12, BIST_EXPECT_DATA_ts11, 
      BIST_EXPECT_DATA_ts10, BIST_EXPECT_DATA_ts9, BIST_EXPECT_DATA_ts8, 
      ...
      .BIRA_SUSPEND(1'b0), .BIST_DIAG_EN(BIST_COLLAR_DIAG_EN), .BIST_CLEAR_DEFAULT(BIST_CLEAR_DEFAULT), 
      ...
      .GO_ID_REG_SEL(GO_ID_REG_SEL), .BIST_COLLAR_EN(BIST_COLLAR_EN0), .FROM_BISR_All_SCOL0_FUSE_REG(tcam_row_0_col_0_bisr_inst_Q[6:1]), 
      .FROM_BISR_All_SCOL0_ALLOC_REG(tcam_row_0_col_0_bisr_inst_Q[0]), .BIST_SHIFT_BIRA_COLLAR(BIST_SHIFT_BIRA_COLLAR), 
      .RESET_REG_SETUP2(MBISTPG_RESET_REG_SETUP2), .ERROR_CNT_ZERO(ERROR_CNT_ZERO), 
      .FLS(FLS), .TVBE(TVBE), .TVBI(TVBI), .BISTE(BISTE), .BIST_CM_MODE(BIST_CM_MODE), 
      .BIST_CM_EN_IN(BIST_CM_EN_IN), .BIST_CM_MATCH_SEL0(BIST_CM_MATCH_SEL0), .BIST_CM_MATCH_SEL1(BIST_CM_MATCH_SEL1), 
      .BIST_ROTATE_SR(BIST_ROTATE_SR), .BIST_ALL_MASK(BIST_ALL_MASK), .BIST_EN_SR_DATA_B(BIST_EN_SR_DATA_B), 
      .BIST_EN_SR_MASK_B(BIST_EN_SR_MASK_B), .BIST_MATCHIN_IN(BIST_MATCHIN_IN), 
      .BIST_FLS(BIST_FLS), .TMASK(TMASK), .WE(tcam_row_0_col_0_interface_inst_WE), 
      ...
      .All_SCOL0_FUSE_REG(All_SCOL0_FUSE_REG[5:0]), .All_SCOL0_ALLOC_REG(All_SCOL0_ALLOC_REG), 
      .REPAIR_STATUS(), .fscan_clkungate(fscan_clkungate), .DFTSHIFTEN(DFTSHIFTEN_ts1)
  );

  hlp_fwd_apr_tcam_mems_rtl_tessent_mbist_TCAM_c1_interface_MEM2 tcam_row_1_col_0_interface_inst(
      .BIST_CLEAR_BIRA(BIST_CLEAR_BIRA), .FLS_IN(1'b0), .TVBE_IN(1'b0), .TVBI_IN(1'b0), 
      .BIST_CM_MODE_IN(1'b0), .BIST_CM_EN_IN_IN(1'b0), .BIST_CM_MATCH_SEL0_IN(1'b0), 
      .BIST_CM_MATCH_SEL1_IN(1'b0), .BIST_ROTATE_SR_IN(1'b0), .BIST_ALL_MASK_IN(1'b0), 
      .BIST_EN_SR_DATA_B_IN(1'b0), .BIST_EN_SR_MASK_B_IN(1'b0), .BIST_MATCHIN_IN_IN(1'b0), 
      .BIST_FLS_IN(1'b0), .WE_IN(tcam_row_1_col_0_wr_en), .RE_IN(tcam_row_1_col_0_rd_en), 
      .ME_IN(tcam_row_1_col_0_memen), .QOUT(tcam_row_1_col_0_data_out), .DIN_IN(tcam_row_1_col_0_data_in_inv[39:0]), 
      .TCK(to_interfaces_tck), .BIST_CMP(BIST_CMP), .INCLUDE_MEM_RESULTS_REG(INCLUDE_MEM_RESULTS_REG), 
      .BIST_USER9(BIST_USER9), .BIST_USER10(BIST_USER10), .BIST_USER11(BIST_USER11), 
      .BIST_USER0(BIST_USER0), .BIST_USER1(BIST_USER1), .BIST_USER2(BIST_USER2), 
      .BIST_USER3(BIST_USER3), .BIST_USER4(BIST_USER4), .BIST_USER5(BIST_USER5), 
      ...
      .BIST_CLEAR(BIST_CLEAR), .BIST_SETUP2(BIST_SETUP_ts2), .BIST_SETUP1(BIST_SETUP_ts1), 
      .BIST_SETUP0(BIST_SETUP), .LV_TM(ltest_to_en), .FREEZE_STOP_ERROR(FREEZE_STOP_ERROR), 
      .GO_ID_REG_SEL(GO_ID_REG_SEL), .BIST_COLLAR_EN(BIST_COLLAR_EN4), .FROM_BISR_All_SCOL0_FUSE_REG(tcam_row_1_col_0_bisr_inst_Q[6:1]), 
      .FROM_BISR_All_SCOL0_ALLOC_REG(tcam_row_1_col_0_bisr_inst_Q[0]), .BIST_SHIFT_BIRA_COLLAR(BIST_SHIFT_BIRA_COLLAR), 
      .RESET_REG_SETUP2(MBISTPG_RESET_REG_SETUP2), .ERROR_CNT_ZERO(ERROR_CNT_ZERO), 
      .FLS(FLS_ts1), .TVBE(TVBE_ts1), .TVBI(TVBI_ts1), .BISTE(BISTE_ts1), .BIST_CM_MODE(BIST_CM_MODE_ts1), 
      .BIST_CM_EN_IN(BIST_CM_EN_IN_ts1), .BIST_CM_MATCH_SEL0(BIST_CM_MATCH_SEL0_ts1), 
      .BIST_CM_MATCH_SEL1(BIST_CM_MATCH_SEL1_ts1), .BIST_ROTATE_SR(BIST_ROTATE_SR_ts1), 
      .BIST_ALL_MASK(BIST_ALL_MASK_ts1), .BIST_EN_SR_DATA_B(BIST_EN_SR_DATA_B_ts1), 
      .BIST_EN_SR_MASK_B(BIST_EN_SR_MASK_B_ts1), .BIST_MATCHIN_IN(BIST_MATCHIN_IN_ts1), 
      .BIST_FLS(BIST_FLS_ts1), .TMASK(TMASK_ts1), .WE(tcam_row_1_col_0_interface_inst_WE), 
      .TWE(TWE_ts1), .RE(tcam_row_1_col_0_interface_inst_RE), .TRE(TRE_ts1), .ME(tcam_row_1_col_0_interface_inst_ME), 
      .TME(TME_ts1), .TADR(TADR_ts1), .DIN(DIN_ts1), .TDIN(TDIN_ts1), .BIST_SO(BIST_SO_ts1), 
      ...
      .DFTSHIFTEN(DFTSHIFTEN_ts2)
  );

  hlp_fwd_apr_tcam_mems_rtl_tessent_mbisr_register_ip783tcam512x40s0c1_dft_wrp tcam_row_0_col_0_bisr_inst(
      .CLK(bisr_clk_pd_vinf), .RSTB(bisr_reset_pd_vinf), .SI(bisr_si_pd_vinf), 
      .SO(tcam_row_0_col_0_bisr_inst_SO), .SE(bisr_shift_en_pd_vinf), .D({
      All_SCOL0_FUSE_REG[5:0], All_SCOL0_ALLOC_REG}), .MSO(1'b0), .MSEL(1'b0), .Q(tcam_row_0_col_0_bisr_inst_Q)
  );

  hlp_fwd_apr_tcam_mems_rtl_tessent_mbisr_register_ip783tcam512x40s0c1_dft_wrp tcam_row_1_col_0_bisr_inst(
      .CLK(bisr_clk_pd_vinf), .RSTB(bisr_reset_pd_vinf), .SI(tcam_row_0_col_0_bisr_inst_SO), 
      .SO(tcam_row_1_col_0_bisr_inst_SO), .SE(bisr_shift_en_pd_vinf), .D({
      All_SCOL0_FUSE_REG_ts1[5:0], All_SCOL0_ALLOC_REG_ts1}), .MSO(1'b0), .MSEL(1'b0), 
      .Q(tcam_row_1_col_0_bisr_inst_Q)
  );
endmodule
