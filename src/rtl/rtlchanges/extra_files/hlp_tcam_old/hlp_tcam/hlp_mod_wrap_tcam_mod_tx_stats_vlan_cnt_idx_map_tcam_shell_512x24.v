...
//clc        output        [*num_of_inst*-1:0]                      fscan_sout
        ...
        input wire [1:0] BIST_BANK_ADD, input wire BIST_COLLAR_EN4, 
...
`endif
  ...
  hlp_mod_apr_tcam_mems_rtl_tessent_mbist_TCAM_c1_interface_MEM5 tcam_row_0_col_0_interface_inst(
      ...
      .BIST_SI(MEM4_BIST_COLLAR_SI), .BIST_COLLAR_SETUP(BIST_COLLAR_SETUP), .BIST_COLLAR_OPSET_SELECT(BIST_COLLAR_OPSET_SELECT), 
  ...
  hlp_mod_apr_tcam_mems_rtl_tessent_mbisr_register_ip783tcam512x24s0c1_dft_wrp tcam_row_0_col_0_bisr_inst(
