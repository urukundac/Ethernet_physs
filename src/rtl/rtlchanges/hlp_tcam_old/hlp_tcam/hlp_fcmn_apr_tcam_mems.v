...
input fsta_afd_en,
input logic             clk_rscclk,         // To u_fcmn_apr_func_logic of hlp_fcmn_apr_func_logic.v
// Module inputs
   ...
   input [`HLP_FCMN_MAP_DOMAIN_TO_TCAM_WIDTH-1:0] fcmn_map_domain_0_to_tcam               ,   
   input [`HLP_FCMN_MAP_DOMAIN_TO_TCAM_WIDTH-1:0] fcmn_map_domain_1_to_tcam               ,   
   input [`HLP_FCMN_MAP_DOMAIN_TO_TCAM_WIDTH-1:0] fcmn_map_domain_2_to_tcam               ,   
   input [`HLP_FCMN_MAP_DOMAIN_TO_TCAM_WIDTH-1:0] fcmn_map_domain_3_to_tcam               ,   
   input [`HLP_FCMN_MAP_DOMAIN_TO_TCAM_WIDTH-1:0] fcmn_map_domain_4_to_tcam               ,   
   input [`HLP_FCMN_MAP_DOMAIN_TO_TCAM_WIDTH-1:0] fcmn_map_domain_5_to_tcam               ,   
   input [`HLP_FCMN_MAP_DOMAIN_TO_TCAM_WIDTH-1:0] fcmn_map_domain_6_to_tcam               ,   
   input [`HLP_FCMN_MAP_DOMAIN_TO_TCAM_WIDTH-1:0] fcmn_map_domain_7_to_tcam               ,   
...
// Module outputs
  ...
  output [`HLP_FCMN_MAP_DOMAIN_FROM_TCAM_WIDTH-1:0] fcmn_map_domain_0_from_tcam             ,   
  output [`HLP_FCMN_MAP_DOMAIN_FROM_TCAM_WIDTH-1:0] fcmn_map_domain_1_from_tcam             ,   
  output [`HLP_FCMN_MAP_DOMAIN_FROM_TCAM_WIDTH-1:0] fcmn_map_domain_2_from_tcam             ,   
  output [`HLP_FCMN_MAP_DOMAIN_FROM_TCAM_WIDTH-1:0] fcmn_map_domain_3_from_tcam             ,   
  output [`HLP_FCMN_MAP_DOMAIN_FROM_TCAM_WIDTH-1:0] fcmn_map_domain_4_from_tcam             ,   
  output [`HLP_FCMN_MAP_DOMAIN_FROM_TCAM_WIDTH-1:0] fcmn_map_domain_5_from_tcam             ,   
  output [`HLP_FCMN_MAP_DOMAIN_FROM_TCAM_WIDTH-1:0] fcmn_map_domain_6_from_tcam             ,   
  output [`HLP_FCMN_MAP_DOMAIN_FROM_TCAM_WIDTH-1:0] fcmn_map_domain_7_from_tcam                 
...
input wire core_rst_b);
  ...
  wire hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_mbist_inst_so, 
       hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_sti_inst_so, 
       hlp_fcmn_apr_tcam_mems_rtl_tessent_tdr_TCAM_c1_algo_select_tdr_inst_so, 
       hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_sti_inst_to_select, 
       hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst_so, 
       hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst_to_select, 
       ...
       hlp_fcmn_apr_tcam_mems_rtl_tessent_mbist_bap_inst_so, MBISTPG_STABLE, 
       ijtag_so, bisr_so_pd_vinf_ts1, trigger_post, trigger_array, 
       mbistpg_select_common_algo_o, select_sram, pass, sys_test_done_clk, 
...
hlp_fcmn_tcam_mems  fcmn_tcam_mems(
        .DFTMASK(DFTMASK),
        ...
        .fcmn_map_domain_0_to_tcam(fcmn_map_domain_0_to_tcam),
        .fcmn_map_domain_1_to_tcam(fcmn_map_domain_1_to_tcam),
        .fcmn_map_domain_2_to_tcam(fcmn_map_domain_2_to_tcam),
        .fcmn_map_domain_3_to_tcam(fcmn_map_domain_3_to_tcam),
        .fcmn_map_domain_4_to_tcam(fcmn_map_domain_4_to_tcam),
        .fcmn_map_domain_5_to_tcam(fcmn_map_domain_5_to_tcam),
        .fcmn_map_domain_6_to_tcam(fcmn_map_domain_6_to_tcam),
        .fcmn_map_domain_7_to_tcam(fcmn_map_domain_7_to_tcam),
`ifdef HLP_FPGA_TCAM_MEMS
...
`endif
        ...
        .fcmn_map_domain_0_from_tcam(fcmn_map_domain_0_from_tcam),
        .fcmn_map_domain_1_from_tcam(fcmn_map_domain_1_from_tcam),
        .fcmn_map_domain_2_from_tcam(fcmn_map_domain_2_from_tcam),
        .fcmn_map_domain_3_from_tcam(fcmn_map_domain_3_from_tcam),
        .fcmn_map_domain_4_from_tcam(fcmn_map_domain_4_from_tcam),
        .fcmn_map_domain_5_from_tcam(fcmn_map_domain_5_from_tcam),
        .fcmn_map_domain_6_from_tcam(fcmn_map_domain_6_from_tcam),
        .fcmn_map_domain_7_from_tcam(fcmn_map_domain_7_from_tcam), .BIST_SETUP(BIST_SETUP[0]), 
...
// END_BOTTOM_LOGIC
  ...
  hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_1 hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_sti_inst(
      ...
      .ijtag_tck(fary_ijtag_tck), .ijtag_so(aary_ijtag_so), .ijtag_from_so(hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_mbist_inst_so), 
      .ltest_si(1'b0), .ltest_scan_en(DFTSHIFTEN), .ltest_en(DFTSHIFTEN), .ltest_clk(clk_rscclk), 
      .ltest_mem_bypass_en(DFTMASK), .ltest_mcp_bounding_en(1'b0), .ltest_async_set_reset_static_disable(fscan_byprst_b), 
      .ijtag_to_tck(ijtag_to_tck), .ijtag_to_reset(ijtag_to_reset), .ijtag_to_si(hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_sti_inst_so), 
      ...
      .ijtag_to_sel(hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_sti_inst_to_select)
  );

  hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_2 hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst(
      .ijtag_reset(ijtag_to_reset), .ijtag_sel(hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_sti_inst_to_select), 
      .ijtag_si(hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_sti_inst_so), .ijtag_ce(ijtag_to_ce), 
      .ijtag_se(ijtag_to_se), .ijtag_ue(ijtag_to_ue), .ijtag_tck(ijtag_to_tck), 
      .ijtag_so(hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst_so), 
      .ijtag_from_so(hlp_fcmn_apr_tcam_mems_rtl_tessent_tdr_TCAM_c1_algo_select_tdr_inst_so), 
      .ijtag_to_sel(hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst_to_select)
  );

  hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_2 hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_mbist_inst(
      .ijtag_reset(ijtag_to_reset), .ijtag_sel(hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_sti_inst_to_select), 
      .ijtag_si(hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst_so), 
      .ijtag_ce(ijtag_to_ce), .ijtag_se(ijtag_to_se), .ijtag_ue(ijtag_to_ue), .ijtag_tck(ijtag_to_tck), 
      .ijtag_so(hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_mbist_inst_so), .ijtag_from_so(ijtag_so), 
      .ijtag_to_sel(ijtag_to_sel)
  );

  hlp_fcmn_apr_tcam_mems_rtl_tessent_tdr_TCAM_c1_algo_select_tdr hlp_fcmn_apr_tcam_mems_rtl_tessent_tdr_TCAM_c1_algo_select_tdr_inst(
      .ijtag_reset(ijtag_to_reset), .ijtag_sel(hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst_to_select), 
      .ijtag_si(hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_sti_inst_so), .ijtag_ce(ijtag_to_ce), 
      .ijtag_se(ijtag_to_se), .ijtag_ue(ijtag_to_ue), .ijtag_tck(ijtag_to_tck), 
      .ALGO_SEL_REG(ALGO_SEL_REG), .ijtag_so(hlp_fcmn_apr_tcam_mems_rtl_tessent_tdr_TCAM_c1_algo_select_tdr_inst_so)
  );

  hlp_fcmn_apr_tcam_mems_rtl_tessent_mbist_bap hlp_fcmn_apr_tcam_mems_rtl_tessent_mbist_bap_inst(
      .reset(ijtag_to_reset), .ijtag_select(ijtag_to_sel), .si(hlp_fcmn_apr_tcam_mems_rtl_tessent_sib_algo_select_sib_inst_so), 
      ...
      .sys_test_init_clk(1'b0), .sys_reset_clk(sync_reset_clk_o), .sys_clock_clk(clk), 
      ...
      .fromBist(MBISTPG_SO), .so(hlp_fcmn_apr_tcam_mems_rtl_tessent_mbist_bap_inst_so), 
      .fscan_clkungate(fscan_clkungate)
  );

  hlp_fcmn_apr_tcam_mems_rtl_tessent_mbist_TCAM_c1_controller hlp_fcmn_apr_tcam_mems_rtl_tessent_mbist_TCAM_c1_controller_inst(
      ...
      .BIST_COLLAR_GO({BIST_GO_ts7, BIST_GO_ts6, BIST_GO_ts5, BIST_GO_ts4, 
      BIST_GO_ts3, BIST_GO_ts2, BIST_GO_ts1, BIST_GO}), .MBISTPG_DIAG_EN(BIST_DIAG_EN), 
      .BIST_CLK(clk), .BIST_SI(toBist), .BIST_HOLD(BIST_HOLD), .BIST_SETUP2(BIST_SETUP[2]), 
  ...
  hlp_fcmn_apr_tcam_mems_rtl_tessent_mbist_diagnosis_ready hlp_fcmn_apr_tcam_mems_rtl_tessent_mbist_diagnosis_ready_inst(
      .ijtag_reset(ijtag_to_reset), .ijtag_sel(ijtag_to_sel), .ijtag_si(hlp_fcmn_apr_tcam_mems_rtl_tessent_mbist_bap_inst_so), 
      .ijtag_ce(ijtag_to_ce), .ijtag_se(ijtag_to_se), .ijtag_ue(ijtag_to_ue), .ijtag_tck(ijtag_to_tck), 
