...
module  hlp_fcmn_wrap_tcam_map_domain_shell_512x40 #(
...
//clc        output        [*num_of_inst*-1:0]                      fscan_sout
        ...
        output wire tcam_row_0_col_0_bisr_inst_SO, input wire DFTSHIFTEN_ts1);
...
// Disassembling the to_tcam bus
  ...
  wire FLS, TVBE, TVBI, BISTE, BIST_CM_MODE, BIST_CM_EN_IN, BIST_CM_MATCH_SEL0, 
       BIST_CM_MATCH_SEL1, BIST_ROTATE_SR, BIST_ALL_MASK, BIST_EN_SR_DATA_B, 
       BIST_EN_SR_MASK_B, BIST_MATCHIN_IN, BIST_FLS, 
       tcam_row_0_col_0_interface_inst_WE, TWE, 
       tcam_row_0_col_0_interface_inst_RE, TRE, 
       tcam_row_0_col_0_interface_inst_ME, TME, All_SCOL0_ALLOC_REG;
...
`ifdef DC
        `ifndef HLP_FCMN_ASIC_MEMS_EXCLUDE
                `define HLP_FCMN_ASIC_MEMS
        `endif
`endif

        // Memories Implementation
`ifdef HLP_FCMN_ASIC_MEMS      
...
localparam TCAM_SLICE_EN_MIN = TCAM_SLICE_EN_FACT < TCAM_SLICE_EN_WIDTH ? TCAM_SLICE_EN_FACT : TCAM_SLICE_EN_WIDTH;
    ...
    logic    [40-1:0]    tcam_rd_data_col[1-1:0][1-1:0];
...
`endif
  ...
  hlp_fcmn_apr_tcam_mems_rtl_tessent_mbist_TCAM_c1_interface_MEM1 tcam_row_0_col_0_interface_inst(
      ...
      .BIST_CLK(clk), .BIST_SHIFT_COLLAR(BIST_SHIFT_COLLAR), .BIST_EXPECT_DATA(BIST_EXPECT_DATA[31:0]), 
  ...
  hlp_fcmn_apr_tcam_mems_rtl_tessent_mbisr_register_ip783tcam512x40s0c1_dft_wrp tcam_row_0_col_0_bisr_inst(
