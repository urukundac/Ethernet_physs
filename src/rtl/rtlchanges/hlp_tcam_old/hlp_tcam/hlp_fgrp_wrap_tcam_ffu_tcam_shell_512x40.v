...
module  hlp_fgrp_wrap_tcam_ffu_tcam_shell_512x40 #(
...
`ifdef DC
        `ifndef HLP_FGRP_ASIC_MEMS_EXCLUDE
                `define HLP_FGRP_ASIC_MEMS
        `endif
`endif

        // Memories Implementation
`ifdef HLP_FGRP_ASIC_MEMS      
...
`endif
  ...
  hlp_fgrp_apr_tcam_mems_rtl_tessent_mbist_TCAM_c1_interface_MEM1 tcam_row_0_col_0_interface_inst(
  ...
  hlp_fgrp_apr_tcam_mems_rtl_tessent_mbisr_register_ip783tcam512x40s0c1_dft_wrp tcam_row_0_col_0_bisr_inst(
