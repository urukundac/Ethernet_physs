...
//  Memory Name:           ip783tcam512x24s0c1                                             //
//  Memory Name Generated: ip783tcam512x24s0c1                                             //
//                                                                                         //
/////////////////////////////////////////////////////////////////////////////////////////////

// control the defines for FPGA/Emulation usage
`ifdef INTEL_FPGA
  `define INTC_MEM_ip783tcam512x24s0c1_EF_MODE
  `define INTC_MEM_ip783tcam512x24s0c1_NOXHANDLING
  `define INTC_MEM_ip783tcam512x24s0c1_SVA_OFF
`else
...
`ifdef INTC_MEM_ESP
  ...
  `define INTC_MEM_ip783tcam512x24s0c1_NOXHANDLING
  `define INTC_MEM_ip783tcam512x24s0c1_SVA_OFF
  `define INTC_MEM_ip783tcam512x24s0c1_NOAGING
`endif // INTC_MEM_ESP
...
`ifdef INTC_MEM_fault_norepair
  `define INTC_ip783tcam512x24s0c1_local_fi_nrep
  `define INTC_MEM_ip783tcam512x24s0c1_FI
`endif // INTC_MEM_fault_norepair

`ifdef INTC_MEM_fault_repair
  `define INTC_ip783tcam512x24s0c1_local_fi_rep
  `define INTC_MEM_ip783tcam512x24s0c1_FI
`endif // INTC_MEM_fault_repair

`ifdef INTC_MEM_fault_single
  `define INTC_ip783tcam512x24s0c1_local_fi_srep
  `define INTC_MEM_ip783tcam512x24s0c1_FI
`endif // INTC_MEM_fault_single

`ifdef INTC_MEM_ip783tcam512x24s0c1_fault_norepair
  `define INTC_ip783tcam512x24s0c1_local_fi_nrep
  `define INTC_MEM_ip783tcam512x24s0c1_FI
`endif // INTC_MEM_ip783tcam512x24s0c1_fault_norepair

`ifdef INTC_MEM_ip783tcam512x24s0c1_fault_repair
  `define INTC_ip783tcam512x24s0c1_local_fi_rep
  `define INTC_MEM_ip783tcam512x24s0c1_FI
`endif // INTC_MEM_ip783tcam512x24s0c1_fault_repair

`ifdef INTC_MEM_ip783tcam512x24s0c1_fault_single
  `define INTC_ip783tcam512x24s0c1_local_fi_srep
  `define INTC_MEM_ip783tcam512x24s0c1_FI
`endif // INTC_MEM_ip783tcam512x24s0c1_fault_single
...
module ip783tcam512x24s0c1 (                                          // lintra s-68000 s-70607
...
// peri
        ...
        logic ren_b_h;
	`ifndef INTC_MEM_ip783tcam512x24s0c1_EF_MODE
        logic wen_b_h;
	`endif // INTC_MEM_ip783tcam512x24s0c1_EF_MODE
        logic srchen_b_h;
	...
	`endif // INTC_MEM_ip783tcam512x24s0c1_EF_MODE
		...
		ip783tcam512x24s0c1_array ip783tcam512x24s0c1_array (
 		`ifndef INTEL_NO_PWR_PINS
			.vddp(vddp),
 		 `ifdef INTC_ADD_VSS
			.vss(vss),
 		...
 		`endif
			...
			.din(din),
			.dinmask(dinmask),
		`ifdef INTC_MEM_ip783tcam512x24s0c1_EF_MODE
			.dinvalid(dinvalid),
		...
		`ifdef INTC_MEM_ip783tcam512x24s0c1_EF_MODE
		`else // INTC_MEM_ip783tcam512x24s0c1_EF_MODE
...
//		   input [`INTC_MEM_PATH_SIZE*8:0] infile;                                  // lintra s-80095
		   ...
		   begin
		      ...
		      ip783tcam512x24s0c1_array.array_x = mem_x;
		      ip783tcam512x24s0c1_array.array_y = mem_y;
		      ip783tcam512x24s0c1_array.array_v = mem_v;
		   end
...
module ip783tcam512x24s0c1_array (                                          // lintra s-68000 s-70607
    `ifndef INTEL_NO_PWR_PINS
        vddp,
      `ifdef INTC_ADD_VSS
        vss,
