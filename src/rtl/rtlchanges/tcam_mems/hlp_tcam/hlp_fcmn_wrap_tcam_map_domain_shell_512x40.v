...
//clc        output        [*num_of_inst*-1:0]                      fscan_sout
        ...
        input wire [2:0] BIST_BANK_ADD, input wire BIST_COLLAR_EN0, 
        ...
        output wire tcam_row_0_col_0_bisr_inst_SO, input wire fscan_mode_ts1);
...
`endif
  ...
  hlp_fcmn_apr_rtl_tessent_mbist_TCAM_c6_interface_MEM1 tcam_row_0_col_0_interface_inst(
      ...
      .BIST_SI(MEM0_BIST_COLLAR_SI), .BIST_COLLAR_SETUP(BIST_COLLAR_SETUP), .BIST_COLLAR_OPSET_SELECT(BIST_COLLAR_OPSET_SELECT[1:0]), 
  ...
  hlp_fcmn_apr_rtl_tessent_mbisr_register_ip783tcam512x40s0c1_dft_wrp tcam_row_0_col_0_bisr_inst(
