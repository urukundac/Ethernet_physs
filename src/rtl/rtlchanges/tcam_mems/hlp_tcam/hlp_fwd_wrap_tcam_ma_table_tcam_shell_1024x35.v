...
//clc        output        [*num_of_inst*-1:0]                      fscan_sout
        ...
        input wire BIST_ROW_ADD_ts5, input wire BIST_BANK_ADD, 
        input wire BIST_BANK_ADD_ts1, input wire BIST_BANK_ADD_ts2, 
        ...
        output wire tcam_row_1_col_0_bisr_inst_SO, input wire fscan_mode_ts1, 
        input wire fscan_mode_ts2);
...
// Disassembling the to_tcam bus
  ...
  wire [39:0] DIN, DIN_ts1, TMASK, TMASK_ts1;
  wire [9:0] TADR, TADR_ts1;
  wire [39:0] TDIN, TDIN_ts1;
  wire [6:0] tcam_row_0_col_0_bisr_inst_Q, tcam_row_1_col_0_bisr_inst_Q;
  wire tcam_row_0_col_0_interface_inst_WE, tcam_row_1_col_0_interface_inst_WE, 
       tcam_row_0_col_0_interface_inst_ME, tcam_row_1_col_0_interface_inst_ME, 
       FLS, FLS_ts1, TVBE, TVBE_ts1, TVBI, TVBI_ts1, BISTE, BISTE_ts1, 
       ...
       BIST_MATCHIN_IN, BIST_MATCHIN_IN_ts1, BIST_FLS, BIST_FLS_ts1, TWE, 
       TWE_ts1, tcam_row_0_col_0_interface_inst_RE, 
       tcam_row_1_col_0_interface_inst_RE, TRE, TRE_ts1, TME, TME_ts1, 
       tcam_row_0_col_0_bisr_inst_SO, All_SCOL0_ALLOC_REG, 
...
// Match In Array 
    ...
    // EBBs Instantiation
        ...
        logic    [512-1:0]                               tcam_row_1_col_0_hit_out_ff;
        ...
        always_ff @(posedge clk) begin
           ...
           tcam_row_1_col_0_hit_out_ff <= tcam_row_1_col_0_hit_out;
        end
        
        assign          tcam_rd_data_col[1][0]      = ~tcam_row_1_col_0_data_out_ff; // invert data_out before sending back to controller // 
        assign          tcam_col_hit_out[1][0]       = tcam_row_1_col_0_hit_out_ff; // DFT_WRP already delays this by one. 25ww35 - DFT_WRP removed delay. Adding back here.
...
`endif
  ...
  hlp_fwd_apr_rtl_tessent_mbist_TCAM_c11_interface_MEM1 tcam_row_0_col_0_interface_inst(
      ...
      .BIST_COL_ADD(BIST_COL_ADD), .BIST_ROW_ADD({BIST_ROW_ADD_ts5, 
      BIST_ROW_ADD_ts4, BIST_ROW_ADD_ts3, BIST_ROW_ADD_ts2, BIST_ROW_ADD_ts1, 
      BIST_ROW_ADD}), .BIST_BANK_ADD({BIST_BANK_ADD_ts2, BIST_BANK_ADD_ts1, 
      ...
      BIST_COLLAR_OPSET_SELECT}), .BIST_COLLAR_HOLD(BIST_COLLAR_HOLD), .BIST_BIRA_EN(BIST_COLLAR_BIRA_EN), 
      ...
      .FROM_BISR_All_SCOL0_FUSE_REG(tcam_row_0_col_0_bisr_inst_Q[6:1]), .FROM_BISR_All_SCOL0_ALLOC_REG(tcam_row_0_col_0_bisr_inst_Q[0]), 
  ...
  hlp_fwd_apr_rtl_tessent_mbist_TCAM_c11_interface_MEM2 tcam_row_1_col_0_interface_inst(
      .BIST_CLEAR_BIRA(BIST_CLEAR_BIRA), .FLS_IN(1'b0), .TVBE_IN(1'b0), .TVBI_IN(1'b0), 
      .BIST_CM_MODE_IN(1'b0), .BIST_CM_EN_IN_IN(1'b0), .BIST_CM_MATCH_SEL0_IN(1'b0), 
      .BIST_CM_MATCH_SEL1_IN(1'b0), .BIST_ROTATE_SR_IN(1'b0), .BIST_ALL_MASK_IN(1'b0), 
      .BIST_EN_SR_DATA_B_IN(1'b0), .BIST_EN_SR_MASK_B_IN(1'b0), .BIST_MATCHIN_IN_IN(1'b0), 
      ...
      .FROM_BISR_All_SCOL0_FUSE_REG(tcam_row_1_col_0_bisr_inst_Q[6:1]), .FROM_BISR_All_SCOL0_ALLOC_REG(tcam_row_1_col_0_bisr_inst_Q[0]), 
      .BIST_SHIFT_BIRA_COLLAR(BIST_SHIFT_BIRA_COLLAR), .RESET_REG_SETUP2(MBISTPG_RESET_REG_SETUP2), 
      .ERROR_CNT_ZERO(ERROR_CNT_ZERO), .FLS(FLS_ts1), .TVBE(TVBE_ts1), .TVBI(TVBI_ts1), 
      .BISTE(BISTE_ts1), .BIST_CM_MODE(BIST_CM_MODE_ts1), .BIST_CM_EN_IN(BIST_CM_EN_IN_ts1), 
      ...
      .fscan_mode(fscan_mode_ts2)
  );

  hlp_fwd_apr_rtl_tessent_mbisr_register_ip783tcam512x40s0c1_dft_wrp tcam_row_0_col_0_bisr_inst(
  ...
  hlp_fwd_apr_rtl_tessent_mbisr_register_ip783tcam512x40s0c1_dft_wrp tcam_row_1_col_0_bisr_inst(
