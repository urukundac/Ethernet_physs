...
`endif
   ...
   input    [`CXP_TRC_TRC_TCAM_TO_TCAM_WIDTH-1:0] trc_trc_tcam_to_tcam                    ,

// Module outputs

  output  [`CXP_TRC_TRC_TCAM_FROM_TCAM_WIDTH-1:0] trc_trc_tcam_from_tcam                        
...
cxp_trc_wrap_tcam_trc_tcam_shell_8192x40  #( // Parameters
    .TCAM_PATRN1_EXP_RESET_VALUE(0),
    .NFUSERED_TCAM(7),
    .FROM_TCAM_WIDTH(`CXP_TRC_TRC_TCAM_FROM_TCAM_WIDTH),
    ...
    .BCAM_RELIEF(0),
    .FPGA_MARGIN(0),
    .TOTAL_MEMORY_INSTANCE(32),
    .BCAM_N7(0),
    .TCAM_WIDTH(40),
    .TO_TCAM_WIDTH(`CXP_TRC_TRC_TCAM_TO_TCAM_WIDTH),
    .FPGA_CLOCKS_RATIO(100),
    .TCAM_PATRN0_EXP_RESET_VALUE(0)
) trc_wrap_tcam_trc_tcam_shell_8192x40(
        .clk(nss_core_clk),
        .car_raw_lan_power_good(scon_cxp_powergood_nss_core_rst_n),
`ifdef CXP_FPGA_TCAM_MEMS
        .fpga_fast_clk(fpga_fast_clk),
`endif
        .wrap_shell_to_tcam(trc_trc_tcam_to_tcam),
        .wrap_shell_from_tcam(trc_trc_tcam_from_tcam),
        .fuse_tcam(fuse_tcam),
