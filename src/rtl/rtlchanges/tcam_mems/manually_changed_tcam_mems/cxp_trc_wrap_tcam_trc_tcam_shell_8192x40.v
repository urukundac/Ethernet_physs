...
//
//////////////////////////////////////////////////////////////////////
`include        "cxp_trc_mem.def"
module  cxp_trc_wrap_tcam_trc_tcam_shell_8192x40 #(
       ...
       ,
        ...
        output wire BIST_SO_ts31, output wire BIST_GO, output wire BIST_GO_ts1, 
        ...
        input wire ram_row_3_col_5_bisr_inst_SO, 
...
localparam PHYSICAL_ROW_WIDTH = TCAM_WIDTH + BCAM_N7*(1*40 - TCAM_WIDTH);
 wire tcam_row_0_col_0_bisr_inst_SO, tcam_row_10_col_0_bisr_inst_SO, 
      ...
      tcam_row_24_col_0_bisr_inst_SO, tcam_row_25_col_0_bisr_inst_SO, 
      tcam_row_26_col_0_bisr_inst_SO, tcam_row_27_col_0_bisr_inst_SO, 
      tcam_row_28_col_0_bisr_inst_SO, tcam_row_29_col_0_bisr_inst_SO, 
      tcam_row_2_col_0_bisr_inst_SO, tcam_row_30_col_0_bisr_inst_SO, 
      tcam_row_31_col_0_bisr_inst_SO, tcam_row_3_col_0_bisr_inst_SO, 
...
`ifndef CXP_TRC_TCAM_BEHAVE_MEMS
    `define CXP_TRC_ASIC_MEMS
`endif

`ifdef  CXP_TRC_ASIC_MEMS
...
localparam TCAM_SLICE_EN_FACT = 256/64;
localparam TCAM_SLICE_EN_MIN = ((TCAM_SLICE_EN_FACT < TCAM_SLICE_EN_WIDTH ) ? TCAM_SLICE_EN_FACT : TCAM_SLICE_EN_WIDTH);
    ...
    wire    [32-1:0]                tcam_row_sel;
    assign                    tcam_row_sel[0]        = ((adr>=14'd0) && (adr<14'd512));
    assign                    tcam_row_sel[1]        = ((adr>=14'd512) && (adr<14'd1024));
    assign                    tcam_row_sel[2]        = ((adr>=14'd1024) && (adr<14'd1536));
    assign                    tcam_row_sel[3]        = ((adr>=14'd1536) && (adr<14'd2048));
    assign                    tcam_row_sel[4]        = ((adr>=14'd2048) && (adr<14'd2560));
    assign                    tcam_row_sel[5]        = ((adr>=14'd2560) && (adr<14'd3072));
    assign                    tcam_row_sel[6]        = ((adr>=14'd3072) && (adr<14'd3584));
    assign                    tcam_row_sel[7]        = ((adr>=14'd3584) && (adr<14'd4096));
    assign                    tcam_row_sel[8]        = ((adr>=14'd4096) && (adr<14'd4608));
    assign                    tcam_row_sel[9]        = ((adr>=14'd4608) && (adr<14'd5120));
    assign                    tcam_row_sel[10]        = ((adr>=14'd5120) && (adr<14'd5632));
    assign                    tcam_row_sel[11]        = ((adr>=14'd5632) && (adr<14'd6144));
    assign                    tcam_row_sel[12]        = ((adr>=14'd6144) && (adr<14'd6656));
    assign                    tcam_row_sel[13]        = ((adr>=14'd6656) && (adr<14'd7168));
    assign                    tcam_row_sel[14]        = ((adr>=14'd7168) && (adr<14'd7680));
    assign                    tcam_row_sel[15]        = ((adr>=14'd7680) && (adr<14'd8192));
    assign                    tcam_row_sel[16]        = ((adr>=14'd8192) && (adr<14'd8704));
    assign                    tcam_row_sel[17]        = ((adr>=14'd8704) && (adr<14'd9216));
    assign                    tcam_row_sel[18]        = ((adr>=14'd9216) && (adr<14'd9728));
    assign                    tcam_row_sel[19]        = ((adr>=14'd9728) && (adr<14'd10240));
    assign                    tcam_row_sel[20]        = ((adr>=14'd10240) && (adr<14'd10752));
    assign                    tcam_row_sel[21]        = ((adr>=14'd10752) && (adr<14'd11264));
    assign                    tcam_row_sel[22]        = ((adr>=14'd11264) && (adr<14'd11776));
    assign                    tcam_row_sel[23]        = ((adr>=14'd11776) && (adr<14'd12288));
    assign                    tcam_row_sel[24]        = ((adr>=14'd12288) && (adr<14'd12800));
    assign                    tcam_row_sel[25]        = ((adr>=14'd12800) && (adr<14'd13312));
    assign                    tcam_row_sel[26]        = ((adr>=14'd13312) && (adr<14'd13824));
    assign                    tcam_row_sel[27]        = ((adr>=14'd13824) && (adr<14'd14336));
    assign                    tcam_row_sel[28]        = ((adr>=14'd14336) && (adr<14'd14848));
    assign                    tcam_row_sel[29]        = ((adr>=14'd14848) && (adr<14'd15360));
    assign                    tcam_row_sel[30]        = ((adr>=14'd15360) && (adr<14'd15872));
    assign                    tcam_row_sel[31]        = (adr>=14'd15872);


    // TCAM Address Decoder

    wire    [9-1:0]        tcam_row_adr[32-1:0];
    assign                    tcam_row_adr[0][9-1:0]    =  tcam_row_sel[0] ? adr - 9'd0 : 9'd0;
    assign                    tcam_row_adr[1][9-1:0]    =  tcam_row_sel[1] ? adr - 9'd512 : 9'd0;
    assign                    tcam_row_adr[2][9-1:0]    =  tcam_row_sel[2] ? adr - 9'd1024 : 9'd0;
    assign                    tcam_row_adr[3][9-1:0]    =  tcam_row_sel[3] ? adr - 9'd1536 : 9'd0;
    assign                    tcam_row_adr[4][9-1:0]    =  tcam_row_sel[4] ? adr - 9'd2048 : 9'd0;
    assign                    tcam_row_adr[5][9-1:0]    =  tcam_row_sel[5] ? adr - 9'd2560 : 9'd0;
    assign                    tcam_row_adr[6][9-1:0]    =  tcam_row_sel[6] ? adr - 9'd3072 : 9'd0;
    assign                    tcam_row_adr[7][9-1:0]    =  tcam_row_sel[7] ? adr - 9'd3584 : 9'd0;
    assign                    tcam_row_adr[8][9-1:0]    =  tcam_row_sel[8] ? adr - 9'd4096 : 9'd0;
    assign                    tcam_row_adr[9][9-1:0]    =  tcam_row_sel[9] ? adr - 9'd4608 : 9'd0;
    assign                    tcam_row_adr[10][9-1:0]    =  tcam_row_sel[10] ? adr - 9'd5120 : 9'd0;
    assign                    tcam_row_adr[11][9-1:0]    =  tcam_row_sel[11] ? adr - 9'd5632 : 9'd0;
    assign                    tcam_row_adr[12][9-1:0]    =  tcam_row_sel[12] ? adr - 9'd6144 : 9'd0;
    assign                    tcam_row_adr[13][9-1:0]    =  tcam_row_sel[13] ? adr - 9'd6656 : 9'd0;
    assign                    tcam_row_adr[14][9-1:0]    =  tcam_row_sel[14] ? adr - 9'd7168 : 9'd0;
    assign                    tcam_row_adr[15][9-1:0]    =  tcam_row_sel[15] ? adr - 9'd7680 : 9'd0;
    assign                    tcam_row_adr[16][9-1:0]    =  tcam_row_sel[16] ? adr - 9'd8192 : 9'd0;
    assign                    tcam_row_adr[17][9-1:0]    =  tcam_row_sel[17] ? adr - 9'd8704 : 9'd0;
    assign                    tcam_row_adr[18][9-1:0]    =  tcam_row_sel[18] ? adr - 9'd9216 : 9'd0;
    assign                    tcam_row_adr[19][9-1:0]    =  tcam_row_sel[19] ? adr - 9'd9728 : 9'd0;
    assign                    tcam_row_adr[20][9-1:0]    =  tcam_row_sel[20] ? adr - 9'd10240 : 9'd0;
    assign                    tcam_row_adr[21][9-1:0]    =  tcam_row_sel[21] ? adr - 9'd10752 : 9'd0;
    assign                    tcam_row_adr[22][9-1:0]    =  tcam_row_sel[22] ? adr - 9'd11264 : 9'd0;
    assign                    tcam_row_adr[23][9-1:0]    =  tcam_row_sel[23] ? adr - 9'd11776 : 9'd0;
    assign                    tcam_row_adr[24][9-1:0]    =  tcam_row_sel[24] ? adr - 9'd12288 : 9'd0;
    assign                    tcam_row_adr[25][9-1:0]    =  tcam_row_sel[25] ? adr - 9'd12800 : 9'd0;
    assign                    tcam_row_adr[26][9-1:0]    =  tcam_row_sel[26] ? adr - 9'd13312 : 9'd0;
    assign                    tcam_row_adr[27][9-1:0]    =  tcam_row_sel[27] ? adr - 9'd13824 : 9'd0;
    assign                    tcam_row_adr[28][9-1:0]    =  tcam_row_sel[28] ? adr - 9'd14336 : 9'd0;
    assign                    tcam_row_adr[29][9-1:0]    =  tcam_row_sel[29] ? adr - 9'd14848 : 9'd0;
    assign                    tcam_row_adr[30][9-1:0]    =  tcam_row_sel[30] ? adr - 9'd15360 : 9'd0;
    assign                    tcam_row_adr[31][9-1:0]    =  tcam_row_sel[31] ? adr - 9'd15872 : 9'd0;


    // TCAM Read Enable Decoder

    wire    [32-1:0]        tcam_row_rd_en;
    ...
    assign            tcam_row_rd_en[24]        = tcam_row_sel[24] ? rd_en : 1'b0;
    assign            tcam_row_rd_en[25]        = tcam_row_sel[25] ? rd_en : 1'b0;
    assign            tcam_row_rd_en[26]        = tcam_row_sel[26] ? rd_en : 1'b0;
    assign            tcam_row_rd_en[27]        = tcam_row_sel[27] ? rd_en : 1'b0;
    assign            tcam_row_rd_en[28]        = tcam_row_sel[28] ? rd_en : 1'b0;
    assign            tcam_row_rd_en[29]        = tcam_row_sel[29] ? rd_en : 1'b0;
    assign            tcam_row_rd_en[30]        = tcam_row_sel[30] ? rd_en : 1'b0;
    assign            tcam_row_rd_en[31]        = tcam_row_sel[31] ? rd_en : 1'b0;


    // TCAM Write Enable Decoder

    wire    [32-1:0]        tcam_row_wr_en;
    ...
    assign            tcam_row_wr_en[24]        = tcam_row_sel[24] ? wr_en : 1'b0;
    assign            tcam_row_wr_en[25]        = tcam_row_sel[25] ? wr_en : 1'b0;
    assign            tcam_row_wr_en[26]        = tcam_row_sel[26] ? wr_en : 1'b0;
    assign            tcam_row_wr_en[27]        = tcam_row_sel[27] ? wr_en : 1'b0;
    assign            tcam_row_wr_en[28]        = tcam_row_sel[28] ? wr_en : 1'b0;
    assign            tcam_row_wr_en[29]        = tcam_row_sel[29] ? wr_en : 1'b0;
    assign            tcam_row_wr_en[30]        = tcam_row_sel[30] ? wr_en : 1'b0;
    assign            tcam_row_wr_en[31]        = tcam_row_sel[31] ? wr_en : 1'b0;


    // Read Delay

    reg            rd_en_nope_done;
    reg    [32-1:0]    rd_en_delay_inst[TCAM_RD_DELAY:0];
    logic   [TCAM_RD_DELAY:0]               rd_en_delay;
    always_comb
         begin
        rd_en_delay_inst[0][32-1:0]        = tcam_row_rd_en[32-1:0];
    ...
    reg            wr_en_nope_done;
    reg    [32-1:0]    wr_en_delay_inst[TCAM_WR_DELAY:0];
    logic    [TCAM_WR_DELAY:0]               wr_en_delay;
    always_comb
         begin
        wr_en_delay_inst[0][32-1:0]        = tcam_row_wr_en[32-1:0];
    ...
    logic    [40-1:0]    tcam_row_wr_data;
    always_comb begin
            tcam_row_wr_data        = wr_data;
    end
    logic    [40-1:0]    tcam_wr_data_col[1-1:0];
    always_comb begin
        for (int i = 0; i < 1; i = i + 1) begin
            tcam_wr_data_col[i][40-1:0]        = tcam_row_wr_data[i*40+:40];
        end
    end
    ...
    logic    [40-1:0]    tcam_chk_key;
    always_comb begin
            tcam_chk_key        = chk_key;
    end
    logic    [40-1:0]    tcam_chk_key_col[1-1:0];
    always_comb begin
        for (int i = 0; i < 1; i = i + 1) begin
            tcam_chk_key_col[i][40-1:0]        = tcam_chk_key[i*40+:40];
        end
    end
    ...
    logic    [40-1:0]    tcam_chk_mask;
    always_comb begin
            tcam_chk_mask        = '0;
            tcam_chk_mask        = wr_en ? '1 : chk_mask_int;
    end
    logic    [40-1:0]    tcam_chk_mask_col[1-1:0];
    always_comb begin
        for (int i = 0; i < 1; i = i + 1) begin
            tcam_chk_mask_col[i][40-1:0]        = tcam_chk_mask[i*40+:40];
        end
    end
    ...
    logic    [8192-1:0]    tcam_hit_in;
    always_comb begin
        tcam_hit_in                = {8192{1'b1}};
        tcam_hit_in[TCAM_RULES_NUM-1:0]    = raw_hit_in[TCAM_RULES_NUM-1:0];
    end
    logic    [256-1:0]    tcam_raw_hit_in[32-1:0];
    always_comb begin
        for (int i = 0; i < 32; i = i + 1) begin
            tcam_raw_hit_in[i][256-1:0]        = tcam_hit_in[i*256+:256];
        end
    end
    ...
    logic    [40-1:0]    tcam_rd_data_col[32-1:0][1-1:0];
    logic    [40-1:0]    tcam_rd_data_row;
    always_comb begin
        for (int i = 0; i < 1; i = i + 1) begin
            tcam_rd_data_row[i*(40)+:40]        = tcam_rd_data_col[tcam_row_num_rd_en_delay[5-1:0]][i][40-1:0];
        end
    end
    ...
    logic    [256-1:0]    tcam_col_hit_out[32-1:0][1-1:0];
    logic    [8192-1:0]    tcam_hit_out;
    always_comb begin
        for (int i = 0; i < 32; i = i + 1) begin
            tcam_hit_out[i*256+:256]    =  tcam_col_hit_out[i][1-1];
        end
    end
    assign    raw_hit_out = tcam_hit_out[TCAM_RULES_NUM-1:0];
// Match In Array 

        logic    [256-1:0]      tcam_row_match_in[32-1:0];
        always_comb begin 
                for (int i = 0; i < 32; i = i + 1) begin
                    tcam_row_match_in[i] = tcam_match_in[i*256+:256]; 
                end
        end
    ...
    // EBBs Instantiation
        ...
        wire    [9-1:0]                       tcam_row_0_col_0_adr  = tcam_row_adr[0][9-1:0];
        wire    [40-1:0]                      tcam_row_0_col_0_data_in = tcam_row_wr_en[0] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_0_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_0_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_0_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_0_col_0_hit_in = tcam_raw_hit_in[0];
        wire    [256-1:0]                       tcam_row_0_col_0_tcam_match_in = tcam_row_match_in[0];
        wire    [40-1:0]                      tcam_row_0_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_0_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_0_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_0_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_0_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_0_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_0_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_0_col_0_tadr = 'b0;
        wire                            tcam_row_0_col_0_tvbe = 'b0;
        wire                            tcam_row_0_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_0_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_0_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_0_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_0_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_0_col_0 (
                   //-------------------------------------------------------------
                   ...
                   //-------------------------------------------------------------   
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_0_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        ...
        wire    [9-1:0]                       tcam_row_1_col_0_adr  = tcam_row_adr[1][9-1:0];
        wire    [40-1:0]                      tcam_row_1_col_0_data_in = tcam_row_wr_en[1] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_1_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_1_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_1_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_1_col_0_hit_in = tcam_raw_hit_in[1];
        wire    [256-1:0]                       tcam_row_1_col_0_tcam_match_in = tcam_row_match_in[1];
        wire    [40-1:0]                      tcam_row_1_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_1_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_1_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_1_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_1_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_1_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_1_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_1_col_0_tadr = 'b0;
        wire                            tcam_row_1_col_0_tvbe = 'b0;
        wire                            tcam_row_1_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_1_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_1_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_1_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_1_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_1_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_1_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        ...
        wire    [9-1:0]                       tcam_row_2_col_0_adr  = tcam_row_adr[2][9-1:0];
        wire    [40-1:0]                      tcam_row_2_col_0_data_in = tcam_row_wr_en[2] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_2_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_2_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_2_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_2_col_0_hit_in = tcam_raw_hit_in[2];
        wire    [256-1:0]                       tcam_row_2_col_0_tcam_match_in = tcam_row_match_in[2];
        wire    [40-1:0]                      tcam_row_2_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_2_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_2_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_2_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_2_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_2_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_2_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_2_col_0_tadr = 'b0;
        wire                            tcam_row_2_col_0_tvbe = 'b0;
        wire                            tcam_row_2_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_2_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_2_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_2_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_2_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_2_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_2_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
                        ...
                        .BIST_SHIFT_BIRA_COLLAR(BIST_SHIFT_BIRA_COLLAR), 
                        .CHECK_REPAIR_NEEDED(CHECK_REPAIR_NEEDED), 
                        .MEM22_BIST_COLLAR_SI(MEM22_BIST_COLLAR_SI), .BIST_SO(BIST_SO_ts22), 
                        .BIST_GO(BIST_GO_ts22), .ltest_to_en(ltest_to_en), 
                        .BIST_USER9(BIST_USER9), .BIST_USER10(BIST_USER10), 
                        .BIST_USER11(BIST_USER11), .BIST_USER0(BIST_USER0), 
                        .BIST_USER1(BIST_USER1), .BIST_USER2(BIST_USER2), 
                        .BIST_USER3(BIST_USER3), .BIST_USER4(BIST_USER4), 
                        ...
                        .bisr_clk_pd_vinf(bisr_clk_pd_vinf), 
                        .bisr_reset_pd_vinf(bisr_reset_pd_vinf), 
                        .tcam_row_29_col_0_bisr_inst_SO(tcam_row_29_col_0_bisr_inst_SO), 
        ...
        wire    [9-1:0]                       tcam_row_3_col_0_adr  = tcam_row_adr[3][9-1:0];
        wire    [40-1:0]                      tcam_row_3_col_0_data_in = tcam_row_wr_en[3] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_3_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_3_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_3_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_3_col_0_hit_in = tcam_raw_hit_in[3];
        wire    [256-1:0]                       tcam_row_3_col_0_tcam_match_in = tcam_row_match_in[3];
        wire    [40-1:0]                      tcam_row_3_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_3_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_3_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_3_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_3_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_3_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_3_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_3_col_0_tadr = 'b0;
        wire                            tcam_row_3_col_0_tvbe = 'b0;
        wire                            tcam_row_3_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_3_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_3_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_3_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_3_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_3_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_3_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
                        ...
                        .BIST_SHIFT_BIRA_COLLAR(BIST_SHIFT_BIRA_COLLAR), 
                        .CHECK_REPAIR_NEEDED(CHECK_REPAIR_NEEDED), 
                        .MEM25_BIST_COLLAR_SI(MEM25_BIST_COLLAR_SI), .BIST_SO(BIST_SO_ts25), 
                        .BIST_GO(BIST_GO_ts25), .ltest_to_en(ltest_to_en), 
                        .BIST_USER9(BIST_USER9), .BIST_USER10(BIST_USER10), 
                        .BIST_USER11(BIST_USER11), .BIST_USER0(BIST_USER0), 
                        .BIST_USER1(BIST_USER1), .BIST_USER2(BIST_USER2), 
                        .BIST_USER3(BIST_USER3), .BIST_USER4(BIST_USER4), 
                        ...
                        .bisr_clk_pd_vinf(bisr_clk_pd_vinf), 
                        .bisr_reset_pd_vinf(bisr_reset_pd_vinf), 
                        .tcam_row_31_col_0_bisr_inst_SO(tcam_row_31_col_0_bisr_inst_SO), 
        ...
        wire    [9-1:0]                       tcam_row_4_col_0_adr  = tcam_row_adr[4][9-1:0];
        wire    [40-1:0]                      tcam_row_4_col_0_data_in = tcam_row_wr_en[4] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_4_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_4_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_4_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_4_col_0_hit_in = tcam_raw_hit_in[4];
        wire    [256-1:0]                       tcam_row_4_col_0_tcam_match_in = tcam_row_match_in[4];
        wire    [40-1:0]                      tcam_row_4_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_4_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_4_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_4_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_4_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_4_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_4_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_4_col_0_tadr = 'b0;
        wire                            tcam_row_4_col_0_tvbe = 'b0;
        wire                            tcam_row_4_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_4_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_4_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_4_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_4_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_4_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_4_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
                        ...
                        .BIST_SHIFT_BIRA_COLLAR(BIST_SHIFT_BIRA_COLLAR), 
                        .CHECK_REPAIR_NEEDED(CHECK_REPAIR_NEEDED), 
                        .MEM26_BIST_COLLAR_SI(MEM26_BIST_COLLAR_SI), .BIST_SO(BIST_SO_ts26), 
                        .BIST_GO(BIST_GO_ts26), .ltest_to_en(ltest_to_en), 
                        .BIST_USER9(BIST_USER9), .BIST_USER10(BIST_USER10), 
                        .BIST_USER11(BIST_USER11), .BIST_USER0(BIST_USER0), 
                        .BIST_USER1(BIST_USER1), .BIST_USER2(BIST_USER2), 
                        .BIST_USER3(BIST_USER3), .BIST_USER4(BIST_USER4), 
        ...
        wire    [9-1:0]                       tcam_row_5_col_0_adr  = tcam_row_adr[5][9-1:0];
        wire    [40-1:0]                      tcam_row_5_col_0_data_in = tcam_row_wr_en[5] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_5_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_5_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_5_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_5_col_0_hit_in = tcam_raw_hit_in[5];
        wire    [256-1:0]                       tcam_row_5_col_0_tcam_match_in = tcam_row_match_in[5];
        wire    [40-1:0]                      tcam_row_5_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_5_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_5_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_5_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_5_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_5_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_5_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_5_col_0_tadr = 'b0;
        wire                            tcam_row_5_col_0_tvbe = 'b0;
        wire                            tcam_row_5_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_5_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_5_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_5_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_5_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_5_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_5_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
                        ...
                        .BIST_SHIFT_BIRA_COLLAR(BIST_SHIFT_BIRA_COLLAR), 
                        .CHECK_REPAIR_NEEDED(CHECK_REPAIR_NEEDED), 
                        .MEM27_BIST_COLLAR_SI(MEM27_BIST_COLLAR_SI), .BIST_SO(BIST_SO_ts27), 
                        .BIST_GO(BIST_GO_ts27), .ltest_to_en(ltest_to_en), 
                        .BIST_USER9(BIST_USER9), .BIST_USER10(BIST_USER10), 
                        .BIST_USER11(BIST_USER11), .BIST_USER0(BIST_USER0), 
                        .BIST_USER1(BIST_USER1), .BIST_USER2(BIST_USER2), 
                        .BIST_USER3(BIST_USER3), .BIST_USER4(BIST_USER4), 
        ...
        wire    [9-1:0]                       tcam_row_6_col_0_adr  = tcam_row_adr[6][9-1:0];
        wire    [40-1:0]                      tcam_row_6_col_0_data_in = tcam_row_wr_en[6] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_6_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_6_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_6_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_6_col_0_hit_in = tcam_raw_hit_in[6];
        wire    [256-1:0]                       tcam_row_6_col_0_tcam_match_in = tcam_row_match_in[6];
        wire    [40-1:0]                      tcam_row_6_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_6_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_6_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_6_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_6_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_6_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_6_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_6_col_0_tadr = 'b0;
        wire                            tcam_row_6_col_0_tvbe = 'b0;
        wire                            tcam_row_6_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_6_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_6_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_6_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_6_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_6_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_6_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
                        ...
                        .BIST_SHIFT_BIRA_COLLAR(BIST_SHIFT_BIRA_COLLAR), 
                        .CHECK_REPAIR_NEEDED(CHECK_REPAIR_NEEDED), 
                        .MEM28_BIST_COLLAR_SI(MEM28_BIST_COLLAR_SI), .BIST_SO(BIST_SO_ts28), 
                        .BIST_GO(BIST_GO_ts28), .ltest_to_en(ltest_to_en), 
                        .BIST_USER9(BIST_USER9), .BIST_USER10(BIST_USER10), 
                        .BIST_USER11(BIST_USER11), .BIST_USER0(BIST_USER0), 
                        .BIST_USER1(BIST_USER1), .BIST_USER2(BIST_USER2), 
                        .BIST_USER3(BIST_USER3), .BIST_USER4(BIST_USER4), 
        ...
        wire    [9-1:0]                       tcam_row_7_col_0_adr  = tcam_row_adr[7][9-1:0];
        wire    [40-1:0]                      tcam_row_7_col_0_data_in = tcam_row_wr_en[7] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_7_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_7_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_7_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_7_col_0_hit_in = tcam_raw_hit_in[7];
        wire    [256-1:0]                       tcam_row_7_col_0_tcam_match_in = tcam_row_match_in[7];
        wire    [40-1:0]                      tcam_row_7_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_7_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_7_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_7_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_7_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_7_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_7_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_7_col_0_tadr = 'b0;
        wire                            tcam_row_7_col_0_tvbe = 'b0;
        wire                            tcam_row_7_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_7_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_7_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_7_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_7_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_7_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_7_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
                        ...
                        .BIST_SHIFT_BIRA_COLLAR(BIST_SHIFT_BIRA_COLLAR), 
                        .CHECK_REPAIR_NEEDED(CHECK_REPAIR_NEEDED), 
                        .MEM29_BIST_COLLAR_SI(MEM29_BIST_COLLAR_SI), .BIST_SO(BIST_SO_ts29), 
                        .BIST_GO(BIST_GO_ts29), .ltest_to_en(ltest_to_en), 
                        .BIST_USER9(BIST_USER9), .BIST_USER10(BIST_USER10), 
                        .BIST_USER11(BIST_USER11), .BIST_USER0(BIST_USER0), 
                        .BIST_USER1(BIST_USER1), .BIST_USER2(BIST_USER2), 
                        .BIST_USER3(BIST_USER3), .BIST_USER4(BIST_USER4), 
        ...
        wire    [9-1:0]                       tcam_row_8_col_0_adr  = tcam_row_adr[8][9-1:0];
        wire    [40-1:0]                      tcam_row_8_col_0_data_in = tcam_row_wr_en[8] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_8_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_8_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_8_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_8_col_0_hit_in = tcam_raw_hit_in[8];
        wire    [256-1:0]                       tcam_row_8_col_0_tcam_match_in = tcam_row_match_in[8];
        wire    [40-1:0]                      tcam_row_8_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_8_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_8_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_8_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_8_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_8_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_8_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_8_col_0_tadr = 'b0;
        wire                            tcam_row_8_col_0_tvbe = 'b0;
        wire                            tcam_row_8_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_8_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_8_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_8_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_8_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_8_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_8_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
                        ...
                        .BIST_SHIFT_BIRA_COLLAR(BIST_SHIFT_BIRA_COLLAR), 
                        .CHECK_REPAIR_NEEDED(CHECK_REPAIR_NEEDED), 
                        .MEM30_BIST_COLLAR_SI(MEM30_BIST_COLLAR_SI), .BIST_SO(BIST_SO_ts30), 
                        .BIST_GO(BIST_GO_ts30), .ltest_to_en(ltest_to_en), 
                        .BIST_USER9(BIST_USER9), .BIST_USER10(BIST_USER10), 
                        .BIST_USER11(BIST_USER11), .BIST_USER0(BIST_USER0), 
                        .BIST_USER1(BIST_USER1), .BIST_USER2(BIST_USER2), 
                        .BIST_USER3(BIST_USER3), .BIST_USER4(BIST_USER4), 
        ...
        wire    [9-1:0]                       tcam_row_9_col_0_adr  = tcam_row_adr[9][9-1:0];
        wire    [40-1:0]                      tcam_row_9_col_0_data_in = tcam_row_wr_en[9] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_9_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_9_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_9_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_9_col_0_hit_in = tcam_raw_hit_in[9];
        wire    [256-1:0]                       tcam_row_9_col_0_tcam_match_in = tcam_row_match_in[9];
        wire    [40-1:0]                      tcam_row_9_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_9_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_9_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_9_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_9_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_9_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_9_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_9_col_0_tadr = 'b0;
        wire                            tcam_row_9_col_0_tvbe = 'b0;
        wire                            tcam_row_9_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_9_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_9_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_9_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_9_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_9_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_9_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
                        ...
                        .BIST_SHIFT_BIRA_COLLAR(BIST_SHIFT_BIRA_COLLAR), 
                        .CHECK_REPAIR_NEEDED(CHECK_REPAIR_NEEDED), 
                        .MEM31_BIST_COLLAR_SI(MEM31_BIST_COLLAR_SI), .BIST_SO(BIST_SO_ts31), 
                        .BIST_GO(BIST_GO_ts31), .ltest_to_en(ltest_to_en), 
                        .BIST_USER9(BIST_USER9), .BIST_USER10(BIST_USER10), 
                        .BIST_USER11(BIST_USER11), .BIST_USER0(BIST_USER0), 
                        .BIST_USER1(BIST_USER1), .BIST_USER2(BIST_USER2), 
                        .BIST_USER3(BIST_USER3), .BIST_USER4(BIST_USER4), 
        ...
        wire    [9-1:0]                       tcam_row_10_col_0_adr  = tcam_row_adr[10][9-1:0];
        wire    [40-1:0]                      tcam_row_10_col_0_data_in = tcam_row_wr_en[10] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_10_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_10_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_10_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_10_col_0_hit_in = tcam_raw_hit_in[10];
        wire    [256-1:0]                       tcam_row_10_col_0_tcam_match_in = tcam_row_match_in[10];
        wire    [40-1:0]                      tcam_row_10_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_10_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_10_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_10_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_10_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_10_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_10_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_10_col_0_tadr = 'b0;
        wire                            tcam_row_10_col_0_tvbe = 'b0;
        wire                            tcam_row_10_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_10_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_10_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_10_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_10_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_10_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_10_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        ...
        wire    [9-1:0]                       tcam_row_11_col_0_adr  = tcam_row_adr[11][9-1:0];
        wire    [40-1:0]                      tcam_row_11_col_0_data_in = tcam_row_wr_en[11] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_11_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_11_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_11_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_11_col_0_hit_in = tcam_raw_hit_in[11];
        wire    [256-1:0]                       tcam_row_11_col_0_tcam_match_in = tcam_row_match_in[11];
        wire    [40-1:0]                      tcam_row_11_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_11_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_11_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_11_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_11_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_11_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_11_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_11_col_0_tadr = 'b0;
        wire                            tcam_row_11_col_0_tvbe = 'b0;
        wire                            tcam_row_11_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_11_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_11_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_11_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_11_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_11_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_11_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        ...
        wire    [9-1:0]                       tcam_row_12_col_0_adr  = tcam_row_adr[12][9-1:0];
        wire    [40-1:0]                      tcam_row_12_col_0_data_in = tcam_row_wr_en[12] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_12_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_12_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_12_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_12_col_0_hit_in = tcam_raw_hit_in[12];
        wire    [256-1:0]                       tcam_row_12_col_0_tcam_match_in = tcam_row_match_in[12];
        wire    [40-1:0]                      tcam_row_12_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_12_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_12_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_12_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_12_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_12_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_12_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_12_col_0_tadr = 'b0;
        wire                            tcam_row_12_col_0_tvbe = 'b0;
        wire                            tcam_row_12_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_12_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_12_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_12_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_12_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_12_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_12_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        ...
        wire    [9-1:0]                       tcam_row_13_col_0_adr  = tcam_row_adr[13][9-1:0];
        wire    [40-1:0]                      tcam_row_13_col_0_data_in = tcam_row_wr_en[13] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_13_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_13_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_13_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_13_col_0_hit_in = tcam_raw_hit_in[13];
        wire    [256-1:0]                       tcam_row_13_col_0_tcam_match_in = tcam_row_match_in[13];
        wire    [40-1:0]                      tcam_row_13_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_13_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_13_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_13_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_13_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_13_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_13_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_13_col_0_tadr = 'b0;
        wire                            tcam_row_13_col_0_tvbe = 'b0;
        wire                            tcam_row_13_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_13_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_13_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_13_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_13_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_13_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_13_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        ...
        wire    [9-1:0]                       tcam_row_14_col_0_adr  = tcam_row_adr[14][9-1:0];
        wire    [40-1:0]                      tcam_row_14_col_0_data_in = tcam_row_wr_en[14] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_14_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_14_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_14_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_14_col_0_hit_in = tcam_raw_hit_in[14];
        wire    [256-1:0]                       tcam_row_14_col_0_tcam_match_in = tcam_row_match_in[14];
        wire    [40-1:0]                      tcam_row_14_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_14_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_14_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_14_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_14_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_14_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_14_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_14_col_0_tadr = 'b0;
        wire                            tcam_row_14_col_0_tvbe = 'b0;
        wire                            tcam_row_14_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_14_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_14_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_14_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_14_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_14_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_14_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        ...
        wire    [9-1:0]                       tcam_row_15_col_0_adr  = tcam_row_adr[15][9-1:0];
        wire    [40-1:0]                      tcam_row_15_col_0_data_in = tcam_row_wr_en[15] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_15_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_15_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_15_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_15_col_0_hit_in = tcam_raw_hit_in[15];
        wire    [256-1:0]                       tcam_row_15_col_0_tcam_match_in = tcam_row_match_in[15];
        wire    [40-1:0]                      tcam_row_15_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_15_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_15_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_15_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_15_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_15_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_15_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_15_col_0_tadr = 'b0;
        wire                            tcam_row_15_col_0_tvbe = 'b0;
        wire                            tcam_row_15_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_15_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_15_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_15_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_15_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_15_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_15_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        ...
        wire    [9-1:0]                       tcam_row_16_col_0_adr  = tcam_row_adr[16][9-1:0];
        wire    [40-1:0]                      tcam_row_16_col_0_data_in = tcam_row_wr_en[16] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_16_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_16_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_16_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_16_col_0_hit_in = tcam_raw_hit_in[16];
        wire    [256-1:0]                       tcam_row_16_col_0_tcam_match_in = tcam_row_match_in[16];
        wire    [40-1:0]                      tcam_row_16_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_16_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_16_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_16_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_16_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_16_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_16_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_16_col_0_tadr = 'b0;
        wire                            tcam_row_16_col_0_tvbe = 'b0;
        wire                            tcam_row_16_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_16_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_16_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_16_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_16_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_16_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_16_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        ...
        wire    [9-1:0]                       tcam_row_17_col_0_adr  = tcam_row_adr[17][9-1:0];
        wire    [40-1:0]                      tcam_row_17_col_0_data_in = tcam_row_wr_en[17] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_17_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_17_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_17_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_17_col_0_hit_in = tcam_raw_hit_in[17];
        wire    [256-1:0]                       tcam_row_17_col_0_tcam_match_in = tcam_row_match_in[17];
        wire    [40-1:0]                      tcam_row_17_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_17_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_17_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_17_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_17_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_17_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_17_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_17_col_0_tadr = 'b0;
        wire                            tcam_row_17_col_0_tvbe = 'b0;
        wire                            tcam_row_17_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_17_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_17_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_17_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_17_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_17_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_17_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        ...
        wire    [9-1:0]                       tcam_row_18_col_0_adr  = tcam_row_adr[18][9-1:0];
        wire    [40-1:0]                      tcam_row_18_col_0_data_in = tcam_row_wr_en[18] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_18_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_18_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_18_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_18_col_0_hit_in = tcam_raw_hit_in[18];
        wire    [256-1:0]                       tcam_row_18_col_0_tcam_match_in = tcam_row_match_in[18];
        wire    [40-1:0]                      tcam_row_18_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_18_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_18_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_18_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_18_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_18_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_18_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_18_col_0_tadr = 'b0;
        wire                            tcam_row_18_col_0_tvbe = 'b0;
        wire                            tcam_row_18_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_18_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_18_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_18_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_18_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_18_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_18_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        ...
        wire    [9-1:0]                       tcam_row_19_col_0_adr  = tcam_row_adr[19][9-1:0];
        wire    [40-1:0]                      tcam_row_19_col_0_data_in = tcam_row_wr_en[19] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_19_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_19_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_19_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_19_col_0_hit_in = tcam_raw_hit_in[19];
        wire    [256-1:0]                       tcam_row_19_col_0_tcam_match_in = tcam_row_match_in[19];
        wire    [40-1:0]                      tcam_row_19_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_19_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_19_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_19_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_19_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_19_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_19_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_19_col_0_tadr = 'b0;
        wire                            tcam_row_19_col_0_tvbe = 'b0;
        wire                            tcam_row_19_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_19_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_19_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_19_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_19_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_19_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_19_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        ...
        wire    [9-1:0]                       tcam_row_20_col_0_adr  = tcam_row_adr[20][9-1:0];
        wire    [40-1:0]                      tcam_row_20_col_0_data_in = tcam_row_wr_en[20] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_20_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_20_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_20_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_20_col_0_hit_in = tcam_raw_hit_in[20];
        wire    [256-1:0]                       tcam_row_20_col_0_tcam_match_in = tcam_row_match_in[20];
        wire    [40-1:0]                      tcam_row_20_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_20_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_20_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_20_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_20_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_20_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_20_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_20_col_0_tadr = 'b0;
        wire                            tcam_row_20_col_0_tvbe = 'b0;
        wire                            tcam_row_20_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_20_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_20_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_20_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_20_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_20_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_20_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        ...
        wire    [9-1:0]                       tcam_row_21_col_0_adr  = tcam_row_adr[21][9-1:0];
        wire    [40-1:0]                      tcam_row_21_col_0_data_in = tcam_row_wr_en[21] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_21_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_21_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_21_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_21_col_0_hit_in = tcam_raw_hit_in[21];
        wire    [256-1:0]                       tcam_row_21_col_0_tcam_match_in = tcam_row_match_in[21];
        wire    [40-1:0]                      tcam_row_21_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_21_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_21_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_21_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_21_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_21_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_21_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_21_col_0_tadr = 'b0;
        wire                            tcam_row_21_col_0_tvbe = 'b0;
        wire                            tcam_row_21_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_21_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_21_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_21_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_21_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_21_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_21_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        ...
        wire    [9-1:0]                       tcam_row_22_col_0_adr  = tcam_row_adr[22][9-1:0];
        wire    [40-1:0]                      tcam_row_22_col_0_data_in = tcam_row_wr_en[22] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_22_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_22_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_22_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_22_col_0_hit_in = tcam_raw_hit_in[22];
        wire    [256-1:0]                       tcam_row_22_col_0_tcam_match_in = tcam_row_match_in[22];
        wire    [40-1:0]                      tcam_row_22_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_22_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_22_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_22_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_22_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_22_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_22_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_22_col_0_tadr = 'b0;
        wire                            tcam_row_22_col_0_tvbe = 'b0;
        wire                            tcam_row_22_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_22_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_22_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_22_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_22_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_22_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_22_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        ...
        wire    [9-1:0]                       tcam_row_23_col_0_adr  = tcam_row_adr[23][9-1:0];
        wire    [40-1:0]                      tcam_row_23_col_0_data_in = tcam_row_wr_en[23] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_23_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_23_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_23_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_23_col_0_hit_in = tcam_raw_hit_in[23];
        wire    [256-1:0]                       tcam_row_23_col_0_tcam_match_in = tcam_row_match_in[23];
        wire    [40-1:0]                      tcam_row_23_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_23_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_23_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_23_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_23_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_23_col_0_fca = 'b0;
        ...
        wire      [40-1:0]    tcam_row_23_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_23_col_0_tadr = 'b0;
        wire                            tcam_row_23_col_0_tvbe = 'b0;
        wire                            tcam_row_23_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_23_col_0_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_23_col_0_slice_en_s1; 
             ...
             wire    [40-1:0]                     tcam_row_23_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         trc_ip783tcam256x40s0c1_23_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_23_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_23_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        ...
        wire                                            tcam_row_24_col_0_clk         = clk;
        
        wire    [TCAM_SLICE_EN_FACT-1:0]                tcam_row_24_col_0_slice_en = TCAM_SLICE_EN_FACT'(slice_en[(24 * TCAM_SLICE_EN_FACT)+:TCAM_SLICE_EN_MIN]);
        
        wire                                            tcam_row_24_col_0_rd_en       = tcam_row_rd_en[24];
        wire                                            tcam_row_24_col_0_wr_en       = tcam_row_wr_en[24];
        wire                                            tcam_row_24_col_0_chk_en      = chk_en;
        wire                                            tcam_row_24_col_0_reset_n = reset_n;
        wire    [9-1:0]                       tcam_row_24_col_0_adr  = tcam_row_adr[24][9-1:0];
        wire    [40-1:0]                      tcam_row_24_col_0_data_in = tcam_row_wr_en[24] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_24_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_24_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_24_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_24_col_0_hit_in = tcam_raw_hit_in[24];
        wire    [256-1:0]                       tcam_row_24_col_0_tcam_match_in = tcam_row_match_in[24];
        wire    [40-1:0]                      tcam_row_24_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_24_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_24_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_24_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_24_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_24_col_0_fca = 'b0;
        wire                            tcam_row_24_col_0_cre = 'b0;
        wire                            tcam_row_24_col_0_dftshiften = 'b0;
        wire                            tcam_row_24_col_0_dftmask = 'b0;
        wire                            tcam_row_24_col_0_dft_array_freeze = 'b0;
        wire                            tcam_row_24_col_0_dft_afd_reset_b = 'b0;
        wire      [40-1:0]    tcam_row_24_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_24_col_0_tadr = 'b0;
        wire                            tcam_row_24_col_0_tvbe = 'b0;
        wire                            tcam_row_24_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_24_col_0_tmask = 'b0;
        wire                            tcam_row_24_col_0_twe = 'b0;
        wire                            tcam_row_24_col_0_tre = 'b0;
        wire                            tcam_row_24_col_0_tme = 'b0;
        wire                            tcam_row_24_col_0_bist_rotate_sr = 'b0;
        wire                            tcam_row_24_col_0_bist_en_sr_mask_b = 'b0;
        wire                            tcam_row_24_col_0_bist_all_mask = 'b0;
        wire                            tcam_row_24_col_0_bist_en_sr_data_b = 'b0;
        wire                            tcam_row_24_col_0_bist_cm_mode = 'b0;
        wire                            tcam_row_24_col_0_bist_cm_en_in = 'b0;
        wire                            tcam_row_24_col_0_bist_cm_match_sel0 = 'b0;
        wire                            tcam_row_24_col_0_bist_cm_match_sel1 = 'b0;
        wire                            tcam_row_24_col_0_bist_matchin_in = 'b0;
        wire                            tcam_row_24_col_0_bist_fls = 'b0;
        
        `else
        wire                            tcam_row_24_col_0_biste = 'b0;
        wire     [6-1:0]                  tcam_row_24_col_0_fca = 'b0;
        wire                            tcam_row_24_col_0_cre = 'b0;
        wire                            tcam_row_24_col_0_dftshiften = dftshiften;
        wire                            tcam_row_24_col_0_dftmask = dftmask;
        wire                            tcam_row_24_col_0_dft_array_freeze = dft_array_freeze;
        wire                            tcam_row_24_col_0_dft_afd_reset_b = dft_afd_reset_b;
        wire      [40-1:0]    tcam_row_24_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_24_col_0_tadr = 'b0;
        wire                            tcam_row_24_col_0_tvbe = 'b0;
        wire                            tcam_row_24_col_0_tvbi = 'b0;
        ...
        // Outputs
        logic                           tcam_row_24_col_0_wr_bira_fail;
        logic                           tcam_row_24_col_0_wr_so;
        logic                           tcam_row_24_col_0_curerrout;
        logic                           tcam_row_24_col_0_rscout;
        
        
        
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_24_col_0_slice_en_s0; 
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_24_col_0_slice_en_s1; 
        
        
        
             wire    [40-1:0]                     tcam_row_24_col_0_data_out ;
        
        
        
         generate
            if (BCAM_N7 == 0) 
              begin : gen_tcam_row_24_col_0_tcam
        ...
        // slice_en kept for TCAM only for backward compatability with Intel process
                ...
                begin
                  for (int i = 0; i < TCAM_SLICE_EN_FACT; i++)
                      if (tcam_row_24_col_0_slice_en_s1[i])
                           tcam_row_24_col_0_hit_out[ i*64 +: 64]  = tcam_row_24_col_0_hit_out_int  [ i*64 +: 64]; 
                      else
                           tcam_row_24_col_0_hit_out[ i*64 +: 64]  = tcam_row_24_col_0_hit_out_latch[ i*64 +: 64]; 
                end
        
        
        
                always_ff  @(posedge tcam_row_24_col_0_clk)
                begin
                  tcam_row_24_col_0_slice_en_s0 <= tcam_row_24_col_0_slice_en; 
                  tcam_row_24_col_0_slice_en_s1 <= tcam_row_24_col_0_slice_en_s0; 
        
                  for (int i = 0; i < TCAM_SLICE_EN_FACT; i++)
                    begin
                      if (tcam_row_24_col_0_slice_en_s1[i])
                         tcam_row_24_col_0_hit_out_latch[ i*64 +: 64] <=  tcam_row_24_col_0_hit_out_int[ i*64 +: 64];
                    end
                end
        ...
        //                             |_____________________________|
                         ...
                         assign tcam_row_24_col_0_data_out  = ~tcam_row_24_col_0_data_out_inv;
                         trc_ip783tcam256x40s0c1_24_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_24_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_24_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        
                         .CLK               (tcam_row_24_col_0_clk), //Clock
                         .CMP               (tcam_row_24_col_0_chk_en), //Control Enable
                         .DIN               (~tcam_row_24_col_0_data_in), 
                         .DSEL              (~tcam_row_24_col_0_adr[0]), //dncen enables access of the TCAM Arrays adr_intessed
                         .FLS               (flush), //flush initiates a Flush operation that resets all Valid
                         .RVLD              (tcam_row_24_col_0_hit_in ), //Row validation bus. Each match_in input controls 1
                         .MASK              (tcam_row_24_col_0_mask_in), //Input msk
                         .QOUT              (tcam_row_24_col_0_data_out_inv), //Output vben
                         .QHR               (tcam_row_24_col_0_hit_out_int),
                         .QVLD              (), 
                         .RE                (tcam_row_24_col_0_rd_en), //Read Enable
                         .RST               (tcam_row_24_col_0_reset_n), //Asynchronous Active-High Reset
                         .VBE               (1'b1), //vben enables the Valid Bit addressed by adr[a-1:0] to
                         .VBI               (1'b0),//  Valid Bit Input
                         .WE                (tcam_row_24_col_0_wr_en), //Write Enable
                         .FAF               (tcam_row_24_col_0_fca),
                         .FAF_EN            (tcam_row_24_col_0_cre),
                         .DFTSHIFTEN        (tcam_row_24_col_0_dftshiften),
                         .DFTMASK           (tcam_row_24_col_0_dftmask),
                         .DFT_ARRAY_FREEZE  (tcam_row_24_col_0_dft_array_freeze),
                         .DFT_AFD_RESET_B   (tcam_row_24_col_0_dft_afd_reset_b),
                         .BISTE           (tcam_row_24_col_0_biste),
                         .TDIN (tcam_row_24_col_0_tdin),
                         .TADR (tcam_row_24_col_0_tadr),
                         .TVBE (tcam_row_24_col_0_tvbe),
                         .TVBI (tcam_row_24_col_0_tvbi),
                         .TMASK (tcam_row_24_col_0_tmask),
                         .TWE (tcam_row_24_col_0_twe),
                         .TRE (tcam_row_24_col_0_tre),
                         .TME (tcam_row_24_col_0_tme),
                         .BIST_ROTATE_SR (tcam_row_24_col_0_bist_rotate_sr),
                         .BIST_EN_SR_MASK_B (tcam_row_24_col_0_bist_en_sr_mask_b),
                         .BIST_ALL_MASK (tcam_row_24_col_0_bist_all_mask),
                         .BIST_EN_SR_DATA_B (tcam_row_24_col_0_bist_en_sr_data_b),
                         .BIST_CM_MODE (tcam_row_24_col_0_bist_cm_mode),
                         .BIST_CM_EN_IN (tcam_row_24_col_0_bist_cm_en_in),
                         .BIST_CM_MATCH_SEL0 (tcam_row_24_col_0_bist_cm_match_sel0),
                         .BIST_CM_MATCH_SEL1 (tcam_row_24_col_0_bist_cm_match_sel1),
                         .BIST_MATCHIN_IN (tcam_row_24_col_0_bist_matchin_in),
                         .BIST_FLS (tcam_row_24_col_0_bist_fls),
                         .MDST_tcam (fuse_tcam), .BIST_SETUP(BIST_SETUP), .BIST_SETUP_ts1(BIST_SETUP_ts1), 
                        .BIST_SETUP_ts2(BIST_SETUP_ts2), .to_interfaces_tck(to_interfaces_tck), 
                        .mcp_bounding_to_en(mcp_bounding_to_en), .scan_to_en(scan_to_en), 
                        .memory_bypass_to_en(memory_bypass_to_en), 
                        ...
                        .BIST_SHIFT_BIRA_COLLAR(BIST_SHIFT_BIRA_COLLAR), 
                        .CHECK_REPAIR_NEEDED(CHECK_REPAIR_NEEDED), 
                        .MEM16_BIST_COLLAR_SI(MEM16_BIST_COLLAR_SI), .BIST_SO(BIST_SO_ts16), 
                        .BIST_GO(BIST_GO_ts16), .ltest_to_en(ltest_to_en), 
                        .BIST_USER9(BIST_USER9), .BIST_USER10(BIST_USER10), 
                        .BIST_USER11(BIST_USER11), .BIST_USER0(BIST_USER0), 
                        .BIST_USER1(BIST_USER1), .BIST_USER2(BIST_USER2), 
                        .BIST_USER3(BIST_USER3), .BIST_USER4(BIST_USER4), 
                        ...
                        .bisr_reset_pd_vinf(bisr_reset_pd_vinf), 
                        .tcam_row_23_col_0_bisr_inst_SO(tcam_row_23_col_0_bisr_inst_SO), 
                        .tcam_row_24_col_0_bisr_inst_SO(tcam_row_24_col_0_bisr_inst_SO), 
                        .fscan_clkungate(fscan_clkungate)
                     );
              ...
              begin : gen_tcam_row_24_col_0_bcam
              end
        ...
        always_ff @(posedge clk) begin
                   tcam_rd_data_col[24][0]      <= tcam_row_24_col_0_data_out;
                   tcam_col_hit_out[24][0]       <= tcam_row_24_col_0_hit_out;
        end
        

        // this is new template - tcam_asic_template
        
        wire                                            tcam_row_25_col_0_clk         = clk;
        
        wire    [TCAM_SLICE_EN_FACT-1:0]                tcam_row_25_col_0_slice_en = TCAM_SLICE_EN_FACT'(slice_en[(25 * TCAM_SLICE_EN_FACT)+:TCAM_SLICE_EN_MIN]);
        
        wire                                            tcam_row_25_col_0_rd_en       = tcam_row_rd_en[25];
        wire                                            tcam_row_25_col_0_wr_en       = tcam_row_wr_en[25];
        wire                                            tcam_row_25_col_0_chk_en      = chk_en;
        wire                                            tcam_row_25_col_0_reset_n = reset_n;
        wire    [9-1:0]                       tcam_row_25_col_0_adr  = tcam_row_adr[25][9-1:0];
        wire    [40-1:0]                      tcam_row_25_col_0_data_in = tcam_row_wr_en[25] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_25_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_25_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_25_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_25_col_0_hit_in = tcam_raw_hit_in[25];
        wire    [256-1:0]                       tcam_row_25_col_0_tcam_match_in = tcam_row_match_in[25];
        wire    [40-1:0]                      tcam_row_25_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_25_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_25_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_25_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_25_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_25_col_0_fca = 'b0;
        wire                            tcam_row_25_col_0_cre = 'b0;
        wire                            tcam_row_25_col_0_dftshiften = 'b0;
        wire                            tcam_row_25_col_0_dftmask = 'b0;
        wire                            tcam_row_25_col_0_dft_array_freeze = 'b0;
        wire                            tcam_row_25_col_0_dft_afd_reset_b = 'b0;
        wire      [40-1:0]    tcam_row_25_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_25_col_0_tadr = 'b0;
        wire                            tcam_row_25_col_0_tvbe = 'b0;
        wire                            tcam_row_25_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_25_col_0_tmask = 'b0;
        wire                            tcam_row_25_col_0_twe = 'b0;
        wire                            tcam_row_25_col_0_tre = 'b0;
        wire                            tcam_row_25_col_0_tme = 'b0;
        wire                            tcam_row_25_col_0_bist_rotate_sr = 'b0;
        wire                            tcam_row_25_col_0_bist_en_sr_mask_b = 'b0;
        wire                            tcam_row_25_col_0_bist_all_mask = 'b0;
        wire                            tcam_row_25_col_0_bist_en_sr_data_b = 'b0;
        wire                            tcam_row_25_col_0_bist_cm_mode = 'b0;
        wire                            tcam_row_25_col_0_bist_cm_en_in = 'b0;
        wire                            tcam_row_25_col_0_bist_cm_match_sel0 = 'b0;
        wire                            tcam_row_25_col_0_bist_cm_match_sel1 = 'b0;
        wire                            tcam_row_25_col_0_bist_matchin_in = 'b0;
        wire                            tcam_row_25_col_0_bist_fls = 'b0;
        
        `else
        wire                            tcam_row_25_col_0_biste = 'b0;
        wire     [6-1:0]                  tcam_row_25_col_0_fca = 'b0;
        wire                            tcam_row_25_col_0_cre = 'b0;
        wire                            tcam_row_25_col_0_dftshiften = dftshiften;
        wire                            tcam_row_25_col_0_dftmask = dftmask;
        wire                            tcam_row_25_col_0_dft_array_freeze = dft_array_freeze;
        wire                            tcam_row_25_col_0_dft_afd_reset_b = dft_afd_reset_b;
        wire      [40-1:0]    tcam_row_25_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_25_col_0_tadr = 'b0;
        wire                            tcam_row_25_col_0_tvbe = 'b0;
        wire                            tcam_row_25_col_0_tvbi = 'b0;
        ...
        // Outputs
        logic                           tcam_row_25_col_0_wr_bira_fail;
        logic                           tcam_row_25_col_0_wr_so;
        logic                           tcam_row_25_col_0_curerrout;
        logic                           tcam_row_25_col_0_rscout;
        
        
        
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_25_col_0_slice_en_s0; 
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_25_col_0_slice_en_s1; 
        
        
        
             wire    [40-1:0]                     tcam_row_25_col_0_data_out ;
        
        
        
         generate
            if (BCAM_N7 == 0) 
              begin : gen_tcam_row_25_col_0_tcam
        ...
        // slice_en kept for TCAM only for backward compatability with Intel process
                ...
                begin
                  for (int i = 0; i < TCAM_SLICE_EN_FACT; i++)
                      if (tcam_row_25_col_0_slice_en_s1[i])
                           tcam_row_25_col_0_hit_out[ i*64 +: 64]  = tcam_row_25_col_0_hit_out_int  [ i*64 +: 64]; 
                      else
                           tcam_row_25_col_0_hit_out[ i*64 +: 64]  = tcam_row_25_col_0_hit_out_latch[ i*64 +: 64]; 
                end
        
        
        
                always_ff  @(posedge tcam_row_25_col_0_clk)
                begin
                  tcam_row_25_col_0_slice_en_s0 <= tcam_row_25_col_0_slice_en; 
                  tcam_row_25_col_0_slice_en_s1 <= tcam_row_25_col_0_slice_en_s0; 
        
                  for (int i = 0; i < TCAM_SLICE_EN_FACT; i++)
                    begin
                      if (tcam_row_25_col_0_slice_en_s1[i])
                         tcam_row_25_col_0_hit_out_latch[ i*64 +: 64] <=  tcam_row_25_col_0_hit_out_int[ i*64 +: 64];
                    end
                end
        ...
        //                             |_____________________________|
                         ...
                         assign tcam_row_25_col_0_data_out  = ~tcam_row_25_col_0_data_out_inv;
                         trc_ip783tcam256x40s0c1_25_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_25_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_25_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        
                         .CLK               (tcam_row_25_col_0_clk), //Clock
                         .CMP               (tcam_row_25_col_0_chk_en), //Control Enable
                         .DIN               (~tcam_row_25_col_0_data_in), 
                         .DSEL              (~tcam_row_25_col_0_adr[0]), //dncen enables access of the TCAM Arrays adr_intessed
                         .FLS               (flush), //flush initiates a Flush operation that resets all Valid
                         .RVLD              (tcam_row_25_col_0_hit_in ), //Row validation bus. Each match_in input controls 1
                         .MASK              (tcam_row_25_col_0_mask_in), //Input msk
                         .QOUT              (tcam_row_25_col_0_data_out_inv), //Output vben
                         .QHR               (tcam_row_25_col_0_hit_out_int),
                         .QVLD              (), 
                         .RE                (tcam_row_25_col_0_rd_en), //Read Enable
                         .RST               (tcam_row_25_col_0_reset_n), //Asynchronous Active-High Reset
                         .VBE               (1'b1), //vben enables the Valid Bit addressed by adr[a-1:0] to
                         .VBI               (1'b0),//  Valid Bit Input
                         .WE                (tcam_row_25_col_0_wr_en), //Write Enable
                         .FAF               (tcam_row_25_col_0_fca),
                         .FAF_EN            (tcam_row_25_col_0_cre),
                         .DFTSHIFTEN        (tcam_row_25_col_0_dftshiften),
                         .DFTMASK           (tcam_row_25_col_0_dftmask),
                         .DFT_ARRAY_FREEZE  (tcam_row_25_col_0_dft_array_freeze),
                         .DFT_AFD_RESET_B   (tcam_row_25_col_0_dft_afd_reset_b),
                         .BISTE           (tcam_row_25_col_0_biste),
                         .TDIN (tcam_row_25_col_0_tdin),
                         .TADR (tcam_row_25_col_0_tadr),
                         .TVBE (tcam_row_25_col_0_tvbe),
                         .TVBI (tcam_row_25_col_0_tvbi),
                         .TMASK (tcam_row_25_col_0_tmask),
                         .TWE (tcam_row_25_col_0_twe),
                         .TRE (tcam_row_25_col_0_tre),
                         .TME (tcam_row_25_col_0_tme),
                         .BIST_ROTATE_SR (tcam_row_25_col_0_bist_rotate_sr),
                         .BIST_EN_SR_MASK_B (tcam_row_25_col_0_bist_en_sr_mask_b),
                         .BIST_ALL_MASK (tcam_row_25_col_0_bist_all_mask),
                         .BIST_EN_SR_DATA_B (tcam_row_25_col_0_bist_en_sr_data_b),
                         .BIST_CM_MODE (tcam_row_25_col_0_bist_cm_mode),
                         .BIST_CM_EN_IN (tcam_row_25_col_0_bist_cm_en_in),
                         .BIST_CM_MATCH_SEL0 (tcam_row_25_col_0_bist_cm_match_sel0),
                         .BIST_CM_MATCH_SEL1 (tcam_row_25_col_0_bist_cm_match_sel1),
                         .BIST_MATCHIN_IN (tcam_row_25_col_0_bist_matchin_in),
                         .BIST_FLS (tcam_row_25_col_0_bist_fls),
                         .MDST_tcam (fuse_tcam), .BIST_SETUP(BIST_SETUP), .BIST_SETUP_ts1(BIST_SETUP_ts1), 
                        .BIST_SETUP_ts2(BIST_SETUP_ts2), .to_interfaces_tck(to_interfaces_tck), 
                        .mcp_bounding_to_en(mcp_bounding_to_en), .scan_to_en(scan_to_en), 
                        .memory_bypass_to_en(memory_bypass_to_en), 
                        ...
                        .BIST_SHIFT_BIRA_COLLAR(BIST_SHIFT_BIRA_COLLAR), 
                        .CHECK_REPAIR_NEEDED(CHECK_REPAIR_NEEDED), 
                        .MEM17_BIST_COLLAR_SI(MEM17_BIST_COLLAR_SI), .BIST_SO(BIST_SO_ts17), 
                        .BIST_GO(BIST_GO_ts17), .ltest_to_en(ltest_to_en), 
                        .BIST_USER9(BIST_USER9), .BIST_USER10(BIST_USER10), 
                        .BIST_USER11(BIST_USER11), .BIST_USER0(BIST_USER0), 
                        .BIST_USER1(BIST_USER1), .BIST_USER2(BIST_USER2), 
                        .BIST_USER3(BIST_USER3), .BIST_USER4(BIST_USER4), 
                        ...
                        .bisr_reset_pd_vinf(bisr_reset_pd_vinf), 
                        .tcam_row_24_col_0_bisr_inst_SO(tcam_row_24_col_0_bisr_inst_SO), 
                        .tcam_row_25_col_0_bisr_inst_SO(tcam_row_25_col_0_bisr_inst_SO), 
                        .fscan_clkungate(fscan_clkungate)
                     );
              ...
              begin : gen_tcam_row_25_col_0_bcam
              end
        ...
        always_ff @(posedge clk) begin
                   tcam_rd_data_col[25][0]      <= tcam_row_25_col_0_data_out;
                   tcam_col_hit_out[25][0]       <= tcam_row_25_col_0_hit_out;
        end
        

        // this is new template - tcam_asic_template
        
        wire                                            tcam_row_26_col_0_clk         = clk;
        
        wire    [TCAM_SLICE_EN_FACT-1:0]                tcam_row_26_col_0_slice_en = TCAM_SLICE_EN_FACT'(slice_en[(26 * TCAM_SLICE_EN_FACT)+:TCAM_SLICE_EN_MIN]);
        
        wire                                            tcam_row_26_col_0_rd_en       = tcam_row_rd_en[26];
        wire                                            tcam_row_26_col_0_wr_en       = tcam_row_wr_en[26];
        wire                                            tcam_row_26_col_0_chk_en      = chk_en;
        wire                                            tcam_row_26_col_0_reset_n = reset_n;
        wire    [9-1:0]                       tcam_row_26_col_0_adr  = tcam_row_adr[26][9-1:0];
        wire    [40-1:0]                      tcam_row_26_col_0_data_in = tcam_row_wr_en[26] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_26_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_26_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_26_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_26_col_0_hit_in = tcam_raw_hit_in[26];
        wire    [256-1:0]                       tcam_row_26_col_0_tcam_match_in = tcam_row_match_in[26];
        wire    [40-1:0]                      tcam_row_26_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_26_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_26_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_26_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_26_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_26_col_0_fca = 'b0;
        wire                            tcam_row_26_col_0_cre = 'b0;
        wire                            tcam_row_26_col_0_dftshiften = 'b0;
        wire                            tcam_row_26_col_0_dftmask = 'b0;
        wire                            tcam_row_26_col_0_dft_array_freeze = 'b0;
        wire                            tcam_row_26_col_0_dft_afd_reset_b = 'b0;
        wire      [40-1:0]    tcam_row_26_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_26_col_0_tadr = 'b0;
        wire                            tcam_row_26_col_0_tvbe = 'b0;
        wire                            tcam_row_26_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_26_col_0_tmask = 'b0;
        wire                            tcam_row_26_col_0_twe = 'b0;
        wire                            tcam_row_26_col_0_tre = 'b0;
        wire                            tcam_row_26_col_0_tme = 'b0;
        wire                            tcam_row_26_col_0_bist_rotate_sr = 'b0;
        wire                            tcam_row_26_col_0_bist_en_sr_mask_b = 'b0;
        wire                            tcam_row_26_col_0_bist_all_mask = 'b0;
        wire                            tcam_row_26_col_0_bist_en_sr_data_b = 'b0;
        wire                            tcam_row_26_col_0_bist_cm_mode = 'b0;
        wire                            tcam_row_26_col_0_bist_cm_en_in = 'b0;
        wire                            tcam_row_26_col_0_bist_cm_match_sel0 = 'b0;
        wire                            tcam_row_26_col_0_bist_cm_match_sel1 = 'b0;
        wire                            tcam_row_26_col_0_bist_matchin_in = 'b0;
        wire                            tcam_row_26_col_0_bist_fls = 'b0;
        
        `else
        wire                            tcam_row_26_col_0_biste = 'b0;
        wire     [6-1:0]                  tcam_row_26_col_0_fca = 'b0;
        wire                            tcam_row_26_col_0_cre = 'b0;
        wire                            tcam_row_26_col_0_dftshiften = dftshiften;
        wire                            tcam_row_26_col_0_dftmask = dftmask;
        wire                            tcam_row_26_col_0_dft_array_freeze = dft_array_freeze;
        wire                            tcam_row_26_col_0_dft_afd_reset_b = dft_afd_reset_b;
        wire      [40-1:0]    tcam_row_26_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_26_col_0_tadr = 'b0;
        wire                            tcam_row_26_col_0_tvbe = 'b0;
        wire                            tcam_row_26_col_0_tvbi = 'b0;
        ...
        // Outputs
        logic                           tcam_row_26_col_0_wr_bira_fail;
        logic                           tcam_row_26_col_0_wr_so;
        logic                           tcam_row_26_col_0_curerrout;
        logic                           tcam_row_26_col_0_rscout;
        
        
        
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_26_col_0_slice_en_s0; 
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_26_col_0_slice_en_s1; 
        
        
        
             wire    [40-1:0]                     tcam_row_26_col_0_data_out ;
        
        
        
         generate
            if (BCAM_N7 == 0) 
              begin : gen_tcam_row_26_col_0_tcam
        ...
        // slice_en kept for TCAM only for backward compatability with Intel process
                ...
                begin
                  for (int i = 0; i < TCAM_SLICE_EN_FACT; i++)
                      if (tcam_row_26_col_0_slice_en_s1[i])
                           tcam_row_26_col_0_hit_out[ i*64 +: 64]  = tcam_row_26_col_0_hit_out_int  [ i*64 +: 64]; 
                      else
                           tcam_row_26_col_0_hit_out[ i*64 +: 64]  = tcam_row_26_col_0_hit_out_latch[ i*64 +: 64]; 
                end
        
        
        
                always_ff  @(posedge tcam_row_26_col_0_clk)
                begin
                  tcam_row_26_col_0_slice_en_s0 <= tcam_row_26_col_0_slice_en; 
                  tcam_row_26_col_0_slice_en_s1 <= tcam_row_26_col_0_slice_en_s0; 
        
                  for (int i = 0; i < TCAM_SLICE_EN_FACT; i++)
                    begin
                      if (tcam_row_26_col_0_slice_en_s1[i])
                         tcam_row_26_col_0_hit_out_latch[ i*64 +: 64] <=  tcam_row_26_col_0_hit_out_int[ i*64 +: 64];
                    end
                end
        ...
        //                             |_____________________________|
                         ...
                         assign tcam_row_26_col_0_data_out  = ~tcam_row_26_col_0_data_out_inv;
                         trc_ip783tcam256x40s0c1_26_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_26_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_26_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        
                         .CLK               (tcam_row_26_col_0_clk), //Clock
                         .CMP               (tcam_row_26_col_0_chk_en), //Control Enable
                         .DIN               (~tcam_row_26_col_0_data_in), 
                         .DSEL              (~tcam_row_26_col_0_adr[0]), //dncen enables access of the TCAM Arrays adr_intessed
                         .FLS               (flush), //flush initiates a Flush operation that resets all Valid
                         .RVLD              (tcam_row_26_col_0_hit_in ), //Row validation bus. Each match_in input controls 1
                         .MASK              (tcam_row_26_col_0_mask_in), //Input msk
                         .QOUT              (tcam_row_26_col_0_data_out_inv), //Output vben
                         .QHR               (tcam_row_26_col_0_hit_out_int),
                         .QVLD              (), 
                         .RE                (tcam_row_26_col_0_rd_en), //Read Enable
                         .RST               (tcam_row_26_col_0_reset_n), //Asynchronous Active-High Reset
                         .VBE               (1'b1), //vben enables the Valid Bit addressed by adr[a-1:0] to
                         .VBI               (1'b0),//  Valid Bit Input
                         .WE                (tcam_row_26_col_0_wr_en), //Write Enable
                         .FAF               (tcam_row_26_col_0_fca),
                         .FAF_EN            (tcam_row_26_col_0_cre),
                         .DFTSHIFTEN        (tcam_row_26_col_0_dftshiften),
                         .DFTMASK           (tcam_row_26_col_0_dftmask),
                         .DFT_ARRAY_FREEZE  (tcam_row_26_col_0_dft_array_freeze),
                         .DFT_AFD_RESET_B   (tcam_row_26_col_0_dft_afd_reset_b),
                         .BISTE           (tcam_row_26_col_0_biste),
                         .TDIN (tcam_row_26_col_0_tdin),
                         .TADR (tcam_row_26_col_0_tadr),
                         .TVBE (tcam_row_26_col_0_tvbe),
                         .TVBI (tcam_row_26_col_0_tvbi),
                         .TMASK (tcam_row_26_col_0_tmask),
                         .TWE (tcam_row_26_col_0_twe),
                         .TRE (tcam_row_26_col_0_tre),
                         .TME (tcam_row_26_col_0_tme),
                         .BIST_ROTATE_SR (tcam_row_26_col_0_bist_rotate_sr),
                         .BIST_EN_SR_MASK_B (tcam_row_26_col_0_bist_en_sr_mask_b),
                         .BIST_ALL_MASK (tcam_row_26_col_0_bist_all_mask),
                         .BIST_EN_SR_DATA_B (tcam_row_26_col_0_bist_en_sr_data_b),
                         .BIST_CM_MODE (tcam_row_26_col_0_bist_cm_mode),
                         .BIST_CM_EN_IN (tcam_row_26_col_0_bist_cm_en_in),
                         .BIST_CM_MATCH_SEL0 (tcam_row_26_col_0_bist_cm_match_sel0),
                         .BIST_CM_MATCH_SEL1 (tcam_row_26_col_0_bist_cm_match_sel1),
                         .BIST_MATCHIN_IN (tcam_row_26_col_0_bist_matchin_in),
                         .BIST_FLS (tcam_row_26_col_0_bist_fls),
                         .MDST_tcam (fuse_tcam), .BIST_SETUP(BIST_SETUP), .BIST_SETUP_ts1(BIST_SETUP_ts1), 
                        .BIST_SETUP_ts2(BIST_SETUP_ts2), .to_interfaces_tck(to_interfaces_tck), 
                        .mcp_bounding_to_en(mcp_bounding_to_en), .scan_to_en(scan_to_en), 
                        .memory_bypass_to_en(memory_bypass_to_en), 
                        ...
                        .BIST_SHIFT_BIRA_COLLAR(BIST_SHIFT_BIRA_COLLAR), 
                        .CHECK_REPAIR_NEEDED(CHECK_REPAIR_NEEDED), 
                        .MEM18_BIST_COLLAR_SI(MEM18_BIST_COLLAR_SI), .BIST_SO(BIST_SO_ts18), 
                        .BIST_GO(BIST_GO_ts18), .ltest_to_en(ltest_to_en), 
                        .BIST_USER9(BIST_USER9), .BIST_USER10(BIST_USER10), 
                        .BIST_USER11(BIST_USER11), .BIST_USER0(BIST_USER0), 
                        .BIST_USER1(BIST_USER1), .BIST_USER2(BIST_USER2), 
                        .BIST_USER3(BIST_USER3), .BIST_USER4(BIST_USER4), 
                        ...
                        .bisr_reset_pd_vinf(bisr_reset_pd_vinf), 
                        .tcam_row_25_col_0_bisr_inst_SO(tcam_row_25_col_0_bisr_inst_SO), 
                        .tcam_row_26_col_0_bisr_inst_SO(tcam_row_26_col_0_bisr_inst_SO), 
                        .fscan_clkungate(fscan_clkungate)
                     );
              ...
              begin : gen_tcam_row_26_col_0_bcam
              end
        ...
        always_ff @(posedge clk) begin
                   tcam_rd_data_col[26][0]      <= tcam_row_26_col_0_data_out;
                   tcam_col_hit_out[26][0]       <= tcam_row_26_col_0_hit_out;
        end
        

        // this is new template - tcam_asic_template
        
        wire                                            tcam_row_27_col_0_clk         = clk;
        
        wire    [TCAM_SLICE_EN_FACT-1:0]                tcam_row_27_col_0_slice_en = TCAM_SLICE_EN_FACT'(slice_en[(27 * TCAM_SLICE_EN_FACT)+:TCAM_SLICE_EN_MIN]);
        
        wire                                            tcam_row_27_col_0_rd_en       = tcam_row_rd_en[27];
        wire                                            tcam_row_27_col_0_wr_en       = tcam_row_wr_en[27];
        wire                                            tcam_row_27_col_0_chk_en      = chk_en;
        wire                                            tcam_row_27_col_0_reset_n = reset_n;
        wire    [9-1:0]                       tcam_row_27_col_0_adr  = tcam_row_adr[27][9-1:0];
        wire    [40-1:0]                      tcam_row_27_col_0_data_in = tcam_row_wr_en[27] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_27_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_27_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_27_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_27_col_0_hit_in = tcam_raw_hit_in[27];
        wire    [256-1:0]                       tcam_row_27_col_0_tcam_match_in = tcam_row_match_in[27];
        wire    [40-1:0]                      tcam_row_27_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_27_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_27_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_27_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_27_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_27_col_0_fca = 'b0;
        wire                            tcam_row_27_col_0_cre = 'b0;
        wire                            tcam_row_27_col_0_dftshiften = 'b0;
        wire                            tcam_row_27_col_0_dftmask = 'b0;
        wire                            tcam_row_27_col_0_dft_array_freeze = 'b0;
        wire                            tcam_row_27_col_0_dft_afd_reset_b = 'b0;
        wire      [40-1:0]    tcam_row_27_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_27_col_0_tadr = 'b0;
        wire                            tcam_row_27_col_0_tvbe = 'b0;
        wire                            tcam_row_27_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_27_col_0_tmask = 'b0;
        wire                            tcam_row_27_col_0_twe = 'b0;
        wire                            tcam_row_27_col_0_tre = 'b0;
        wire                            tcam_row_27_col_0_tme = 'b0;
        wire                            tcam_row_27_col_0_bist_rotate_sr = 'b0;
        wire                            tcam_row_27_col_0_bist_en_sr_mask_b = 'b0;
        wire                            tcam_row_27_col_0_bist_all_mask = 'b0;
        wire                            tcam_row_27_col_0_bist_en_sr_data_b = 'b0;
        wire                            tcam_row_27_col_0_bist_cm_mode = 'b0;
        wire                            tcam_row_27_col_0_bist_cm_en_in = 'b0;
        wire                            tcam_row_27_col_0_bist_cm_match_sel0 = 'b0;
        wire                            tcam_row_27_col_0_bist_cm_match_sel1 = 'b0;
        wire                            tcam_row_27_col_0_bist_matchin_in = 'b0;
        wire                            tcam_row_27_col_0_bist_fls = 'b0;
        
        `else
        wire                            tcam_row_27_col_0_biste = 'b0;
        wire     [6-1:0]                  tcam_row_27_col_0_fca = 'b0;
        wire                            tcam_row_27_col_0_cre = 'b0;
        wire                            tcam_row_27_col_0_dftshiften = dftshiften;
        wire                            tcam_row_27_col_0_dftmask = dftmask;
        wire                            tcam_row_27_col_0_dft_array_freeze = dft_array_freeze;
        wire                            tcam_row_27_col_0_dft_afd_reset_b = dft_afd_reset_b;
        wire      [40-1:0]    tcam_row_27_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_27_col_0_tadr = 'b0;
        wire                            tcam_row_27_col_0_tvbe = 'b0;
        wire                            tcam_row_27_col_0_tvbi = 'b0;
        ...
        // Outputs
        logic                           tcam_row_27_col_0_wr_bira_fail;
        logic                           tcam_row_27_col_0_wr_so;
        logic                           tcam_row_27_col_0_curerrout;
        logic                           tcam_row_27_col_0_rscout;
        
        
        
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_27_col_0_slice_en_s0; 
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_27_col_0_slice_en_s1; 
        
        
        
             wire    [40-1:0]                     tcam_row_27_col_0_data_out ;
        
        
        
         generate
            if (BCAM_N7 == 0) 
              begin : gen_tcam_row_27_col_0_tcam
        ...
        // slice_en kept for TCAM only for backward compatability with Intel process
                ...
                begin
                  for (int i = 0; i < TCAM_SLICE_EN_FACT; i++)
                      if (tcam_row_27_col_0_slice_en_s1[i])
                           tcam_row_27_col_0_hit_out[ i*64 +: 64]  = tcam_row_27_col_0_hit_out_int  [ i*64 +: 64]; 
                      else
                           tcam_row_27_col_0_hit_out[ i*64 +: 64]  = tcam_row_27_col_0_hit_out_latch[ i*64 +: 64]; 
                end
        
        
        
                always_ff  @(posedge tcam_row_27_col_0_clk)
                begin
                  tcam_row_27_col_0_slice_en_s0 <= tcam_row_27_col_0_slice_en; 
                  tcam_row_27_col_0_slice_en_s1 <= tcam_row_27_col_0_slice_en_s0; 
        
                  for (int i = 0; i < TCAM_SLICE_EN_FACT; i++)
                    begin
                      if (tcam_row_27_col_0_slice_en_s1[i])
                         tcam_row_27_col_0_hit_out_latch[ i*64 +: 64] <=  tcam_row_27_col_0_hit_out_int[ i*64 +: 64];
                    end
                end
        ...
        //                             |_____________________________|
                         ...
                         assign tcam_row_27_col_0_data_out  = ~tcam_row_27_col_0_data_out_inv;
                         trc_ip783tcam256x40s0c1_27_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_27_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_27_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        
                         .CLK               (tcam_row_27_col_0_clk), //Clock
                         .CMP               (tcam_row_27_col_0_chk_en), //Control Enable
                         .DIN               (~tcam_row_27_col_0_data_in), 
                         .DSEL              (~tcam_row_27_col_0_adr[0]), //dncen enables access of the TCAM Arrays adr_intessed
                         .FLS               (flush), //flush initiates a Flush operation that resets all Valid
                         .RVLD              (tcam_row_27_col_0_hit_in ), //Row validation bus. Each match_in input controls 1
                         .MASK              (tcam_row_27_col_0_mask_in), //Input msk
                         .QOUT              (tcam_row_27_col_0_data_out_inv), //Output vben
                         .QHR               (tcam_row_27_col_0_hit_out_int),
                         .QVLD              (), 
                         .RE                (tcam_row_27_col_0_rd_en), //Read Enable
                         .RST               (tcam_row_27_col_0_reset_n), //Asynchronous Active-High Reset
                         .VBE               (1'b1), //vben enables the Valid Bit addressed by adr[a-1:0] to
                         .VBI               (1'b0),//  Valid Bit Input
                         .WE                (tcam_row_27_col_0_wr_en), //Write Enable
                         .FAF               (tcam_row_27_col_0_fca),
                         .FAF_EN            (tcam_row_27_col_0_cre),
                         .DFTSHIFTEN        (tcam_row_27_col_0_dftshiften),
                         .DFTMASK           (tcam_row_27_col_0_dftmask),
                         .DFT_ARRAY_FREEZE  (tcam_row_27_col_0_dft_array_freeze),
                         .DFT_AFD_RESET_B   (tcam_row_27_col_0_dft_afd_reset_b),
                         .BISTE           (tcam_row_27_col_0_biste),
                         .TDIN (tcam_row_27_col_0_tdin),
                         .TADR (tcam_row_27_col_0_tadr),
                         .TVBE (tcam_row_27_col_0_tvbe),
                         .TVBI (tcam_row_27_col_0_tvbi),
                         .TMASK (tcam_row_27_col_0_tmask),
                         .TWE (tcam_row_27_col_0_twe),
                         .TRE (tcam_row_27_col_0_tre),
                         .TME (tcam_row_27_col_0_tme),
                         .BIST_ROTATE_SR (tcam_row_27_col_0_bist_rotate_sr),
                         .BIST_EN_SR_MASK_B (tcam_row_27_col_0_bist_en_sr_mask_b),
                         .BIST_ALL_MASK (tcam_row_27_col_0_bist_all_mask),
                         .BIST_EN_SR_DATA_B (tcam_row_27_col_0_bist_en_sr_data_b),
                         .BIST_CM_MODE (tcam_row_27_col_0_bist_cm_mode),
                         .BIST_CM_EN_IN (tcam_row_27_col_0_bist_cm_en_in),
                         .BIST_CM_MATCH_SEL0 (tcam_row_27_col_0_bist_cm_match_sel0),
                         .BIST_CM_MATCH_SEL1 (tcam_row_27_col_0_bist_cm_match_sel1),
                         .BIST_MATCHIN_IN (tcam_row_27_col_0_bist_matchin_in),
                         .BIST_FLS (tcam_row_27_col_0_bist_fls),
                         .MDST_tcam (fuse_tcam), .BIST_SETUP(BIST_SETUP), .BIST_SETUP_ts1(BIST_SETUP_ts1), 
                        .BIST_SETUP_ts2(BIST_SETUP_ts2), .to_interfaces_tck(to_interfaces_tck), 
                        .mcp_bounding_to_en(mcp_bounding_to_en), .scan_to_en(scan_to_en), 
                        .memory_bypass_to_en(memory_bypass_to_en), 
                        ...
                        .BIST_SHIFT_BIRA_COLLAR(BIST_SHIFT_BIRA_COLLAR), 
                        .CHECK_REPAIR_NEEDED(CHECK_REPAIR_NEEDED), 
                        .MEM19_BIST_COLLAR_SI(MEM19_BIST_COLLAR_SI), .BIST_SO(BIST_SO_ts19), 
                        .BIST_GO(BIST_GO_ts19), .ltest_to_en(ltest_to_en), 
                        .BIST_USER9(BIST_USER9), .BIST_USER10(BIST_USER10), 
                        .BIST_USER11(BIST_USER11), .BIST_USER0(BIST_USER0), 
                        .BIST_USER1(BIST_USER1), .BIST_USER2(BIST_USER2), 
                        .BIST_USER3(BIST_USER3), .BIST_USER4(BIST_USER4), 
                        ...
                        .bisr_reset_pd_vinf(bisr_reset_pd_vinf), 
                        .tcam_row_26_col_0_bisr_inst_SO(tcam_row_26_col_0_bisr_inst_SO), 
                        .tcam_row_27_col_0_bisr_inst_SO(tcam_row_27_col_0_bisr_inst_SO), 
                        .fscan_clkungate(fscan_clkungate)
                     );
              ...
              begin : gen_tcam_row_27_col_0_bcam
              end
        ...
        always_ff @(posedge clk) begin
                   tcam_rd_data_col[27][0]      <= tcam_row_27_col_0_data_out;
                   tcam_col_hit_out[27][0]       <= tcam_row_27_col_0_hit_out;
        end
        

        // this is new template - tcam_asic_template
        
        wire                                            tcam_row_28_col_0_clk         = clk;
        
        wire    [TCAM_SLICE_EN_FACT-1:0]                tcam_row_28_col_0_slice_en = TCAM_SLICE_EN_FACT'(slice_en[(28 * TCAM_SLICE_EN_FACT)+:TCAM_SLICE_EN_MIN]);
        
        wire                                            tcam_row_28_col_0_rd_en       = tcam_row_rd_en[28];
        wire                                            tcam_row_28_col_0_wr_en       = tcam_row_wr_en[28];
        wire                                            tcam_row_28_col_0_chk_en      = chk_en;
        wire                                            tcam_row_28_col_0_reset_n = reset_n;
        wire    [9-1:0]                       tcam_row_28_col_0_adr  = tcam_row_adr[28][9-1:0];
        wire    [40-1:0]                      tcam_row_28_col_0_data_in = tcam_row_wr_en[28] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_28_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_28_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_28_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_28_col_0_hit_in = tcam_raw_hit_in[28];
        wire    [256-1:0]                       tcam_row_28_col_0_tcam_match_in = tcam_row_match_in[28];
        wire    [40-1:0]                      tcam_row_28_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_28_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_28_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_28_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_28_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_28_col_0_fca = 'b0;
        wire                            tcam_row_28_col_0_cre = 'b0;
        wire                            tcam_row_28_col_0_dftshiften = 'b0;
        wire                            tcam_row_28_col_0_dftmask = 'b0;
        wire                            tcam_row_28_col_0_dft_array_freeze = 'b0;
        wire                            tcam_row_28_col_0_dft_afd_reset_b = 'b0;
        wire      [40-1:0]    tcam_row_28_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_28_col_0_tadr = 'b0;
        wire                            tcam_row_28_col_0_tvbe = 'b0;
        wire                            tcam_row_28_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_28_col_0_tmask = 'b0;
        wire                            tcam_row_28_col_0_twe = 'b0;
        wire                            tcam_row_28_col_0_tre = 'b0;
        wire                            tcam_row_28_col_0_tme = 'b0;
        wire                            tcam_row_28_col_0_bist_rotate_sr = 'b0;
        wire                            tcam_row_28_col_0_bist_en_sr_mask_b = 'b0;
        wire                            tcam_row_28_col_0_bist_all_mask = 'b0;
        wire                            tcam_row_28_col_0_bist_en_sr_data_b = 'b0;
        wire                            tcam_row_28_col_0_bist_cm_mode = 'b0;
        wire                            tcam_row_28_col_0_bist_cm_en_in = 'b0;
        wire                            tcam_row_28_col_0_bist_cm_match_sel0 = 'b0;
        wire                            tcam_row_28_col_0_bist_cm_match_sel1 = 'b0;
        wire                            tcam_row_28_col_0_bist_matchin_in = 'b0;
        wire                            tcam_row_28_col_0_bist_fls = 'b0;
        
        `else
        wire                            tcam_row_28_col_0_biste = 'b0;
        wire     [6-1:0]                  tcam_row_28_col_0_fca = 'b0;
        wire                            tcam_row_28_col_0_cre = 'b0;
        wire                            tcam_row_28_col_0_dftshiften = dftshiften;
        wire                            tcam_row_28_col_0_dftmask = dftmask;
        wire                            tcam_row_28_col_0_dft_array_freeze = dft_array_freeze;
        wire                            tcam_row_28_col_0_dft_afd_reset_b = dft_afd_reset_b;
        wire      [40-1:0]    tcam_row_28_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_28_col_0_tadr = 'b0;
        wire                            tcam_row_28_col_0_tvbe = 'b0;
        wire                            tcam_row_28_col_0_tvbi = 'b0;
        ...
        // Outputs
        logic                           tcam_row_28_col_0_wr_bira_fail;
        logic                           tcam_row_28_col_0_wr_so;
        logic                           tcam_row_28_col_0_curerrout;
        logic                           tcam_row_28_col_0_rscout;
        
        
        
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_28_col_0_slice_en_s0; 
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_28_col_0_slice_en_s1; 
        
        
        
             wire    [40-1:0]                     tcam_row_28_col_0_data_out ;
        
        
        
         generate
            if (BCAM_N7 == 0) 
              begin : gen_tcam_row_28_col_0_tcam
        ...
        // slice_en kept for TCAM only for backward compatability with Intel process
                ...
                begin
                  for (int i = 0; i < TCAM_SLICE_EN_FACT; i++)
                      if (tcam_row_28_col_0_slice_en_s1[i])
                           tcam_row_28_col_0_hit_out[ i*64 +: 64]  = tcam_row_28_col_0_hit_out_int  [ i*64 +: 64]; 
                      else
                           tcam_row_28_col_0_hit_out[ i*64 +: 64]  = tcam_row_28_col_0_hit_out_latch[ i*64 +: 64]; 
                end
        
        
        
                always_ff  @(posedge tcam_row_28_col_0_clk)
                begin
                  tcam_row_28_col_0_slice_en_s0 <= tcam_row_28_col_0_slice_en; 
                  tcam_row_28_col_0_slice_en_s1 <= tcam_row_28_col_0_slice_en_s0; 
        
                  for (int i = 0; i < TCAM_SLICE_EN_FACT; i++)
                    begin
                      if (tcam_row_28_col_0_slice_en_s1[i])
                         tcam_row_28_col_0_hit_out_latch[ i*64 +: 64] <=  tcam_row_28_col_0_hit_out_int[ i*64 +: 64];
                    end
                end
        ...
        //                             |_____________________________|
                         ...
                         assign tcam_row_28_col_0_data_out  = ~tcam_row_28_col_0_data_out_inv;
                         trc_ip783tcam256x40s0c1_28_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_28_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_28_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        
                         .CLK               (tcam_row_28_col_0_clk), //Clock
                         .CMP               (tcam_row_28_col_0_chk_en), //Control Enable
                         .DIN               (~tcam_row_28_col_0_data_in), 
                         .DSEL              (~tcam_row_28_col_0_adr[0]), //dncen enables access of the TCAM Arrays adr_intessed
                         .FLS               (flush), //flush initiates a Flush operation that resets all Valid
                         .RVLD              (tcam_row_28_col_0_hit_in ), //Row validation bus. Each match_in input controls 1
                         .MASK              (tcam_row_28_col_0_mask_in), //Input msk
                         .QOUT              (tcam_row_28_col_0_data_out_inv), //Output vben
                         .QHR               (tcam_row_28_col_0_hit_out_int),
                         .QVLD              (), 
                         .RE                (tcam_row_28_col_0_rd_en), //Read Enable
                         .RST               (tcam_row_28_col_0_reset_n), //Asynchronous Active-High Reset
                         .VBE               (1'b1), //vben enables the Valid Bit addressed by adr[a-1:0] to
                         .VBI               (1'b0),//  Valid Bit Input
                         .WE                (tcam_row_28_col_0_wr_en), //Write Enable
                         .FAF               (tcam_row_28_col_0_fca),
                         .FAF_EN            (tcam_row_28_col_0_cre),
                         .DFTSHIFTEN        (tcam_row_28_col_0_dftshiften),
                         .DFTMASK           (tcam_row_28_col_0_dftmask),
                         .DFT_ARRAY_FREEZE  (tcam_row_28_col_0_dft_array_freeze),
                         .DFT_AFD_RESET_B   (tcam_row_28_col_0_dft_afd_reset_b),
                         .BISTE           (tcam_row_28_col_0_biste),
                         .TDIN (tcam_row_28_col_0_tdin),
                         .TADR (tcam_row_28_col_0_tadr),
                         .TVBE (tcam_row_28_col_0_tvbe),
                         .TVBI (tcam_row_28_col_0_tvbi),
                         .TMASK (tcam_row_28_col_0_tmask),
                         .TWE (tcam_row_28_col_0_twe),
                         .TRE (tcam_row_28_col_0_tre),
                         .TME (tcam_row_28_col_0_tme),
                         .BIST_ROTATE_SR (tcam_row_28_col_0_bist_rotate_sr),
                         .BIST_EN_SR_MASK_B (tcam_row_28_col_0_bist_en_sr_mask_b),
                         .BIST_ALL_MASK (tcam_row_28_col_0_bist_all_mask),
                         .BIST_EN_SR_DATA_B (tcam_row_28_col_0_bist_en_sr_data_b),
                         .BIST_CM_MODE (tcam_row_28_col_0_bist_cm_mode),
                         .BIST_CM_EN_IN (tcam_row_28_col_0_bist_cm_en_in),
                         .BIST_CM_MATCH_SEL0 (tcam_row_28_col_0_bist_cm_match_sel0),
                         .BIST_CM_MATCH_SEL1 (tcam_row_28_col_0_bist_cm_match_sel1),
                         .BIST_MATCHIN_IN (tcam_row_28_col_0_bist_matchin_in),
                         .BIST_FLS (tcam_row_28_col_0_bist_fls),
                         .MDST_tcam (fuse_tcam), .BIST_SETUP(BIST_SETUP), .BIST_SETUP_ts1(BIST_SETUP_ts1), 
                        .BIST_SETUP_ts2(BIST_SETUP_ts2), .to_interfaces_tck(to_interfaces_tck), 
                        .mcp_bounding_to_en(mcp_bounding_to_en), .scan_to_en(scan_to_en), 
                        .memory_bypass_to_en(memory_bypass_to_en), 
                        ...
                        .BIST_SHIFT_BIRA_COLLAR(BIST_SHIFT_BIRA_COLLAR), 
                        .CHECK_REPAIR_NEEDED(CHECK_REPAIR_NEEDED), 
                        .MEM20_BIST_COLLAR_SI(MEM20_BIST_COLLAR_SI), .BIST_SO(BIST_SO_ts20), 
                        .BIST_GO(BIST_GO_ts20), .ltest_to_en(ltest_to_en), 
                        .BIST_USER9(BIST_USER9), .BIST_USER10(BIST_USER10), 
                        .BIST_USER11(BIST_USER11), .BIST_USER0(BIST_USER0), 
                        .BIST_USER1(BIST_USER1), .BIST_USER2(BIST_USER2), 
                        .BIST_USER3(BIST_USER3), .BIST_USER4(BIST_USER4), 
                        ...
                        .bisr_reset_pd_vinf(bisr_reset_pd_vinf), 
                        .tcam_row_27_col_0_bisr_inst_SO(tcam_row_27_col_0_bisr_inst_SO), 
                        .tcam_row_28_col_0_bisr_inst_SO(tcam_row_28_col_0_bisr_inst_SO), 
                        .fscan_clkungate(fscan_clkungate)
                     );
              ...
              begin : gen_tcam_row_28_col_0_bcam
              end
        ...
        always_ff @(posedge clk) begin
                   tcam_rd_data_col[28][0]      <= tcam_row_28_col_0_data_out;
                   tcam_col_hit_out[28][0]       <= tcam_row_28_col_0_hit_out;
        end
        

        // this is new template - tcam_asic_template
        
        wire                                            tcam_row_29_col_0_clk         = clk;
        
        wire    [TCAM_SLICE_EN_FACT-1:0]                tcam_row_29_col_0_slice_en = TCAM_SLICE_EN_FACT'(slice_en[(29 * TCAM_SLICE_EN_FACT)+:TCAM_SLICE_EN_MIN]);
        
        wire                                            tcam_row_29_col_0_rd_en       = tcam_row_rd_en[29];
        wire                                            tcam_row_29_col_0_wr_en       = tcam_row_wr_en[29];
        wire                                            tcam_row_29_col_0_chk_en      = chk_en;
        wire                                            tcam_row_29_col_0_reset_n = reset_n;
        wire    [9-1:0]                       tcam_row_29_col_0_adr  = tcam_row_adr[29][9-1:0];
        wire    [40-1:0]                      tcam_row_29_col_0_data_in = tcam_row_wr_en[29] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_29_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_29_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_29_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_29_col_0_hit_in = tcam_raw_hit_in[29];
        wire    [256-1:0]                       tcam_row_29_col_0_tcam_match_in = tcam_row_match_in[29];
        wire    [40-1:0]                      tcam_row_29_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_29_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_29_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_29_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_29_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_29_col_0_fca = 'b0;
        wire                            tcam_row_29_col_0_cre = 'b0;
        wire                            tcam_row_29_col_0_dftshiften = 'b0;
        wire                            tcam_row_29_col_0_dftmask = 'b0;
        wire                            tcam_row_29_col_0_dft_array_freeze = 'b0;
        wire                            tcam_row_29_col_0_dft_afd_reset_b = 'b0;
        wire      [40-1:0]    tcam_row_29_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_29_col_0_tadr = 'b0;
        wire                            tcam_row_29_col_0_tvbe = 'b0;
        wire                            tcam_row_29_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_29_col_0_tmask = 'b0;
        wire                            tcam_row_29_col_0_twe = 'b0;
        wire                            tcam_row_29_col_0_tre = 'b0;
        wire                            tcam_row_29_col_0_tme = 'b0;
        wire                            tcam_row_29_col_0_bist_rotate_sr = 'b0;
        wire                            tcam_row_29_col_0_bist_en_sr_mask_b = 'b0;
        wire                            tcam_row_29_col_0_bist_all_mask = 'b0;
        wire                            tcam_row_29_col_0_bist_en_sr_data_b = 'b0;
        wire                            tcam_row_29_col_0_bist_cm_mode = 'b0;
        wire                            tcam_row_29_col_0_bist_cm_en_in = 'b0;
        wire                            tcam_row_29_col_0_bist_cm_match_sel0 = 'b0;
        wire                            tcam_row_29_col_0_bist_cm_match_sel1 = 'b0;
        wire                            tcam_row_29_col_0_bist_matchin_in = 'b0;
        wire                            tcam_row_29_col_0_bist_fls = 'b0;
        
        `else
        wire                            tcam_row_29_col_0_biste = 'b0;
        wire     [6-1:0]                  tcam_row_29_col_0_fca = 'b0;
        wire                            tcam_row_29_col_0_cre = 'b0;
        wire                            tcam_row_29_col_0_dftshiften = dftshiften;
        wire                            tcam_row_29_col_0_dftmask = dftmask;
        wire                            tcam_row_29_col_0_dft_array_freeze = dft_array_freeze;
        wire                            tcam_row_29_col_0_dft_afd_reset_b = dft_afd_reset_b;
        wire      [40-1:0]    tcam_row_29_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_29_col_0_tadr = 'b0;
        wire                            tcam_row_29_col_0_tvbe = 'b0;
        wire                            tcam_row_29_col_0_tvbi = 'b0;
        ...
        // Outputs
        logic                           tcam_row_29_col_0_wr_bira_fail;
        logic                           tcam_row_29_col_0_wr_so;
        logic                           tcam_row_29_col_0_curerrout;
        logic                           tcam_row_29_col_0_rscout;
        
        
        
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_29_col_0_slice_en_s0; 
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_29_col_0_slice_en_s1; 
        
        
        
             wire    [40-1:0]                     tcam_row_29_col_0_data_out ;
        
        
        
         generate
            if (BCAM_N7 == 0) 
              begin : gen_tcam_row_29_col_0_tcam
        ...
        // slice_en kept for TCAM only for backward compatability with Intel process
                ...
                begin
                  for (int i = 0; i < TCAM_SLICE_EN_FACT; i++)
                      if (tcam_row_29_col_0_slice_en_s1[i])
                           tcam_row_29_col_0_hit_out[ i*64 +: 64]  = tcam_row_29_col_0_hit_out_int  [ i*64 +: 64]; 
                      else
                           tcam_row_29_col_0_hit_out[ i*64 +: 64]  = tcam_row_29_col_0_hit_out_latch[ i*64 +: 64]; 
                end
        
        
        
                always_ff  @(posedge tcam_row_29_col_0_clk)
                begin
                  tcam_row_29_col_0_slice_en_s0 <= tcam_row_29_col_0_slice_en; 
                  tcam_row_29_col_0_slice_en_s1 <= tcam_row_29_col_0_slice_en_s0; 
        
                  for (int i = 0; i < TCAM_SLICE_EN_FACT; i++)
                    begin
                      if (tcam_row_29_col_0_slice_en_s1[i])
                         tcam_row_29_col_0_hit_out_latch[ i*64 +: 64] <=  tcam_row_29_col_0_hit_out_int[ i*64 +: 64];
                    end
                end
        ...
        //                             |_____________________________|
                         ...
                         assign tcam_row_29_col_0_data_out  = ~tcam_row_29_col_0_data_out_inv;
                         trc_ip783tcam256x40s0c1_29_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_29_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_29_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        
                         .CLK               (tcam_row_29_col_0_clk), //Clock
                         .CMP               (tcam_row_29_col_0_chk_en), //Control Enable
                         .DIN               (~tcam_row_29_col_0_data_in), 
                         .DSEL              (~tcam_row_29_col_0_adr[0]), //dncen enables access of the TCAM Arrays adr_intessed
                         .FLS               (flush), //flush initiates a Flush operation that resets all Valid
                         .RVLD              (tcam_row_29_col_0_hit_in ), //Row validation bus. Each match_in input controls 1
                         .MASK              (tcam_row_29_col_0_mask_in), //Input msk
                         .QOUT              (tcam_row_29_col_0_data_out_inv), //Output vben
                         .QHR               (tcam_row_29_col_0_hit_out_int),
                         .QVLD              (), 
                         .RE                (tcam_row_29_col_0_rd_en), //Read Enable
                         .RST               (tcam_row_29_col_0_reset_n), //Asynchronous Active-High Reset
                         .VBE               (1'b1), //vben enables the Valid Bit addressed by adr[a-1:0] to
                         .VBI               (1'b0),//  Valid Bit Input
                         .WE                (tcam_row_29_col_0_wr_en), //Write Enable
                         .FAF               (tcam_row_29_col_0_fca),
                         .FAF_EN            (tcam_row_29_col_0_cre),
                         .DFTSHIFTEN        (tcam_row_29_col_0_dftshiften),
                         .DFTMASK           (tcam_row_29_col_0_dftmask),
                         .DFT_ARRAY_FREEZE  (tcam_row_29_col_0_dft_array_freeze),
                         .DFT_AFD_RESET_B   (tcam_row_29_col_0_dft_afd_reset_b),
                         .BISTE           (tcam_row_29_col_0_biste),
                         .TDIN (tcam_row_29_col_0_tdin),
                         .TADR (tcam_row_29_col_0_tadr),
                         .TVBE (tcam_row_29_col_0_tvbe),
                         .TVBI (tcam_row_29_col_0_tvbi),
                         .TMASK (tcam_row_29_col_0_tmask),
                         .TWE (tcam_row_29_col_0_twe),
                         .TRE (tcam_row_29_col_0_tre),
                         .TME (tcam_row_29_col_0_tme),
                         .BIST_ROTATE_SR (tcam_row_29_col_0_bist_rotate_sr),
                         .BIST_EN_SR_MASK_B (tcam_row_29_col_0_bist_en_sr_mask_b),
                         .BIST_ALL_MASK (tcam_row_29_col_0_bist_all_mask),
                         .BIST_EN_SR_DATA_B (tcam_row_29_col_0_bist_en_sr_data_b),
                         .BIST_CM_MODE (tcam_row_29_col_0_bist_cm_mode),
                         .BIST_CM_EN_IN (tcam_row_29_col_0_bist_cm_en_in),
                         .BIST_CM_MATCH_SEL0 (tcam_row_29_col_0_bist_cm_match_sel0),
                         .BIST_CM_MATCH_SEL1 (tcam_row_29_col_0_bist_cm_match_sel1),
                         .BIST_MATCHIN_IN (tcam_row_29_col_0_bist_matchin_in),
                         .BIST_FLS (tcam_row_29_col_0_bist_fls),
                         .MDST_tcam (fuse_tcam), .BIST_SETUP(BIST_SETUP), .BIST_SETUP_ts1(BIST_SETUP_ts1), 
                        .BIST_SETUP_ts2(BIST_SETUP_ts2), .to_interfaces_tck(to_interfaces_tck), 
                        .mcp_bounding_to_en(mcp_bounding_to_en), .scan_to_en(scan_to_en), 
                        .memory_bypass_to_en(memory_bypass_to_en), 
                        ...
                        .BIST_SHIFT_BIRA_COLLAR(BIST_SHIFT_BIRA_COLLAR), 
                        .CHECK_REPAIR_NEEDED(CHECK_REPAIR_NEEDED), 
                        .MEM21_BIST_COLLAR_SI(MEM21_BIST_COLLAR_SI), .BIST_SO(BIST_SO_ts21), 
                        .BIST_GO(BIST_GO_ts21), .ltest_to_en(ltest_to_en), 
                        .BIST_USER9(BIST_USER9), .BIST_USER10(BIST_USER10), 
                        .BIST_USER11(BIST_USER11), .BIST_USER0(BIST_USER0), 
                        .BIST_USER1(BIST_USER1), .BIST_USER2(BIST_USER2), 
                        .BIST_USER3(BIST_USER3), .BIST_USER4(BIST_USER4), 
              ...
              begin : gen_tcam_row_29_col_0_bcam
              end
        ...
        always_ff @(posedge clk) begin
                   tcam_rd_data_col[29][0]      <= tcam_row_29_col_0_data_out;
                   tcam_col_hit_out[29][0]       <= tcam_row_29_col_0_hit_out;
        end
        

        // this is new template - tcam_asic_template
        
        wire                                            tcam_row_30_col_0_clk         = clk;
        
        wire    [TCAM_SLICE_EN_FACT-1:0]                tcam_row_30_col_0_slice_en = TCAM_SLICE_EN_FACT'(slice_en[(30 * TCAM_SLICE_EN_FACT)+:TCAM_SLICE_EN_MIN]);
        
        wire                                            tcam_row_30_col_0_rd_en       = tcam_row_rd_en[30];
        wire                                            tcam_row_30_col_0_wr_en       = tcam_row_wr_en[30];
        wire                                            tcam_row_30_col_0_chk_en      = chk_en;
        wire                                            tcam_row_30_col_0_reset_n = reset_n;
        wire    [9-1:0]                       tcam_row_30_col_0_adr  = tcam_row_adr[30][9-1:0];
        wire    [40-1:0]                      tcam_row_30_col_0_data_in = tcam_row_wr_en[30] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_30_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_30_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_30_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_30_col_0_hit_in = tcam_raw_hit_in[30];
        wire    [256-1:0]                       tcam_row_30_col_0_tcam_match_in = tcam_row_match_in[30];
        wire    [40-1:0]                      tcam_row_30_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_30_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_30_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_30_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_30_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_30_col_0_fca = 'b0;
        wire                            tcam_row_30_col_0_cre = 'b0;
        wire                            tcam_row_30_col_0_dftshiften = 'b0;
        wire                            tcam_row_30_col_0_dftmask = 'b0;
        wire                            tcam_row_30_col_0_dft_array_freeze = 'b0;
        wire                            tcam_row_30_col_0_dft_afd_reset_b = 'b0;
        wire      [40-1:0]    tcam_row_30_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_30_col_0_tadr = 'b0;
        wire                            tcam_row_30_col_0_tvbe = 'b0;
        wire                            tcam_row_30_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_30_col_0_tmask = 'b0;
        wire                            tcam_row_30_col_0_twe = 'b0;
        wire                            tcam_row_30_col_0_tre = 'b0;
        wire                            tcam_row_30_col_0_tme = 'b0;
        wire                            tcam_row_30_col_0_bist_rotate_sr = 'b0;
        wire                            tcam_row_30_col_0_bist_en_sr_mask_b = 'b0;
        wire                            tcam_row_30_col_0_bist_all_mask = 'b0;
        wire                            tcam_row_30_col_0_bist_en_sr_data_b = 'b0;
        wire                            tcam_row_30_col_0_bist_cm_mode = 'b0;
        wire                            tcam_row_30_col_0_bist_cm_en_in = 'b0;
        wire                            tcam_row_30_col_0_bist_cm_match_sel0 = 'b0;
        wire                            tcam_row_30_col_0_bist_cm_match_sel1 = 'b0;
        wire                            tcam_row_30_col_0_bist_matchin_in = 'b0;
        wire                            tcam_row_30_col_0_bist_fls = 'b0;
        
        `else
        wire                            tcam_row_30_col_0_biste = 'b0;
        wire     [6-1:0]                  tcam_row_30_col_0_fca = 'b0;
        wire                            tcam_row_30_col_0_cre = 'b0;
        wire                            tcam_row_30_col_0_dftshiften = dftshiften;
        wire                            tcam_row_30_col_0_dftmask = dftmask;
        wire                            tcam_row_30_col_0_dft_array_freeze = dft_array_freeze;
        wire                            tcam_row_30_col_0_dft_afd_reset_b = dft_afd_reset_b;
        wire      [40-1:0]    tcam_row_30_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_30_col_0_tadr = 'b0;
        wire                            tcam_row_30_col_0_tvbe = 'b0;
        wire                            tcam_row_30_col_0_tvbi = 'b0;
        ...
        // Outputs
        logic                           tcam_row_30_col_0_wr_bira_fail;
        logic                           tcam_row_30_col_0_wr_so;
        logic                           tcam_row_30_col_0_curerrout;
        logic                           tcam_row_30_col_0_rscout;
        
        
        
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_30_col_0_slice_en_s0; 
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_30_col_0_slice_en_s1; 
        
        
        
             wire    [40-1:0]                     tcam_row_30_col_0_data_out ;
        
        
        
         generate
            if (BCAM_N7 == 0) 
              begin : gen_tcam_row_30_col_0_tcam
        ...
        // slice_en kept for TCAM only for backward compatability with Intel process
                ...
                begin
                  for (int i = 0; i < TCAM_SLICE_EN_FACT; i++)
                      if (tcam_row_30_col_0_slice_en_s1[i])
                           tcam_row_30_col_0_hit_out[ i*64 +: 64]  = tcam_row_30_col_0_hit_out_int  [ i*64 +: 64]; 
                      else
                           tcam_row_30_col_0_hit_out[ i*64 +: 64]  = tcam_row_30_col_0_hit_out_latch[ i*64 +: 64]; 
                end
        
        
        
                always_ff  @(posedge tcam_row_30_col_0_clk)
                begin
                  tcam_row_30_col_0_slice_en_s0 <= tcam_row_30_col_0_slice_en; 
                  tcam_row_30_col_0_slice_en_s1 <= tcam_row_30_col_0_slice_en_s0; 
        
                  for (int i = 0; i < TCAM_SLICE_EN_FACT; i++)
                    begin
                      if (tcam_row_30_col_0_slice_en_s1[i])
                         tcam_row_30_col_0_hit_out_latch[ i*64 +: 64] <=  tcam_row_30_col_0_hit_out_int[ i*64 +: 64];
                    end
                end
        ...
        //                             |_____________________________|
                         ...
                         assign tcam_row_30_col_0_data_out  = ~tcam_row_30_col_0_data_out_inv;
                         trc_ip783tcam256x40s0c1_30_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_30_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_30_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        
                         .CLK               (tcam_row_30_col_0_clk), //Clock
                         .CMP               (tcam_row_30_col_0_chk_en), //Control Enable
                         .DIN               (~tcam_row_30_col_0_data_in), 
                         .DSEL              (~tcam_row_30_col_0_adr[0]), //dncen enables access of the TCAM Arrays adr_intessed
                         .FLS               (flush), //flush initiates a Flush operation that resets all Valid
                         .RVLD              (tcam_row_30_col_0_hit_in ), //Row validation bus. Each match_in input controls 1
                         .MASK              (tcam_row_30_col_0_mask_in), //Input msk
                         .QOUT              (tcam_row_30_col_0_data_out_inv), //Output vben
                         .QHR               (tcam_row_30_col_0_hit_out_int),
                         .QVLD              (), 
                         .RE                (tcam_row_30_col_0_rd_en), //Read Enable
                         .RST               (tcam_row_30_col_0_reset_n), //Asynchronous Active-High Reset
                         .VBE               (1'b1), //vben enables the Valid Bit addressed by adr[a-1:0] to
                         .VBI               (1'b0),//  Valid Bit Input
                         .WE                (tcam_row_30_col_0_wr_en), //Write Enable
                         .FAF               (tcam_row_30_col_0_fca),
                         .FAF_EN            (tcam_row_30_col_0_cre),
                         .DFTSHIFTEN        (tcam_row_30_col_0_dftshiften),
                         .DFTMASK           (tcam_row_30_col_0_dftmask),
                         .DFT_ARRAY_FREEZE  (tcam_row_30_col_0_dft_array_freeze),
                         .DFT_AFD_RESET_B   (tcam_row_30_col_0_dft_afd_reset_b),
                         .BISTE           (tcam_row_30_col_0_biste),
                         .TDIN (tcam_row_30_col_0_tdin),
                         .TADR (tcam_row_30_col_0_tadr),
                         .TVBE (tcam_row_30_col_0_tvbe),
                         .TVBI (tcam_row_30_col_0_tvbi),
                         .TMASK (tcam_row_30_col_0_tmask),
                         .TWE (tcam_row_30_col_0_twe),
                         .TRE (tcam_row_30_col_0_tre),
                         .TME (tcam_row_30_col_0_tme),
                         .BIST_ROTATE_SR (tcam_row_30_col_0_bist_rotate_sr),
                         .BIST_EN_SR_MASK_B (tcam_row_30_col_0_bist_en_sr_mask_b),
                         .BIST_ALL_MASK (tcam_row_30_col_0_bist_all_mask),
                         .BIST_EN_SR_DATA_B (tcam_row_30_col_0_bist_en_sr_data_b),
                         .BIST_CM_MODE (tcam_row_30_col_0_bist_cm_mode),
                         .BIST_CM_EN_IN (tcam_row_30_col_0_bist_cm_en_in),
                         .BIST_CM_MATCH_SEL0 (tcam_row_30_col_0_bist_cm_match_sel0),
                         .BIST_CM_MATCH_SEL1 (tcam_row_30_col_0_bist_cm_match_sel1),
                         .BIST_MATCHIN_IN (tcam_row_30_col_0_bist_matchin_in),
                         .BIST_FLS (tcam_row_30_col_0_bist_fls),
                         .MDST_tcam (fuse_tcam), .BIST_SETUP(BIST_SETUP), .BIST_SETUP_ts1(BIST_SETUP_ts1), 
                        .BIST_SETUP_ts2(BIST_SETUP_ts2), .to_interfaces_tck(to_interfaces_tck), 
                        .mcp_bounding_to_en(mcp_bounding_to_en), .scan_to_en(scan_to_en), 
                        .memory_bypass_to_en(memory_bypass_to_en), 
                        ...
                        .BIST_SHIFT_BIRA_COLLAR(BIST_SHIFT_BIRA_COLLAR), 
                        .CHECK_REPAIR_NEEDED(CHECK_REPAIR_NEEDED), 
                        .MEM23_BIST_COLLAR_SI(MEM23_BIST_COLLAR_SI), .BIST_SO(BIST_SO_ts23), 
                        .BIST_GO(BIST_GO_ts23), .ltest_to_en(ltest_to_en), 
                        .BIST_USER9(BIST_USER9), .BIST_USER10(BIST_USER10), 
                        .BIST_USER11(BIST_USER11), .BIST_USER0(BIST_USER0), 
                        .BIST_USER1(BIST_USER1), .BIST_USER2(BIST_USER2), 
                        .BIST_USER3(BIST_USER3), .BIST_USER4(BIST_USER4), 
                        ...
                        .bisr_reset_pd_vinf(bisr_reset_pd_vinf), 
                        .tcam_row_2_col_0_bisr_inst_SO(tcam_row_2_col_0_bisr_inst_SO), 
                        .tcam_row_30_col_0_bisr_inst_SO(tcam_row_30_col_0_bisr_inst_SO), 
                        .fscan_clkungate(fscan_clkungate)
                     );
              ...
              begin : gen_tcam_row_30_col_0_bcam
              end
        ...
        always_ff @(posedge clk) begin
                   tcam_rd_data_col[30][0]      <= tcam_row_30_col_0_data_out;
                   tcam_col_hit_out[30][0]       <= tcam_row_30_col_0_hit_out;
        end
        

        // this is new template - tcam_asic_template
        
        wire                                            tcam_row_31_col_0_clk         = clk;
        
        wire    [TCAM_SLICE_EN_FACT-1:0]                tcam_row_31_col_0_slice_en = TCAM_SLICE_EN_FACT'(slice_en[(31 * TCAM_SLICE_EN_FACT)+:TCAM_SLICE_EN_MIN]);
        
        wire                                            tcam_row_31_col_0_rd_en       = tcam_row_rd_en[31];
        wire                                            tcam_row_31_col_0_wr_en       = tcam_row_wr_en[31];
        wire                                            tcam_row_31_col_0_chk_en      = chk_en;
        wire                                            tcam_row_31_col_0_reset_n = reset_n;
        wire    [9-1:0]                       tcam_row_31_col_0_adr  = tcam_row_adr[31][9-1:0];
        wire    [40-1:0]                      tcam_row_31_col_0_data_in = tcam_row_wr_en[31] ? tcam_wr_data_col[0][40-1:0] : tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_31_col_0_data_in_pre = tcam_wr_data_col[0][40-1:0] ;
        wire    [40-1:0]                      tcam_row_31_col_0_key_in =  tcam_chk_key_col[0][40-1:0];
        wire    [40-1:0]                      tcam_row_31_col_0_mask_in = tcam_chk_mask_col[0][40-1:0];
        wire    [256-1:0]                       tcam_row_31_col_0_hit_in = tcam_raw_hit_in[31];
        wire    [256-1:0]                       tcam_row_31_col_0_tcam_match_in = tcam_row_match_in[31];
        wire    [40-1:0]                      tcam_row_31_col_0_data_out_inv;
        logic   [256-1:0]                     tcam_row_31_col_0_hit_out_int;
        logic   [256-1:0]                     tcam_row_31_col_0_hit_out_latch;
        logic   [256-1:0]                     tcam_row_31_col_0_hit_out;
        
        `ifdef CXP_DFX_DISABLE
        wire                          tcam_row_31_col_0_biste = 'b0; 
        wire     [6-1:0]                  tcam_row_31_col_0_fca = 'b0;
        wire                            tcam_row_31_col_0_cre = 'b0;
        wire                            tcam_row_31_col_0_dftshiften = 'b0;
        wire                            tcam_row_31_col_0_dftmask = 'b0;
        wire                            tcam_row_31_col_0_dft_array_freeze = 'b0;
        wire                            tcam_row_31_col_0_dft_afd_reset_b = 'b0;
        wire      [40-1:0]    tcam_row_31_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_31_col_0_tadr = 'b0;
        wire                            tcam_row_31_col_0_tvbe = 'b0;
        wire                            tcam_row_31_col_0_tvbi = 'b0;
        wire      [40-1:0]    tcam_row_31_col_0_tmask = 'b0;
        wire                            tcam_row_31_col_0_twe = 'b0;
        wire                            tcam_row_31_col_0_tre = 'b0;
        wire                            tcam_row_31_col_0_tme = 'b0;
        wire                            tcam_row_31_col_0_bist_rotate_sr = 'b0;
        wire                            tcam_row_31_col_0_bist_en_sr_mask_b = 'b0;
        wire                            tcam_row_31_col_0_bist_all_mask = 'b0;
        wire                            tcam_row_31_col_0_bist_en_sr_data_b = 'b0;
        wire                            tcam_row_31_col_0_bist_cm_mode = 'b0;
        wire                            tcam_row_31_col_0_bist_cm_en_in = 'b0;
        wire                            tcam_row_31_col_0_bist_cm_match_sel0 = 'b0;
        wire                            tcam_row_31_col_0_bist_cm_match_sel1 = 'b0;
        wire                            tcam_row_31_col_0_bist_matchin_in = 'b0;
        wire                            tcam_row_31_col_0_bist_fls = 'b0;
        
        `else
        wire                            tcam_row_31_col_0_biste = 'b0;
        wire     [6-1:0]                  tcam_row_31_col_0_fca = 'b0;
        wire                            tcam_row_31_col_0_cre = 'b0;
        wire                            tcam_row_31_col_0_dftshiften = dftshiften;
        wire                            tcam_row_31_col_0_dftmask = dftmask;
        wire                            tcam_row_31_col_0_dft_array_freeze = dft_array_freeze;
        wire                            tcam_row_31_col_0_dft_afd_reset_b = dft_afd_reset_b;
        wire      [40-1:0]    tcam_row_31_col_0_tdin = 'b0;
        wire      [9-1:0]     tcam_row_31_col_0_tadr = 'b0;
        wire                            tcam_row_31_col_0_tvbe = 'b0;
        wire                            tcam_row_31_col_0_tvbi = 'b0;
        ...
        // Outputs
        logic                           tcam_row_31_col_0_wr_bira_fail;
        logic                           tcam_row_31_col_0_wr_so;
        logic                           tcam_row_31_col_0_curerrout;
        logic                           tcam_row_31_col_0_rscout;
        
        
        
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_31_col_0_slice_en_s0; 
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_31_col_0_slice_en_s1; 
        
        
        
             wire    [40-1:0]                     tcam_row_31_col_0_data_out ;
        
        
        
         generate
            if (BCAM_N7 == 0) 
              begin : gen_tcam_row_31_col_0_tcam
        ...
        // slice_en kept for TCAM only for backward compatability with Intel process
                ...
                begin
                  for (int i = 0; i < TCAM_SLICE_EN_FACT; i++)
                      if (tcam_row_31_col_0_slice_en_s1[i])
                           tcam_row_31_col_0_hit_out[ i*64 +: 64]  = tcam_row_31_col_0_hit_out_int  [ i*64 +: 64]; 
                      else
                           tcam_row_31_col_0_hit_out[ i*64 +: 64]  = tcam_row_31_col_0_hit_out_latch[ i*64 +: 64]; 
                end
        
        
        
                always_ff  @(posedge tcam_row_31_col_0_clk)
                begin
                  tcam_row_31_col_0_slice_en_s0 <= tcam_row_31_col_0_slice_en; 
                  tcam_row_31_col_0_slice_en_s1 <= tcam_row_31_col_0_slice_en_s0; 
        
                  for (int i = 0; i < TCAM_SLICE_EN_FACT; i++)
                    begin
                      if (tcam_row_31_col_0_slice_en_s1[i])
                         tcam_row_31_col_0_hit_out_latch[ i*64 +: 64] <=  tcam_row_31_col_0_hit_out_int[ i*64 +: 64];
                    end
                end
        ...
        //                             |_____________________________|
                         ...
                         assign tcam_row_31_col_0_data_out  = ~tcam_row_31_col_0_data_out_inv;
                         trc_ip783tcam256x40s0c1_31_0_wrap #(        
                                 )               
        
                                 ip783tcam256x40s0c1_wrap_tcam_row_31_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_31_col_0_adr[9-1:1]), //Input adr_intess
                         .ME                (ce),  
        
                         .CLK               (tcam_row_31_col_0_clk), //Clock
                         .CMP               (tcam_row_31_col_0_chk_en), //Control Enable
                         .DIN               (~tcam_row_31_col_0_data_in), 
                         .DSEL              (~tcam_row_31_col_0_adr[0]), //dncen enables access of the TCAM Arrays adr_intessed
                         .FLS               (flush), //flush initiates a Flush operation that resets all Valid
                         .RVLD              (tcam_row_31_col_0_hit_in ), //Row validation bus. Each match_in input controls 1
                         .MASK              (tcam_row_31_col_0_mask_in), //Input msk
                         .QOUT              (tcam_row_31_col_0_data_out_inv), //Output vben
                         .QHR               (tcam_row_31_col_0_hit_out_int),
                         .QVLD              (), 
                         .RE                (tcam_row_31_col_0_rd_en), //Read Enable
                         .RST               (tcam_row_31_col_0_reset_n), //Asynchronous Active-High Reset
                         .VBE               (1'b1), //vben enables the Valid Bit addressed by adr[a-1:0] to
                         .VBI               (1'b0),//  Valid Bit Input
                         .WE                (tcam_row_31_col_0_wr_en), //Write Enable
                         .FAF               (tcam_row_31_col_0_fca),
                         .FAF_EN            (tcam_row_31_col_0_cre),
                         .DFTSHIFTEN        (tcam_row_31_col_0_dftshiften),
                         .DFTMASK           (tcam_row_31_col_0_dftmask),
                         .DFT_ARRAY_FREEZE  (tcam_row_31_col_0_dft_array_freeze),
                         .DFT_AFD_RESET_B   (tcam_row_31_col_0_dft_afd_reset_b),
                         .BISTE           (tcam_row_31_col_0_biste),
                         .TDIN (tcam_row_31_col_0_tdin),
                         .TADR (tcam_row_31_col_0_tadr),
                         .TVBE (tcam_row_31_col_0_tvbe),
                         .TVBI (tcam_row_31_col_0_tvbi),
                         .TMASK (tcam_row_31_col_0_tmask),
                         .TWE (tcam_row_31_col_0_twe),
                         .TRE (tcam_row_31_col_0_tre),
                         .TME (tcam_row_31_col_0_tme),
                         .BIST_ROTATE_SR (tcam_row_31_col_0_bist_rotate_sr),
                         .BIST_EN_SR_MASK_B (tcam_row_31_col_0_bist_en_sr_mask_b),
                         .BIST_ALL_MASK (tcam_row_31_col_0_bist_all_mask),
                         .BIST_EN_SR_DATA_B (tcam_row_31_col_0_bist_en_sr_data_b),
                         .BIST_CM_MODE (tcam_row_31_col_0_bist_cm_mode),
                         .BIST_CM_EN_IN (tcam_row_31_col_0_bist_cm_en_in),
                         .BIST_CM_MATCH_SEL0 (tcam_row_31_col_0_bist_cm_match_sel0),
                         .BIST_CM_MATCH_SEL1 (tcam_row_31_col_0_bist_cm_match_sel1),
                         .BIST_MATCHIN_IN (tcam_row_31_col_0_bist_matchin_in),
                         .BIST_FLS (tcam_row_31_col_0_bist_fls),
                         .MDST_tcam (fuse_tcam), .BIST_SETUP(BIST_SETUP), .BIST_SETUP_ts1(BIST_SETUP_ts1), 
                        .BIST_SETUP_ts2(BIST_SETUP_ts2), .to_interfaces_tck(to_interfaces_tck), 
                        .mcp_bounding_to_en(mcp_bounding_to_en), .scan_to_en(scan_to_en), 
                        .memory_bypass_to_en(memory_bypass_to_en), 
                        ...
                        .BIST_SHIFT_BIRA_COLLAR(BIST_SHIFT_BIRA_COLLAR), 
                        .CHECK_REPAIR_NEEDED(CHECK_REPAIR_NEEDED), 
                        .MEM24_BIST_COLLAR_SI(MEM24_BIST_COLLAR_SI), .BIST_SO(BIST_SO_ts24), 
                        .BIST_GO(BIST_GO_ts24), .ltest_to_en(ltest_to_en), 
                        .BIST_USER9(BIST_USER9), .BIST_USER10(BIST_USER10), 
                        .BIST_USER11(BIST_USER11), .BIST_USER0(BIST_USER0), 
                        .BIST_USER1(BIST_USER1), .BIST_USER2(BIST_USER2), 
                        .BIST_USER3(BIST_USER3), .BIST_USER4(BIST_USER4), 
              ...
              begin : gen_tcam_row_31_col_0_bcam
              end
        ...
        always_ff @(posedge clk) begin
                   tcam_rd_data_col[31][0]      <= tcam_row_31_col_0_data_out;
                   tcam_col_hit_out[31][0]       <= tcam_row_31_col_0_hit_out;
        end
    ...
    if (BCAM_N7 == 1) 
        begin : bacm_prot_calc
            always_comb begin
                ...
                for (int i = 0; i < 1; i = i + 1) begin
                    rd_data[PHYSICAL_ROW_WIDTH-((1-i-1)*2)-2] = ^rd_data_before_prot_calc[(i*(40-2))+:((40-2)/2)];
                    rd_data[PHYSICAL_ROW_WIDTH-((1-i-1)*2)-1] = ^rd_data_before_prot_calc[(i*(40-2))+((40-2)/2)+:((40-2)/2)];
                end
            end
        end
    else
...
parameter       MEM_SEG_PADDING_W = 0 ; 
    ...
    generate if (BCAM_N7==0 && TCAM_PROTECTION_TYPE==1 && BCAM_RELIEF==0) begin : protect    
       ...
       task automatic update_col_sweeper(input bit pattern, input logic[40-1:0] old_val, input logic[40-1:0] new_val);
           logic [40-1:0] temp;
    ...
    // ********** this task is valid for TCAM only *****
      task automatic write_tcam_raw_key (input logic[40-1:0] key, input int row_idx);
          reg temp1,temp2;
          logic [(1 * 40) - 1:0] local_key = '1;
          logic [(1 * 40) - 1:0] prev_key_data;
          local_key[40-1:0] = TCAM_18A ? ~key : ~key;
          ...
          `ifdef CXP_TRC_TCAM_BEHAVE_MEMS
             `ifndef CXP_FPGA_TCAM_MEMS
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_0_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_0_col_0.tcam_row_0_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_0_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_0_col_0.tcam_row_0_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_1_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_1_col_0.tcam_row_1_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_1_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_1_col_0.tcam_row_1_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_2_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_2_col_0.tcam_row_2_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_2_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_2_col_0.tcam_row_2_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_3_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_3_col_0.tcam_row_3_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_3_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_3_col_0.tcam_row_3_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_4_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_4_col_0.tcam_row_4_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_4_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_4_col_0.tcam_row_4_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_5_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_5_col_0.tcam_row_5_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_5_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_5_col_0.tcam_row_5_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_6_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_6_col_0.tcam_row_6_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_6_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_6_col_0.tcam_row_6_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_7_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_7_col_0.tcam_row_7_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_7_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_7_col_0.tcam_row_7_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_8_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_8_col_0.tcam_row_8_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_8_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_8_col_0.tcam_row_8_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_9_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_9_col_0.tcam_row_9_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_9_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_9_col_0.tcam_row_9_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_10_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_10_col_0.tcam_row_10_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_10_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_10_col_0.tcam_row_10_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_11_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_11_col_0.tcam_row_11_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_11_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_11_col_0.tcam_row_11_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_12_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_12_col_0.tcam_row_12_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_12_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_12_col_0.tcam_row_12_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_13_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_13_col_0.tcam_row_13_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_13_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_13_col_0.tcam_row_13_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_14_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_14_col_0.tcam_row_14_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_14_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_14_col_0.tcam_row_14_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_15_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_15_col_0.tcam_row_15_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_15_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_15_col_0.tcam_row_15_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_16_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_16_col_0.tcam_row_16_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_16_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_16_col_0.tcam_row_16_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_17_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_17_col_0.tcam_row_17_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_17_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_17_col_0.tcam_row_17_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_18_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_18_col_0.tcam_row_18_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_18_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_18_col_0.tcam_row_18_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_19_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_19_col_0.tcam_row_19_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_19_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_19_col_0.tcam_row_19_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_20_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_20_col_0.tcam_row_20_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_20_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_20_col_0.tcam_row_20_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_21_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_21_col_0.tcam_row_21_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_21_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_21_col_0.tcam_row_21_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_22_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_22_col_0.tcam_row_22_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_22_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_22_col_0.tcam_row_22_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_23_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_23_col_0.tcam_row_23_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_23_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_23_col_0.tcam_row_23_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_24_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_24_col_0.tcam_row_24_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_24_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_24_col_0.tcam_row_24_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_25_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_25_col_0.tcam_row_25_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_25_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_25_col_0.tcam_row_25_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_26_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_26_col_0.tcam_row_26_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_26_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_26_col_0.tcam_row_26_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_27_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_27_col_0.tcam_row_27_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_27_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_27_col_0.tcam_row_27_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_28_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_28_col_0.tcam_row_28_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_28_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_28_col_0.tcam_row_28_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_29_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_29_col_0.tcam_row_29_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_29_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_29_col_0.tcam_row_29_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_30_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_30_col_0.tcam_row_30_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_30_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_30_col_0.tcam_row_30_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_31_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_31_col_0.tcam_row_31_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_31_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_31_col_0.tcam_row_31_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
       ...
       // ********** backdoor DATA ***********
        task automatic write_tcam_raw_inv_key (input logic[40-1:0] inv_key, input int row_idx);
          reg temp1,temp2;
          logic [(1 * 40) - 1:0] local_inv_key = '0;
          logic [(1 * 40) - 1:0] prev_inv_key_data;
          local_inv_key[40-1:0] = TCAM_18A ? ~inv_key : ~inv_key;
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_0_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_0_col_0.tcam_row_0_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_0_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_0_col_0.tcam_row_0_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_1_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_1_col_0.tcam_row_1_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_1_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_1_col_0.tcam_row_1_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_2_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_2_col_0.tcam_row_2_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_2_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_2_col_0.tcam_row_2_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_3_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_3_col_0.tcam_row_3_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_3_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_3_col_0.tcam_row_3_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_4_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_4_col_0.tcam_row_4_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_4_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_4_col_0.tcam_row_4_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_5_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_5_col_0.tcam_row_5_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_5_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_5_col_0.tcam_row_5_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_6_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_6_col_0.tcam_row_6_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_6_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_6_col_0.tcam_row_6_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_7_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_7_col_0.tcam_row_7_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_7_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_7_col_0.tcam_row_7_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_8_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_8_col_0.tcam_row_8_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_8_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_8_col_0.tcam_row_8_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_9_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_9_col_0.tcam_row_9_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_9_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_9_col_0.tcam_row_9_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_10_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_10_col_0.tcam_row_10_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_10_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_10_col_0.tcam_row_10_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_11_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_11_col_0.tcam_row_11_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_11_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_11_col_0.tcam_row_11_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_12_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_12_col_0.tcam_row_12_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_12_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_12_col_0.tcam_row_12_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_13_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_13_col_0.tcam_row_13_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_13_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_13_col_0.tcam_row_13_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_14_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_14_col_0.tcam_row_14_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_14_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_14_col_0.tcam_row_14_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_15_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_15_col_0.tcam_row_15_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_15_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_15_col_0.tcam_row_15_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_16_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_16_col_0.tcam_row_16_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_16_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_16_col_0.tcam_row_16_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_17_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_17_col_0.tcam_row_17_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_17_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_17_col_0.tcam_row_17_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_18_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_18_col_0.tcam_row_18_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_18_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_18_col_0.tcam_row_18_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_19_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_19_col_0.tcam_row_19_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_19_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_19_col_0.tcam_row_19_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_20_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_20_col_0.tcam_row_20_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_20_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_20_col_0.tcam_row_20_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_21_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_21_col_0.tcam_row_21_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_21_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_21_col_0.tcam_row_21_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_22_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_22_col_0.tcam_row_22_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_22_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_22_col_0.tcam_row_22_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_23_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_23_col_0.tcam_row_23_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_23_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_23_col_0.tcam_row_23_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_24_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_24_col_0.tcam_row_24_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_24_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_24_col_0.tcam_row_24_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_25_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_25_col_0.tcam_row_25_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_25_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_25_col_0.tcam_row_25_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_26_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_26_col_0.tcam_row_26_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_26_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_26_col_0.tcam_row_26_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_27_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_27_col_0.tcam_row_27_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_27_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_27_col_0.tcam_row_27_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_28_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_28_col_0.tcam_row_28_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_28_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_28_col_0.tcam_row_28_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_29_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_29_col_0.tcam_row_29_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_29_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_29_col_0.tcam_row_29_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_30_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_30_col_0.tcam_row_30_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_30_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_30_col_0.tcam_row_30_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_31_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_31_col_0.tcam_row_31_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_31_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_31_col_0.tcam_row_31_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_v[row_idx % 256] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
       ...
       task automatic write_tcam_raw_line (input logic[40-1:0] key, input logic [40-1:0] inv_key, input int row_idx);
       ...
       // ********** backdoor MASK ***********
       //****this task is valid for TCAM only*****
       task automatic read_tcam_raw_key (output logic[40-1:0] key, input int row_idx);
           reg temp1,valid_word;
           logic [(1 * 40) - 1:0] local_key;
           // check size out-of-bounds
           if (row_idx >= TCAM_RULES_NUM) begin
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_0_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_0_col_0.tcam_row_0_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_1_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_1_col_0.tcam_row_1_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_2_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_2_col_0.tcam_row_2_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_3_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_3_col_0.tcam_row_3_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_4_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_4_col_0.tcam_row_4_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_5_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_5_col_0.tcam_row_5_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_6_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_6_col_0.tcam_row_6_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_7_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_7_col_0.tcam_row_7_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_8_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_8_col_0.tcam_row_8_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_9_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_9_col_0.tcam_row_9_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_10_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_10_col_0.tcam_row_10_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_11_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_11_col_0.tcam_row_11_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_12_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_12_col_0.tcam_row_12_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_13_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_13_col_0.tcam_row_13_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_14_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_14_col_0.tcam_row_14_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_15_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_15_col_0.tcam_row_15_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_16_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_16_col_0.tcam_row_16_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_17_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_17_col_0.tcam_row_17_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_18_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_18_col_0.tcam_row_18_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_19_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_19_col_0.tcam_row_19_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_20_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_20_col_0.tcam_row_20_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_21_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_21_col_0.tcam_row_21_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_22_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_22_col_0.tcam_row_22_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_23_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_23_col_0.tcam_row_23_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_24_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_24_col_0.tcam_row_24_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_25_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_25_col_0.tcam_row_25_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_26_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_26_col_0.tcam_row_26_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_27_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_27_col_0.tcam_row_27_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_28_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_28_col_0.tcam_row_28_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_29_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_29_col_0.tcam_row_29_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_30_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_30_col_0.tcam_row_30_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_31_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_31_col_0.tcam_row_31_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_x[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
     ...
     // ********** backdoor DATA ***********
       task automatic read_tcam_raw_inv_key (output logic[40-1:0] inv_key, input int row_idx);
           reg temp1,valid_word;
           logic [(1 * 40) - 1:0] local_inv_key;
           // check size out-of-bounds
           if (row_idx >= TCAM_RULES_NUM) begin
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_0_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_0_col_0.tcam_row_0_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_1_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_1_col_0.tcam_row_1_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_2_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_2_col_0.tcam_row_2_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_3_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_3_col_0.tcam_row_3_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_4_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_4_col_0.tcam_row_4_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_5_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_5_col_0.tcam_row_5_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_6_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_6_col_0.tcam_row_6_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_7_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_7_col_0.tcam_row_7_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_8_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_8_col_0.tcam_row_8_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_9_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_9_col_0.tcam_row_9_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_10_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_10_col_0.tcam_row_10_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_11_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_11_col_0.tcam_row_11_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_12_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_12_col_0.tcam_row_12_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_13_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_13_col_0.tcam_row_13_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_14_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_14_col_0.tcam_row_14_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_15_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_15_col_0.tcam_row_15_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_16_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_16_col_0.tcam_row_16_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_17_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_17_col_0.tcam_row_17_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_18_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_18_col_0.tcam_row_18_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_19_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_19_col_0.tcam_row_19_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_20_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_20_col_0.tcam_row_20_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_21_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_21_col_0.tcam_row_21_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_22_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_22_col_0.tcam_row_22_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_23_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_23_col_0.tcam_row_23_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_24_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_24_col_0.tcam_row_24_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_25_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_25_col_0.tcam_row_25_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_26_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_26_col_0.tcam_row_26_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_27_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_27_col_0.tcam_row_27_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_28_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_28_col_0.tcam_row_28_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_29_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_29_col_0.tcam_row_29_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_30_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_30_col_0.tcam_row_30_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_31_col_0_tcam.ip783tcam256x40s0c1_wrap_tcam_row_31_col_0.tcam_row_31_col_0.ip783tcam256x40s0c1_gen_wrp_inst.ip783tcam256x40s0c1_inst.ip783tcam256x40s0c1_array.array_y[row_idx % 256];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
       ...
       task automatic read_tcam_raw_line (output logic[40-1:0] key, output logic [40-1:0] inv_key, input int row_idx);
