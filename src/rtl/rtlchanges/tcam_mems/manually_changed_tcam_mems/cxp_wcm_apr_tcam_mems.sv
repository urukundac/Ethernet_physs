...
module cxp_wcm_apr_tcam_mems
// EDIT_PORT BEGIN
 ( 
input wire cxp_par_non_ana_wcm_apr_rstsync_scon_cxp_func_nss_core_rst_n,
output wire [645:0] cxp_wcm_tcam_mems_wcm_wcm_tcam_from_tcam,
input wire [1696:0] cxp_wcm_wcm_wcm_tcam_to_tcam,
input wire [15:0] cxp_fuse_tcam,
input wire cxp_wcm_apr_dftshiften,
input wire cxp_wcm_apr_dftmask,
input wire cxp_wcm_apr_dft_array_freeze,
input wire cxp_wcm_apr_dft_afd_reset_b,
input wire cxp_par_non_ana_wcm_apr_bypass_cg_gated_clk , input wire BIST_SETUP, 
...
output wire BIST_GO_ts8, output wire BIST_GO_ts9, output wire BIST_GO_ts10, 
output wire BIST_GO_ts11, output wire BIST_GO_ts12, output wire BIST_GO_ts13, 
...
// EDIT_INSTANCE BEGIN
cxp_wcm_tcam_mems cxp_wcm_tcam_mems (
    .scon_cxp_powergood_nss_core_rst_n(cxp_par_non_ana_wcm_apr_rstsync_scon_cxp_func_nss_core_rst_n), 
    .wcm_wcm_tcam_from_tcam(cxp_wcm_tcam_mems_wcm_wcm_tcam_from_tcam), 
    .wcm_wcm_tcam_to_tcam(cxp_wcm_wcm_wcm_tcam_to_tcam), 
    .fuse_tcam(cxp_fuse_tcam), 
    .dftshiften(cxp_wcm_apr_dftshiften), 
    .dftmask(cxp_wcm_apr_dftmask), 
    .dft_array_freeze(cxp_wcm_apr_dft_array_freeze), 
    .dft_afd_reset_b(cxp_wcm_apr_dft_afd_reset_b), 
    .nss_core_clk(cxp_par_non_ana_wcm_apr_bypass_cg_gated_clk), 
