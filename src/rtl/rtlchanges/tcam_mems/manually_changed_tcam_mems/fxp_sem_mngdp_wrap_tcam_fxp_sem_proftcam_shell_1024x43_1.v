...
module  fxp_sem_mngdp_wrap_tcam_fxp_sem_proftcam_shell_1024x43_1 #(
       ...
       ,
        ...
        input wire [6:0] BIST_ROW_ADD, input wire BIST_COLLAR_EN1, 
        input wire BIST_COLLAR_EN5, input wire BIST_COLLAR_EN9, 
        input wire BIST_COLLAR_EN13, input wire BIST_RUN_TO_COLLAR1, 
        input wire BIST_RUN_TO_COLLAR5, input wire BIST_RUN_TO_COLLAR9, 
        input wire BIST_RUN_TO_COLLAR13, input wire BIST_ASYNC_RESET, 
        ...
        //                             |_____________________________|
                   ...
                   //-------------------------------------------------------------   
                      ...
                      `endif
                        ...
                        .BIST_COLLAR_EN0(BIST_COLLAR_EN1), 
        ...
        //                             |_____________________________|
                   ...
                   //-------------------------------------------------------------   
                      ...
                      `endif
                        ...
                        .BIST_WRITEENABLE(BIST_WRITEENABLE), .BIST_READENABLE(BIST_READENABLE), 
                        .BIST_SELECT(BIST_SELECT), .BIST_ROW_ADD(BIST_ROW_ADD[6:0]), 
                        .BIST_COLLAR_EN4(BIST_COLLAR_EN5), 
                        ...
                        .MEM2_All_SCOL0_FUSE_REG(MEM6_All_SCOL0_FUSE_REG[5:0]), 
        ...
        //                             |_____________________________|
                   ...
                   //-------------------------------------------------------------   
                      ...
                      `endif
                        ...
                        .MEM3_All_SCOL0_FUSE_REG(MEM7_All_SCOL0_FUSE_REG[5:0]), 
        ...
        //                             |_____________________________|
                   ...
                   //-------------------------------------------------------------   
                      ...
                      `endif
                        ...
                        .BIST_WRITEENABLE(BIST_WRITEENABLE), .BIST_READENABLE(BIST_READENABLE), 
                        .BIST_SELECT(BIST_SELECT), .BIST_ROW_ADD(BIST_ROW_ADD[6:0]), 
                        .BIST_COLLAR_EN12(BIST_COLLAR_EN13), 
                        ...
                        .MEM4_All_SCOL0_FUSE_REG(MEM8_All_SCOL0_FUSE_REG[5:0]), 
