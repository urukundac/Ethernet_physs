...
module  fxp_sem_mngdp_wrap_tcam_fxp_sem_proftcam_shell_1024x43_2 #(
        ...
        parameter       TCAM_ANALOG_TUNE_CONFG_WIDTH            = `FXP_TCAM_ANALOG_TUNE_CONFG_WIDTH             , //
       ...
       ,
        ...
        input wire [6:0] BIST_ROW_ADD, input wire BIST_COLLAR_EN2, 
        input wire BIST_COLLAR_EN6, input wire BIST_COLLAR_EN10, 
        input wire BIST_COLLAR_EN14, input wire BIST_RUN_TO_COLLAR2, 
        input wire BIST_RUN_TO_COLLAR6, input wire BIST_RUN_TO_COLLAR10, 
        input wire BIST_RUN_TO_COLLAR14, input wire BIST_ASYNC_RESET, 
        ...
        input wire BIST_COLLAR_HOLD, output wire [23:0] BIST_DATA_FROM_MEM, 
        ...
        input wire tcam_row_1_col_1_bisr_inst_SO, 
        output wire tcam_row_1_col_1_bisr_inst_SO_ts1, 
...
localparam PHYSICAL_ROW_WIDTH = TCAM_WIDTH + BCAM_N7*(2*24 - TCAM_WIDTH);
 wire tcam_row_0_col_0_bisr_inst_SO, tcam_row_0_col_1_bisr_inst_SO, 
      tcam_row_1_col_0_bisr_inst_SO;
 
// Disassembling the to_tcam bus
 `ifndef FXP_FPGA_TCAM_MEMS
        wire     fpga_fast_clk ; 
        assign   fpga_fast_clk   = clk; // Dummy assignment for 
 `endif

`ifdef FXP_FPGA_TCAM_MEMS
        `define FXP_TCAM_FPGA_MEMS
`else
        `define FXP_TCAM_BEHAVE_FPGA_MEMS
`endif
...
`ifndef FXP_FXP_SEM_MNGDP_TCAM_BEHAVE_MEMS
    `define FXP_FXP_SEM_MNGDP_ASIC_MEMS
`endif

`ifdef  FXP_FXP_SEM_MNGDP_ASIC_MEMS
...
localparam TCAM_SLICE_EN_MIN = ((TCAM_SLICE_EN_FACT < TCAM_SLICE_EN_WIDTH ) ? TCAM_SLICE_EN_FACT : TCAM_SLICE_EN_WIDTH);
    ...
    logic    [48-1:0]    tcam_row_wr_data;
    always_comb begin
            tcam_row_wr_data = '1;
            tcam_row_wr_data[0+:PHYSICAL_ROW_WIDTH]    = wr_data;
    end
    logic    [24-1:0]    tcam_wr_data_col[2-1:0];
    always_comb begin
        for (int i = 0; i < 2; i = i + 1) begin
    ...
    logic    [48-1:0]    tcam_chk_key;
    always_comb begin
            tcam_chk_key = '1;
            tcam_chk_key[0+:PHYSICAL_ROW_WIDTH]    = chk_key;
    end
    logic    [24-1:0]    tcam_chk_key_col[2-1:0];
    always_comb begin
        for (int i = 0; i < 2; i = i + 1) begin
    ...
    logic    [48-1:0]    tcam_chk_mask;
    always_comb begin
            tcam_chk_mask        = '0;
            tcam_chk_mask        = wr_en ? '1 : chk_mask_int;
    end
    logic    [24-1:0]    tcam_chk_mask_col[2-1:0];
    always_comb begin
        for (int i = 0; i < 2; i = i + 1) begin
    ...
    logic    [24-1:0]    tcam_rd_data_col[2-1:0][2-1:0];
    logic    [48-1:0]    tcam_rd_data_row;
    always_comb begin
        for (int i = 0; i < 2; i = i + 1) begin
    ...
    logic    [512-1:0]    tcam_col_hit_out[2-1:0][2-1:0];
...
// Match In Array 
    ...
    // EBBs Instantiation
        ...
        wire    [24-1:0]                      tcam_row_0_col_0_data_in_pre = tcam_wr_data_col[0][24-1:0] ;
        wire    [24-1:0]                      tcam_row_0_col_0_key_in =  tcam_chk_key_col[0][24-1:0];
        wire    [24-1:0]                      tcam_row_0_col_0_mask_in = tcam_chk_mask_col[0][24-1:0];
        wire    [512-1:0]                       tcam_row_0_col_0_hit_in = tcam_raw_hit_in[0];
        wire    [512-1:0]                       tcam_row_0_col_0_tcam_match_in = tcam_row_match_in[0];
        wire    [24-1:0]                      tcam_row_0_col_0_data_out_inv;
        ...
        //                             |_____________________________|
                         ...
                         fxp_sem_mngdp_ip783tcam512x24s0c1_0_0_wrap #(        
                                 )               
                   ...
                   //-------------------------------------------------------------   
                      ...
                      `endif
                        ...
                        .BIST_COLLAR_EN0(BIST_COLLAR_EN2), 
                        ...
                        .ram_row_0_col_0_bisr_inst_SO(tcam_row_1_col_1_bisr_inst_SO), 
                        .tcam_row_0_col_0_bisr_inst_SO(tcam_row_0_col_0_bisr_inst_SO), 
                        .MEM1_All_SCOL0_FUSE_REG(MEM9_All_SCOL0_FUSE_REG[5:0]), 
        ...
        wire    [24-1:0]                      tcam_row_0_col_1_data_in = tcam_row_wr_en[0] ? tcam_wr_data_col[1][24-1:0] : tcam_chk_key_col[1][24-1:0];
        wire    [24-1:0]                      tcam_row_0_col_1_data_in_pre = tcam_wr_data_col[1][24-1:0] ;
        wire    [24-1:0]                      tcam_row_0_col_1_key_in =  tcam_chk_key_col[1][24-1:0];
        wire    [24-1:0]                      tcam_row_0_col_1_mask_in = tcam_chk_mask_col[1][24-1:0];
        wire    [512-1:0]                       tcam_row_0_col_1_hit_in = tcam_raw_hit_in[0];
        wire    [512-1:0]                       tcam_row_0_col_1_tcam_match_in = tcam_row_match_in[0];
        wire    [24-1:0]                      tcam_row_0_col_1_data_out_inv;
        logic   [512-1:0]                     tcam_row_0_col_1_hit_out_int;
        logic   [512-1:0]                     tcam_row_0_col_1_hit_out_latch;
        logic   [512-1:0]                     tcam_row_0_col_1_hit_out;
        ...
        wire      [24-1:0]    tcam_row_0_col_1_tdin = 'b0;
        wire      [10-1:0]     tcam_row_0_col_1_tadr = 'b0;
        wire                            tcam_row_0_col_1_tvbe = 'b0;
        wire                            tcam_row_0_col_1_tvbi = 'b0;
        wire      [24-1:0]    tcam_row_0_col_1_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_0_col_1_slice_en_s1; 
             ...
             wire    [24-1:0]                     tcam_row_0_col_1_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         fxp_sem_mngdp_ip783tcam512x24s0c1_0_1_wrap #(        
                                 )               
        
                                 ip783tcam512x24s0c1_wrap_tcam_row_0_col_1 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_0_col_1_adr[10-1:1]), //Input adr_intess
                         .ME                (ce),  
                        ...
                        .BIST_WRITEENABLE(BIST_WRITEENABLE), .BIST_READENABLE(BIST_READENABLE), 
                        .BIST_SELECT(BIST_SELECT), .BIST_ROW_ADD(BIST_ROW_ADD[6:0]), 
                        .BIST_COLLAR_EN4(BIST_COLLAR_EN6), 
                        ...
                        .MEM2_All_SCOL0_FUSE_REG(MEM10_All_SCOL0_FUSE_REG[5:0]), 
                        .tcam_row_0_col_1_bisr_inst_Q_ts1(tcam_row_0_col_1_bisr_inst_Q[5:0]), 
                        .fscan_clkungate(fscan_clkungate), .fscan_mode(ltest_to_en)
                     );
        ...
        wire    [24-1:0]                      tcam_row_1_col_0_data_in = tcam_row_wr_en[1] ? tcam_wr_data_col[0][24-1:0] : tcam_chk_key_col[0][24-1:0];
        wire    [24-1:0]                      tcam_row_1_col_0_data_in_pre = tcam_wr_data_col[0][24-1:0] ;
        wire    [24-1:0]                      tcam_row_1_col_0_key_in =  tcam_chk_key_col[0][24-1:0];
        wire    [24-1:0]                      tcam_row_1_col_0_mask_in = tcam_chk_mask_col[0][24-1:0];
        wire    [512-1:0]                       tcam_row_1_col_0_hit_in = tcam_raw_hit_in[1];
        wire    [512-1:0]                       tcam_row_1_col_0_tcam_match_in = tcam_row_match_in[1];
        wire    [24-1:0]                      tcam_row_1_col_0_data_out_inv;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_1_col_0_slice_en_s1; 
             ...
             wire    [24-1:0]                     tcam_row_1_col_0_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         fxp_sem_mngdp_ip783tcam512x24s0c1_1_0_wrap #(        
                                 )               
                   ...
                   //-------------------------------------------------------------   
                      ...
                      `endif
                        ...
                        .MEM3_All_SCOL0_FUSE_REG(MEM11_All_SCOL0_FUSE_REG[5:0]), 
        ...
        wire    [10-1:0]                       tcam_row_1_col_1_adr  = tcam_row_adr[1][10-1:0];
        wire    [24-1:0]                      tcam_row_1_col_1_data_in = tcam_row_wr_en[1] ? tcam_wr_data_col[1][24-1:0] : tcam_chk_key_col[1][24-1:0];
        wire    [24-1:0]                      tcam_row_1_col_1_data_in_pre = tcam_wr_data_col[1][24-1:0] ;
        wire    [24-1:0]                      tcam_row_1_col_1_key_in =  tcam_chk_key_col[1][24-1:0];
        wire    [24-1:0]                      tcam_row_1_col_1_mask_in = tcam_chk_mask_col[1][24-1:0];
        wire    [512-1:0]                       tcam_row_1_col_1_hit_in = tcam_raw_hit_in[1];
        wire    [512-1:0]                       tcam_row_1_col_1_tcam_match_in = tcam_row_match_in[1];
        wire    [24-1:0]                      tcam_row_1_col_1_data_out_inv;
        logic   [512-1:0]                     tcam_row_1_col_1_hit_out_int;
        logic   [512-1:0]                     tcam_row_1_col_1_hit_out_latch;
        logic   [512-1:0]                     tcam_row_1_col_1_hit_out;
        ...
        wire      [24-1:0]    tcam_row_1_col_1_tdin = 'b0;
        wire      [10-1:0]     tcam_row_1_col_1_tadr = 'b0;
        wire                            tcam_row_1_col_1_tvbe = 'b0;
        wire                            tcam_row_1_col_1_tvbi = 'b0;
        wire      [24-1:0]    tcam_row_1_col_1_tmask = 'b0;
        ...
        logic   [TCAM_SLICE_EN_FACT-1:0]                  tcam_row_1_col_1_slice_en_s1; 
             ...
             wire    [24-1:0]                     tcam_row_1_col_1_data_out ;
        ...
        //                             |_____________________________|
                         ...
                         fxp_sem_mngdp_ip783tcam512x24s0c1_1_1_wrap #(        
                                 )               
        
                                 ip783tcam512x24s0c1_wrap_tcam_row_1_col_1 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        .vddp             (1'b1),
                      `endif
                         .ADR               (tcam_row_1_col_1_adr[10-1:1]), //Input adr_intess
                         .ME                (ce),  
                        ...
                        .BIST_WRITEENABLE(BIST_WRITEENABLE), .BIST_READENABLE(BIST_READENABLE), 
                        .BIST_SELECT(BIST_SELECT), .BIST_ROW_ADD(BIST_ROW_ADD[6:0]), 
                        .BIST_COLLAR_EN12(BIST_COLLAR_EN14), 
                        .BIST_RUN_TO_COLLAR12(BIST_RUN_TO_COLLAR14), 
                        .BIST_ASYNC_RESET(BIST_ASYNC_RESET), 
                        .BIST_TESTDATA_SELECT_TO_COLLAR(BIST_TESTDATA_SELECT_TO_COLLAR), 
                        .BIST_ON_TO_COLLAR(BIST_ON_TO_COLLAR), 
                        .BIST_WRITE_DATA(BIST_WRITE_DATA[23:0]), 
                        ...
                        .MEM4_All_SCOL0_FUSE_REG(MEM12_All_SCOL0_FUSE_REG[5:0]), 
                        .tcam_row_1_col_1_bisr_inst_Q_ts1(tcam_row_1_col_1_bisr_inst_Q[5:0]), 
                        .fscan_clkungate(fscan_clkungate), .fscan_mode(ltest_to_en)
                     );
...
// DFX output concatination 
        ...
        `ifdef INTEL_SIMONLY
           `ifndef FXP_FEV_APPROVE_SIM_ONLY
                generate
                        if ((TCAM_INIT_TYPE == 1) & (BCAM_N7 == 0)) begin : CONST_TCAM_INIT                           
                            ...
                            task backdoor_loading();
                                forever begin
                                   ...
                                   // release ce;
                                    #1; 
                                    if ($test$plusargs("FXP_FAST_CONFIG")) begin
    ...
    if (BCAM_N7 == 1) 
        begin : bacm_prot_calc
            always_comb begin
                ...
                for (int i = 0; i < 2; i = i + 1) begin
                    rd_data[PHYSICAL_ROW_WIDTH-((2-i-1)*2)-2] = ^rd_data_before_prot_calc[(i*(24-2))+:((24-2)/2)];
                    rd_data[PHYSICAL_ROW_WIDTH-((2-i-1)*2)-1] = ^rd_data_before_prot_calc[(i*(24-2))+((24-2)/2)+:((24-2)/2)];
                end
            end
        end
    else
...
endgenerate
   ...
   `ifdef FXP_TCAM_FPGA_MEMS
       ...
       fxp_mgm_fpga_tcam #(
        ...
        //`ifndef FXP_FPGA_TCAM_MEMS_TCAM_BEHAVE_EN
    ...
    `endif
    `ifdef FXP_TCAM_BEHAVE_FPGA_MEMS
        fxp_mgm_tcam_behave #(
...
parameter       MEM_SEG_PADDING_W = 5 ; 
    ...
    generate if (BCAM_N7==0 && TCAM_PROTECTION_TYPE==1 && BCAM_RELIEF==0) begin : protect    
       ...
       task automatic update_col_sweeper(input bit pattern, input logic[43-1:0] old_val, input logic[43-1:0] new_val);
           logic [43-1:0] temp;
    ...
    // ********** this task is valid for TCAM only *****
      task automatic write_tcam_raw_key (input logic[43-1:0] key, input int row_idx);
          reg temp1,temp2;
          logic [(2 * 24) - 1:0] local_key = '1;
          logic [(2 * 24) - 1:0] prev_key_data;
          local_key[43-1:0] = TCAM_18A ? ~key : ~key;
          ...
          `ifdef FXP_FXP_SEM_MNGDP_TCAM_BEHAVE_MEMS
             `ifndef FXP_FPGA_TCAM_MEMS
         ...
         for (int j = 0;j < 2 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_0_col_0_tcam.ip783tcam512x24s0c1_wrap_tcam_row_0_col_0.tcam_row_0_col_0.ip783tcam512x24s0c1_gen_wrp_inst.ip783tcam512x24s0c1_inst.ip783tcam512x24s0c1_array.array_x[row_idx % 512] = local_key[0*(24 -2*BCAM_N7) +: 24-2*BCAM_N7];
                                    ...
                                    1: begin
                                            //write_mask
                                             gen_tcam_row_0_col_1_tcam.ip783tcam512x24s0c1_wrap_tcam_row_0_col_1.tcam_row_0_col_1.ip783tcam512x24s0c1_gen_wrp_inst.ip783tcam512x24s0c1_inst.ip783tcam512x24s0c1_array.array_x[row_idx % 512] = local_key[1*(24 -2*BCAM_N7) +: 24-2*BCAM_N7];
                                             gen_tcam_row_0_col_1_tcam.ip783tcam512x24s0c1_wrap_tcam_row_0_col_1.tcam_row_0_col_1.ip783tcam512x24s0c1_gen_wrp_inst.ip783tcam512x24s0c1_inst.ip783tcam512x24s0c1_array.array_v[row_idx % 512] = 1'b1;
                                    end
                                    default : begin
         ...
         for (int j = 0;j < 2 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_1_col_0_tcam.ip783tcam512x24s0c1_wrap_tcam_row_1_col_0.tcam_row_1_col_0.ip783tcam512x24s0c1_gen_wrp_inst.ip783tcam512x24s0c1_inst.ip783tcam512x24s0c1_array.array_x[row_idx % 512] = local_key[0*(24 -2*BCAM_N7) +: 24-2*BCAM_N7];
                                    ...
                                    1: begin
                                            //write_mask
                                             gen_tcam_row_1_col_1_tcam.ip783tcam512x24s0c1_wrap_tcam_row_1_col_1.tcam_row_1_col_1.ip783tcam512x24s0c1_gen_wrp_inst.ip783tcam512x24s0c1_inst.ip783tcam512x24s0c1_array.array_x[row_idx % 512] = local_key[1*(24 -2*BCAM_N7) +: 24-2*BCAM_N7];
                                             gen_tcam_row_1_col_1_tcam.ip783tcam512x24s0c1_wrap_tcam_row_1_col_1.tcam_row_1_col_1.ip783tcam512x24s0c1_gen_wrp_inst.ip783tcam512x24s0c1_inst.ip783tcam512x24s0c1_array.array_v[row_idx % 512] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
       ...
       // ********** backdoor DATA ***********
        task automatic write_tcam_raw_inv_key (input logic[43-1:0] inv_key, input int row_idx);
          reg temp1,temp2;
          logic [(2 * 24) - 1:0] local_inv_key = '0;
          logic [(2 * 24) - 1:0] prev_inv_key_data;
          local_inv_key[43-1:0] = TCAM_18A ? ~inv_key : ~inv_key;
         ...
         for (int j = 0;j < 2 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_0_col_0_tcam.ip783tcam512x24s0c1_wrap_tcam_row_0_col_0.tcam_row_0_col_0.ip783tcam512x24s0c1_gen_wrp_inst.ip783tcam512x24s0c1_inst.ip783tcam512x24s0c1_array.array_y[row_idx % 512] = local_inv_key[0*(24 -2*BCAM_N7) +: 24-2*BCAM_N7];
                                             gen_tcam_row_0_col_0_tcam.ip783tcam512x24s0c1_wrap_tcam_row_0_col_0.tcam_row_0_col_0.ip783tcam512x24s0c1_gen_wrp_inst.ip783tcam512x24s0c1_inst.ip783tcam512x24s0c1_array.array_v[row_idx % 512] = 1'b1;
                                    end
                                    1: begin
                                            //write_DATA
                                             gen_tcam_row_0_col_1_tcam.ip783tcam512x24s0c1_wrap_tcam_row_0_col_1.tcam_row_0_col_1.ip783tcam512x24s0c1_gen_wrp_inst.ip783tcam512x24s0c1_inst.ip783tcam512x24s0c1_array.array_y[row_idx % 512] = local_inv_key[1*(24 -2*BCAM_N7) +: 24-2*BCAM_N7];
                                             gen_tcam_row_0_col_1_tcam.ip783tcam512x24s0c1_wrap_tcam_row_0_col_1.tcam_row_0_col_1.ip783tcam512x24s0c1_gen_wrp_inst.ip783tcam512x24s0c1_inst.ip783tcam512x24s0c1_array.array_v[row_idx % 512] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 2 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_1_col_0_tcam.ip783tcam512x24s0c1_wrap_tcam_row_1_col_0.tcam_row_1_col_0.ip783tcam512x24s0c1_gen_wrp_inst.ip783tcam512x24s0c1_inst.ip783tcam512x24s0c1_array.array_y[row_idx % 512] = local_inv_key[0*(24 -2*BCAM_N7) +: 24-2*BCAM_N7];
                                             gen_tcam_row_1_col_0_tcam.ip783tcam512x24s0c1_wrap_tcam_row_1_col_0.tcam_row_1_col_0.ip783tcam512x24s0c1_gen_wrp_inst.ip783tcam512x24s0c1_inst.ip783tcam512x24s0c1_array.array_v[row_idx % 512] = 1'b1;
                                    end
                                    1: begin
                                            //write_DATA
                                             gen_tcam_row_1_col_1_tcam.ip783tcam512x24s0c1_wrap_tcam_row_1_col_1.tcam_row_1_col_1.ip783tcam512x24s0c1_gen_wrp_inst.ip783tcam512x24s0c1_inst.ip783tcam512x24s0c1_array.array_y[row_idx % 512] = local_inv_key[1*(24 -2*BCAM_N7) +: 24-2*BCAM_N7];
                                             gen_tcam_row_1_col_1_tcam.ip783tcam512x24s0c1_wrap_tcam_row_1_col_1.tcam_row_1_col_1.ip783tcam512x24s0c1_gen_wrp_inst.ip783tcam512x24s0c1_inst.ip783tcam512x24s0c1_array.array_v[row_idx % 512] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
       ...
       task automatic write_tcam_raw_line (input logic[43-1:0] key, input logic [43-1:0] inv_key, input int row_idx);
       ...
       // ********** backdoor MASK ***********
       //****this task is valid for TCAM only*****
       task automatic read_tcam_raw_key (output logic[43-1:0] key, input int row_idx);
           reg temp1,valid_word;
           logic [(2 * 24) - 1:0] local_key;
           // check size out-of-bounds
           if (row_idx >= TCAM_RULES_NUM) begin
         ...
         for (int j = 0;j < 2 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*24 +: 24] = gen_tcam_row_0_col_0_tcam.ip783tcam512x24s0c1_wrap_tcam_row_0_col_0.tcam_row_0_col_0.ip783tcam512x24s0c1_gen_wrp_inst.ip783tcam512x24s0c1_inst.ip783tcam512x24s0c1_array.array_x[row_idx % 512];
                                    end
                                    1: begin
                                            //READ_mask
                                             local_key[1*24 +: 24] = gen_tcam_row_0_col_1_tcam.ip783tcam512x24s0c1_wrap_tcam_row_0_col_1.tcam_row_0_col_1.ip783tcam512x24s0c1_gen_wrp_inst.ip783tcam512x24s0c1_inst.ip783tcam512x24s0c1_array.array_x[row_idx % 512];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 2 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*24 +: 24] = gen_tcam_row_1_col_0_tcam.ip783tcam512x24s0c1_wrap_tcam_row_1_col_0.tcam_row_1_col_0.ip783tcam512x24s0c1_gen_wrp_inst.ip783tcam512x24s0c1_inst.ip783tcam512x24s0c1_array.array_x[row_idx % 512];
                                    end
                                    1: begin
                                            //READ_mask
                                             local_key[1*24 +: 24] = gen_tcam_row_1_col_1_tcam.ip783tcam512x24s0c1_wrap_tcam_row_1_col_1.tcam_row_1_col_1.ip783tcam512x24s0c1_gen_wrp_inst.ip783tcam512x24s0c1_inst.ip783tcam512x24s0c1_array.array_x[row_idx % 512];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
     ...
     // ********** backdoor DATA ***********
       task automatic read_tcam_raw_inv_key (output logic[43-1:0] inv_key, input int row_idx);
           reg temp1,valid_word;
           logic [(2 * 24) - 1:0] local_inv_key;
           // check size out-of-bounds
           if (row_idx >= TCAM_RULES_NUM) begin
         ...
         for (int j = 0;j < 2 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*24 +: 24] = gen_tcam_row_0_col_0_tcam.ip783tcam512x24s0c1_wrap_tcam_row_0_col_0.tcam_row_0_col_0.ip783tcam512x24s0c1_gen_wrp_inst.ip783tcam512x24s0c1_inst.ip783tcam512x24s0c1_array.array_y[row_idx % 512];
                                    end
                                    1: begin
                                            //READ_data
                                             local_inv_key[1*24 +: 24] = gen_tcam_row_0_col_1_tcam.ip783tcam512x24s0c1_wrap_tcam_row_0_col_1.tcam_row_0_col_1.ip783tcam512x24s0c1_gen_wrp_inst.ip783tcam512x24s0c1_inst.ip783tcam512x24s0c1_array.array_y[row_idx % 512];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 2 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*24 +: 24] = gen_tcam_row_1_col_0_tcam.ip783tcam512x24s0c1_wrap_tcam_row_1_col_0.tcam_row_1_col_0.ip783tcam512x24s0c1_gen_wrp_inst.ip783tcam512x24s0c1_inst.ip783tcam512x24s0c1_array.array_y[row_idx % 512];
                                    end
                                    1: begin
                                            //READ_data
                                             local_inv_key[1*24 +: 24] = gen_tcam_row_1_col_1_tcam.ip783tcam512x24s0c1_wrap_tcam_row_1_col_1.tcam_row_1_col_1.ip783tcam512x24s0c1_gen_wrp_inst.ip783tcam512x24s0c1_inst.ip783tcam512x24s0c1_array.array_y[row_idx % 512];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
       ...
       task automatic read_tcam_raw_line (output logic[43-1:0] key, output logic [43-1:0] inv_key, input int row_idx);
