...
module  fxp_sem_mngdp_wrap_tcam_fxp_sem_proftcam_shell_1024x43_3 #(
       ...
       ,
        ...
        input wire [6:0] BIST_ROW_ADD, input wire BIST_COLLAR_EN3, 
        input wire BIST_COLLAR_EN7, input wire BIST_COLLAR_EN11, 
        input wire BIST_COLLAR_EN15, input wire BIST_RUN_TO_COLLAR3, 
        input wire BIST_RUN_TO_COLLAR7, input wire BIST_RUN_TO_COLLAR11, 
        ...
        //                             |_____________________________|
                   ...
                   //-------------------------------------------------------------   
                      ...
                      `endif
                        ...
                        .BIST_COLLAR_EN0(BIST_COLLAR_EN3), 
                        ...
                        .MEM1_All_SCOL0_FUSE_REG(MEM13_All_SCOL0_FUSE_REG[5:0]), 
        ...
        //                             |_____________________________|
                   ...
                   //-------------------------------------------------------------   
                      ...
                      `endif
                        ...
                        .BIST_WRITEENABLE(BIST_WRITEENABLE), .BIST_READENABLE(BIST_READENABLE), 
                        .BIST_SELECT(BIST_SELECT), .BIST_ROW_ADD(BIST_ROW_ADD[6:0]), 
                        .BIST_COLLAR_EN4(BIST_COLLAR_EN7), 
                        ...
                        .MEM2_All_SCOL0_FUSE_REG(MEM14_All_SCOL0_FUSE_REG[5:0]), 
        ...
        //                             |_____________________________|
                   ...
                   //-------------------------------------------------------------   
                      ...
                      `endif
                        ...
                        .MEM3_All_SCOL0_FUSE_REG(MEM15_All_SCOL0_FUSE_REG[5:0]), 
        ...
        //                             |_____________________________|
                   ...
                   //-------------------------------------------------------------   
                      ...
                      `endif
                        ...
                        .BIST_WRITEENABLE(BIST_WRITEENABLE), .BIST_READENABLE(BIST_READENABLE), 
                        .BIST_SELECT(BIST_SELECT), .BIST_ROW_ADD(BIST_ROW_ADD[6:0]), 
                        .BIST_COLLAR_EN12(BIST_COLLAR_EN15), 
                        .BIST_RUN_TO_COLLAR12(BIST_RUN_TO_COLLAR15), 
                        .BIST_ASYNC_RESET(BIST_ASYNC_RESET), 
                        .BIST_TESTDATA_SELECT_TO_COLLAR(BIST_TESTDATA_SELECT_TO_COLLAR), 
                        .BIST_ON_TO_COLLAR(BIST_ON_TO_COLLAR), 
                        .BIST_WRITE_DATA(BIST_WRITE_DATA[23:0]), 
                        ...
                        .MEM4_All_SCOL0_FUSE_REG(MEM16_All_SCOL0_FUSE_REG[5:0]), 
