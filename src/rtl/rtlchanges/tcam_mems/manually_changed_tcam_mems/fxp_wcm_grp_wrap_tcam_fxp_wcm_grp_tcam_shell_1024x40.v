...
module  fxp_wcm_grp_wrap_tcam_fxp_wcm_grp_tcam_shell_1024x40 #(
       ...
       ,
        ...
        input wire BIST_COLLAR_EN0, input wire BIST_COLLAR_EN8, 
        input wire BIST_RUN_TO_COLLAR0, input wire BIST_RUN_TO_COLLAR8, 
        ...
        input wire bisr_reset_pd_vinf, input wire ram_row_0_col_0_bisr_inst_SO, 
        ...
        input wire fscan_clkungate, input wire fscan_mode, 
...
localparam PHYSICAL_ROW_WIDTH = TCAM_WIDTH + BCAM_N7*(1*40 - TCAM_WIDTH);
 wire tcam_row_0_col_0_bisr_inst_SO;
...
`ifndef FXP_FXP_WCM_GRP_TCAM_BEHAVE_MEMS
    `define FXP_FXP_WCM_GRP_ASIC_MEMS
`endif

`ifdef  FXP_FXP_WCM_GRP_ASIC_MEMS
...
// Match In Array 
    ...
    // EBBs Instantiation
        ...
        //                             |_____________________________|
                         ...
                         fxp_wcm_grp_ip783tcam512x40s0c1_0_0_wrap #(        
                                 )               
        
                                 ip783tcam512x40s0c1_wrap_tcam_row_0_col_0 (
                   //-------------------------------------------------------------
                   ...
                   //-------------------------------------------------------------   
                      ...
                      `endif
                        ...
                        .fscan_clkungate(fscan_clkungate), .fscan_mode(fscan_mode)
                     );
        ...
        //                             |_____________________________|
                         ...
                         fxp_wcm_grp_ip783tcam512x40s0c1_1_0_wrap #(        
                                 )               
        
                                 ip783tcam512x40s0c1_wrap_tcam_row_1_col_0 (
                   //-------------------------------------------------------------
                   // Power Management Interfaces
                   //-------------------------------------------------------------   
                      `ifndef INTEL_NO_PWR_PINS
                      ...
                      `endif
                        ...
                        .BIST_WRITEENABLE(BIST_WRITEENABLE), .BIST_READENABLE(BIST_READENABLE), 
                        .BIST_SELECT(BIST_SELECT), .BIST_COL_ADD(BIST_COL_ADD), 
                        .BIST_ROW_ADD(BIST_ROW_ADD[6:0]), .BIST_COLLAR_EN8(BIST_COLLAR_EN8), 
                        ...
                        .fscan_clkungate(fscan_clkungate), .fscan_mode(fscan_mode_ts1)
                     );
...
parameter       MEM_SEG_PADDING_W = 0 ; 
    ...
    // ********** this task is valid for TCAM only *****
      task automatic write_tcam_raw_key (input logic[40-1:0] key, input int row_idx);
          ...
          `ifdef FXP_FXP_WCM_GRP_TCAM_BEHAVE_MEMS
             `ifndef FXP_FPGA_TCAM_MEMS
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_0_col_0_tcam.ip783tcam512x40s0c1_wrap_tcam_row_0_col_0.tcam_row_0_col_0.ip783tcam512x40s0c1_gen_wrp_inst.ip783tcam512x40s0c1_inst.ip783tcam512x40s0c1_array.array_x[row_idx % 512] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_0_col_0_tcam.ip783tcam512x40s0c1_wrap_tcam_row_0_col_0.tcam_row_0_col_0.ip783tcam512x40s0c1_gen_wrp_inst.ip783tcam512x40s0c1_inst.ip783tcam512x40s0c1_array.array_v[row_idx % 512] = 1'b1;
                                    end
                                    default : begin
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_mask
                                             gen_tcam_row_1_col_0_tcam.ip783tcam512x40s0c1_wrap_tcam_row_1_col_0.tcam_row_1_col_0.ip783tcam512x40s0c1_gen_wrp_inst.ip783tcam512x40s0c1_inst.ip783tcam512x40s0c1_array.array_x[row_idx % 512] = local_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_1_col_0_tcam.ip783tcam512x40s0c1_wrap_tcam_row_1_col_0.tcam_row_1_col_0.ip783tcam512x40s0c1_gen_wrp_inst.ip783tcam512x40s0c1_inst.ip783tcam512x40s0c1_array.array_v[row_idx % 512] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
        ...
        task automatic write_tcam_raw_inv_key (input logic[40-1:0] inv_key, input int row_idx);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_0_col_0_tcam.ip783tcam512x40s0c1_wrap_tcam_row_0_col_0.tcam_row_0_col_0.ip783tcam512x40s0c1_gen_wrp_inst.ip783tcam512x40s0c1_inst.ip783tcam512x40s0c1_array.array_y[row_idx % 512] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_0_col_0_tcam.ip783tcam512x40s0c1_wrap_tcam_row_0_col_0.tcam_row_0_col_0.ip783tcam512x40s0c1_gen_wrp_inst.ip783tcam512x40s0c1_inst.ip783tcam512x40s0c1_array.array_v[row_idx % 512] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //write_DATA
                                             gen_tcam_row_1_col_0_tcam.ip783tcam512x40s0c1_wrap_tcam_row_1_col_0.tcam_row_1_col_0.ip783tcam512x40s0c1_gen_wrp_inst.ip783tcam512x40s0c1_inst.ip783tcam512x40s0c1_array.array_y[row_idx % 512] = local_inv_key[0*(40 -2*BCAM_N7) +: 40-2*BCAM_N7];
                                             gen_tcam_row_1_col_0_tcam.ip783tcam512x40s0c1_wrap_tcam_row_1_col_0.tcam_row_1_col_0.ip783tcam512x40s0c1_gen_wrp_inst.ip783tcam512x40s0c1_inst.ip783tcam512x40s0c1_array.array_v[row_idx % 512] = 1'b1;
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
       ...
       task automatic read_tcam_raw_key (output logic[40-1:0] key, input int row_idx);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_0_col_0_tcam.ip783tcam512x40s0c1_wrap_tcam_row_0_col_0.tcam_row_0_col_0.ip783tcam512x40s0c1_gen_wrp_inst.ip783tcam512x40s0c1_inst.ip783tcam512x40s0c1_array.array_x[row_idx % 512];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_mask
                                             local_key[0*40 +: 40] = gen_tcam_row_1_col_0_tcam.ip783tcam512x40s0c1_wrap_tcam_row_1_col_0.tcam_row_1_col_0.ip783tcam512x40s0c1_gen_wrp_inst.ip783tcam512x40s0c1_inst.ip783tcam512x40s0c1_array.array_x[row_idx % 512];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
       ...
       task automatic read_tcam_raw_inv_key (output logic[40-1:0] inv_key, input int row_idx);
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_0_col_0_tcam.ip783tcam512x40s0c1_wrap_tcam_row_0_col_0.tcam_row_0_col_0.ip783tcam512x40s0c1_gen_wrp_inst.ip783tcam512x40s0c1_inst.ip783tcam512x40s0c1_array.array_y[row_idx % 512];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
         ...
         for (int j = 0;j < 1 ; j = j + 1) 
             case (j)
                                    0: begin
                                            //READ_data
                                             local_inv_key[0*40 +: 40] = gen_tcam_row_1_col_0_tcam.ip783tcam512x40s0c1_wrap_tcam_row_1_col_0.tcam_row_1_col_0.ip783tcam512x40s0c1_gen_wrp_inst.ip783tcam512x40s0c1_inst.ip783tcam512x40s0c1_array.array_y[row_idx % 512];
                                    end
                                    default : begin
                                       $error("SOMTING IS wrong with parameters given for col number %d ",j);
                                     end
