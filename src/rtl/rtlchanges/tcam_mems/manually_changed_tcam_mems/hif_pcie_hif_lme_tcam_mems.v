...
module hif_pcie_hif_lme_tcam_mems 
// Interface
(
...
`endif
   ...
   input [`HIF_PCIE_HIF_LME_HIF_LME_LUT_TCAM_TO_TCAM_WIDTH-1:0] hif_lme_hif_lme_lut_tcam_to_tcam        ,   
   input                                          nss_hif_clk                             ,   
   input                                          scon_hif_powergood                      ,

// Module outputs

  output [`HIF_PCIE_HIF_LME_HIF_LME_LUT_TCAM_FROM_TCAM_WIDTH-1:0] hif_lme_hif_lme_lut_tcam_from_tcam            
);
...
hif_pcie_hif_lme_wrap_tcam_hif_lme_lut_tcam_shell_2048x91  #( // Parameters
    .TO_TCAM_WIDTH(`HIF_PCIE_HIF_LME_HIF_LME_LUT_TCAM_TO_TCAM_WIDTH),
    .TCAM_INIT_TYPE(1),
    ...
    .FROM_TCAM_WIDTH(`HIF_PCIE_HIF_LME_HIF_LME_LUT_TCAM_FROM_TCAM_WIDTH),
...
) hif_lme_wrap_tcam_hif_lme_lut_tcam_shell_2048x91(
        .clk(nss_hif_clk),
        .car_raw_lan_power_good(scon_hif_powergood),
`ifdef HIF_PCIE_FPGA_TCAM_MEMS
        .fpga_fast_clk(fpga_fast_clk),
`endif
        .wrap_shell_to_tcam(hif_lme_hif_lme_lut_tcam_to_tcam),
        .wrap_shell_from_tcam(hif_lme_hif_lme_lut_tcam_from_tcam),
        .fuse_tcam(fuse_tcam),
