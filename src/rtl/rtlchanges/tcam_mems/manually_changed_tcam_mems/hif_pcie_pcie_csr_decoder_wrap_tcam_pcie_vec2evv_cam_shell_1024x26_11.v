...
module  hif_pcie_pcie_csr_decoder_wrap_tcam_pcie_vec2evv_cam_shell_1024x26_11 #(
       ...
       ,
        ...
        input wire [5:0] BIST_ROW_ADD, input wire BIST_COLLAR_EN3, 
        input wire BIST_COLLAR_EN19, input wire BIST_COLLAR_EN35, 
        input wire BIST_COLLAR_EN51, input wire BIST_COLLAR_EN67, 
        input wire BIST_COLLAR_EN83, input wire BIST_COLLAR_EN99, 
        input wire BIST_COLLAR_EN115, input wire BIST_RUN_TO_COLLAR3, 
        input wire BIST_RUN_TO_COLLAR19, input wire BIST_RUN_TO_COLLAR35, 
        input wire BIST_RUN_TO_COLLAR51, input wire BIST_RUN_TO_COLLAR67, 
        input wire BIST_RUN_TO_COLLAR83, input wire BIST_RUN_TO_COLLAR99, 
        input wire BIST_RUN_TO_COLLAR115, input wire BIST_ASYNC_RESET, 
        ...
        //                             |_____________________________|
                   ...
                   //-------------------------------------------------------------   
                      ...
                      `endif
                        ...
                        .BIST_WRITEENABLE(BIST_WRITEENABLE), .BIST_READENABLE(BIST_READENABLE), 
                        .BIST_SELECT(BIST_SELECT), .BIST_ROW_ADD(BIST_ROW_ADD[5:0]), 
                        .BIST_COLLAR_EN16(BIST_COLLAR_EN19), 
                        .BIST_RUN_TO_COLLAR16(BIST_RUN_TO_COLLAR19), 
                        .BIST_ASYNC_RESET(BIST_ASYNC_RESET), 
                        .BIST_TESTDATA_SELECT_TO_COLLAR(BIST_TESTDATA_SELECT_TO_COLLAR), 
                        .BIST_ON_TO_COLLAR(BIST_ON_TO_COLLAR), 
                        .BIST_WRITE_DATA(BIST_WRITE_DATA[27:0]), 
        ...
        //                             |_____________________________|
                   ...
                   //-------------------------------------------------------------   
                      ...
                      `endif
                        ...
                        .BIST_WRITEENABLE(BIST_WRITEENABLE), .BIST_READENABLE(BIST_READENABLE), 
                        .BIST_SELECT(BIST_SELECT), .BIST_ROW_ADD(BIST_ROW_ADD[5:0]), 
                        .BIST_COLLAR_EN32(BIST_COLLAR_EN35), 
                        .BIST_RUN_TO_COLLAR32(BIST_RUN_TO_COLLAR35), 
                        .BIST_ASYNC_RESET(BIST_ASYNC_RESET), 
                        .BIST_TESTDATA_SELECT_TO_COLLAR(BIST_TESTDATA_SELECT_TO_COLLAR), 
                        .BIST_ON_TO_COLLAR(BIST_ON_TO_COLLAR), 
                        .BIST_WRITE_DATA(BIST_WRITE_DATA[27:0]), 
        ...
        //                             |_____________________________|
                   ...
                   //-------------------------------------------------------------   
                      ...
                      `endif
                        ...
                        .BIST_WRITEENABLE(BIST_WRITEENABLE), .BIST_READENABLE(BIST_READENABLE), 
                        .BIST_SELECT(BIST_SELECT), .BIST_ROW_ADD(BIST_ROW_ADD[5:0]), 
                        .BIST_COLLAR_EN48(BIST_COLLAR_EN51), 
                        .BIST_RUN_TO_COLLAR48(BIST_RUN_TO_COLLAR51), 
                        .BIST_ASYNC_RESET(BIST_ASYNC_RESET), 
                        .BIST_TESTDATA_SELECT_TO_COLLAR(BIST_TESTDATA_SELECT_TO_COLLAR), 
                        .BIST_ON_TO_COLLAR(BIST_ON_TO_COLLAR), 
                        .BIST_WRITE_DATA(BIST_WRITE_DATA[27:0]), 
        ...
        //                             |_____________________________|
                   ...
                   //-------------------------------------------------------------   
                      ...
                      `endif
                        ...
                        .BIST_WRITEENABLE(BIST_WRITEENABLE), .BIST_READENABLE(BIST_READENABLE), 
                        .BIST_SELECT(BIST_SELECT), .BIST_ROW_ADD(BIST_ROW_ADD[5:0]), 
                        .BIST_COLLAR_EN64(BIST_COLLAR_EN67), 
                        .BIST_RUN_TO_COLLAR64(BIST_RUN_TO_COLLAR67), 
                        .BIST_ASYNC_RESET(BIST_ASYNC_RESET), 
                        .BIST_TESTDATA_SELECT_TO_COLLAR(BIST_TESTDATA_SELECT_TO_COLLAR), 
                        .BIST_ON_TO_COLLAR(BIST_ON_TO_COLLAR), 
                        .BIST_WRITE_DATA(BIST_WRITE_DATA[27:0]), 
        ...
        //                             |_____________________________|
                   ...
                   //-------------------------------------------------------------   
                      ...
                      `endif
                        ...
                        .BIST_WRITEENABLE(BIST_WRITEENABLE), .BIST_READENABLE(BIST_READENABLE), 
                        .BIST_SELECT(BIST_SELECT), .BIST_ROW_ADD(BIST_ROW_ADD[5:0]), 
                        .BIST_COLLAR_EN80(BIST_COLLAR_EN83), 
                        .BIST_RUN_TO_COLLAR80(BIST_RUN_TO_COLLAR83), 
                        .BIST_ASYNC_RESET(BIST_ASYNC_RESET), 
                        .BIST_TESTDATA_SELECT_TO_COLLAR(BIST_TESTDATA_SELECT_TO_COLLAR), 
                        .BIST_ON_TO_COLLAR(BIST_ON_TO_COLLAR), 
                        .BIST_WRITE_DATA(BIST_WRITE_DATA[27:0]), 
        ...
        //                             |_____________________________|
                   ...
                   //-------------------------------------------------------------   
                      ...
                      `endif
                        ...
                        .BIST_WRITEENABLE(BIST_WRITEENABLE), .BIST_READENABLE(BIST_READENABLE), 
                        .BIST_SELECT(BIST_SELECT), .BIST_ROW_ADD(BIST_ROW_ADD[5:0]), 
                        .BIST_COLLAR_EN96(BIST_COLLAR_EN99), 
                        .BIST_RUN_TO_COLLAR96(BIST_RUN_TO_COLLAR99), 
                        .BIST_ASYNC_RESET(BIST_ASYNC_RESET), 
                        .BIST_TESTDATA_SELECT_TO_COLLAR(BIST_TESTDATA_SELECT_TO_COLLAR), 
                        .BIST_ON_TO_COLLAR(BIST_ON_TO_COLLAR), 
                        .BIST_WRITE_DATA(BIST_WRITE_DATA[27:0]), 
        ...
        //                             |_____________________________|
                   ...
                   //-------------------------------------------------------------   
                      ...
                      `endif
                        ...
                        .BIST_WRITEENABLE(BIST_WRITEENABLE), .BIST_READENABLE(BIST_READENABLE), 
                        .BIST_SELECT(BIST_SELECT), .BIST_ROW_ADD(BIST_ROW_ADD[5:0]), 
                        .BIST_COLLAR_EN112(BIST_COLLAR_EN115), 
                        .BIST_RUN_TO_COLLAR112(BIST_RUN_TO_COLLAR115), 
                        .BIST_ASYNC_RESET(BIST_ASYNC_RESET), 
                        .BIST_TESTDATA_SELECT_TO_COLLAR(BIST_TESTDATA_SELECT_TO_COLLAR), 
                        .BIST_ON_TO_COLLAR(BIST_ON_TO_COLLAR), 
                        .BIST_WRITE_DATA(BIST_WRITE_DATA[27:0]), 
