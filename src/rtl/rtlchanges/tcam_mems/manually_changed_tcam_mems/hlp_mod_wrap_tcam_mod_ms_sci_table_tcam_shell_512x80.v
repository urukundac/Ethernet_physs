...
//clc        output        [*num_of_inst*-1:0]                      fscan_sout
        ...
        output wire tcam_row_0_col_1_bisr_inst_SO, input wire fscan_mode_ts1, 
...
// Disassembling the to_tcam bus
  ...
  wire tcam_row_0_col_0_interface_inst_WE, tcam_row_0_col_1_interface_inst_WE, 
       ...
       tcam_row_0_col_1_interface_inst_RE, TRE, TRE_ts1, TME, TME_ts1, 
...
// Match In Array 
    ...
    // EBBs Instantiation
        ...
        logic    [512-1:0]                               tcam_row_0_col_1_hit_out_ff;
        ...
        always_ff @(posedge clk) begin
           ...
           tcam_row_0_col_1_hit_out_ff <= tcam_row_0_col_1_hit_out;
        end
        
        assign          tcam_rd_data_col[0][1]      = ~tcam_row_0_col_1_data_out_ff; // invert data_out before sending back to controller // 
        assign          tcam_col_hit_out[0][1]       = tcam_row_0_col_1_hit_out_ff; // DFT_WRP already delays this by one. 25ww35 - DFT_WRP removed delay. Adding back here.
...
`endif
  ...
  hlp_mod_apr_rtl_tessent_mbist_TCAM_c10_interface_MEM1 tcam_row_0_col_0_interface_inst(
  ...
  hlp_mod_apr_rtl_tessent_mbist_TCAM_c10_interface_MEM2 tcam_row_0_col_1_interface_inst(
      .BIST_CLEAR_BIRA(BIST_CLEAR_BIRA), .FLS_IN(1'b0), .TVBE_IN(1'b0), .TVBI_IN(1'b0), 
      .BIST_CM_MODE_IN(1'b0), .BIST_CM_EN_IN_IN(1'b0), .BIST_CM_MATCH_SEL0_IN(1'b0), 
      .BIST_CM_MATCH_SEL1_IN(1'b0), .BIST_ROTATE_SR_IN(1'b0), .BIST_ALL_MASK_IN(1'b0), 
      .BIST_EN_SR_DATA_B_IN(1'b0), .BIST_EN_SR_MASK_B_IN(1'b0), .BIST_MATCHIN_IN_IN(1'b0), 
      ...
      .BIST_CLEAR_DEFAULT(BIST_CLEAR_DEFAULT), .BIST_CLEAR(BIST_CLEAR), .BIST_SETUP2(BIST_SETUP_ts2), 
      .BIST_SETUP1(BIST_SETUP_ts1), .BIST_SETUP0(BIST_SETUP), .LV_TM(ltest_to_en), 
      .FREEZE_STOP_ERROR(FREEZE_STOP_ERROR), .GO_ID_REG_SEL(GO_ID_REG_SEL), .BIST_COLLAR_EN(BIST_COLLAR_EN2), 
      .FROM_BISR_All_SCOL0_FUSE_REG(tcam_row_0_col_1_bisr_inst_Q[6:1]), .FROM_BISR_All_SCOL0_ALLOC_REG(tcam_row_0_col_1_bisr_inst_Q[0]), 
      .BIST_SHIFT_BIRA_COLLAR(BIST_SHIFT_BIRA_COLLAR), .RESET_REG_SETUP2(MBISTPG_RESET_REG_SETUP2), 
  ...
  hlp_mod_apr_rtl_tessent_mbisr_register_ip783tcam512x40s0c1_dft_wrp tcam_row_0_col_0_bisr_inst(
  ...
  hlp_mod_apr_rtl_tessent_mbisr_register_ip783tcam512x40s0c1_dft_wrp tcam_row_0_col_1_bisr_inst(
