module pcie_upp_ip783tcam128x36s0c1_0_1_wrap   (
	     ...
	     input logic BIST_FLS,
             ...
             input wire [0:0] BIST_BANK_ADD, input wire BIST_COLLAR_EN1, 
             ...
             output wire tcam_row_0_col_1_bisr_inst_SO, 
             input wire [6:0] MEM2_All_SCOL0_FUSE_REG, 
             output wire [6:0] tcam_row_0_col_1_bisr_inst_Q_ts1, 
             input wire fscan_clkungate);
                 ...
                 wire FLS_ts1, TVBE_ts1, TVBI_ts1, BISTE_ts1, BIST_CM_MODE_ts1, 
                      ...
                      tcam_row_0_col_1_interface_inst_WE, TWE_ts1, 
                      tcam_row_0_col_1_interface_inst_RE, TRE_ts1, 
                      tcam_row_0_col_1_interface_inst_ME, TME_ts1;
                 wire [6:0] tcam_row_0_col_1_bisr_inst_Q;
              ...
              `endif    
                 ...
                 .QHR               (QHR),
                 .QVLD              (), 
                 .RE                (tcam_row_0_col_1_interface_inst_RE), //Read Enable
                 ...
                 .WE                (tcam_row_0_col_1_interface_inst_WE), //Write Enable
                 .FAF               (tcam_row_0_col_1_bisr_inst_Q[6:1]),
                 .FAF_EN            (tcam_row_0_col_1_bisr_inst_Q[0]),
  ...
  hif_pcie_pcie_upp_tcam_mems_rtl_tessent_mbist_TCAM_c1_interface_MEM2 tcam_row_0_col_1_interface_inst(
      ...
      .BIST_CLEAR(BIST_CLEAR), .BIST_SETUP0(BIST_SETUP), .LV_TM(ltest_to_en), .BIST_COLLAR_EN(BIST_COLLAR_EN1), 
  ...
  hif_pcie_pcie_upp_tcam_mems_rtl_tessent_mbisr_register_ip783tcam128x36s0c1_dft_wrp tcam_row_0_col_1_bisr_inst(
      .CLK(bisr_clk_pd_vinf), .RSTB(bisr_reset_pd_vinf), .SI(tcam_row_0_col_0_bisr_inst_SO), 
      .SO(tcam_row_0_col_1_bisr_inst_SO), .SE(bisr_shift_en_pd_vinf), .D(MEM2_All_SCOL0_FUSE_REG[6:0]), 
      .MSO(1'b0), .MSEL(1'b0), .Q(tcam_row_0_col_1_bisr_inst_Q)
  );

  assign tcam_row_0_col_1_bisr_inst_Q_ts1[0] = tcam_row_0_col_1_bisr_inst_Q[0];

  assign tcam_row_0_col_1_bisr_inst_Q_ts1[1] = tcam_row_0_col_1_bisr_inst_Q[1];

  assign tcam_row_0_col_1_bisr_inst_Q_ts1[2] = tcam_row_0_col_1_bisr_inst_Q[2];

  assign tcam_row_0_col_1_bisr_inst_Q_ts1[3] = tcam_row_0_col_1_bisr_inst_Q[3];

  assign tcam_row_0_col_1_bisr_inst_Q_ts1[4] = tcam_row_0_col_1_bisr_inst_Q[4];

  assign tcam_row_0_col_1_bisr_inst_Q_ts1[5] = tcam_row_0_col_1_bisr_inst_Q[5];

  assign tcam_row_0_col_1_bisr_inst_Q_ts1[6] = tcam_row_0_col_1_bisr_inst_Q[6];
endmodule
