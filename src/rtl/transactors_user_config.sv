...
////////// USER MUST EDIT THE FOLLOWING LINES /////////////
  ...
  `ifdef FPGA_SYNTH //non DPI (HVCS) and non-sim
     ...
     `endif
			...
			parameter int SFI_D_SRC_0  						= 128 ;    //uru // The options are 64 and 128.
			parameter int SFI_D_SRC_1  						= 128 ;
			parameter int SFI_D_SRC_2  						= 128 ;
			parameter int SFI_D_SRC_3  						= 128 ;
			parameter int SFI_D_SRC_4  						= 128 ;
			parameter int SFI_D_SRC_5  						= 128 ; 
