...
module eth_mem_AW_dcsacram_1r_1w_128x81 (
    input    logic  		 CLKW
   ,input    logic  		 CLKR
   ...
   ,input    logic  [81-1:0] 	 WDATA
   ,input    logic  		 WE
   ,input    logic  		 RE
   ,input    logic 		 RSTB
   ,output   logic  [81-1:0] 	 RDATA
...
eth_ip783hd2prf128x82s0c1r1p3d0v0_mem_wrapper i_rf_128x82_b0 (
