...
module eth_mem_AW_dcsacram_1r_1w_32x32 (
    input    logic  		 CLKW
   ,input    logic  		 CLKR
...
logic  [32-1:0]  b_dout;
logic   [32-1:0]  unused_bout;

//*******************************************************************
// Hook up ASIC SINGLE MEM RF 
//*******************************************************************

eth_ip783hd2prf32x64s0c1r1p3d0v0_mem_wrapper i_rf_32x64_b0 (
