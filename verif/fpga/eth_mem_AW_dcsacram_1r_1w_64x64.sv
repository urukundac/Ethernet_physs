...
module eth_mem_AW_dcsacram_1r_1w_64x64 (
    input    logic  		 CLKW
   ,input    logic  		 CLKR
   ...
   ,output   logic  [64-1:0] 	 RDATA
    ...
    ,input logic shutoff
		,input logic shutoffin // power switch enable input
...
eth_ip783hd2prf64x64s0c1r1p3d0v0_mem_wrapper i_rf_64x64_b0 (
