source [file join [file dirname [info script]] ./../../../ip/i2c_master_tb/i2c_master_inst_avalon_master_bfm_ip/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../../i2c_master/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/i2c_master_tb/i2c_master_inst_clock_bfm_ip/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/i2c_master_tb/i2c_master_inst_conduit_end_bfm_ip/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/i2c_master_tb/i2c_master_inst_reset_bfm_ip/sim/common/modelsim_files.tcl]
...
namespace eval i2c_master_tb {
  ...
  proc get_design_files {QSYS_SIMDIR} {
    ...
    set design_files [concat $design_files [i2c_master_inst_avalon_master_bfm_ip::get_design_files "$QSYS_SIMDIR/../../ip/i2c_master_tb/i2c_master_inst_avalon_master_bfm_ip/sim/"]]
    set design_files [concat $design_files [i2c_master::get_design_files "$QSYS_SIMDIR/../../../i2c_master/sim/"]]
    set design_files [concat $design_files [i2c_master_inst_clock_bfm_ip::get_design_files "$QSYS_SIMDIR/../../ip/i2c_master_tb/i2c_master_inst_clock_bfm_ip/sim/"]]
    set design_files [concat $design_files [i2c_master_inst_conduit_end_bfm_ip::get_design_files "$QSYS_SIMDIR/../../ip/i2c_master_tb/i2c_master_inst_conduit_end_bfm_ip/sim/"]]
    set design_files [concat $design_files [i2c_master_inst_reset_bfm_ip::get_design_files "$QSYS_SIMDIR/../../ip/i2c_master_tb/i2c_master_inst_reset_bfm_ip/sim/"]]
    lappend design_files "-makelib i2c_master_tb \"[normalize_path "$QSYS_SIMDIR/i2c_master_tb.v"]\"   -end"
    return $design_files
  }
