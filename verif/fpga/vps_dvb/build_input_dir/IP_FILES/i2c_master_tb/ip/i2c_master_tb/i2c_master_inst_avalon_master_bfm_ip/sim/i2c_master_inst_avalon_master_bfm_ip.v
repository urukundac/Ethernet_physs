// i2c_master_inst_avalon_master_bfm_ip.v
...
module i2c_master_inst_avalon_master_bfm_ip #(
	...
	altera_avalon_mm_slave_bfm #(
		...
		.VHDL_ID                    (VHDL_ID)
	) i2c_master_inst_avalon_master_bfm (
		.clk                      (clk),               //   input,   width = 1,       clk.clk
		.reset                    (reset),             //   input,   width = 1, clk_reset.reset
		.avs_writedata            (avs_writedata),     //   input,  width = 32,        s0.writedata
		...
		.avs_byteenable           (avs_byteenable),    //   input,   width = 4,          .byteenable
