	component phy_xcvr_rst_ctrl_gen is
		port (
			...
			rx_analogreset_stat  : in  std_logic_vector(3 downto 0) := (others => 'X'); -- rx_analogreset_stat
			rx_digitalreset_stat : in  std_logic_vector(3 downto 0) := (others => 'X')  -- rx_digitalreset_stat
		);
	end component phy_xcvr_rst_ctrl_gen;

	u0 : component phy_xcvr_rst_ctrl_gen
		port map (
