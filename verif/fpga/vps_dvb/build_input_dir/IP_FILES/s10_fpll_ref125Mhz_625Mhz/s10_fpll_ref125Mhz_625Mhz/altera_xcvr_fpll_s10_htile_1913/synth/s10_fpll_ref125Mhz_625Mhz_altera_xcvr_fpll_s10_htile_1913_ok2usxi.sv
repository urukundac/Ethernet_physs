...
module s10_fpll_ref125Mhz_625Mhz_altera_xcvr_fpll_s10_htile_1913_ok2usxi
#(
  // H-Tile specific
...
alt_xcvr_pll_rcfg_opt_logic_ok2usxi 
#(
...
//
  ...
  // Instantiate pulse-width control module
         dps_pulse_ctrl_ok2usxi phase_en_pulse(
        ...
        dps_reset_gen_ok2usxi dps_reset_gen_1 (
           .clk(reconfig_clk[0]),                  // input clock to the HSSI AVMM
