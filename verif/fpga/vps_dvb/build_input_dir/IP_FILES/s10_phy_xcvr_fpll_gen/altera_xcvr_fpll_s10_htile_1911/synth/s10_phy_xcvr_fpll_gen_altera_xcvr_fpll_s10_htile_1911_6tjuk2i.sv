...
module s10_phy_xcvr_fpll_gen_altera_xcvr_fpll_s10_htile_1911_6tjuk2i
#(
  // H-Tile specific
...
alt_xcvr_pll_rcfg_opt_logic_6tjuk2i 
#(
...
//
  ...
  // Instantiate pulse-width control module
         dps_pulse_ctrl_6tjuk2i phase_en_pulse(
        ...
        dps_reset_gen_6tjuk2i dps_reset_gen_1 (
           .clk(reconfig_clk[0]),                  // input clock to the HSSI AVMM
