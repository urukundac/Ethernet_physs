...
# ACDS 19.4 64 linux 2020.02.19.03:08:44
# ----------------------------------------
# Auto-generated simulation script rivierapro_setup.tcl
# ----------------------------------------
# This script provides commands to simulate the following IP detected in
# your Quartus project:
#     s10_pipe_gen1_x4_native_gen
# 
...
# ----------------------------------------
# If s10_pipe_gen1_x4_native_gen is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "s10_pipe_gen1_x4_native_gen.s10_pipe_gen1_x4_native_gen"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/u/red22/Altera/19.4.0.64-Pro/quartus/"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [s10_pipe_gen1_x4_native_gen::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [s10_pipe_gen1_x4_native_gen::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [s10_pipe_gen1_x4_native_gen::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [s10_pipe_gen1_x4_native_gen::get_memory_files "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [s10_pipe_gen1_x4_native_gen::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [s10_pipe_gen1_x4_native_gen::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [s10_pipe_gen1_x4_native_gen::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
