...
# ----------------------------------------
# If io_pll_125mhz_eth_clks is one of several IP cores in your
...
# ----------------------------------------
# ACDS 23.3 104 linux 2025.04.01.23:16:53
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "io_pll_125mhz_eth_clks.io_pll_125mhz_eth_clks"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [io_pll_125mhz_eth_clks::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [io_pll_125mhz_eth_clks::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [io_pll_125mhz_eth_clks::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [io_pll_125mhz_eth_clks::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [io_pll_125mhz_eth_clks::normalize_path "$file"]
  set normalized_dest [io_pll_125mhz_eth_clks::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [io_pll_125mhz_eth_clks::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [io_pll_125mhz_eth_clks::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [io_pll_125mhz_eth_clks::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [io_pll_125mhz_eth_clks::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
