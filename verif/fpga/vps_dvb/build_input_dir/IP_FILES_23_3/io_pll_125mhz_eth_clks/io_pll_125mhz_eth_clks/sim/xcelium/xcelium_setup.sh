...
TOP_LEVEL_NAME="io_pll_125mhz_eth_clks.io_pll_125mhz_eth_clks"
QSYS_SIMDIR="./../"
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [io_pll_125mhz_eth_clks::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [io_pll_125mhz_eth_clks::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set libraries [dict merge $libraries [io_pll_125mhz_eth_clks::get_design_libraries]]
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set design_files [dict merge $design_files [io_pll_125mhz_eth_clks::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set files [concat $files [io_pll_125mhz_eth_clks::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
