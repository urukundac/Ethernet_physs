...
module s10_fpll_ref125Mhz_625Mhz_altera_xcvr_fpll_s10_htile_1913_x6jqpja
#(
  // H-Tile specific
...
alt_xcvr_pll_rcfg_opt_logic_x6jqpja 
#(
...
//
  ...
  // Instantiate pulse-width control module
         dps_pulse_ctrl_x6jqpja phase_en_pulse(
        ...
        dps_reset_gen_x6jqpja dps_reset_gen_1 (
           .clk(reconfig_clk[0]),                  // input clock to the HSSI AVMM
