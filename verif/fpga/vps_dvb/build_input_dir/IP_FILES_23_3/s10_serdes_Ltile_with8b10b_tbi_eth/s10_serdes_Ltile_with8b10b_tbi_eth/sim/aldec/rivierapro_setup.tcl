...
# ACDS 23.3 104 linux 2025.04.02.01:13:23
# ----------------------------------------
# Auto-generated simulation script rivierapro_setup.tcl
# ----------------------------------------
# This script provides commands to simulate the following IP detected in
# your Quartus project:
#     s10_serdes_Ltile_with8b10b_tbi_eth
# 
...
# ----------------------------------------
# If s10_serdes_Ltile_with8b10b_tbi_eth is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "s10_serdes_Ltile_with8b10b_tbi_eth.s10_serdes_Ltile_with8b10b_tbi_eth"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/nfs/site/cproj/gnrd/zsc14.xne_00263/users/tools/altera/pro.23.3/quartus/"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [s10_serdes_Ltile_with8b10b_tbi_eth::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [s10_serdes_Ltile_with8b10b_tbi_eth::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [s10_serdes_Ltile_with8b10b_tbi_eth::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [s10_serdes_Ltile_with8b10b_tbi_eth::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [s10_serdes_Ltile_with8b10b_tbi_eth::normalize_path "$file"]
  set normalized_dest [s10_serdes_Ltile_with8b10b_tbi_eth::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [s10_serdes_Ltile_with8b10b_tbi_eth::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [s10_serdes_Ltile_with8b10b_tbi_eth::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [s10_serdes_Ltile_with8b10b_tbi_eth::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [s10_serdes_Ltile_with8b10b_tbi_eth::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
