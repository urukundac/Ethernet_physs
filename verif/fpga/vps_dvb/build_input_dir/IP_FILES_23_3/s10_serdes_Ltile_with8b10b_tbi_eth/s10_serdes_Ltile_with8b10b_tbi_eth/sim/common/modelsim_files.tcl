...
namespace eval s10_serdes_Ltile_with8b10b_tbi_eth {
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_xcvr_native_s10_htile_1930/sim/s10_serdes_Ltile_with8b10b_tbi_eth_altera_xcvr_native_s10_htile_1930_xmzqn2a.sv"]\" -L altera_common_sv_packages -work altera_xcvr_native_s10_htile_1930"
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_xcvr_native_s10_htile_1930/sim/alt_xcvr_native_rcfg_opt_logic_xmzqn2a.sv"]\" -L altera_common_sv_packages -work altera_xcvr_native_s10_htile_1930"                                      
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/s10_serdes_Ltile_with8b10b_tbi_eth.v"]\"  -work s10_serdes_Ltile_with8b10b_tbi_eth"                                                                                                                   
    return $design_files
  }
