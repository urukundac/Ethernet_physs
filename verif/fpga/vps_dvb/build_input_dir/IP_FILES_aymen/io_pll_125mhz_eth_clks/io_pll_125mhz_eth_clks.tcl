...
# create the system "io_pll_125mhz_eth_clks"
proc do_create_io_pll_125mhz_eth_clks {} {
	# create the system
	create_system io_pll_125mhz_eth_clks
	...
	set_instance_parameter_value iopll_0 {gui_output_clock_frequency1} {3.125}
	...
	set_instance_parameter_value iopll_0 {gui_output_clock_frequency_ps1} {320000.0}
...
<bonusData>
 <element __value="iopll_0">
  <datum __value="_sortIndex" value="0" type="int" />
	...
	#set_module_property FILE {io_pll_125mhz_eth_clks.ip}
	set_module_property GENERATION_ID {0x00000000}
	set_module_property NAME {io_pll_125mhz_eth_clks}

	# save the system
	sync_sysinfo_parameters
	save_system io_pll_125mhz_eth_clks
}
...
do_create_io_pll_125mhz_eth_clks
