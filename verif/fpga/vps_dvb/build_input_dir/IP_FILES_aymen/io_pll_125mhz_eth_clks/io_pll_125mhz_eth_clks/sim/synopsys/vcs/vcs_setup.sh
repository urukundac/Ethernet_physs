...
# ACDS 23.3 104 linux 2025.04.05.05:11:35
...
TOP_LEVEL_NAME="io_pll_125mhz_eth_clks"
QSYS_SIMDIR="./../../"
...
source $QSYS_SIMDIR/common/vcs_files.tcl
set files [dict merge $files [io_pll_125mhz_eth_clks::get_common_design_files "$QSYS_SIMDIR"]]
...
set QSYS_SIMDIR [lindex $argv 1]
source $QSYS_SIMDIR/common/vcs_files.tcl
if {[catch {io_pll_125mhz_eth_clks::get_design_files "$QSYS_SIMDIR"} errorMsg]} {
 puts "Catch error: $errorMsg"
 exit 1 
}
set files [dict create]
set files [dict merge $files [io_pll_125mhz_eth_clks::get_design_files "$QSYS_SIMDIR"]]
