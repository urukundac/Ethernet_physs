...
# ACDS 19.4 64 linux 2020.02.19.02:53:38
# ----------------------------------------
# Auto-generated simulation script rivierapro_setup.tcl
# ----------------------------------------
# This script provides commands to simulate the following IP detected in
# your Quartus project:
#     phy_xcvr_rst_ctrl_gen
# 
...
# ----------------------------------------
# If phy_xcvr_rst_ctrl_gen is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "phy_xcvr_rst_ctrl_gen.phy_xcvr_rst_ctrl_gen"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [phy_xcvr_rst_ctrl_gen::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [phy_xcvr_rst_ctrl_gen::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [phy_xcvr_rst_ctrl_gen::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [phy_xcvr_rst_ctrl_gen::get_memory_files "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [phy_xcvr_rst_ctrl_gen::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [phy_xcvr_rst_ctrl_gen::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [phy_xcvr_rst_ctrl_gen::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
