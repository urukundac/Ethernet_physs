...
TOP_LEVEL_NAME="s10_serdes_Ltile_with8b10b_tbi_eth.s10_serdes_Ltile_with8b10b_tbi_eth"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/nfs/site/cproj/gnrd/zsc14.xne_00263/users/tools/altera/pro.23.3/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [s10_serdes_Ltile_with8b10b_tbi_eth::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [s10_serdes_Ltile_with8b10b_tbi_eth::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set libraries [dict merge $libraries [s10_serdes_Ltile_with8b10b_tbi_eth::get_design_libraries]]
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set design_files [dict merge $design_files [s10_serdes_Ltile_with8b10b_tbi_eth::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set files [concat $files [s10_serdes_Ltile_with8b10b_tbi_eth::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
