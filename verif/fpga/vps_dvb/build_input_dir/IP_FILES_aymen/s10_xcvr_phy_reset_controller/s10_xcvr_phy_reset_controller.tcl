...
# create the system "s10_xcvr_phy_reset_controller"
proc do_create_s10_xcvr_phy_reset_controller {} {
	# create the system
	create_system s10_xcvr_phy_reset_controller
	...
	set_instance_parameter_value xcvr_reset_control_s10_0 {RX_PER_CHANNEL} {0}
	...
	set_instance_parameter_value xcvr_reset_control_s10_0 {TX_PER_CHANNEL} {0}
	...
	set_instance_parameter_value xcvr_reset_control_s10_0 {gui_pll_cal_busy} {0}
...
<bonusData>
 <element __value="xcvr_reset_control_s10_0">
  <datum __value="_sortIndex" value="0" type="int" />
	...
	#set_module_property FILE {s10_xcvr_phy_reset_controller.ip}
	set_module_property GENERATION_ID {0x00000000}
	set_module_property NAME {s10_xcvr_phy_reset_controller}

	# save the system
	sync_sysinfo_parameters
	save_system s10_xcvr_phy_reset_controller
}
...
do_create_s10_xcvr_phy_reset_controller
