...
# create the system "altera_fifo_1x64"
proc do_create_altera_fifo_1x64 {} {
	# create the system
	create_system altera_fifo_1x64
	...
	# add the components
	add_instance fifo_0 fifo 19.1.0
	...
	set_instance_parameter_value fifo_0 {GUI_Depth} {1024}
	...
	set_instance_parameter_value fifo_0 {GUI_Width} {64}
...
<bonusData>
 <element __value="fifo_0">
  <datum __value="_sortIndex" value="0" type="int" />
	...
	#set_module_property FILE {altera_fifo_1x64.ip}
	set_module_property GENERATION_ID {0x00000000}
	set_module_property NAME {altera_fifo_1x64}

	# save the system
	sync_sysinfo_parameters
	save_system altera_fifo_1x64
}
