...
`timescale 1 ns / 1 ns
module clkx_1_altera_avalon_mm_clock_crossing_bridge_1920_4qrhg5a 
#(
...
(
    ...
    clkx_1_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_hcrvori #(
        .SYMBOLS_PER_BEAT (1),
   ...
   endgenerate
    ...
    // --------------------------------------
    (* altera_attribute = "-name ALLOW_ANY_RAM_SIZE_FOR_RECOGNITION ON" *) 
    clkx_1_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_5yposnq #(
        .SYMBOLS_PER_BEAT   (1),
