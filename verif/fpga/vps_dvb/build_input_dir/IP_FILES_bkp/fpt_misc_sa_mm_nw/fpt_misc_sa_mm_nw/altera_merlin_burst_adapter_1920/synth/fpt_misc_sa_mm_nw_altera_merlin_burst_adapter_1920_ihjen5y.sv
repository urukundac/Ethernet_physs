...
// parameterization.
// -----------------------------------------------------
module fpt_misc_sa_mm_nw_altera_merlin_burst_adapter_1920_ihjen5y 
#(
    parameter 
...
(
    ...
    generate if (COMPRESSED_READ_SUPPORT == 0) begin : altera_merlin_burst_adapter_uncompressed_only
        ...
        if(PIPE_INPUTS == 1) begin: pipe_inputs
            fpt_misc_sa_mm_nw_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1920_odztmfi # (
                .SYMBOLS_PER_BEAT (1),
