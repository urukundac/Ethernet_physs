// fpt_misc_sa_mm_nw_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1920_fjiukki.v

// Generated using ACDS version 20.3 158

`timescale 1 ps / 1 ps
module fpt_misc_sa_mm_nw_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1920_fjiukki #(
	...
	fpt_misc_sa_mm_nw_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (in_data),           //   input,  width = 157,          .data
		...
		.out_data          (out_data),          //  output,  width = 157,          .data
