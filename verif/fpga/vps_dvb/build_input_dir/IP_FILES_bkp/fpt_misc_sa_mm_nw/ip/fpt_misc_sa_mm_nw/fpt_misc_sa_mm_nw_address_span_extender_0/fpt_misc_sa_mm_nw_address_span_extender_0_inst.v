	fpt_misc_sa_mm_nw_address_span_extender_0 #(
		...
		.avs_s0_address       (_connected_to_avs_s0_address_),       //   input,  width = 16,  windowed_slave.address
		...
		.avs_s0_burstcount    (_connected_to_avs_s0_burstcount_),    //   input,  width = 11,                .burstcount
		.avm_m0_address       (_connected_to_avm_m0_address_),       //  output,  width = 36, expanded_master.address
		...
		.avm_m0_burstcount    (_connected_to_avm_m0_burstcount_),    //  output,  width = 11,                .burstcount
		.avs_cntl_address     (_connected_to_avs_cntl_address_),     //   input,   width = 2,            cntl.address
		.avs_cntl_read        (_connected_to_avs_cntl_read_),        //   input,   width = 1,                .read
