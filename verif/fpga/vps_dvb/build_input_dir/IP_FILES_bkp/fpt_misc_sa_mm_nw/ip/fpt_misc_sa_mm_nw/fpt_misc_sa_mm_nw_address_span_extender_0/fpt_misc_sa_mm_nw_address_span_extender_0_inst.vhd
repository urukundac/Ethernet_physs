	component fpt_misc_sa_mm_nw_address_span_extender_0 is
		generic (
		...
		port (
			...
			avs_s0_address       : in  std_logic_vector(15 downto 0) := (others => 'X'); -- address
			...
			avs_s0_burstcount    : in  std_logic_vector(10 downto 0) := (others => 'X'); -- burstcount
			avm_m0_address       : out std_logic_vector(35 downto 0);                    -- address
			...
			avm_m0_burstcount    : out std_logic_vector(10 downto 0);                    -- burstcount
			avs_cntl_address     : in  std_logic_vector(1 downto 0)  := (others => 'X'); -- address
	...
	end component fpt_misc_sa_mm_nw_address_span_extender_0;

	u0 : component fpt_misc_sa_mm_nw_address_span_extender_0
		generic map (
		...
		port map (
			...
			avs_cntl_address     => CONNECTED_TO_avs_cntl_address,     --            cntl.address
			avs_cntl_read        => CONNECTED_TO_avs_cntl_read,        --                .read
