	component fpt_misc_sa_mm_nw_mm_clock_crossing_bridge_2 is
		generic (
	...
	end component fpt_misc_sa_mm_nw_mm_clock_crossing_bridge_2;

	u0 : component fpt_misc_sa_mm_nw_mm_clock_crossing_bridge_2
		generic map (
