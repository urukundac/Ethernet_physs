// fpt_misc_sa_mm_nw_mm_clock_crossing_bridge_3_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_yva3jga.v

// Generated using ACDS version 20.3 158

`timescale 1 ps / 1 ps
module fpt_misc_sa_mm_nw_mm_clock_crossing_bridge_3_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_yva3jga #(
		...
		input  wire [59:0] in_data,     //            in.data
		input  wire        in_valid,    //              .valid
		output wire        in_ready,    //              .ready
		output wire [59:0] out_data,    //           out.data
	...
	fpt_misc_sa_mm_nw_mm_clock_crossing_bridge_3_altera_avalon_dc_fifo_1940_j7a573y #(
		...
		.in_data            (in_data),                              //   input,  width = 60,            in.data
		.in_valid           (in_valid),                             //   input,   width = 1,              .valid
		.in_ready           (in_ready),                             //  output,   width = 1,              .ready
		.out_data           (out_data),                             //  output,  width = 60,           out.data
