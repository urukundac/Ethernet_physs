	component fpt_misc_sa_mm_nw_mm_clock_crossing_bridge_3 is
		generic (
	...
	end component fpt_misc_sa_mm_nw_mm_clock_crossing_bridge_3;

	u0 : component fpt_misc_sa_mm_nw_mm_clock_crossing_bridge_3
		generic map (
