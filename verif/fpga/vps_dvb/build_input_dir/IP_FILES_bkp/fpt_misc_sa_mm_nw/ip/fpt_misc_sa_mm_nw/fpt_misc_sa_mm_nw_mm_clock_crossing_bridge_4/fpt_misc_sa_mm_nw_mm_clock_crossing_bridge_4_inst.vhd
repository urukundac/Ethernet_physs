	component fpt_misc_sa_mm_nw_mm_clock_crossing_bridge_4 is
		generic (
	...
	end component fpt_misc_sa_mm_nw_mm_clock_crossing_bridge_4;

	u0 : component fpt_misc_sa_mm_nw_mm_clock_crossing_bridge_4
		generic map (
