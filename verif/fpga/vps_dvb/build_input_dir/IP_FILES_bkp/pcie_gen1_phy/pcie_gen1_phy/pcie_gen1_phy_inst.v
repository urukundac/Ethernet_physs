	pcie_gen1_phy u0 (
		.pipe_sw_done              (_connected_to_pipe_sw_done_),              //   input,   width = 2,              pipe_sw_done.pipe_sw_done
		.pipe_sw                   (_connected_to_pipe_sw_),                   //  output,   width = 2,                   pipe_sw.pipe_sw
		...
		.tx_parallel_data          (_connected_to_tx_parallel_data_),          //   input,  width = 16,          tx_parallel_data.tx_parallel_data
		.tx_datak                  (_connected_to_tx_datak_),                  //   input,   width = 2,                  tx_datak.tx_datak
		.pipe_tx_compliance        (_connected_to_pipe_tx_compliance_),        //   input,   width = 1,        pipe_tx_compliance.pipe_tx_compliance
		.pipe_tx_elecidle          (_connected_to_pipe_tx_elecidle_),          //   input,   width = 1,          pipe_tx_elecidle.pipe_tx_elecidle
		.pipe_tx_detectrx_loopback (_connected_to_pipe_tx_detectrx_loopback_), //   input,   width = 1, pipe_tx_detectrx_loopback.pipe_tx_detectrx_loopback
		.pipe_powerdown            (_connected_to_pipe_powerdown_),            //   input,   width = 2,            pipe_powerdown.pipe_powerdown
		.pipe_tx_margin            (_connected_to_pipe_tx_margin_),            //   input,   width = 3,            pipe_tx_margin.pipe_tx_margin
		.pipe_tx_swing             (_connected_to_pipe_tx_swing_),             //   input,   width = 1,             pipe_tx_swing.pipe_tx_swing
		.pipe_rx_polarity          (_connected_to_pipe_rx_polarity_),          //   input,   width = 1,          pipe_rx_polarity.pipe_rx_polarity
		...
		.rx_parallel_data          (_connected_to_rx_parallel_data_),          //  output,  width = 16,          rx_parallel_data.rx_parallel_data
		.rx_datak                  (_connected_to_rx_datak_),                  //  output,   width = 2,                  rx_datak.rx_datak
		.rx_syncstatus             (_connected_to_rx_syncstatus_),             //  output,   width = 2,             rx_syncstatus.rx_syncstatus
		.pipe_phy_status           (_connected_to_pipe_phy_status_),           //  output,   width = 1,           pipe_phy_status.pipe_phy_status
		.pipe_rx_valid             (_connected_to_pipe_rx_valid_),             //  output,   width = 1,             pipe_rx_valid.pipe_rx_valid
		.pipe_rx_status            (_connected_to_pipe_rx_status_),            //  output,   width = 3,            pipe_rx_status.pipe_rx_status
		.unused_rx_parallel_data   (_connected_to_unused_rx_parallel_data_),   //  output,  width = 55,   unused_rx_parallel_data.unused_rx_parallel_data
		...
		.pipe_rx_eidleinfersel     (_connected_to_pipe_rx_eidleinfersel_),     //   input,   width = 3,     pipe_rx_eidleinfersel.pipe_rx_eidleinfersel
		.pipe_rx_elecidle          (_connected_to_pipe_rx_elecidle_),          //  output,   width = 1,          pipe_rx_elecidle.pipe_rx_elecidle
