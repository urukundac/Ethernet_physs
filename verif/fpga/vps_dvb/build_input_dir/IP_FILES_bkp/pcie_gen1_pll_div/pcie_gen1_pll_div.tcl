...
# create the system "pcie_gen1_pll_div"
proc do_create_pcie_gen1_pll_div {} {
	# create the system
	create_system pcie_gen1_pll_div
	...
	set_instance_parameter_value iopll_0 {gui_output_clock_frequency3} {15.625}
...
<bonusData>
 <element __value="iopll_0">
  <datum __value="_sortIndex" value="0" type="int" />
	...
	#set_module_property FILE {pcie_gen1_pll_div.ip}
	set_module_property GENERATION_ID {0x00000000}
	set_module_property NAME {pcie_gen1_pll_div}

	# save the system
	sync_sysinfo_parameters
	save_system pcie_gen1_pll_div
}
