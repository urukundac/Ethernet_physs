...
# create the system "pcie_gen2_fPLL"
proc do_create_pcie_gen2_fPLL {} {
	# create the system
	create_system pcie_gen2_fPLL
	...
	set_instance_parameter_value xcvr_fpll_s10_htile_0 {enable_mcgb_pcie_clksw} {1}
...
<bonusData>
 <element __value="xcvr_fpll_s10_htile_0">
  <datum __value="_sortIndex" value="0" type="int" />
	...
	#set_module_property FILE {pcie_gen2_fPLL.ip}
	set_module_property GENERATION_ID {0x00000000}
	set_module_property NAME {pcie_gen2_fPLL}

	# save the system
	sync_sysinfo_parameters
	save_system pcie_gen2_fPLL
}
