...
module pcie_gen2_fPLL_altera_xcvr_fpll_s10_htile_1912_5hsjcuq
#(
  // H-Tile specific
...
alt_xcvr_pll_rcfg_opt_logic_5hsjcuq 
#(
...
//
  ...
  // Instantiate pulse-width control module
         dps_pulse_ctrl_5hsjcuq phase_en_pulse(
        ...
        dps_reset_gen_5hsjcuq dps_reset_gen_1 (
           .clk(reconfig_clk[0]),                  // input clock to the HSSI AVMM
