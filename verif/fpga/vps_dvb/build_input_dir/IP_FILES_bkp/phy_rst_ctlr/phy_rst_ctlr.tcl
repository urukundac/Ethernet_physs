...
# create the system "phy_rst_ctlr"
proc do_create_phy_rst_ctlr {} {
	# create the system
	create_system phy_rst_ctlr
	...
	# add the components
	add_instance xcvr_reset_control_s10_0 altera_xcvr_reset_control_s10 19.1.1
...
<bonusData>
 <element __value="xcvr_reset_control_s10_0">
  <datum __value="_sortIndex" value="0" type="int" />
	...
	#set_module_property FILE {phy_rst_ctlr.ip}
	set_module_property GENERATION_ID {0x00000000}
	set_module_property NAME {phy_rst_ctlr}

	# save the system
	sync_sysinfo_parameters
	save_system phy_rst_ctlr
}
