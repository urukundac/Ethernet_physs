...
module s10_fpll_altera_xcvr_fpll_s10_htile_1912_otzyr3q
#(
  // H-Tile specific
...
alt_xcvr_pll_rcfg_opt_logic_otzyr3q 
#(
...
//
  ...
  // Instantiate pulse-width control module
         dps_pulse_ctrl_otzyr3q phase_en_pulse(
        ...
        dps_reset_gen_otzyr3q dps_reset_gen_1 (
           .clk(reconfig_clk[0]),                  // input clock to the HSSI AVMM
