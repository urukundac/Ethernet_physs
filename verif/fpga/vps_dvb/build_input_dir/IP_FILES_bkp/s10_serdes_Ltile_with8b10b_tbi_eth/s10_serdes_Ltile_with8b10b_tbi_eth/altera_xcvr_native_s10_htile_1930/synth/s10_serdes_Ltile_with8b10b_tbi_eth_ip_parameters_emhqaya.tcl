...
set ::GLOBAL_corename s10_serdes_Ltile_with8b10b_tbi_eth_altera_xcvr_native_s10_htile_1930_emhqaya
# -------------------------------- #
# --- Default Profile settings --- #
# -------------------------------- #
dict set native_phy_ip_params channels_profile0 "1"
dict set native_phy_ip_params set_data_rate_profile0 "1250"
...
dict set native_phy_ip_params protocol_mode_profile0 "gige"
