...
# ACDS 23.3 104 linux 2025.04.07.10:55:48
...
TOP_LEVEL_NAME="s10_serdes_Ltile_with8b10b_tbi_eth"
QSYS_SIMDIR="./../../"
...
source $QSYS_SIMDIR/common/vcs_files.tcl
set files [dict merge $files [s10_serdes_Ltile_with8b10b_tbi_eth::get_common_design_files "$QSYS_SIMDIR"]]
...
set QSYS_SIMDIR [lindex $argv 1]
source $QSYS_SIMDIR/common/vcs_files.tcl
if {[catch {s10_serdes_Ltile_with8b10b_tbi_eth::get_design_files "$QSYS_SIMDIR"} errorMsg]} {
 puts "Catch error: $errorMsg"
 exit 1 
}
set files [dict create]
set files [dict merge $files [s10_serdes_Ltile_with8b10b_tbi_eth::get_design_files "$QSYS_SIMDIR"]]
