...
# ACDS 23.3 104 linux 2025.04.07.10:59:26
...
# ----------------------------------------
# If s10_xcvr_phy_reset_controller is one of several IP cores in your
...
TOP_LEVEL_NAME="s10_xcvr_phy_reset_controller"
QSYS_SIMDIR="./../../"
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [s10_xcvr_phy_reset_controller::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [s10_xcvr_phy_reset_controller::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [s10_xcvr_phy_reset_controller::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/vcs_files.tcl
set memory_files [concat $memory_files [s10_xcvr_phy_reset_controller::get_memory_files "$QSYS_SIMDIR"]]
...
source $QSYS_SIMDIR/common/vcs_files.tcl
set files [dict merge $files [s10_xcvr_phy_reset_controller::get_common_design_files "$QSYS_SIMDIR"]]
...
set QSYS_SIMDIR [lindex $argv 1]
source $QSYS_SIMDIR/common/vcs_files.tcl
if {[catch {s10_xcvr_phy_reset_controller::get_design_files "$QSYS_SIMDIR"} errorMsg]} {
 puts "Catch error: $errorMsg"
 exit 1 
}
set files [dict create]
set files [dict merge $files [s10_xcvr_phy_reset_controller::get_design_files "$QSYS_SIMDIR"]]
...
source $QSYS_SIMDIR/common/vcs_files.tcl
set libraries [dict merge $libraries [s10_xcvr_phy_reset_controller::get_dpi_libraries "$QSYS_SIMDIR"]]
