...
# create the system "serdes_tbi_loopback_fifo"
proc do_create_serdes_tbi_loopback_fifo {} {
	# create the system
	create_system serdes_tbi_loopback_fifo
	...
	set_instance_parameter_value fifo_0 {GUI_Width} {10}
...
<bonusData>
 <element __value="fifo_0">
  <datum __value="_sortIndex" value="0" type="int" />
	...
	#set_module_property FILE {serdes_tbi_loopback_fifo.ip}
	set_module_property GENERATION_ID {0x00000000}
	set_module_property NAME {serdes_tbi_loopback_fifo}

	# save the system
	sync_sysinfo_parameters
	save_system serdes_tbi_loopback_fifo
}
...
do_create_serdes_tbi_loopback_fifo
