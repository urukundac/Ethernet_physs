...
# ACDS 23.3 104 linux 2025.04.07.11:11:05
...
TOP_LEVEL_NAME="serdes_tbi_loopback_fifo"
QSYS_SIMDIR="./../../"
...
source $QSYS_SIMDIR/common/vcs_files.tcl
set files [dict merge $files [serdes_tbi_loopback_fifo::get_common_design_files "$QSYS_SIMDIR"]]
...
set QSYS_SIMDIR [lindex $argv 1]
source $QSYS_SIMDIR/common/vcs_files.tcl
if {[catch {serdes_tbi_loopback_fifo::get_design_files "$QSYS_SIMDIR"} errorMsg]} {
 puts "Catch error: $errorMsg"
 exit 1 
}
set files [dict create]
set files [dict merge $files [serdes_tbi_loopback_fifo::get_design_files "$QSYS_SIMDIR"]]
