...
# ----------------------------------------
# If i2c_ip is one of several IP cores in your
...
# ----------------------------------------
# ACDS 24.1 115 linux 2025.07.10.10:02:36
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "i2c_ip.i2c_ip"
}
...
append ELAB_OPTIONS [subst [i2c_ip::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [i2c_ip::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [i2c_ip::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [i2c_ip::normalize_path "$file"]
  set normalized_dest [i2c_ip::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [i2c_ip::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [i2c_ip::get_design_libraries]]
...
alias com {
  ...
  set common_design_files [dict values [i2c_ip::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [i2c_ip::get_design_files "$QSYS_SIMDIR"]]
