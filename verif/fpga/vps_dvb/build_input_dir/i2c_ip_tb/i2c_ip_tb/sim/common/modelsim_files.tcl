source [file join [file dirname [info script]] ./../../../ip/i2c_ip_tb/i2c_ip_inst_conduit_end_bfm_ip/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../../i2c_ip/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/i2c_ip_tb/i2c_ip_inst_avalon_master_bfm_ip/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/i2c_ip_tb/i2c_ip_inst_reset_bfm_ip/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/i2c_ip_tb/i2c_ip_inst_clock_bfm_ip/sim/common/modelsim_files.tcl]
...
namespace eval i2c_ip_tb {
  ...
  proc get_common_design_files {QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [i2c_ip_inst_conduit_end_bfm_ip::get_common_design_files "$QSYS_SIMDIR/../../ip/i2c_ip_tb/i2c_ip_inst_conduit_end_bfm_ip/sim/"]]
    set design_files [dict merge $design_files [i2c_ip::get_common_design_files "$QSYS_SIMDIR/../../../i2c_ip/sim/"]]
    set design_files [dict merge $design_files [i2c_ip_inst_avalon_master_bfm_ip::get_common_design_files "$QSYS_SIMDIR/../../ip/i2c_ip_tb/i2c_ip_inst_avalon_master_bfm_ip/sim/"]]
    set design_files [dict merge $design_files [i2c_ip_inst_reset_bfm_ip::get_common_design_files "$QSYS_SIMDIR/../../ip/i2c_ip_tb/i2c_ip_inst_reset_bfm_ip/sim/"]]
    set design_files [dict merge $design_files [i2c_ip_inst_clock_bfm_ip::get_common_design_files "$QSYS_SIMDIR/../../ip/i2c_ip_tb/i2c_ip_inst_clock_bfm_ip/sim/"]]
    return $design_files
  }
  
  proc get_design_files {QSYS_SIMDIR} {
    set design_files [list]
    set design_files [concat $design_files [i2c_ip_inst_conduit_end_bfm_ip::get_design_files "$QSYS_SIMDIR/../../ip/i2c_ip_tb/i2c_ip_inst_conduit_end_bfm_ip/sim/"]]
    set design_files [concat $design_files [i2c_ip::get_design_files "$QSYS_SIMDIR/../../../i2c_ip/sim/"]]
    set design_files [concat $design_files [i2c_ip_inst_avalon_master_bfm_ip::get_design_files "$QSYS_SIMDIR/../../ip/i2c_ip_tb/i2c_ip_inst_avalon_master_bfm_ip/sim/"]]
    set design_files [concat $design_files [i2c_ip_inst_reset_bfm_ip::get_design_files "$QSYS_SIMDIR/../../ip/i2c_ip_tb/i2c_ip_inst_reset_bfm_ip/sim/"]]
    set design_files [concat $design_files [i2c_ip_inst_clock_bfm_ip::get_design_files "$QSYS_SIMDIR/../../ip/i2c_ip_tb/i2c_ip_inst_clock_bfm_ip/sim/"]]
    lappend design_files "-makelib i2c_ip_tb \"[normalize_path "$QSYS_SIMDIR/i2c_ip_tb.v"]\"   -end"
    return $design_files
  }
