source [file join [file dirname [info script]] ./../../../ip/i2c_ip_tb/i2c_ip_inst_conduit_end_bfm_ip/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../../i2c_ip/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/i2c_ip_tb/i2c_ip_inst_avalon_master_bfm_ip/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/i2c_ip_tb/i2c_ip_inst_reset_bfm_ip/sim/common/vcs_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/i2c_ip_tb/i2c_ip_inst_clock_bfm_ip/sim/common/vcs_files.tcl]
...
namespace eval i2c_ip_tb {
  ...
  proc get_design_files {QSYS_SIMDIR} {
    set design_files [dict create]
    set design_files [dict merge $design_files [i2c_ip_inst_conduit_end_bfm_ip::get_design_files "$QSYS_SIMDIR/../../ip/i2c_ip_tb/i2c_ip_inst_conduit_end_bfm_ip/sim/"]]
    set design_files [dict merge $design_files [i2c_ip::get_design_files "$QSYS_SIMDIR/../../../i2c_ip/sim/"]]
    set design_files [dict merge $design_files [i2c_ip_inst_avalon_master_bfm_ip::get_design_files "$QSYS_SIMDIR/../../ip/i2c_ip_tb/i2c_ip_inst_avalon_master_bfm_ip/sim/"]]
    set design_files [dict merge $design_files [i2c_ip_inst_reset_bfm_ip::get_design_files "$QSYS_SIMDIR/../../ip/i2c_ip_tb/i2c_ip_inst_reset_bfm_ip/sim/"]]
    set design_files [dict merge $design_files [i2c_ip_inst_clock_bfm_ip::get_design_files "$QSYS_SIMDIR/../../ip/i2c_ip_tb/i2c_ip_inst_clock_bfm_ip/sim/"]]
    dict set design_files "i2c_ip_tb.v" "$QSYS_SIMDIR/i2c_ip_tb.v"
    return $design_files
  }
