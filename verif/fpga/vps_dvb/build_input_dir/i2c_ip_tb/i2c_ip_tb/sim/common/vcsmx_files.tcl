source [file join [file dirname [info script]] ./../../../ip/i2c_ip_tb/i2c_ip_inst_conduit_end_bfm_ip/sim/common/vcsmx_files.tcl]
source [file join [file dirname [info script]] ./../../../../i2c_ip/sim/common/vcsmx_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/i2c_ip_tb/i2c_ip_inst_avalon_master_bfm_ip/sim/common/vcsmx_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/i2c_ip_tb/i2c_ip_inst_reset_bfm_ip/sim/common/vcsmx_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/i2c_ip_tb/i2c_ip_inst_clock_bfm_ip/sim/common/vcsmx_files.tcl]
...
namespace eval i2c_ip_tb {
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    lappend design_files "vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"$QSYS_SIMDIR/i2c_ip_tb.v\"  -work i2c_ip_tb"
    return $design_files
  }
